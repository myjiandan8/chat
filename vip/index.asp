    ...
    <tr>
      ...
      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="578" id="AutoNumber2" height="250">
        ...
        <tr>
          ...
          <td width="61" height="249" rowspan="13" valign="bottom"><img border="0" src="img/girl01.gif"></td>
        </tr>

        <tr>
          <td width="90" height="19" align="center">
          我的虚拟形象</td>
          <td width="427" height="18" colspan="2">&nbsp;</td>
          </tr>
        <tr>
          <td width="90" height="162" align="center" rowspan="5">
...
<a href="dudu">更换形象</a></td>
        ...
        <tr>
          ...
          <td width="375" height="28">
          <a href="../chat">聊天主页</a> |
          <a target="_blank" href="room_add.asp">建立VIP会员KTV房间</a> |
          <a href="shop_bchat.asp"><font color="#FF0000">购买房间</font></a> | 
			<font color="#FF0000"><a href="shop_bliaochat.asp">
			<font color="#800080">申请巡管</font></a></font></td>
          </tr>
        <tr>
          <td width="52" height="29"><img border="0" src="img/button_7.gif"></td>
          <td width="375" height="29">
        ...
        <tr>
          ...
          <td width="375" height="31"><a href="/bbs/friend.asp">好友列表</a> | 黑名单 |</td>
          </tr>
        <tr>
          <td width="52" height="33"><img border="0" src="img/button_5.gif"></td>
          <td width="375" height="33"><a target="_blank" href="/bbs">视频社区</a> | 音乐在线 | </td>
          </tr>
        <tr>
        ...
        <tr>
          <td width="517" height="206" valign="top" colspan="3">
          <b>
          <font color="#008000">
          【立即申请VIP会员 立即拥有30多视频立体声KTV聊吧】 </font>
          <font color="#FF0000">
          仅仅￥280</font></b><p>&nbsp;&nbsp; 在碧聊拥有自己房间的用户你们有福了，聊湾的碧聊房间挂接系统[<font color="#FF0000">订价980元人民币</font>]，<font color="#008000">现<b>免费</b>提供试用</font>，<font color="#FF0000">使用期为2个月</font>，您将免费享受同聊湾的聊天室一样的服务，拥有自己的聊天室的<b><font color="#000080">网站系统（包括留言系统、新闻、友情连接、网站可自定义界面和聊天室标志。）、相册系统、论坛社区系统、俱乐部[帮会]系统</font></b>。让你一次拥有所有的这一切，而这一切现在都是免费的提供给你。GO 
			GO GO！<br>
...
　</td>
		...
		<tr>
          <td width="517" height="31" valign="top" colspan="3">
          <font color="#008000"><b>你是舞林高手嘛？你的歌声可以迷倒一片吗？你的主持能让听众激动不已吗？<br>
			<br>
			马上注册VCU认证的《视频聊天》 1，注册歌手<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
			2，注册主持人 NetDJ<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
			3，注册舞蹈艺人 </b></font></td>
		...
		<tr>
          <td width="517" height="22" valign="top" colspan="3">
          	</td>
          </tr>
		<tr>
          <td width="517" height="15" valign="top" colspan="3" align="center">
