...
var userlist_top_html = "<table border=0 cellspacing=0><tr><td align=middle><img width=100% height=50 src=http://qliao.wangbo.dhcn.net/01/2171.gif></td></tr><tr><td align=middle><img width=100% src=http://huizhi.91x.net/li/222.gif></td></tr><tr><td align=middle><marquee scrollamount=2><font color=Olive><b>欢迎<font color=red><b>〖"+document.inputform.USER.value+"〗</b></font>来到<font color=red>深蓝情怀</font><font color=red>要麦请打999</font></marquee></td></tr></table>";var config_place= "http://huizhi.91x.net/li/";

var userlist_bottom_html = "";//聊友列表区底部HTML代码
var room_owner           = "*伊人妙禅  ";            //室主名称
var room_name            = "深蓝情怀";		    //房间名称
var room_adminname_head  = "  ";	    //花园管理名
var room_number          = "2171";			    //房间号
var room_link_url        = "http://2171.liaowan.com";	    //房间的地址
var black_roomname       = "";			            //双工房间名称
var black_roomnumb       = "";			            //双工房间号码
var userlist_bkcolor     = "#D9ECFB";	//聊友列表区的背景色
var userlist_bkimage     = "http://qliao.wangbo.dhcn.net/01/img/2013.jpg";		//聊友列表区的背景图，设置为空串则使用输入区的图片
...
(
              ...
              "主页",  "http://",
        "情怀论坛",  "http://qliao.wangbo.dhcn.net",
        "情怀留言",  "http://qliao.wangbo.dhcn.net/beike/flashbook.htm",
        "情怀像册",  "http://qliao.wangbo.dhcn.net/Clasky_photo.asp",
        "情怀音乐",  "http://118.vip.dig86.com/music/Nclass.asp?ID=2",
        "情怀注册",  "http://www.liaowan.com/USadmin/regadd.asp"
);
...
(
   0,"情怀主持",        "http://huizhi.91x.net/hud.gif",	                "#FF0000","#FFFFFF",	
   1,"情怀室主",	"http://huizhi.91x.net/huizi/hqi.gif",	                "#FF0880","#FFFFFF",	
   2,"情怀副室",	"http://218.14.151.133/friend/photo/2390314369.gif",	"#9B439B","#FFFFFF", 	
   3,"情怀高管",	"http://huizhi.91x.net/huizi/xing.gif",	                "#FF00FF","#FFFFFF",	
   4,"情怀管理",	"http://qliao.wangbo.dhcn.net/01/006.gif",	        "#8000BD","#FFFFFF",	
   5,"情怀巡管",	"http://qliao.wangbo.dhcn.net/01/img1/em32.gif",	                "#6D61C9","#FFFFFF",	
   6,"情怀贵宾",	"http://huizhi.91x.net/huizi/e.gif",	                "#0033FF","#FFFFFF",	
   7,"情怀嘉宾",	"http://huizhi.91x.net/huizi/14.gif",	                "#008FEE","#EEF8FF",	
   8,"情怀来宾",	"http://huizhi.91x.net/huizi/0005.gif",	                "#008FEE","#EEF8FF",
   9,"情怀来宾",	"http://huizhi.91x.net/huizi/0005.gif",	                "#41ABF1","#FFFFFF"
...
(
        "花園注册",  "http://admin.bliao.com/user/reguser.htm",

        "网址大全",     "http://hao123.com",

        "免费信箱",     "http://china.msn.com/",

        "碧聊游戏",     "http://game.yinsha.com",
...
(
	...
	"抓你","〖"+document.inputform.USER.value+"〗抓你111111111抓你是疼你111111111抓你是爱你1111111111111111111",

	"抓你","我抓1111111111111111111111〖"+document.inputform.USER.value+"〗疼你才抓你1111111111111111111111111",

	"抓你","我抓111111111我抓11111111111〖"+document.inputform.USER.value+"〗要抓你，抓你是爱你11111111111111111111111",
...
(
	...
	"听见",	"听见啦〖"+document.inputform.USER.value+"〗~~~111111111111111〖"+document.inputform.USER.value+"〗听见啦~~~111111111111111111",

	"听见",	"【〖"+document.inputform.USER.value+"〗听见了】【〖"+document.inputform.USER.value+"〗听见了】【〖"+document.inputform.USER.value+"〗听见了】【〖"+document.inputform.USER.value+"〗听见了】【〖"+document.inputform.USER.value+"〗听见了】",

	"听见",	"好清楚▲▲▲〖"+document.inputform.USER.value+"〗听见了▲▲▲▲▲〖"+document.inputform.USER.value+"〗听见了，好清楚▲▲▲▲▲"
...
(
	...
	"请您准备",	"您好，欢迎来到《心情驿站》,下一个就是您的麦了,请准备好!!!","",
...
(
"管理辛苦了",    "http://qliao.wangbo.dhcn.net/01/img1/gl.gif",
"欢迎光临!请坐!请上坐!!!",         "003.gif",
"太好听啦",      "http://qliao.wangbo.dhcn.net/01/img1/ht.gif",
"跳起来!!!",     "http://qliao.wangbo.dhcn.net/01/img1/tao.gif",
"美妙的歌声!!",  "http://qliao.wangbo.dhcn.net/01/img1/gs.gif",
"好歌",     "http://qliao.wangbo.dhcn.net/01/img1/haoge.gif",
"嘴你",     "http://qliao.wangbo.dhcn.net/01/img1/1.gif",
"吻你",     "http://qliao.wangbo.dhcn.net/01/img1/2.gif",
"放我出去",    "http://qliao.wangbo.dhcn.net/01/img1/3.gif",
"签名",       "http://qliao.wangbo.dhcn.net/01/img1/qm.gif",
"专业啊",     "http://qliao.wangbo.dhcn.net/01/img1/zy.gif",
"开心一笑^_^",         "008.gif",
"我们是好兄弟",     "009.gif",
"快快请坐!先歇一会儿!!",         "010.gif",
"请你喝酒小姐快上菜~~~",         "011.gif",
...
"请喝咖啡进口的哦",         "017.gif",
"请喝咖啡",         "018.gif",
"请您喝茶",   "http://home.91i.net/bjlx/huizi/tg93.gif",
"请您抽烟",   "http://v118v.51.net/huizi/chouyan.gif ", 
"拥抱一个",   "http://www.music.ne.jp/~ucsun/pic/yb.jpg",             
"玫瑰送你",   "http://www.51roses.com/rose/wallpaper/17.jpg",
"蝴蝶情缘",   "http://home.91i.net/bjlx/huizi/9_5489_6.gif",
"邀请歌手",   "http://v118v.51.net/gs004.gif",       
"吵死了丫",	"http://v58v.51.net/tupian/0004.gif",
"缘分有吗?它该来的时候,怎么都挡不住...", "http://dadao.net/htm/wlwx/2002/0708/3322.jpg",
"相隔十万八千里，也是沐浴在同一片月光下。让这棵心送去我的祝福：快乐每一天！ ","http://home.91i.net/bjlx/li/20041.gif",
"我曾有数不清的梦，每个梦都有你；~@~","http://home.91i.net/bjlx/li/hx.gif",
...
"花园仙茶", "http://218.14.151.133/friend/photo/2390314270.jpg", 
...
var a_gc = new Array
(
       "告辞","〖"+room_name+"〗的朋友，〖"+document.inputform.USER.value+"〗先行告辞了。祝大家在此玩得开心！！",
       "888","再见了，〖"+document.inputform.USER.value+"〗要做个堕落天使，到梦中去找我的最爱……"
);
...
(
        "爱你","爱你！！！！！就象老鼠爱大米！！！！",
	"爱错",	"〖"+document.inputform.USER.value+"〗想在五十年之後我一定还是像现在一样爱你,我不要短暂的温存.只要你一世的陪伴.只因你太美好令我无法坦白说出我爱你...",
	"浪漫",	"我希望睡前最後看到的是你... 请你当我手心里的宝,不知道爱你算不算是一个贴心的理由?〖"+document.inputform.USER.value+"〗想要和你一起慢慢变老...",
	"一世",	"好笑吗?身边没你.好怪,陪我一生一世好吗? 和你在一起只是我不想给任何人机会！〖"+document.inputform.USER.value+"〗想未来我一定会天天陪你上市场...",
	"真爱",	"自从你出现後.〖"+document.inputform.USER.value+"〗才知道原来有人爱是那麽的美好.. 曾经迷惘的心中.是你牵引我走出寂寞.我爱你的心是直到世界末日也不变 ...",
	"永恒",	"对你,不管阴晴圆缺,也不变 想想和我一同看日升日落的喜悦吧〖"+document.inputform.USER.value+"〗愿意用一千万年等待你初春暖阳般的绽颜一笑...",
	"陪伴",	"〖"+document.inputform.USER.value+"〗的世界只有你懂 就把你深深藏在我心中 我知道爱要自由才能快乐,我却宁愿留在你身边.陪你.陪你走过...",
	"一生",	"不知什麽时後开始.〖"+document.inputform.USER.value+"〗已学会依赖 只有你知我的情绪,也只有你能带给我情绪 如果这一生我们爱不够.来世必能长久....",
	"珍惜",	"因为知道不能没有你,所以〖"+document.inputform.USER.value+"〗会更珍惜.... 地球仍然转着,世间依旧善变,而我永远爱你 在每一个有你相伴的夜.不再过於寂寥冷清",
	"飞回",	"〖"+document.inputform.USER.value+"〗每天...很想你...人总是会老的.希望到时.你仍在我身边.不论天涯海角.只要你需要我的时候.我就会飞回你的身边...",
	"情爱",	"你使得我的生活有情有爱.还有泪.....〖"+document.inputform.USER.value+"〗不会写情书.只会写~心~.....",
	"想留",	"跳楼须知：痛快到七楼，喘气到六楼，挣扎到五楼，残废到四楼，住院到三楼，吓人到二楼，看热闹到一楼。",
	"爱你",	"如果你冷.我将你拥入怀中.如果你恨.我替你擦去泪痕..如果你爱我.我要向全世界广播..如果你离开我...我会默默地承受...",
	"有留",	"天下雨了是云儿哭了，爱人走了是爱情输了，风儿累了是要去睡了，夕阳醉了是要下坠了，看聊的小猪又在傻哈哈地笑了",
	"惟一",	"我的爱为你开启,像白色的闪电划破天际;我的爱为你奔驰,像红色的血液充满身体....不管今世也来世也好....我所要的只有你.....",
	"有留",	"特大喜讯，上网单向收费已开通，方法：将电脑放入锅中，小火将其煮开，待电脑屏幕上出现“单向收费开通成功”字样即可！",
	"热情",	"虽然不能满足你最大的物质生活...但〖"+document.inputform.USER.value+"〗用自己的心来满足你.. 爱你用自己旧愁里的热情和孩童时代的忠诚...",
	"想留",	"紧急提醒，一种新型网络病毒传播方式：由手机国庆祝福语来传播，为了您的健康，收到祝福语后，务必将电脑浸泡在消毒液中一小时后方可使用！",
	"爱恋",	"你的话已经锁在我的记忆里了那钥匙你就替我保管一辈子吧.没有一种服装比你的爱更合身.没有一种装饰比你的爱更迷人.我想对你爱恋的极短诗篇升华为漫长的生活散文...",
	"合约",	"对你我已经无条件投降了..你就签下爱情合约吧..今生如果.不能拥有你.我会.好恨自己喝了你酿的爱情的酒.如果没有续杯.情愿渴一辈子...",
	"永远",	"我发誓...五十年後...我还是像现在一样爱你...你的名字写满在我心里...就让我永远爱你吧!如果没有你的爱..活著的目标将难复再!",
	"牵挂",	"为你情愿不自由..今生今世永远爱你，我已准备好将权利减半...义务倍增了.... 这一生我只牵你的手....因为今生有你早已足够.....",
	"依恋",	"认识你才知道有一种心情叫做依恋..有一种感觉叫着爱..原来等待也可以如此的美丽..因为爱你..我不相信永远的爱..因为我只会一天比一天更爱你...",
	"温柔",	"自从爱你以後.....才知爱的甜美....... 除了爱你...我想不出能使我继续活著的理由..... 只有爱你..爱你..永远爱你....直到变成风温柔的将你包围......",
	"海枯",	"你是我今生的...新娘... 幸福!只存在和你相聚时刻... 我心中任何时刻都只有想你!爱你! 时间的巨轮无法抹去他对你的思念纵使海枯石烂..你的身影永存於心中...",
	"无言",	"不需言语..让我用行动告诉你..什麽叫爱...... 看著你(你)的眼..我看见了大海..蓝天..更看到了美丽的未来!! 你是我生命中所能经历的..最最深切的感觉!!",
	"吻你",	"只想牵你的手..看你的眼...光著脚丫子..在海边漫步...只有你...只因你...我这一生只为了吻你........",
	"睡容",	"〖"+document.inputform.USER.value+"〗现在每天醒来睁开眼见到的是墙上你那似阳光般的笑靥..好想哪天醒来时..第一眼所触及的是真正的你那似花般甜甜的睡容......",
	"上帝",	"如果活著..是上帝赋予我最大的使命..那麽活麽有你..将会是上帝赋予我使命中最大的恩赐.... 不愿意醒来时..台灯投射在墙上只有我孤独的身影...",
	"习惯",	"不要问我爱你有多深..我真的说不出来..只知道你已成为我生活中的一种习惯..不可或缺的习惯..每天每天..可以不吃饭..不睡觉..却无法不想你......",
	"抱你",	"好想从现在开始抱著你..紧紧的抱著你..一直走到上帝面前... 这辈子最疯狂的事..就是爱上了你..最大的希望..就是有你陪我疯一辈子... ..",
	"情愿",	"真的..输了你..赢了世界又如何？？？　如果爱上你也算是一种错..〖"+document.inputform.USER.value+"〗深信这会是生命中最美丽的错..我情愿错一辈子......",
	"幸福",	"或许我没有太阳般狂热的爱..也没有流水般绵长的情..只知道不断的爱你爱你..无所□能的为你.....看著微笑的你..突然发现..我真是世界上最幸福的人.....",
	"感动",	"假如可以的话..我愿意花去生命中的每一分每一秒~~陪著你~你看到的..就是最真的我!一种永无止尽的感动!感动这世界有你与我这最美的存在!!",
	"坚强",	"好好照顾自己..〖"+document.inputform.USER.value+"〗不想等到下辈子再来爱你 每次我感到失意时..都回忆起你的浅笑..你的鼓励..它们使我坚强的面对下去..谢谢你!!",
	"流星",	"默默祝愿天上的每一个流星..都为你而闪耀天际... 在人群之中寻觅著你..就彷佛在海边掬起所有的沙粒..急於发现你的踪迹..如果不从愿..但愿还有来生...",
	"心情",	"在认识你之後...我才发现自己可以这样情愿的付出........ 以为没有你...我可以坚强一个人.....终於知道这是不可能.... 想你的心情实在没办法用一句话代替....",
	"想念",	"总是想念著你..虽然我们无法共同拥有每分每秒..你就是我最困难时的那位永远支持我的人!你可知我百年的孤寂只为你一人守候千夜的恋歌只为你一人而唱...",
	"思念",	"白昼与黑夜将无法阻挡我俩的深深思念!我是那深深的大海..你是那自海的另一边升起的曙光..永远照亮我的人生.....将你心再加上我的心..就算痛苦滋味也愿意尝...",
	"相遇",	"直到遇见了你.〖"+document.inputform.USER.value+"〗才感受到自己的存在.一直舍不得离开你..虽然你说的如此坚决........每天我的动力就是见到你..并和你说说话....",
	"想留",	"给你点阳光你就灿烂，给你点洪水你就泛滥。我让老太太抹红嘴唇儿，给你点颜色看看。",
	"喜欢",	"思念就像河流般.滔滔不绝地流向大海.流向我的心房.喜欢你的笑容.喜欢静静的看著你.忧愁就像云一样一下子就飞去了,如果能用一辈子换你停留在我视线中.我将毫不保留...",
	"厮守",	"谁说你作的菜难以下□?我会每天回家吃晚饭!!! 虽然天上有多少星光世间有多少女孩..............但天上只有一个月亮世间只有一个你..."
);
...

{
	...
	write_button("","情怀播放器",565,0,75,20,"","情怀播放器","xdjm()");
	...
	write_button("","告辞",478,60,35,20,"","向大家告辞","autosend(a_gc)");
	...
	write_select("linkurl","花园链接",569,80,72,select_color,a_linkurl,"gotolinkurl(this)");
...

{
	...
	write_button("autospack","情话",443,80,35,20,"","快速情话","autosend(a_qh)");
...

{
	...
	HTMLstr += "--></style></head><body leftmargin=2 rightmargin=0";
        ...
        HTMLstr += ('</script>');
	HTMLstr += "<br><a title='当前聊天室在线人数'><font color=#027F17> 当前有 </font><font color=red><B id='usercount'>0</B></font><font color=#027F17> 位朋友</font></a><br>";
	...
	HTMLstr += "<Table cellspacing='0' cellpadding='0'><tr><td id='listhtml'></td></tr></table><center><hr><br>";
        HTMLstr += ("<span style='font-size: 8.7pt;COLOR:red'><marquee direction=up height=80 onmouseout='this.start()' onmouseover=this.stop() scrollAmount=2 width=130 crolldelay=60><center><font color=#FF0000>==深蓝情怀==<Br><font color=#027F17>室主：<Br>*伊人妙禅</Br>欢迎〖"+document.inputform.USER.value+"〗的到来<br>深蓝情怀是我们共同的家</font>");
...
//if ((tmpmsg.indexOf(badword[i])!=-1)&&(auser=="aaa")){
  ...
  document.inputform.msg.value='这里的警察真厉害，我只说了一句脏话网络警察就从天而降，把我扔出了钟情E旧~~~';              
...

{
        ...
        document.write('<input type="button" name=show value="上管刷卡" style="width:70px;height:20;background-image:url(http://v514v.web165.net/AN/6.gif);border:1px" onclick=window.open("http://='+roomnameK+'")>');
...

{
        ...
        open_new_url("http://qliao.wangbo.dhcn.net/06/exobud.html","windowsname","toolbar=no,location=no,menubar=no,revisable=no,width=270,height=176");
...
function fp()
{
        ...
        parent.u1.document.write('(00:00:00)<font color="#9900FF">礼仪小姐微微一笑:</font><font color=#ff00ff>呵呵, 你终于来了! 好想你啊! 我想的都快想不起来了!! 哈哈哈 ! ! ! </font><br>');
}
        function fpbg()
{
        setTimeout("fp()",5000);
