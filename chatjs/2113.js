...
var room_owner="*_小蕾";			//	室主名称
var room_name="天狼伴蕾";		//	房间名称
var room_number="2113";			//	房间号码
...
var userlist_top_html = "<img src=http://liaowan.com/bbs/upload/2004918-161108-$$BF$$E1$$B6$$F9.gif><br><img src=http://pic.liaowan.com/gif/hx.gif>";
//	聊友列表下面的文字，如果不需要，请设置为空串
var userlist_bottom_html = "<p align='center' class='p9'><font color=#009900 >"+room_name+"欢迎您</font><img src=http://lovebbs.yinsha.com/upload/31/2004080409314418/20031114230814309.gif><br><br><br><font color=#009900 > 脚本维护：黑马<br>QQ：317809810</font></SPAN></td></tr></table></td></tr>";
...
var btn_pic_18 = "http://pic.liaowan.com/anniu/15/1.gif";		//	18点宽
var btn_pic_35 = "http://pic.liaowan.com/anniu/15/2.gif";		//	35点宽
var btn_pic_45 = "http://pic.liaowan.com/anniu/15/2.gif";		//	45点宽
var btn_pic_60 = "http://pic.liaowan.com/anniu/15/3.gif";		//	60点宽
var btn_pic_72 = "http://pic.liaowan.com/anniu/15/4.gif";		//	72点宽
...
(
"论坛","http://liaowan.com/bbs/index.asp",	"http://liaowan.com/bbs/index.asp",
"音乐","今生娱乐网",	"http://www.666ccc.com/",
"管理","聊湾加管专用",	"http://liaowan.com/roomadmin/",
"注册","聊友注册",	"http://www.liaowan.com/USadmin/regadd.asp",
"留言","黑马留言本",	"http://mm.cnzjxx.com/FreeWeb/bhqf/book/index.asp?username=黑马"
);
...
(
0,"在线管理（要麦请向我打999）",	"http://pic.liaowan.com/tb/002.gif", 
1,"聊湾站长（你们在玩什么）",	"http://js.liaowan.com/tp/tb/1/009.gif",	
3,"室主（最高权限,可增撤管理。）","http://js.liaowan.com/tp/tb/2/001.gif",       
3,"本室副室",	"http://js.liaowan.com/tp/tb/1/002.gif",
4,"本室高管",	"http://pic.liaowan.com/tb/031.gif",
5,"本室管理（我还没上线）",	"http://pic.liaowan.com/tb/019.gif",
6,"没事偷着乐",	"http://pic.liaowan.com/tb/039.gif",
7,"本室贵宾",	"http://pic.liaowan.com/tb/035.gif",
8,"本室嘉宾",	"http://pic.liaowan.com/tb/040.gif",
9,"本室客人",	"http://pic.liaowan.com/tb/032.gif"
);

//	分屏公告文字
var div_msg1 = "『欢 迎 您 的 光 临』";
var div_msg2 = "本室招聘管理和歌手，有意者请联系室主*_小蕾<a href=http://mm.cnzjxx.com/FreeWeb/bhqf/book/index.asp?username=黑马 target=_blank><font color=#009900 >（点击这里）</font></a>在线申请！";
var div_msg3 = "室主提示你：复制请使用CTRL+C复制 CTRL+V粘贴";
var div_msg4 = '';
var div_link = "";
...
(
"不舍","真是舍不得你走啊....我会想你的..走好~~~~~有空常来玩，http://2113.liaowan.com/，别走错了哦~！",
"走好","真是舍不得，一路走好！我们会想你的~~~~~！有空常来玩，http://2113.liaowan.com/，别忘了哦~！"
);
...
(
"听见",	"111111111【听见了】11111111【我听见了呀】",
"听见",	"【听见了】【是是是】【听见了】【是是是】",
"听见",	"听见了，好清楚▲▲▲▲▲是是是，对对对"
);
...
(
"聊天室网址 http://2113.liaowan.com/","请您牢记<<天狼伴蕾>>聊天室网址 http://2113.liaowan.com/  ",
"聊天室网址 http://2113.liaowan.com/","<<天狼伴蕾>>语音视频聊天室网址 http://2113.liaowan.com/  "
);
...
(
"本室网址","天狼伴蕾欢迎爰亲”臼彝穐ttp://2048.liaowan.com/","color:#009900",
...
function writecv()
{
	...
	if (!accept_right_click)
		parent.v.document.write('<SCRIPT>function about(){alert("黑马欢迎你进入天狼伴蕾");return false;} document.oncontextmenu = new Function("return false;");document.oncontextmenu=about;</script>');
...
if (!accept_right_click)
	parent.r.document.write('<SCRIPT>function about(){alert("黑马欢迎你光临天狼伴蕾");return false;} document.oncontextmenu = new Function("return false;");document.oncontextmenu=about;</script>');
if (userlist_top_html != "")
	...
	parent.r.document.write("</td></tr><tr><td align=middle><marquee><font color=#002FFC><b>欢迎<font color=#002FFC><b>〖"+document.inputform.USER.value+"〗</b></font>来到天狼伴蕾语音聊天室，室主和所有管理欢迎您的到来，愿这里能成为你们情感交流的港湾！！！</b></font></marquee></td></tr></table>");
...
if (!accept_right_click)
	this.u1.document.write('<SCRIPT>function about(){alert("黑马欢迎你进入天狼伴蕾");return false;} document.oncontextmenu = new Function("return false;");document.oncontextmenu=about;</script>');
	fp();
...
//	禁止信息
function about(){alert("黑马欢迎你进入天狼伴蕾");return false;}
...
//-->
//防踢
var admins=new Array("*_小蕾","*_蕾蕾","*开心我的朋友","*§天狼§")
