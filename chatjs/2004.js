...
// 使用方法：<SCRIPT src=http://liaowan.com/chatjs/2004.js></SCRIPT>
...
var room_owner="*冰峰";			//室主名称
var room_name="人间天堂";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="*№聊湾∮";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2004";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";
var room_link_url = "http://"+room_number+".liaowan.com";
alert('   \n\b       ╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮       \n\b       ║欢│║★│║迎│║★│║光│║★│║临│       \n\b       ╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝   \n\b       ╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮       \n\b       ║人│║★│║间│║★│║天│║★│║堂│       \n\b       ╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝\n\n\b\b\b 欢迎您进入『人间天堂』，室主：*冰峰 *阳光熙人   \n\n    希望您在这里能够玩的愉快开心！\n\n\b\b\b【人间天堂】房间招聘在线时间长\n\n\b\b\b有责任心的值班高管及上管歌手,\n\n\b\b\b愿意加入我们这个大家庭的，请与在线高管及室主联系！\n\n\b\b\b本室决定在本月的20号举行开业晚会，希望新老朋友一起光临！！！') 


//	聊友列表区顶部HTML代码
var userlist_top_html = "<table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://web.fs169.net/xiongmaolei/2233gif/2004.gif><BR><B>  <font color=#009900 size=5></font><font color=#0000FF size=4> </font><font color=#FF00FF size=6> </font><font color=#CC00FF size=4> </font></font></B><font color=#0000FF size=4></font></td><tr><td align=middle><img src=http://web.fs169.net/xiongmaolei/2233gif/hx.gif></td></tr><tr><td align=middle><marquee scrollamount=1><font color=Olive size=2><b>室主*冰峰 欢迎<font color=Olive><b>〖"+document.inputform.USER.value+"〗</b></font>来到<font color=Olive>★★</font><font color=red>希望你在这里玩的开心！要麦打999，试麦打666</font></marquee></td></tr></table>"; 
//聊友列表区头部显示
...
//	聊友列表区底部框内文字代码
var listbottem0="室主*冰峰<Br>*阳光熙人<Br>副室*小縘,*聽风*~@海海@~<Br>配置*聊湾<Br>欢迎您的到来<Br>";

var userlist_bkcolor = "#e5fffd";	//	聊友列表区的背景色
var userlist_bkimage = "http://www.liaowan.com/bbs/upload/200498-114425-$$B4$$BD.jpg";			//	聊友列表区的背景图，设置为空串则使用输入区的图片
...
var div_screen_bkimage = "http://www.liaowan.com/bbs/upload/200498-114425-$$B4$$BD.jpg";		//	分屏背景图片	

var voice_bkcolor = "D:\NetRGPlus\Cache\Temporary Internet Files\Content.IE5\9X16COJ3\135302[1].jpg";		//	语音区的背景
var voice_bkimage = "b1.gif";				//	语音区的背景图，空串则使用聊友区图片

var input_bkcolor = "#e5fffd";		//	输入区背景色
var input_bkimage = "fp.gif";				//	输入区背景图片
...
var button_text_color = "#8800FF";	//	输入区按钮文字色
var button_bk_image	= 1;			//	按钮使用背景图片，1--使用，0--不使用
var button_bk_color = "b2.jpg";			//	输入区按钮不使用图片时背景色
...
//	分屏公告文字
var div_msg_color1 = "#008C00";		//	分屏公告颜色
var div_msg_color2 = "#8800FF";		//	分屏公告颜色

var div_msg1 = "欢迎光临人间天堂，这里永远是大家温暖的天堂";
var div_msg2 = "曾经有一份真挚的爱情摆在我面前，我不懂得珍惜，当我失去她的时候，才知道她的珍贵，如果上天再给我一次机会，我一定会对她说，我爱你，如果非要给这份爱加个期限，我希望是一万年..";
var div_msg3 = "【人间天堂】室主:*冰峰*阳光熙人欢迎您光临『人间天堂』语音聊天室！愿您在这里玩的开心愉快！本室大量招聘值班管理和歌手，有意者请与在线高管及室主联系！管理马甲格式：_╱╳天堂※** ，歌手格式：♂歌手→**，请各位管理加管理群:6945422,被下掉的管理请重新申请马甲，一个星期不来的管理将下了管理权限，请相互转告";
var div_msg4 = "今日话题：你相信这个世界上有真爱吗？你会追求真爱吗？本室决定在本月的20号举行开业晚会，希望新老朋友一起光临！！！";  //通知
var div_link = "";var div_link = "";
...
(
	"后台","http://www.liaowan.com/roomadmin",
	"排行","http://www.liaowan.com/paihang.asp",
	"注册","http://liaowan.com/USadmin/regfrom.asp",
	"歌站","http://liaowan.com/bbs/index.asp",
        "论坛","http://asp.ik8.com/jinfan/mybbs/",
        "留言","http://www.qq163.com"
);
//	本室中的 VIP 聊友
...
(
	0,"天堂在线管理","http://pic.liaowan.com/tb/002.gif","#FF0000","#ffffff",     
	1,	"天堂室主",	
         "http://web.fs169.net/xiongmaolei/liao/fu.gif", 
         "#ff00ff","#ffffff", 
      
	2,	"天堂副室",	
         "http://web.fs169.net/xiongmaolei/liao/87383.gif",	"#000000",	"#ffffff",       
         3,	"天堂高管",	"http://pic.liaowan.com/tb/031.gif", 
                                               "#FF8000",	"#ffffff",	4,	"天堂管理",     "http://pic.liaowan.com/tb/030.gif",	 "#970097",	"#ffffff",
         	5,	"天堂宝贝",	"http://xynet.ik8.com/xynet/images/0349.gif",	   "#8B0A50","#FFFFFF",
	6,	"天堂歌手",	"http://pic.liaowan.com/tb/039.gif",	"#008C00",	"#ffffff",
	7,	"天堂贵宾",      "http://pic.liaowan.com/tb/035.gif",	"#000000",	"#ffffff",
	8,	"天堂嘉宾",	"http://pic.liaowan.com/tb/040.gif",	"#2c07fe",	"#ffffff",
         9,	"天堂客人",	"http://web.fs169.net/xiongmaolei/2233gif/10.gif",	"#2c07fe",	"#ffffff"
         );


// 不可踢马甲
var wudimajia=new Array("*Annie","*聽风","*冰峰","*阳光熙人","*~@海海@~");  
...
"管理辛苦了", "http://pic.liaowan.com/gif/z.gif",
...
"唱得太好了",   "http://lovecoco.8u8.com/la023.gif",
...
"不好意思",     "http://fcr01.27h.com/027.jpg",
...
"笑一个",	"http://fcr01.27h.com/070.gif",
"听话哟",	"http://fcr01.27h.com/086.gif",
"你真逗",	"http://gxr02.27h.com/130.gif",
"太可笑了",     "http://fcr01.27h.com/093.jpg",
"笑死我了",     "http://fcr01.27h.com/057.jpg",
"哈哈哈哈",     "http://fcr01.27h.com/117.gif",
"你在吗",       "http://fcr01.27h.com/050.jpg",
"对不起",       "http://fcr01.27h.com/019.gif",
"擦鼻涕",       "http://fcr01.27h.com/041.gif",
"哥俩喝",       "http://fcr01.27h.com/059.gif",
"臭得瑟",       "http://fcr01.27h.com/042.gif",
