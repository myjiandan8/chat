...
var room_owner="*ぬωぬ";			//	室主名称
var room_name="恋网物语";			//	房间名称
var room_adminname_head="*ぬωぬ";			//	本室管理名
var room_number="2071";			//	房间号
var room_link_url = "http://2071.liaowan.com";	//	房间的地址
var black_roomname="";			//	双工房间名称，如果允许房间内双工，请将此名称设为空
var black_roomnumb="";			//	双工房间号码

//	聊友列表区顶部HTML代码
var userlist_top_html = "<table border=0 width=120px cellspacing=0><tr><td align=middle><img WIDTH=140 HEIGHT=60 src=http://www.touch.sh/gb/upload/140101_827_1095946700_1.gif></td></tr></table>";
var userlist_bottom_html = "<img src=http://asp5.6to23.com/gyyj2001/yy/57.gif border=0></td></br><br><tr><td colspan=3 align=center><table width='96' border='1' cellspacing='0' cellpadding='0' bordercolordark='#000000' bordercolorlight='#880099' height='15'><tr><td  colspan=3 width='103' align='center'><span style='font-size: 8.7pt;COLOR=#880099'><marquee direction=up height=70 onmouseout='this.start()' onmouseover=this.stop() scrollAmount=4 width=133 crolldelay=80><center>本室室主：<BR>ゞ*╰ぃLoveぷ海浪ゞゞ<BR>*恋网物语<br>︵ <BR>欢迎大家光临<BR>祝*恋网物语所有朋友<BR>永远开心快乐！<BR>健康幸福常相伴！<BR>配置维护：<BR>*ぬωぬ<BR>QQ30945183</marquee></font></SPAN></td></tr></table></td></tr><a href=http://788685.bliao.com target=_blank>";
...
var body_text_color	= "#DD22DD";	//	输入区文字色
var select_color = "#DD22DD";		//	列表框文字色
var select_text_color = "#DD22DD";	//	列表框内文字色
var button_text_color = "#DD22DD";	//	输入区按钮文字色
...
(
	17,		"http://www.scxws.com/chat/888722/018.gif",
	18,		"http://www.scxws.com/chat/888722/018.gif",
	19,		"http://www.scxws.com/chat/888722/018.gif",
	35,		"http://www.scxws.com/chat/888722/035.gif",
	46,		"http://www.scxws.com/chat/888722/046.gif",
	70,		"http://www.scxws.com/chat/888722/070.gif"
);
...
(   
  ...
  "*!!!℡闲￡逛‰",5,  "*开心了了",5,
  "*0oヾ东来东往︶ㄣ",5,  "*ぐ淼儿ゞ",5,
  "*0oヾ咖啡べ わ",5,  "*0oヾ云儿べ わ",5,
  "*与世无争笑看风云",5,  "*ゞ幻云㊣如梦ゞ",5,
  "*≒忍者∮自来也≡",5,  "*庐山◇安心",5,
  "*ξ︶骗子也钟情ㄣ",5,"*じovの倩儿оО",5,
  "*ξ灬离开水dě魚灬",5,"*.开心了了.",5,
  "*",1,"*",1,
  "*",1,"*",1,
  "*",1,"*",1,
...
(
	0,	"钟情在线主持",	"http://www.touch.sh/gb/upload/140101_545_1095947014_00.gif",	"#FF0000",	"#FFFFFF",
	1,	"宝贝网站长",	"http://www.touch.sh/gb/upload/140101_831_1095947070_01.gif",	"#2C00A5",	"#FFFFFF",
	2,	"宝贝网副站", 	"http://www.touch.sh/gb/upload/140101_224_1095947176_02.gif",	"#5C0099",	"#FFFFFF",
	3,	"本室室主",	"http://www.touch.sh/gb/upload/140101_986_1095947217_03.gif",	"#FF11FF",	"#FFFFFF",
	4,	"本室副室",	"http://www.touch.sh/gb/upload/140101_325_1095947412_04.gif",	"#006400",	"#FFFFFF",
	5,	"特邀贵宾",	"x1.gif",	"#C30072",	"#FFFFFF",
	6,	"本室歌手",	"http://huizhi.91x.net/huizi/0005.gif",	"#0033FF",	"#FFFFFF",
	7,	"本室嘉宾",	"ao3.gif",	"#FF50A7",	"#FFFFFF",
	8,	"本室来宾",	"ao1.gif",	"#FF9428",	"#FFFFFF",
	9,	"本室过客",	"ao.gif",	"#0092C3",	"#FFFFFF"
);
...
function add_new_element()//加入新的界面元素
{
	...
	{
		write_button("","上管",0,0,46,20,"","快速上管","guan()");
...
function writelistbase()//重写聊友列表区
{
	...
	HTMLstr += ('<SCRIPT>');
    HTMLstr += ("function Click(){alert('【钟情-E旧】欢迎您，制作：*音樂索魂  ')\;window.event.returnValue=false\;}document.oncontextmenu=Click\;");
    HTMLstr += ('</script>'); 
	...
	HTMLstr += "<a title=\"请您注意\"><marquee bgcolor=#ffffff><font color=990099>&nbsp;宝贝语音聊天网《钟情-E旧》聊天室```欢迎你的到来~~*^_^*         要麦请向在线的</font><font color=red>红衣管理</font><font color=990099>打出你手中宝贵的</font><font color=red>99999</font></marquee></a><br>";
...
function write_singer_form(left,top,color)//加入麦序管理
{
	...
	document.write('<option selected style=color:'+color+' VALUE="" >¤钟情-E旧-麦序¤</option>');
...
function writecv()//未开语音时的界面
{
	...
	HTMLstr += "<br><a href=http://www.lzswzy.com target=_blank><span style=' font-size: 9pt; color:#0000FF; text-decoration: none'>那就这样吧</span></a></body></html>";
...
function write_make_flowerr(left,top)//输入区流动公告
{
     ...
     document.write("<font style=color:#E68094><marquee scrollamount=1.9 > 欢迎热情开朗、成熟稳重的朋友加入到我们的管理队伍，和大家共同来营造一个清新、愉快的聊天氛围。</marquee></font>");
     document.write('</DIV>')
}
...
function writeu1()//重写分屏区
{
	...
	parent.u1.document.write('<marquee direction=up scrollamount=1.9 height=100 scoolldelay=10><center><font color=#F076A6>【公告】<br><font color=#C078FF>室主：*ξ︶淡№然︶ㄣ<br>*∴爱似盆景∵<br> *o︵ぐ媚儿ゞ︵o <br>欢迎您到来<br>愿【钟情-E旧】留下您快乐的足迹<br>真心祝福您开心快乐！<br>永远支持<a href="http://9love.cn/" target="_blank"><font color="#990099" size="4"><b>【宝贝语音聊天网】</b></font></a><font color=#C078FF>寻找你梦幻中的宝贝！<br>本室网址：http://9love.cn/</marquee><p class=p9 align=left>');	
}
...
document.write('<input type="button" name=show value="管理" style="width:35px;height:18;background-image:url(http://www.scxws.com/chat/888722/035.gif);border:1px" onclick=window.open("http://www.fs169.net/chat/admin.php?room='+roomnameK+'")>');
