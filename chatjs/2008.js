...
var room_owner="*☆〾寳贝〾☆唇";			//室主名称
var room_name="美丽视界";			//	房间名称
var room_adminname_head="*℡ML视界╃" 	//	本室管理名格式
var room_adminname_headg="*ぷ樂隊∮"	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2008";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = " <table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://liaowan.com/bbs/upload/20041024-131827-$$B4$$BD.gif><BR><tr><td align=middle><img src=http://pic.liaowan.com/gif/hx.gif>"; //聊友列表区头部显示
...
var div_msg3 = "无论您走到天涯海角。【"+room_name+"】永远欢迎您！永远等候您！永远陪伴着您！！";
var div_msg4 = "本室诚邀在线主持,乐队歌手,舞员.有意者可以与在线管理联系,或在本室留言板上留言.";  //通知
var div_link = "";
...
(
	...
	"电台","http://radio.lwmm.com/",
       ...
       "留言","http://www.66vi.com/bbs/cgi-bin/forums.cgi?forum=15"
);
...
(
	0,	"婚礼主持",	"http://pic.liaowan.com/tb/023.gif",	"#FF0000",	"#ffffff",
	1,	"美丽视界巡管",	"0002.gif",	"#000000",	"#ffffff",
	2,	"祝愿新人百年好合甜甜美美",	"http://pic.liaowan.com/tb/016.gif",	"#ff00ff",	"#ffffff",
	3,	"嘻嘻说不定下次就轮到偶了",	"http://pic.liaowan.com/tb/017.gif",	 "#ff00ff",	"#ffffff",
	4,	"本室高管",	"http://pic.liaowan.com/tb/jg.gif","#008B8B",	"#ffffff",
	5,	"婚礼管理",	"http://pic.liaowan.com/gif/0004.gif","#34c534",	"#ffffff",
	6,	"婚礼歌手","http://pic.liaowan.com/tb/004.gif", "#FF8C00",	"#ffffff",
	7,	"让开偶给新人送红包来了",	"http://pic.liaowan.com/gif/0003.gif",	"#2c07fe",	"#ffffff",
	8,	"祝福新人天长地久",	"http://pic.liaowan.com/gif/010.gif",	"#2c07fe",	"#ffffff",
	9,	"路过来讨红包滴",	"http://pic.liaowan.com/tb/018.gif",	"#2c07fe","#ffffff"
...
(
	"不舍","走好呀，天黑了，留神脚底下。有时间一定再来《美丽视界》串串门好吗！！ ",
	"走好","真是舍不得你走啊....我会想你的..走好~~~~~有空常来玩http://2008.liaowan.com，别忘了哦~!"
);
...
(
	"想留",	"青山不改，绿水常流，山高水长，后会有期！不用等到江寒月冷日，雪雨风飘时，有缘的你我一定会在《美丽视界》再次相会！",
	"告别",	"长叹一声,凄婉地说道:▅█拜拜●了█▅一曲离歌泪千行,不知何日再逢君.我这就去了,大家多保重▅█拜拜●了█▅··有红包收吗，有的话，可以再多留三秒······",
        "告别",   "其实不想走 其实我想留,留下来陪你每个春夏秋冬,你要相信我 再不用多久,我要你和我今生一起度过... "
);
...
function writecv()//未开语音时的界面
{
	...
	HTMLstr += ("INPUT{COLOR:"+button_text_color+";FONT-SIZE:9pt;FONT-FAMILY:宋体,SimSun;cursor:hand}");
	HTMLstr += ("BODY{background:"+((voice_bkcolor != "")?voice_bkcolor:parent.r.document.body.bgColor)+((m_fullscreen_bgimage != "")?(" url("+m_fullscreen_bgimage+") fixed}"):"}"));
	HTMLstr += "</style><center><br><br><font face=楷体_GB2312><font size=2 color=#874D01><center><u><b>美丽视界<br>语音视频聊天室<br>欢迎您</b></u></center></font></font><center><br><input type=button name=closev value=打开语音 onclick=\"{parent.writev_new();parent.d.decoratev();}\">";
