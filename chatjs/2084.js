<!--
var vers = "1.113";			//	配置版本号
var config_style = 0;			//	配置的风格

var room_owner="*蓝色调子";			//	室主名称
var room_name="蓝调酒吧";		//	房间名称
var room_number="2084";			//	房间号码

var black_roomname="";			//	双工房间名称
var black_roomnumb="";			//	双工房间号码

//	图片等的存放位置，所有没有指定完全网址（http://.....）的图片都到此网址下寻找，但不包括下拉列表框。
var config_place = "http://218.67.78.11:99/vyc/xh/";
//	上管记录地址
var guan_record = "";
//	进门自动播放音乐的地址，没有就设置为空
var auto_player = "";
//	聊友列表区上方的房间名称，可设为图片，只要用HTML代码就可以
var userlist_top_html ="var userlist_top_html ="<img src=http://218.67.78.11:99/vyc/xh/xh-ld.gif border=0 alt=蓝调酒吧>"; 
//	聊友列表下面的文字，如果不需要，请设置为空串
var userlist_bottom_html = "<p align='center' class='p9'><font color=#009900 >"+room_name+"欢迎您</font><br><tr><td colspan=3 align=center><table ><tr><td  colspan=3 width='103' align='center'><span style='font-size: 8.7pt;COLOR:red'><marquee direction=up height=70 onmouseout='this.start()' onmouseover=this.stop() scrollAmount=1 width=120 crolldelay=50><center>==室主==:<br> *蓝色调子<br>欢迎您的光临!<BR></marquee></font><font color=#009900 >http://2084.liaowan.com</font></SPAN></td></tr></table></td></tr>";

var msg_bkimage = "http://kirchoff.ee.suffolk.edu/~lin/bluemelody.jpg";			//	大屏背景图片
var full_screen = 1;			//	是否使用整幅背景，0不使用，1使用（使用大屏背景）
var def_textcolor = 3;			//	默认的发言文字色,从1号到16号
var def_bgcolor = "";			//	默认的发言文字背景色

var div_screen_bkcolor = "fff6ea";	//	分屏区背景色
var div_screen_bkimage = "http://kirchoff.ee.suffolk.edu/~lin/bluemelody.jpg";		//	分屏背景图片	
var div_msg_color1 = "#8800FF";		//	分屏公告颜色
var div_msg_color2 = "#FF0000";		//	分屏公告颜色

var list_user_color = "8800FF";		//	列表区字色
var userlist_bkcolor = "#ECD4F6";	//	列表区背景色
var userlist_bkimage = "http://kirchoff.ee.suffolk.edu/~lin/bluemelody.jpg";		//	列表区的背景图

var voice_bkcolor = "#ECD4F6";		//	语音区背景色
var voice_bkimage = "http://kirchoff.ee.suffolk.edu/~lin/bluemelody.jpg";			//	语音区的背景图
var voice_openimg = "http://kirchoff.ee.suffolk.edu/~lin/bluemelody.jpg";			//	打开语音后下部背景图

var body_text_color = "#660099";	//	输入区文字色
var input_bkcolor = "#C196CE";		//	输入区背景色
var input_bkimage = "#C196CE";			//	输入区背景图片
...
var button_text_color = "#715293";	//	输入区按钮离开后文字色
var button_over_color = "#7438A9";	//	输入区鼠标覆盖时按钮文字色
var input_msg_color = "#715293";	//	输入区文字输入框文字色
...
var btn_pic_18 = "xh18.gif";		//	18点宽
var btn_pic_35 = "xh35.gif";		//	35点宽
var btn_pic_45 = "xh46.gif";		//	45点宽
var btn_pic_60 = "xh70.gif";		//	60点宽
var btn_pic_72 = "xh70.gif";		//	72点宽
...
1,"",	"http://web.fs169.net/xiongmaolei/liao/87383.gif",	
2,"本室室主",     "http://qliao.wangbo.dhcn.net/01/fu.gif", 
3,"本室总管",	"http://qliao.wangbo.dhcn.net/01/em32.gif",
4,"本室高管",	"http://qliao.wangbo.dhcn.net/01/003.gif",
5,"本室管理",	"http://js.liaowan.com/tp/tb/1/010.gif",
6,"本室巡管",	"http://qliao.wangbo.dhcn.net/01/em32.gif",
7,"本室贵宾",	"http://js.liaowan.com/tp/tb/1/009.gif",
8,"本室嘉宾",	"http://js.liaowan.com/tp/tb/1/009.gif",
9,"本室嘉宾",	"http://chat.yeeyoo.com/chatimages/22.gif" ,   "#00FF00",    "",
"666",   ""
);
...
//防踢
var admins=new Array("*o眞訫眞意灬ぺ  ","*╰☆芳⺷_⺷缘☆╮","*火~╲☆╳☆╱~焰","*じ☆寒灬雨☆￡")
