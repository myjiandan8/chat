...
var room_owner="*┈─→魔";			//	室主名称
var room_name="迷情乐园";		//	房间名称
var room_number="2054";			//	房间号码

var black_roomname="";			//	双工房间名称
var black_roomnumb="";			//	双工房间号码
alert('   \n\b       ╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮       \n\b       ║欢│║★│║迎│║★│║光│║★│║临│       \n\b       ╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝   \n\b       ╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮       \n\b       ║迷│║★│║情│║★│║乐│║★│║园│       \n\b       ╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝\n\n\b\b\b 欢迎您进入『迷情乐园』，室主：*┈─→魔    \n\n    希望您在这里能够玩的愉快开心！\n\n\b\b\b 本室欢迎有能力的朋友，加盟本室管理队伍\n\n    有意者请联系QQ:185064051！\n\n\b\b\b\ 谢谢您的支持！欢迎你的加入！！')
//	图片等的存放位置，所有没有指定完全网址（http://.....）的图片都到此网址下寻找，但不包括下拉列表框。
var config_place ="http://pic.liaowan.com/gif/"; 
//	上管记录地址
var guan_record ="";
//	进门自动播放音乐的地址，没有就设置为空
var auto_player = "";
var userlist_top_html = "<table border=0 width=120px cellspacing=0></td><tr><td align=middle><img src=http://free.ty168.net/feitian_0501/2127/miqing.gif><td></tr><tr><td align=middle><img src= http://www.6see.com/js/001/js/gif/lines02.gif ></td></tr><tr><td align=middle><marquee scrollamount=1><font color=ff0000 size=2><b>室主*┈─→魔欢迎<font color=ff0000><b>〖"+document.inputform.USER.value+"〗</b></font>来到<font color=ff0000>★★</font><font color=aa00ff>*迷情乐园*希望你们在这里玩的开心！要麦打999，试麦打666</font></marquee></td></tr></table>"; //聊友列表区头部显示
var userlist_bottom_html = "";
//	聊友列表下面的文字，如果不需要，请设置为空串
var userlist_bottom_html="<tr><td colspan=3 align=center><table width='126' border='1' cellspacing='1' cellpadding='1' bordercolordark='#ff66ff' bordercolorlight='#FFFFFF' height='15'><tr><td  colspan=3 width='130' align='center'><span style='font-size: 8.7pt;COLOR:#ff0000'><marquee direction=up height=70 onmouseout='this.start()' onmouseover=this.stop() scrollAmount=1 width=130 crolldelay=80><center>欢迎朋友们光临<BR>『迷情乐园』<BR><BR>本室网址:<BR>http://2054.liaowan.com<BR><BR>〓★本室室主★〓<BR>*┈─→<BR>*<BR>〓★本室副室★〓<BR>*┈─→<BR><BR>祝朋友们<BR>玩得开心！玩得愉快！<br><img src=http://free.ty168.net/feitian_0501/2127/tingfengtingyu.gif></marquee></font></SPAN></td></tr></table></td></tr>";

var msg_bkimage = "";	//	大屏背景图片
var full_screen = 1;			//	是否使用整幅背景，0不使用，1使用（使用大屏背景）
var def_textcolor = 18;			//	默认的发言文字色,从1号到16号
var def_bgcolor = "";			//	默认的发言文字背景色

var div_screen_bkcolor = "";	//	分屏区背景色
var div_screen_bkimage = "";		//	分屏背景图片	
var div_msg_color1 = "#216937";		//	分屏公告颜色
var div_msg_color2 = "#216937";		//	分屏公告颜色

var list_user_color = "#030FFC";		//	列表区字色
var userlist_bkcolor = "#D4F6DC";	//	列表区背景色
var userlist_bkimage = "";		//	列表区的背景图

var voice_bkcolor = "#E6F7E8";		//	语音区背景色
var voice_bkimage = "";			//	语音区的背景图
var voice_openimg = "";			//	打开语音后下部背景图

var body_text_color = "#660099";	//	输入区文字色
var input_bkcolor = "#DBF7E2";		//	输入区背景色
var input_bkimage = "";			//	输入区背景图片
var select_text_color = "#339900";	//	输入区列表框文字色
var select_bkg_color = "#E6F7E8";	//	输入区列表框背景色
var sel_txt_color = "#CC4499";		//	输入区列表框说明文字颜色
var sel_bkg_color = "#E6F7E8";		//	输入区列表框说明背景颜色
var button_t_color = "#2D6C28";		//	输入区按钮文字色
var button_text_color = "#246622";	//	输入区按钮离开后文字色
var button_over_color = "#ff0000";	//	输入区鼠标覆盖时按钮文字色
var input_msg_color = "#1D5D26";	//	输入区文字输入框文字色
var input_msg_bkcolor = "#E6F7E8";	//	输入区文字输入框背景色
...
var btn_pic_18 = "http://free.ty168.net/feitian_0501/2127/1.gif";		//	18点宽
var btn_pic_35 = "http://free.ty168.net/feitian_0501/2127/2.gif";		//	34点宽
var btn_pic_45 = "http://free.ty168.net/feitian_0501/2127/3.gif";		//	44点宽
var btn_pic_60 = "http://free.ty168.net/feitian_0501/2127/4.gif";		//	60点宽
var btn_pic_72 = "http://free.ty168.net/feitian_0501/2127/4.gif";		//	70点宽

var url_popup_window = "";		//	进入聊天室时弹出的窗口，如果为空则不弹出
var only_registr_user = 0;		//	只允许注册用户进入,0否；1是
var only_chinese_name = 0;		//	只允许汉字名用户进入0否；1是
var default_admin_pass = "147";		//	默认的管理员口令
...
var auto_refresh = 0;			//	自动打开刷新,0不打开；1自动打开
var auto_disable_kick = 1;		//	自动禁止踢人,0不禁止；1自动禁止

var auto_flower_time = 5;		//	自动送花的时间间隔，（单位：秒）
...
"留言","欢迎留言",	"http://gb.wo99.com/index.php?UID=yhh_0316"
);
...
(
	0,	"在线主持",		"http://free.ty168.net/feitian_0501/2127/023.gif",	
	1,	"本室房主",		"http://free.ty168.net/feitian_0501/2127/plnvlb1.gif",
	2,	"执行室主",		"http://free.ty168.net/feitian_0501/2127/16.gif",
	3,	"本室监察",             "http://free.ty168.net/feitian_0501/2127/shi.gif",	
	4,	"本室高管",		"http://free.ty168.net/feitian_0501/2127/009.gif",	
	5,	"本室管理",		"http://free.ty168.net/feitian_0501/2127/031.gif",	
	6,	"本室歌手",		"http://free.ty168.net/feitian_0501/2127/041.gif",
	7,	"本室嘉宾",		"http://free.ty168.net/feitian_0501/2127/10.gif",	
	8,	"本室客人",		"http://free.ty168.net/feitian_0501/2127/10.gif",
	9,	"本室过客",		"http://free.ty168.net/feitian_0501/2127/10.gif"
);

//	分屏公告文字
var div_msg1 = "『　迷情乐园欢迎您　』";
var div_msg2 = "如果立体声语音不能正常运行，请点击下边说明";
var div_msg3 = "欢迎您光临『迷情乐园』语音聊天室！愿您在这里玩的开心愉快！希望这里能够成为您的家！";
var div_msg4 = "本室从即日起招【室主，副室】，由【室主，副室】招聘以下人员：高管，管理，歌手。具体事宜请加房主QQ：185064051联系";
var div_link = "";
//	自动迎宾语
...
black_roomname,	black_roomnumb,
            "真情小屋",		"http://chat1.chat-chat.net:2127/",
	"等待加入",	""
);
//——自动发言内容——
...
"歌星","艺术家！！专业歌星~~~~ぷⅱ哗...「╮ぷⅱ「ⅰ满ぱ琍」☆ぷ(((((霸啪)))))ぷ╰ぷ╰签名！签名！)嘿！哥们~~~~别挤嘛 **我的鞋呢？眼镜？ ",
...
"百荷","★☆ぷⅱ「╮ぷⅱ「ⅰ满ぱ琍」☆ぷぷ(((((((((霸啪))))))))ぷⅱ「ⅰ档」☆ぷⅱ「ⅰ」☆ぷⅱ「╮ぷⅱ「ⅰ偿κ颤」☆ぷⅱ「╮ぷ",
"好听","▇▆▅▄▃▂▁唱得好！▁▂▃▄▅▆▇▇▆▅▄▃▂▁啪啪啪▁▂▃▄▅▆▇▇▆▅▄▃▂▁唱得好！▁▂▃▄▅▆▇▇▆▅▄▃▂▁",
"加油","加油加油！为你加油！你唱的真好哦！(((((((((啪啪))))))))瑰花★☆ぷⅱ「ⅰ满ぱ琍」「╮ぷ",
...
"水仙","玫瑰花★☆ぷⅱ「╮ぷⅱ「ⅰ满ぱ琍」☆ぷⅱ「╮ぷ(((((((((霸啪))))))))ぷⅱ「ⅰ档」☆ぷⅱ「╮ぷぷⅱ「ⅰ」☆ぷⅱ「╮ぷ╰☆╮",
...
(
"不舍","真是舍不得你走啊....我会想你的..走好~~~~~有空常来玩，http://2054.liaowan.com/，别走错了哦~！",
"走好","真是舍不得，一路走好！我们会想你的~~~~~！有空常来玩，http://2054.liaowan.com/，别忘了哦~！"
);
...
(
"网址","请您牢记<<迷情乐园>>聊天室网址 http://2054.liaowan.com ，感觉这里不好，请对我们说！ ",
"网址","<<迷情乐园>>语音视频聊天室网址 http://2054.liaowan.com  ，感觉这里很好，请对你们的朋友说！"
);
...
if (!accept_right_click)
	parent.r.document.write('<SCRIPT>function about(){alert("《迷情乐园》提示您：请使用Ctrl+C、Ctrl+V进行复制、粘贴！！");return false;} document.oncontextmenu = new Function("return false;");document.oncontextmenu=about;</script>');
...
if(lists[2]==1)
	parent.r.document.write("<font face=\"Webdings\" color=#EE00EE size=\"2\">O</font>");
if(lists[2]==2)
	parent.r.document.write("<font face=\"Webdings\" color=#D02090 size=\"2\">H</font>");
if(lists[3]==1)
	parent.r.document.write("<font face=\"Webdings\" color=#ff0000>N</font>");	
...
function fp()
{
if (div_msg1!="") parent.u1.document.write('<p align="center"><font style=filter:glow(color=' + div_msg_color1 + ',strength=5);Height:"2";padding:1px;cursor:hand color=#FFFFFF>'+div_msg1+'</font></p>');
if (div_msg2!="") parent.u1.document.write('<p align="center"><font style=filter:glow(color=' + div_msg_color2 + ',strength=3);Height:"2";padding:1px;cursor:hand color=#FFFFFF>'+div_msg2+'</font></p>');
if (div_msg3!="") parent.u1.document.write('<p align="left"><font color="#FF0000" size="3" face="黑体"><b>〖迷情乐园〗公告：</b></font><font color="#216937" size="2" face="黑体">'+div_msg3+'</font></p>');
...
//	禁止信息
function about(){alert("《迷情乐园》提示您：请使用Ctrl+C、Ctrl+V进行复制、粘贴！ ");return false;}
...
//-->
//防踢
var admins=new Array("*┈─→龍戰","*┈─→問傷","*泪魔","*水水魔","*")
