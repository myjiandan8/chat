...
var room_owner="*◣☆晓慢☆◢";			//室主名称
var room_name="圆梦清角 ";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2101";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";
alert('〓欢迎您光临 圆梦清角  语音聊天室〓       \n\n\n◆◆◆◆◆◆◆◆◆我们的口号◆◆◆◆◆◆◆◆◆       \n\n提高个人素质，体现精神文明，请文明聊天\n你们是幸福的，我们就是快乐的，为你们付出的，再多也值得\n\n◆◆◆◆◆◆◆◆◆我们的口号◆◆◆◆◆◆◆◆◆       \n\n              ★★★　　　★★★       \n            ★★★★★  ★★★★★       \n            ★★★★★★★★★★★       \n            　★★★★★★★★★       \n　            　★★★★★★★       \n　            　　★★★★★       \n　　            　　★★★       \n　　            　　　★       \n有建议请与室主:*◣☆晓慢☆◢/*園夢哈哈联系       \n\n         *☆晓慢☆QQ：270914770^Θ^       \n         *ぶ☆園夢哈哈☆ぶ☆QQ：411312592^Θ^       \n\n ╱◥█◣　╱◥█◣        \n︱田︱田︱︱田︱田︱        \n╬╬╬╬╬╬╬╬╬╬╬╬╬╬    ←^Θ^圆梦清角 ');
//	聊友列表区顶部HTML代码
var userlist_top_html = " <B><td align=middle><img src=http://www8.25158.com/pic/myqj.gif></td></B><BR>"; //聊友列表区头部显示
var userlist_bottom_html = "<marquee scrollamount='2' > <font color=DE55cc> "+room_name+"欢迎</font><font color=ff0000>『"+a_user+"』</font><font color=DE55cc>的到来！要麦向红衣管理打9999 </font></marquee></a>";

//	聊友列表区底部框内文字代码
var listbottem0="本室室主<BR>"+room_owner+"<BR><BR>族长<BR>╠◇天☆下◇╣<BR><BR>执行室主<BR>*園夢哈哈<BR><BR>配置维护<BR>*静静<BR>欢迎你的到来<BR>"+room_name+"<Br>是我们<Br>共同的家";

var userlist_bkcolor = "#FF00FF";	//	聊友列表区的背景色
var userlist_bkimage = "http://www8.25158.com/pic/16.jpg";			//	聊友列表区的背景图，设置为空串则使用输入区的图片
...
var voice_bkcolor = "#FF00FF";		//	语音区的背景
var voice_bkimage = "";				//	语音区的背景图，空串则使用聊友区图片

var input_bkcolor = "#FF00FF";		//	输入区背景色
var input_bkimage = "http://www8.25158.com/pic/16.jpg";				//	输入区背景图片
var input_msg_color	= "#0000ff";	//	输入区文字输入框文字色
var input_msg_bkcolor = "#ffffff";	//	输入区文字输入框背景色

var body_text_color	= "#038ffe";	//	输入区文字色
var select_color = "#FF0100";		//	列表框文字色
var select_text_color = "#FF0100";	//	列表框内文字色
...
(
	17,	"http://www.wzdu.com/UploadFile/200431122204125932.gif",
	18,	"http://www.wzdu.com/UploadFile/200431122204125932.gif",
	19,	"http://www.wzdu.com/UploadFile/200431122204125932.gif",
	35,	"http://www.wzdu.com/UploadFile/200431122202892564.gif",
	46,	"http://www.wzdu.com/UploadFile/20043112220058086.gif",
	70,	"http://www.wzdu.com/UploadFile/200431122194834982.gif"
);
...
var div_msg1 = "『　圆梦清角欢迎您　』 ";
var div_msg2 = "";
var div_msg3 = "本室招聘帅哥美女管理，有意者请联系在线高管或室主。本室马甲样式：管理马甲，╰★→園夢‰某某；歌手马甲：∮清角歌声╉某某ゞ";
var div_msg4 = "【圆梦清角】室主:*╰╮晓慢╭╯欢迎您光临『圆梦清角』语音聊天室！愿您在这里玩的开心愉快！希望这里能够成为您的家!";  //通知
var div_link = "";
...
(
	"留言","http://2101.liaowan.com/RB/1/guest",
	"论坛","http://liaowan.com/bbs/index.asp",
	"注册","http://www.liaowan.com/USadmin/regadd.asp",
	"电台","http://radio.lwmm.com/",
        "查歌","http://mp3.baidu.com",
        "管理","http://liaowan.com/roomadmin/"
);
...
(
	0,	"在线主持",		"http://rqmm.web101.3558.com/405362/button/000.gif","#FFc2e","#FFFFFF",	
	1,	"室^灬^主",		"http://www8.25158.com/pic/pic/48.gif",  "#FF00ff","#FFFFFF",
	2,	"副^灬^室",		"http://www8.25158.com/pic/pic/71.gif",     "#FF00ff",        "#FFFFFF",
	3,	"配置维护",		"http://www8.25158.com/pic/pic/60.jpg",     "#970097",        "#FFFFFF",
	4,	"本室高管",		"http://www8.25158.com/pic/pic/30.gif",   "#009900","#FFFFFF",
	5,	"本室管理",		"http://www8.25158.com/pic/pic/74.gif","#009900","#FFFFFF",
	6,	"本室歌手",		"http://www8.25158.com/pic/pic/36.gif","#0033FF","#FFFFFF",
	7,	"本室贵宾",		"http://www8.25158.com/pic/pic/28.gif",   "#9B30FF","",
	8,	"本室嘉客",		"http://www8.25158.com/pic/pic/24.gif",   "#9B30FF","",
	9,	"本室过客",		"http://www8.25158.com/pic/pic/25.gif",   "#0000FF","",
	10,	"执行室主",		"http://www8.25158.com/pic/pic/70.jpg",    "#8B8B00","#FFFFFF",
	11,	"配置维护",		"http://www8.25158.com/pic/pic/60.jpg",   "#FF69B4","#FFFFFF",
	12,      "配置维护",             
        "http://www8.25158.com/pic/pic/60.jpg","#FF7F00","#FFFFFF",
...
// 不可踢马甲
var wudimajia=new Array("*╰╮晓慢╭╯","*╰★→園夢‰狂潮","*╰★→園夢‰弯月","*静静","*╰★→園夢‰小兵"); 
...
"不舍","真是舍不得你走啊....我会想你的..走好~~~~~有空常来玩，http://2101.liaowan.com/，别走错了哦~！",
"快乐","和你共度的时光是最快乐的时光~~~~希望你记着这份快乐，让它伴你每一天！！！",
"走好","真是舍不得，一路走好！我们会想你的~~~~~！有空常来玩，http://2101.liaowan.com/，别忘了哦~！"
);
...
(
"想留",	"其实不想走 其实我想留......可是我真的不行了，我就先撤退啦，你们要挺住，挺住啊！！！",
	"告别",	"长叹一声,凄婉地说道: 各位网友，网虫，网迷，网痴，网魔们▅▆▇█俺这就拜拜了█▇▆▅祝大家聊得愉快，唱得开心▅▆▇█goodbye▅祝大家每天都有好心情，明早拣到钱！ ",
	"不舍",	"依依不舍地望着大家  ,真是舍不得啊....我会想你们的..你们不用想我的，也不一定要把我放在心里，只要今晚有梦，梦里有我就行啦%¤%￥"
);
...
(
"准备","您好!下一位到您接麦了,请您做好准备~~!如果您在请回话。谢谢! ",
"准备","您好!等好久了吧,下一位就是您接麦了~~!如果您在请回话。谢谢! ",
"准备","您好!请您做好准备,马上就到您接麦了~~!如果您在请回话。谢谢！"
);
...
var a_jie = new Array
(
"请您接麦","您好!请您接麦,不好意思,让你久等了,请接好您的麦克风!(聊天请把右小角面板最左边和最右边的口勾上，若要放歌请同时把中间的口也勾上。)",
"请您接麦","您好!请您接麦,请接好您的麦克风!(聊天请把右小角面板最左边和最右边的口勾上，若要放歌请同时把中间的口也勾上。)"
);
...
"请喝茶","http://home.hnjzcrc.com/387829/chashe/jiaoben/biaoqing/007.gif",
"请喝咖啡","http://home.hnjzcrc.com/387829/chashe/jiaoben/biaoqing/008.gif",
"谢谢(男)","http://home.hnjzcrc.com/387829/chashe/jiaoben/biaoqing/014.gif",
"谢谢(女)","http://home.hnjzcrc.com/387829/chashe/jiaoben/biaoqing/015.gif",
...
"浪漫","http://img.3721.com/sms3721/color/07/14834.gif",
"想你","http://219.133.40.170:8080/mcard/images/42020.gif",
...
"可爱2",	"http://fcr01.27h.com/034.gif",	
...
function add_new_element()//加入新的界面元素
{
	...
	write_button("","听见",480,39,45,20,"","快速听见","autosend(a_heart)");
       write_button("","网址",304,80,35,20,"","本室网址","autosend(a_wang)");
	write_button("","送花",444,60,35,20,"","发送鲜花掌声","autosendf(a_flower)");
	write_button("","欢迎",525,39,45,20,"","快速欢迎","autosend(a_welcome)");
	write_button("","话题",6,0,35,20,"","发送话题","autosend(huati)");
          write_button("","答谢",374,60,35,20,"","谢谢朋友们的献花和鼓励","autosend(a_daxie)");
	...
	if (is_online_manager())
	{
		...
		write_button("","横",286,0,18,20,"","游戏横线","autosend(a_heng)");
		write_button("","听见",394,0,35,20,"","麦克有声","autosend(a_heart)");
		write_button("","断",304,0,18,20,"","麦克断续","autosend(a_duan)");
		write_button("","无",358,0,18,20,"","麦克无声","autosend(a_wu)");
		write_button("","未",322,0,18,20,"","麦克未开","autosend(a_wei)");
		write_button("","已",340,0,18,20,"","已经排麦","autosend(a_yi)");
		write_button("","接",376,0,18,20,"","久等接麦","autosend(a_jie)");
		write_button("","准备",429,0,35,20,"","准备接麦","autosend(a_zhun)");
              write_button("IntFlower","自献",251,0,35,20,"","快速送花","IntervalFlower()"); 
                write_button("","插图",339,80,35,20,"","输入图片","insert_picture()");
            write_button("","搅拌",444,80,35,20,"","搅拌","autosend(a_dai)");
	      write_button("","欢迎",374,60,35,20,"","快速欢迎","autosend(a_welcome)");
	...
	else
	{
		...
		write_button("","上管",6,20,35,20,"","快速上管","guan()");
                  write_button("","试麦",444,80,35,20,"","试麦","autosend(a_shi)");
              write_button("","搅拌",339,80,35,20,"","搅拌","autosend(a_dai)");
...
//	报到信息文字色在此修改
	...
	document.inputform.color.options[color].selected=true;
       document.inputform.IMGURL.value = "http://www8.25158.com/pic/pic/05.gif"
...
function autosend(array)//自动发送 array 中的一句话
{
	...
	if (array == a_flower)
		msg += "【"+room_name+" 专用】";
	        document.inputform.IMGURL.value = 'http://www8.25158.com/pic/pic/72.gif';
...
function writev()//打开语音后的界面
{
	...
	var HTMLstr = "<html><head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=#970097\"></head><body><style type=text/css>";
	...
	HTMLstr += '</style><form name=#970097><center><input type=button name=v2vv value=双工对话 onclick=\'parent.d.v2v();\'>';
...
function writeu1()//重写分屏区
{
	...
	else
	{
      ...
      if (div_msg3!="") parent.u1.document.write('<p align="left"><font color="#8800FF" size="2" face="宋体"><b>〖'+room_name+'〗公告：</b></font><font color="#228B22" size="2" face="宋体">'+div_msg3+'</font></p>');
