...
var xztp_number="1";//按钮形状 1为方形 2为圆形 3为菱形
var txlx_number="1";//图标类型 1为花草 2卡通动物
var config_place = "http://js.liaowan.com/tp/";  //	图片等的存放位置，请设定为您存放图片的位置


var room_owner="*思索者";			//室主名称
var room_name="幻想聊吧 ";			//	房间名称
var room_adminname_head="*聊湾╅";	//	本室管理名格式
var room_adminname_headg="*№聊湾∮";	//	本室歌手名格式
var majia = "聊湾╅名ぶめ" ;            //   默认换马甲格式

var room_number="2051";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = " <B><td align=middle><img src=http://liaowan.com/bbs/upload/2004831-32309-$$BC$$BD$$C8$$CB$$C0$$CF$$B5$$B6.gif></td></B><BR>"; //聊友列表区头部显示
...
var userlist_bkcolor = "";	//	聊友列表区的背景色
var userlist_bkimage = "http://www.menghuancn.com/chat/mengyu3.jpg";			//	聊友列表区的背景图，设置为空串则使用输入区的图片
...
var input_bkcolor = "";		//	输入区背景色
var input_bkimage = "http://www.menghuancn.com/chat/mengyu3.jpg";				//	输入区背景图片
...
var div_msg4 = "本室招管理数名!有意者请联系室主";  //通知
var div_link = "";
...
//	本室中的 VIP 聊友
//	级别：1室主；2总管；3副室主；4高管；5-6管理；0、7、8、9已由内部使用
...
(
	0,	"在线管理",	"tb/"+txlx_number+"/000.gif ",	"#FF0000",	"",
	1,	"本室室主",	"tb/"+txlx_number+"/001.gif ",	"#DE55cc",	"",
	2,	"本室副室",	"tb/"+txlx_number+"/002.gif ",	"#DE55cc",	"",
	3,	"聊弯巡管",	"tb/"+txlx_number+"/003.gif ",	"#DE55cc",	"",
	4,	"高级管理",	"tb/"+txlx_number+"/004.gif ",	"#DE55cc",	"",
	5,	"本室管理",	"tb/"+txlx_number+"/005.gif ",	"#2c07fe",	"",
	6,	"本室歌手",	"tb/"+txlx_number+"/006.gif ",	"#2c07fe",	"",
	7,	"注册名",	         "tb/"+txlx_number+"/007.gif ",	"#2c07fe",	"",
	8,	"汉字名",	         "tb/"+txlx_number+"/008.gif ",	"#2c07fe",	"",
	9,	"数字名",	         "tb/"+txlx_number+"/009.gif ",	"#2c07fe",	""
);
