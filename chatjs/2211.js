...
var room_owner="*coco";			//室主名称
var room_name="動感佳人";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="*№聊湾∮";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2211";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = "<table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://js.liaowan.com/logo/dgjr.gif><BR><B>  <font color=#009900 size=5> </font><font color=#0000FF size=5>   </font><font color=#FF00FF size=5>   </font><font color=#CC00FF size=5>   </font></font></B><font color=#0000FF size=5></font></td><tr><td align=middle><img src= http://www.6see.com/js/001/js/gif/lines02.gif ></td></tr><tr><td align=middle><marquee scrollamount=1><font color=ff0000 size=2><b>歡迎<font color=ff0000><b>〖"+document.inputform.USER.value+"〗</b></font>來到<font color=ff0000>★★</font><font color=aa00ff>希望這里成為你們開心的樂園,記住我們的約定哦!</font></marquee></td></tr></table>"; //聊友列表区头部显示
var userlist_bottom_html = "<marquee scrollamount='2' > <font color=2e8b57> "+room_name+"歡迎</font><font color=ff0000>『"+a_user+"』</font><font color=2e8b57>的到來！要麥向紅衣管理打9999 </font></marquee></a>";

//	聊友列表区底部框内文字代码
var listbottem0="〓★室主★〓<BR>"+room_owner+"<BR>歡迎你的到來<BR>"+room_name+"<Br>是我們<Br>共同的家";
...
var div_msg2 = "";
var div_msg3 = "";
var div_msg4 = "本室招一批能歌尚舞的帥哥美女,有意者請來本室找室主"; //通知
var div_link = "";
...
(
	...
	10,	"本室房主",		"http://bsradio.net/jl/tb/86.gif",    "#ff00ff","#FFFFFF",
	...
	15,	"本室管理",		"http://pic.liaowan.com/tb/041.gif",    "#757575","#FFFFFF",
        16,	"偶是美女再看咬你",		"http://www.y88.info/tp/23.gif",         "#228B22","#FFFFFF",
	17,	"偶漂亮你羨幕嗎",		"http://bsradio.net/jl/tb/44.gif",         "#CD6889","#FFFFFF",
	18,	"本室过客",		"http://www.y88.info/tp/17.gif",         "#0000ff","#FFFFFF",
	19,	"本室过客",		"http://www.y88.info/tp/17.gif",         "#0000ff","#FFFFFF"	   
);

// 不可踢马甲
var wudimajia=new Array("*凉风有信","*","*絕戀","*","*coco","*kill-you","*kiss-you","*","*overmaster",
"*-123","*123-","*1001","*1860",
"*‖巡站‖老暴","*","*","*骑着大象的蚊子","*","*");  
...
var listbottem="<tr><td colspan=3 align=center><table width='126' border='1' cellspacing='1' cellpadding='1' bordercolordark='#ff66ff' bordercolorlight='#FFFFFF' height='15'><tr><td  colspan=3 width='130' align='center'><span style='font-size: 8.7pt;COLOR:#ff0000'><marquee direction=up height=70 onmouseout='this.start()' onmouseover=this.stop() scrollAmount=1 width=130 crolldelay=80><center>〓★本室室主★〓:<BR>*COCO<BR><BR>祝朋友们<BR>玩得开心！玩得愉快！<br><img src=http://web.fs169.net/xiongmaolei/liao/coco.JPG><BR</marquee></font></SPAN></td></tr></table></td></tr>";
