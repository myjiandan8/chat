...
// 使用方法：<SCRIPT src=http://liaowan.com/chatjs/2102.js></SCRIPT>
 
<!--
alert('\n\n       \n\n       \n\n            公        告          \n╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮  \n║欢│║★│║迎│║★│║光│║★│║临│\n╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝\n╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮\n║訫│║★│║雨│║★│║戀│║★│║樂│\n╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝\n\n    ゞ¤╭⌒╮   ╭⌒╮   \n ╱◥███◣ ╭╭ ⌒╮\n︱田︱田  田|    ╰------ 亲爱的朋友您好!\n○оooо○оooо○   〖訫雨∮戀樂〗    \n+++++++++++++++++   欢迎您的到来！！！\n\n心梦情缘聊天室；希望这里能成为您心灵的港湾温馨的家园\n\n本室现大量招收有能力的管理及歌手！！！！！！！！！！\n\n有意者请您联系室主  *R∽ainЖ冷月QQ365923957\n\n    本房间于11月16日正式开张！届时请大家光临！') 
...
var room_owner="*R∽ainЖ冷月";			//室主名称
var room_name="訫雨∮戀樂";			//	房间名称
var room_adminname_head="*";	//	本室管理名格式
var room_adminname_headg="*";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2102";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = "<table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><b><font color=#009900 size=5>欢</font><font color=#0000FF size=5>迎</font></font></B><font color=##757575 size=5>∮</font><font color=#FF00FF size=5>光</font><font color=#CC00FF size=5>临</font></font></B><font color=#0000FF size=5></font></td><tr><td align=middle><img src= http://www.liaowan.com/bbs/upload/20041112-62416-$$D0$$A1$$D2$$C0.gif></td></tr><tr><td align=middle><marquee scrollamount=1><font color=ff0000 size=2><b>欢迎<font color=ff0000><b>〖"+document.inputform.USER.value+"〗</b></font>来到<font color=ff0000>★★</font><font color=aa00ff>希望这里成为你们开心的乐园,记住我们的约定哦!</font></marquee></td></tr></table>"; //聊友列表区头部显示
...
//	聊友列表区底部框内文字代码
var listbottem0="暗夜正在睡觉！2天没睡了！要考管考歌手考副室的家QQ332334815说！（不一定回醒）";
...
var div_msg1 = "本室歌手马甲*戀樂☆XX☆男 *訫雨★XX★女 ";
var div_msg2 = "本室管理马甲*M√siC☆XX☆男 *M√Sic★XX★女！";
var div_msg3 = "本室疯狂招收有能力的主持与歌手！另对外招收副室2名！有能力者可与室主联系！有管理队伍者优先！";
var div_msg4 = "新来管理必须去论坛看管理守则和发报道贴！管理Q群917343所有管理必须加"; //通知
var div_link = "";
...
//      便衣马甲
     ...
     (
     "*R∽ainЖ暗夜","*R∽ainЖ冷魂","*R∽ainЖ冷月","*R∽ainЖ冷傲","*R∽ainЖ冷爱","*R∽ainЖ月翎","","*","*","*","*","*","*","","*", "","","","",""      );
 

//——聊友说明，在此修改聊友名字的颜色——   （0到9）
var a_usertitle = new Array
(
	0,	"在线主持",		"http://www.fengyu.org/pixel/material2/pic1091.gif",     "#FF0000","#FFFFFF",
         1,	"室主∮戀",		
         "http://www.y88.info/tp/16.gif",	        "#7FFF00","#FFFFFF",
	2,	"ぷ樂队∮主い",		"http://xupeng521.51.net/tx/t120.gif",           "#ADD8E6","#FFFFFF",
         3,	"本室管理",		"http://www.fengyu.org/pixel/material2/pic103.gif",    "#757575","#FFFFFF",
	4,	"歌手",	
	"http://pic.liaowan.com/tb/039.gif",	"#00BFFF","#FFFFFF",
	5,	"本室嘉宾",		"http://www.y88.info/tp/17.gif",	"#AA00ff","#FFFFFF",
	6,	"过客",             "http://www.y88.info/tp/shi.gif",	        "#FF7F00","#FFFFFF",
	7,	"本室嘉宾",		"http://www.y88.info/tp/17.gif",	"#0000ff","#FFFFFF",
	8,	"贵宾",		"http://www.y88.info/tp/10.gif",         "#0000ff","#FFFFFF",
	9,	"本室过客",		"http://xupeng521.51.net/tx/t93.gif",        "#0000ff","#FFFFFF",
	...
	13,	"本室高管",		"http://xupeng521.51.net/tx/t73.gif",	"#EE1289","#FFFFFF",
	14,	"无聊呢！转转",		"http://xupeng521.51.net/tx/t70.gif",	"#48D1CC","#FFFFFF",
...
// 不可踢马甲
var wudimajia=new Array("*R∽ainЖ冷魂","*R∽ainЖ冷月","婈","*R∽ainЖ冷傲","*R∽ainЖ暗夜","*","*","*",
"*","*","*","*","*","*");  
