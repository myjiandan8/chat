...
parent.document.title=tx[wo].substr(0, kk)+"_"; 
if (ud==0) kk--; 
if (ud==1) kk++; 
if (kk==-1) {ud=1;kk=0;wo++;wo=wo%txcount;} 
if (kk==tx[wo].length+10) {ud=0;kk=tx[wo].length;} 
...
var vers = "聊湾孖軒为你服务  QQ:947585";			//	配置版本号
var config_style = 0;			//	配置的风格

var room_owner="逛逛";			//	室主名称
var room_name="绿林军旅";		//	房间名称
var room_number="2021";			//	房间号码

var black_roomname="";			//	双工房间名称
var black_roomnumb="";			//	双工房间号码

//	图片等的存放位置，所有没有指定完全网址（http://.....）的图片都到此网址下寻找，但不包括下拉列表框。
var config_place = "";			//	语音区的背景图";
//	上管记录地址
var guan_record = "";
//	进门自动播放音乐的地址，没有就设置为空
var auto_player = "";
//	聊友列表区上方的房间名称，可设为图片，只要用HTML代码就可以
var userlist_top_html = "<a href=http://www.18-81.net target=_blank><img src=http://plall.51.net/images/chat.jpg border=0></a><font color=blue>室主:逛逛 QQ:5960990<br>站长:李不言 QQ:21175362</font>";
//	聊友列表下面的文字，如果不需要，请设置为空串
var userlist_bottom_html = "<p align='center' class='p9'><font color=#009900 >"+room_name+"欢迎您</font><br><tr><td colspan=3 align=center><table ><tr><td  colspan=3 width='103' align='center'><span style='font-size: 8.7pt;COLOR:red'><marquee direction=up height=70 onmouseout='this.start()' onmouseover=this.stop() scrollAmount=1 width=120 crolldelay=50><center>===室主===<br><font color=#FA8072><center>*逛逛<font color=#FA8072><center>★站长★<font color=#FA8072><center>*李不言<font color=#D15FEE><center>*<font color=#FA8072><center>*</font><br><font color=#2C16C9>祝朋友们开心<br>快乐每一天</font></marquee></b></td></td></tr></td></td></tr></font>&nbsp&nbsp&nbsp<img src=http://www.fm81.net/img/logo.gif></td></tr></table>";

var msg_bkimage = "";			//	大屏背景图片
var full_screen = 0;			//	是否使用整幅背景，0不使用，1使用（使用大屏背景）
var def_textcolor = 4;			//	默认的发言文字色,从1号到16号
var def_bgcolor = "";			//	默认的发言文字背景色

var div_screen_bkcolor = "fff6ea";	//	分屏区背景色
var div_screen_bkimage = "http://plall.51.net/images/siliao.jpg";		//	分屏背景图片	
...
var userlist_bkimage = "http://plall.51.net/images/liaotianshi01.gif";		//	列表区的背景图

var voice_bkcolor = "#CDE4F3";		//	语音区背景色
var voice_bkimage = "";			//	语音区的背景图
var voice_openimg = "";			//	打开语音后下部背景图

var body_text_color = "#9C0008";	//	输入区文字色
var input_bkcolor = "#CDE4F3";		//	输入区背景色
var input_bkimage = "http://plall.51.net/images/liaotianshi.gif";			//	输入区背景图片
...
var button_t_color = "#000000";		//	输入区按钮文字色
...
var btn_pic_18 = "http://plall.51.net/images/btn18.gif";		//	18点宽
var btn_pic_35 = "http://plall.51.net/images/btn35.gif";		//	35点宽
var btn_pic_45 = "http://plall.51.net/images/btn46.gif";		//	45点宽
var btn_pic_60 = "http://plall.51.net/images/btn70.gif";		//	60点宽
var btn_pic_72 = "http://plall.51.net/images/btn70.gif";		//	72点宽
...
var accept_right_click = 0;		//	是否允许右键菜单,0不允许；1允许//	用于连接按钮
var a_link_button = new Array
(
"主站","绿林军旅",	"http://www.18-81.net/",
"论坛","论坛社区",	"http://bbs.18-81.net/",
"广播","军旅广播",	"http://www.fm81.net/",
"军歌","军旅歌曲",	"http://www.81music.net/index.asp",
"留言","欢迎留言",	"http://www.fm81.net/chat/default.asp"
"送你紫玫瑰","http://wychbdjx.nease.net/tp/hua27.gif",
"送你紫玫瑰","http://wychbdjx.nease.net/tp/hua28.gif",
"送你金刚","http://wychbdjx.nease.net/tp/jingang1.gif",
"送你红金刚","http://wychbdjx.nease.net/tp/jingang2.gif",
"奖励勋章","http://wychbdjx.nease.net/tp/tianshi1.gif",
"送你奖章","http://wychbdjx.nease.net/tp/tianshi2.gif",
"送你太阳花","http://wychbdjx.nease.net/tp/hua22.gif",
"送你一束鲜花","http://wychbdjx.nease.net/tp/hua48.gif",
"唱的它也开花","http://wychbdjx.nease.net/tp/hua35.gif",
"我好爱你","http://wychbdjx.nease.net/tp/hua36.gif",
"真的好爱你","http://wychbdjx.nease.net/tp/hua37.gif",
"送你红玫瑰","http://wychbdjx.nease.net/tp/hua26.gif",
"爱的很深","http://wychbdjx.nease.net/tp/hua39.gif",
"送你花篮","http://wychbdjx.nease.net/tp/hua45.gif",
"送你大花篮","http://wychbdjx.nease.net/tp/hua46.gif",
"送你鲜花","http://wychbdjx.nease.net/tp/hua47.gif",
"唱的小鸭也高兴","http://wychbdjx.nease.net/tp/dw08.gif",
"爱心黄花","http://wychbdjx.nease.net/tp/hua40.gif",
"送花给你","http://wychbdjx.nease.net/tp/hua33.gif",
"爱的花朵","http://wychbdjx.nease.net/tp/hua41.gif",
"爱心花朵","http://wychbdjx.nease.net/tp/hua42.gif",
"乐队伴奏","http://wychbdjx.nease.net/tp/yuedui.gif",
"乐队伴奏","http://wychbdjx.nease.net/tp/yuedui2.gif",
...
"点亮生日蜡烛","http://wychbdjx.nease.net/tp/sr2.gif",
"生日快乐","http://wychbdjx.nease.net/tp/sr.gif",
"生日快乐","http://wychbdjx.nease.net/tp/sr0.gif",
"生日快乐","http://wychbdjx.nease.net/tp/sr1.gif",
"生日快乐","http://wychbdjx.nease.net/tp/sr3.gif",
"生日快乐","http://wychbdjx.nease.net/tp/sr4.gif",
"生日快乐","http://wychbdjx.nease.net/tp/sr5.gif",
"生日快乐","http://wychbdjx.nease.net/tp/sr6.gif",
"生日快乐","http://wychbdjx.nease.net/tp/sr7.gif",
"生日快乐","http://wychbdjx.nease.net/tp/sr8.gif",
"送你巧克力","http://wychbdjx.nease.net/tp/t1.gif",
"生日快乐","http://wychbdjx.nease.net/tp/sr9.gif",
"生日快乐","http://wychbdjx.nease.net/tp/sr10.gif",
...
"再见","http://wychbdjx.nease.net/tp/baibai1.gif",
"再见","http://wychbdjx.nease.net/tp/baibai2.gif",
"再见","http://wychbdjx.nease.net/tp/baibai3.gif",
"再见","http://wychbdjx.nease.net/tp/baibai4.gif",
"慢点走","http://wychbdjx.nease.net/tp/dw16.gif",
"我好失望",	"http://wychbdjx.nease.net/tp/da38.gif",
...
if (userlist_top_html != "")
	...
	parent.r.document.write('<br><a title=\"当前聊天室在线人数\"><font color=000000>  绿林军旅有 </font><font color=red><B>'+user_array.length+'</B></font><font color=000000> 位聊友</font><br>');
	parent.r.document.write("</td></tr><tr><td align=middle><marquee><font color=#002FFC><b>欢迎<font color=#002FFC><b>〖"+document.inputform.USER.value+"〗</b></font>来到《绿林军旅》视频语聊天室，全体室主,管理欢迎您的到来，愿这里能成为你们情感交流的港湾!!</b></font></marquee></td></tr></table>");
...
if(lists[0] == "0")
	parent.r.document.write("<a><IMG align=absMiddle src=" + a_user_pic[0] + "><a target=d href=\"javascript:parent.cs('"+lists[1]+"')\"title=\"" + a_usertitle[1] + "\"><font style=filter:glow(color=FF0000,strength=3);Height:8pt;padding:1px;cursor:hand color=#FFFFFF >"+lists[1]+"</font></a>");
else	parent.r.document.write("<a><IMG align=absMiddle src=" + a_user_pic[lists[0]] + "><a target=d href=\"javascript:parent.cs('"+lists[1]+"')\"title=\"" + a_usertitle[lists[0]*3+1] + "\"><font style=filter:glow(color=" + list_user_color + ",strength=2);Height:8pt;padding:1px;cursor:hand color=#FFFFFF >"+lists[1]+"</font></a>");
