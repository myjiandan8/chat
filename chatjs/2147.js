...
var userlist_top_html = "<table border=0 cellspacing=0><tr><td align=middle><img width=100% height=50 src=http://www.5916.info/images/009.gif></td></tr><tr><td align=middle><img width=100% src=http://vip.7sn.com/515029/wyx/tup/logo2.gif></td></tr><tr><td align=middle><marquee scrollamount=2><font color=Olive><b>欢迎<font color=red><b>〖"+document.inputform.USER.value+"〗</b></font>来到<font color=red>DSAYJ家族？</font><font color=red>要麦请打999</font></marquee></td></tr></table>";
var config_place= "http://vip.7sn.com/515029/wyx/tup/";

var userlist_bottom_html = "";//聊友列表区底部HTML代码
var room_owner           = "飞腾网络";            //室主名称
var room_name            = "DSAYJ家族";		    //房间名称
var room_adminname_head  = "飞腾网络";	    //爱难管理名
var room_number          = "2147";			    //房间号
var room_link_url        = "http://2147.liaowan.com";	    //房间的地址
...
(
        ...
        "飞腾论坛",  "http://www.5916.info/bbs",
        "飞腾DJ",  "http://www.5916.info/bbs",
        "飞腾留言",  "http://www.5916.info/bbs",
        "飞腾音乐",  "http://www.5916.info/music",
        "飞腾江湖",  "http://jh.5916.info",
        "招聘室主",  "http://www.5916.info/bbs"
);
...
(
   0,"DJ主持",     "xdguanl.gif",	                "#FF0000","#FFFFFF",	
   1,"DJ站长",	"87383.gif",	                "#FF0880","#FFFFFF",	
   2,"DJ副站",	"369ai.gif",	"#9B439B","#FFFFFF", 	
   3,"DJ室主",	"369ai.gif",	                "##FFc2e","",	
   4,"DJ副室",	"369ai.gif",	        "#FFc2e","",	
   5,"DJ督察",	"em40.gif",	                "#6D61C9","#FFFFFF",	
   6,"DJ贵宾",	"h001.gif",	                "#0033FF","#FFFFFF",	
   7,"DJ嘉宾",	"jb.gif ",	                "#008FEE","#EEF8FF",	
   8,"DJ来宾",	"0005.gif",	                "#008FEE","#EEF8FF",
   9,"DJ来宾",	"0005.gif",	                "#41ABF1","#FFFFFF"
...
(
        "免费注册",  "http://liaowan.com/USadmin/regadd.asp",

        "飞腾论坛",     "http://5916.info/bbs/index.asp",
...

{
	...
	write_select("linkurl","爱难链接",569,80,72,select_color,a_linkurl,"gotolinkurl(this)");
...

{
	...
	write_select("linkroom","房间走廊",569,60,72,select_color,a_roomlink,"gotolinkroom(this)");
        write_button("reauto","自动回复消息",198,60,105,20,"","请输入您的自动回复","reauto()");
        ...
        for(i = 0 ; i < user_array.length;i++)
{
	...
	HTMLstr += ("<font face=\"Wingdings\" color="+voice_normal_color+">(</font>");
        if(lists[2]==2)
        HTMLstr += ("<img src=http://www.5916.info/~lxr/y2.gif border=0>");
        if(lists[3]==1)
        HTMLstr += ("<img src=http://www.5916.info/eye.gif width=20 height=10 border=0>");
        HTMLstr += "</div>";
}
...

{
	...
	HTMLstr += "--></style></head><body leftmargin=2 rightmargin=0";
        ...
        HTMLstr += ('<SCRIPT>');
        HTMLstr += ("function Click(){alert('配置制作：*偷心中尉)\;window.event.returnValue=false\;}document.oncontextmenu=Click\;");
        HTMLstr += ('</script>');
	HTMLstr += "<br><a title='当前聊天室在线人数'><font color=#027F17> 当前爱难有 </font><font color=red><B id='usercount'>0</B></font><font color=#027F17> 位朋友</font></a><br>";
	...
	HTMLstr += "<Table cellspacing='0' cellpadding='0'><tr><td id='listhtml'></td></tr></table><center><hr><br>";
        HTMLstr += "<br><br><a target=_blank href='http://www.5916.info/' title='脚本设计：*飞腾网络'><img src=http://www.5916.info/cvc.gif border=0><br></a><br><font color=#FF0000 >配置：*飞腾网络 <br>QQ：355981</font></body></html>";
...

{
	...
	document.write('<option selected style=color:'+color+' VALUE="" >¤-爱难-*-麦序-¤</option>');
...
//if ((tmpmsg.indexOf(badword[i])!=-1)&&(auser=="aaa")){
  ...
  document.inputform.msg.value='这里的警察真厉害，我只说了一句脏话网络警察就从天而降，把我扔出了爱难~~~';              
...
function fp()
{
        ...
        parent.u1.document.write('(00:00:00)<font color="#9900FF">*DSAYJ家族微微一笑:</font><font color=#ff00ff>呵呵, 你终于来了! 好想你啊! 我想的都快想不起来了!! 哈哈哈 ! ! ! </font><br>');
}
        function fpbg()
{
        setTimeout("fp()",5000);
