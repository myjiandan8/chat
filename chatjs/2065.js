...
var colortp_number="2";//按钮颜色 1为红色 2为兰色 3为绿色
var xztp_number="3";//按钮形状 1为方形 2为圆形 3为菱形
var txlx_number="2";//图标类型 1为花草 2卡通动物
var config_place = "http://js.liaowan.com/tp/";  //	图片等的存放位置，请设定为您存放图片的位置


var room_owner="*●酷儿●";			//室主名称
var room_name="●我的地盘● ";			//	房间名称
var room_adminname_head="*";	//	本室管理名格式
var room_adminname_headg="*";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2065";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = " <B><td align=middle><img src=http://www.es28.net/gif/lunt/UploadFile/2004-10/2004109193412319.gif></td></B><BR>"; //聊友列表区头部显示
...
var voice_bkcolor = "#BDDBF5";		//	语音区的背景
var voice_bkimage = "";				//	语音区的背景图，空串则使用聊友区图片

var input_bkcolor = "#BDDBF5";		//	输入区背景色
...
var default_admin_pass = "1234";	//	默认的管理员上管口令
...
var div_msg1 = "●我的地盘●聊天室广招管理主持 请到论坛留言，点此进入论坛--》<a target=_blank href='http://www.es28.net/gif/lunt/index.asp' title='我行我素欢迎您！'><IMG align=absMiddle src=http://www.es28.net/gif/lunt/UploadFile/2004-9/20049784735460.gif></a>";
var div_msg2 = "如果立体声语音不能正常运行，请点击下边帮助";
var div_msg3 = "欢迎光临【"+room_name+"】!~~视频连接请直接点名字后小眼睛";
var div_msg4 = "";  //通知
var div_link = "";
...
(
"主页","http://2065.liaowan.com",
	"论坛","http://www.es28.net/gif/lunt/index.asp",
	"注册","http://www.liaowan.com/USadmin/regadd.asp",
	"加管","http://www.liaowan.com/roomadmin/addadmin.asp?roomport=2065&xz=admin",
       "留言","http://www.ice-book.com/bookMX/icemx.asp?userid=●酷ぷ儿●",
       "伴奏","http://ok.wo99.com/"
);
//	本室中的 VIP 聊友
...
(
	0,	"在线管理",	"http://www.es28.net/gif/lunt/UploadFile/2004-9/20049131152611.gif",	"#FF0000",	"#ffffff",
	1,	"聊湾巡站",	"http://www.es28.net/gif/lunt/UploadFile/2004-9/20049131145445.gif",	"#228B22",	"#ADFF2F",
	2,	"高级管理",	"http://www.es28.net/gif/lunt/UploadFile/2004-9/2004913057965.gif",	"#ff00ff",	"#ffffff",
	3,	"特约特色歌手主持",	"http://www.es28.net/gif/lunt/UploadFile/2004-9/20049130579770.gif",	 "#333333",	"#ffffff",
	4,	"本室管理",	"http://www.es28.net/gif/lunt/UploadFile/2004-9/200491304926634.gif","#F3942E",	"#ffffff",
	5,	"本室歌手",	"http://www.es28.net/gif/lunt/UploadFile/2004-9/20049130579770.gif",	"#34c535",	"#ffffff",
	6,	"论坛贵宾",	"http://www.es28.net/gif/lunt/UploadFile/2004-9/2004916125624940.gif", "#8800FF",	"#ffffff",
	7,	"注册名",	"http://www.es28.net/gif/lunt/UploadFile/2004-9/200491613204215.gif",	"#2c07fe",	"#ffffff",
	8,	"汉字名",	"http://www.es28.net/gif/lunt/UploadFile/2004-9/200491613204487.gif",	"#2c07fe",	"#ffffff",
	9,	"数字名",	"http://www.es28.net/gif/lunt/UploadFile/2004-9/200491613204487.gif",	"#2c07fe",	""
);

// 不可踢马甲
var wudimajia=new Array("*●酷ぷ儿●","*⊙〓⊙","*⿻咖≌啡〾", "*好想哭", 
"*酷儿","*@颠@","*好想笑",
"*","*","*","*"
 );  
