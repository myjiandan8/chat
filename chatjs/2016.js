...
var colortp_number="3";//按钮颜色 1为红色 2为兰色 3为绿色
...
var room_owner="*含月";			//室主名称
var room_name="雨季心情 ";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2016";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = " <B><td align=middle><img src=http://www.liaowan.com/bbs/upload/20041013-225135-$$B0$$AE$$CF$$A7.jpg></td></B><BR>"; //聊友列表区头部显示
...
var userlist_bkcolor = "#CCFF99";	//	聊友列表区的背景色
...
var div_screen_bkcolor = "CCFF99";		//	分屏背景色
var div_screen_bkimage = "";		//	分屏背景图片	

var voice_bkcolor = "#BDDBF5";		//	语音区的背景
var voice_bkimage = "";				//	语音区的背景图，空串则使用聊友区图片

var input_bkcolor = "#CCFF99";		//	输入区背景色
var input_bkimage = "";				//	输入区背景图片
var input_msg_color	= "#006633";	//	输入区文字输入框文字色
var input_msg_bkcolor = "#CCFF99";	//	输入区文字输入框背景色

var body_text_color	= "#006633";	//	输入区文字色
var select_color = "#006633";		//	列表框文字色
var select_text_color = "#006633";	//	列表框内文字色
var button_text_color = "#006633";	//	输入区按钮文字色
...
//	分屏公告文字
var div_msg_color1 = "#006633";		//	分屏公告颜色
var div_msg_color2 = "#006633";		//	分屏公告颜色
...
var div_msg4 = "本室招管理数名!有意者请联系室主含月,啥也不是，服务员爱惜，";  //通知
var div_link = "快速入口";
...
(
	...
	5,	"本室女管理",	"tb/"+txlx_number+"/005.gif ",	"#33CC66",	"",
	6,	"本室歌手",	"tb/"+txlx_number+"/006.gif ",	"#000000",	"",
	7,	"注册名",	         "tb/"+txlx_number+"/007.gif ",	"#006633",	"",
	8,	"汉字名",	         "tb/"+txlx_number+"/008.gif ",	"#006633",	"",
	9,	"数字名",	         "tb/"+txlx_number+"/009.gif ",	"#006633",	""
);

// 不可踢马甲
var wudimajia=new Array("*来个","*浅曲","*老暴","*亦芸","*aixi","*laopao","*啥也不是","*xiaoxi",
"*暴","*依溪","*溪"
 );  
