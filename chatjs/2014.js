...
*                                           碧海  冀人老刀QQ:153251392                        *
*                                           真情论坛 http://www.369590.com     2004.8.31                *
*******************************************************************************************/
...
var room_owner="*★战争贩子★";			//室主名称
var room_name="吉林长春";			//	房间名称
var room_adminname_head="*聊湾╅";	//	本室管理名格式
var room_adminname_headg="*№聊湾∮";	//	本室歌手名格式
var majia = "吉林╅名ぶめ" ;            //   默认换马甲格式

var room_number="2014";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = " <table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://pic.liaowan.com/sb/jl.gif><BR><tr><td align=middle><img src=http://pic.liaowan.com/gif/hx.gif>"; //聊友列表区头部显示
...
var default_admin_pass = "369";	//	默认的管理员上管口令
...
// 不可踢马甲
var wudimajia=new Array("*在线维护","*旮旯","*~碧海","*~依然","*5411111","*5400000",
"*冀人老刀","*★战争贩子★","*依溪","*老刀～" 
 );  
