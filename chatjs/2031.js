...
// 使用方法：<SCRIPT src=http://liaowan.com/chatjs/2031.js></SCRIPT> 

//test

//alert("“老Ａ的窝”\n\n（４５kbps高保真立体声编码）\n\nhttp://2031.liaowan.com或http://chat1.chat-chat.net:2031/\n\n我们是相识于Ｔ２００２ 的发烧友\n\n为了发烧音质的目的，故本房间是简单配置\n\n朋友们可以换上“老Ａ的朋友|abc”实习临时管理 ");
...
var room_owner="*老Ａ";			//室主名称
var room_name="老Ａ的窝";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2031";			//	房间号
...
/*
var userlist_top_html = " <table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://www.liaowan.com/logo/logo.gif><BR><tr><td align=middle>"; //聊友列表区头部显示
var userlist_bottom_html = "<marquee scrollamount='2' > <font color=2e8b57> "+room_name+"欢迎</font><font color=ff0000>『"+a_user+"』</font><font color=2e8b57>的到来！向红衣管理点“要麦”打999 </font></marquee></a>";
*/
...
var default_admin_pass = "6636";	//	默认的管理员上管口令
...
var div_msg1 = "";
var div_msg2 = "";
var div_msg3 = "朋友们可以换上“老Ａ的朋友”临时管理";
var div_msg4 = "";  //通知
var div_link = "";
//	用于连接按钮
var jilu="";   //刷卡器地址   空时没有
...
//	本室中的 VIP 聊友
//	级别：0---在线主持  1--站长巡管；2--室主  3--特殊贵宾... 4-----高级管理   5---管理员格式  6----歌手格式    7--注册马甲  8----汉字马甲   9---数字马甲
...
(
	0,	"县官现管",	"yg.gif",	"#FF0000",	"#ffffff",
	1,	"站长or巡管",	"0002.gif",	"#000000",	"#ffffff",
	2,	"老友粉",	"14.gif",	"#ff00ff",	"#ffffff",
	3,	"高级管理",	"0003.gif",	 "#333333",	"#ffffff",
	4,	"金牌管理",	"plnvlb1.gif","#F3942E",	"#ffffff",
	5,	"管理成员",	"4.gif",	"#34c534",	"#ffffff",
	6,	"本室VIP",	"alogo2.gif ", "#61598a",	"#ffffff",
	7,	"注册嘉宾",	"alogo2.gif ",	"#2c07fe",	"#ffffff",
	8,	"汉字便衣",	"alogo2.gif ",	"#2c07fe",	"#ffffff",
	9,	"数字便衣",	"alogo2.gif ",	"#2c07fe",	""
);

// 不可踢马甲
var wudimajia=new Array("*老Ａ","*老A",
"*laobao","*~碧海","*~依然","*5411111","*5400000",
"*冀人老刀","*老暴","*依溪","*老刀～" 
 );  
...
(
	"帮助之一",		"http://www.bliao.com/help/help17.htm",
	"帮助之二",		"http://www.bliao.com/help/help51.htm",
	"帮助之三",		"http://www.bliao.com/help/help53 .htm",
...
(
	"要麦",	"999999999999999999999999我要麦9999999谢谢",
	"唱歌",	"999999999999999999999999我要唱歌99999999谢谢"
);
...
var a_shi = new Array
(
	"试麦",	"管理员，您好。我要试麦66666666666666666666666谢谢 ",
	"试麦",	"管理员，您好。我要试麦666666666666666666666666谢谢 "
);
...
function writelistbase()//重写聊友列表区
{
	...
	parent.r.document.writeln("<script language=javaScript>"); 
        parent.r.document.writeln("function Click(){alert('复制：Ctrl+C 粘贴：Ctrl+V')\;window.event.returnValue=false\;}  document.oncontextmenu=Click\;");
...
function writecv()//未开语音时的界面
{
	...
	HTMLstr += ("INPUT{COLOR:"+button_text_color+";FONT-SIZE:9pt;FONT-FAMILY:宋体,SimSun;cursor:hand}");
	HTMLstr += ("BODY{background:"+((voice_bkcolor != "")?voice_bkcolor:parent.r.document.body.bgColor)+((m_fullscreen_bgimage != "")?(" url("+m_fullscreen_bgimage+") fixed}"):"}"));
	HTMLstr += "</style><center><font face=楷体_GB2312><font size=2 color=#874D01><center><u><b>*老Ａ</b></u></center></font></font><center><br><input type=button name=closev value=打开语音 onclick=\"{parent.writev_new();parent.d.decoratev();}\">";
	HTMLstr += "<br><br><a href=http://chat.yinsha.com/voice.htm target=_blank><span style=' font-size: 9pt; color:#0000FF; text-decoration: none'>麦克测试<br>040917版</span></a></body></html>";
...
function auto_log_func()//自动登录后台管理
{
              ...
              if ((a_user=="*冀人老刀")||(a_user=="*熏衣草")|| (a_user=="*老Ａ")|| (a_user=="*老A") )
              { }
               else {
