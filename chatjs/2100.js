...
* 本配置版权属真情论坛,你可以随意使用和传播.如你认可本人修改 请保留文字                     *
...
var room_owner="*了孑";			//室主名称
var room_name="2girls-Les";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2100";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = " <table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://pic.liaowan.com/sb/2100.gif><BR><tr><td align=middle><img src=http://pic.liaowan.com/gif/hx.gif>"; //聊友列表区头部显示
...
var div_msg1 = "";
var div_msg2 = "";
var div_msg3 = "歡迎光臨【"+room_name+"】多视频聊天室!希望你玩得開心！！";
var div_msg4 = "本房間為純女性聊天室，男士請回避！本室室主：*了孑";  //通知
var div_link = "";
//	用于连接按钮
...
// 不可踢马甲
var wudimajia=new Array("*＿尐烏鴉＿","*在线维护","*︿清淡如煙︿","Bubbleˇ","","",
"*冀人老刀","","*依溪","*老刀～" 
 );  
//——房间走廊,请注意房间号的写法——
...
///////////////自动回复结束//////////////////////////////////
var listbottem="<a target=_blank href='http://www.liaowan.com/bbs/' title='配置技术帮助联系QQ：153251392！'><IMG align=absMiddle src=http://pic.liaowan.com/sb/ld.gif></a><Br><a target=_blank href='http://www.liaowan.com/' title='聊湾语音视频网欢迎您！'><IMG align=absMiddle src=http://liaowan.com/logo/logo.gif></a>";
...
now = new Date();
          ...
          for (var i=1;i<j+1;i++)
           {if (i==1) {user1="*夜雨听竹";}if (i==2) {user1="*絮语";} if (i==3) {user1="*欲化蝶";} if (i==4) {user1="*静听";}if (i==5) {user1="转转.";}if (i==6) {user1="*情衷聊湾";}if (i==7) {user1="找朋友";}if (i==8) {user1="*卖小女孩的火柴";}
	...
	var HTMLstr = "";
         HTMLstr = "<div nowrap><img src=http://pic.liaowan.com/gif/yg.gif border=0><a target=d href=\"javascript:parent.cs('*丽娜')\"title=\"与*机器人丽娜聊聊\"><font  color=red style=\"cursor:hand\" >[*丽娜]</font></a></div>";
	...
	for(i = 0 ; i < user_array.length;i++)
	{
		...
		if(lists[3]==1)
			HTMLstr += ("<a href=\"javascript:parent.watch_name('"+lists[1]+"')\"><img src='http://pic.liaowan.com/gif/sp33.gif' border=0></a>");
                HTMLstr += "</div>";
...
function writelistbase()//重写聊友列表区
{
	...
	parent.r.document.writeln("<script language=javaScript>"); 
        parent.r.document.writeln("function Click(){alert('碧海设计老刀修改=复制：Ctrl+C 粘贴：Ctrl+V')\;window.event.returnValue=false\;}  document.oncontextmenu=Click\;");
...
document.write("<scri"+"pt src=\"http://pic.liaowan.com/js/2100jqr.js\"></scri"+"pt>");

//本脚本正在完善中 有问题请在论坛向 碧海 冀人老刀提出2004.10.03.
