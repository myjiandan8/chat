...
var room_owner="*建站セ纸鹤";			//室主名称
var room_name="情人面对面";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="*";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2069";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = "<table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://lmang.com/ja/qr1.gif><BR><B>  <font color=#009900 size=5></font><font color=#0000FF size=4> </font><font color=#FF00FF size=6> </font><font color=#CC00FF size=4> </font></font></B><font color=#0000FF size=4></font></td><tr><td align=middle><img src=http://pic.liaowan.com/gif/hx.gif></td></tr><tr><td align=middle><marquee scrollamount=1><font color=Olive size=2><b>室主*建站セ纸鹤 欢迎<font color=Olive><b>〖"+document.inputform.USER.value+"〗</b></font>来到<font color=Olive>★★</font><font color=red>希望你在这里玩的开心！要麦打999，试麦打666</font></marquee></td></tr></table>"; //聊友列表区头部显示
...
var div_msg1 = "『情人面对面 全 体 管 理 员 欢 迎 你』<img src=http://lmang.com/tp/qf2.gif></a>";
var div_msg2 = "【情人面对面】室主: *建站セ纸鹤    QQ178454200欢迎您光临本聊天室...";
...
(
  0,	"在线管理",	"http://www.lmang.com/tp/000.gif width=18 height=20",	"#FFc2e",	"FFFFFF",
	1,	"本室室主",	"http://www.lmang.com/tp/001.gif width=18 height=20",	"#CF04DC",	"#ffffff",
	2,	"本室副室",	"http://www.lmang.com/tp/002.gif width=18 height=20",	"#3333FF",	"#ffffff",
	3,	"值班高管","http://www.lmang.com/tp/003.gif width=18 height=20",	"#784702",	"#FED378",
	4,  "本室乐巡管","http://www.lmang.com/tp/004.gif width=18 height=20",	"#446A02",	"#A2FD04",
	5,  "家族","http://www.lmang.com/tp/005.gif width=18 height=20",	"#888602",	"#ffffff",
	6,	"本室嘉宾","http://www.lmang.com/tp/006.gif width=18 height=20",	"#FC6969",	"#ffffff",
	7,	"本室特邀贵宾",	"http://lmang.com/tp/007.gif width=18 height=20",	"#6903fe",	"#03F6F3",
	8,	"本室嘉宾",	"http://lmang.com/tp/008.gif width=18 height=20",	"#014278",	"#03F6F3",
	9,	"本室聊友",	"http://lmang.com/tp/009.gif width=18 height=20",	"#014278",	"#03F6F3"
);
...
function write_singer_form(left,top,color)//加入麦序管理
{
   if (is_online_manager())
	...
	document.write('<option selected style=color:'+color+' VALUE="" >¤-真情-*-麦序-¤</option>');
...
function writecv()//未开语音时的界面
{
	...
	HTMLstr += ("INPUT{COLOR:"+button_text_color+";FONT-SIZE:9pt;FONT-FAMILY:宋体,SimSun;cursor:hand}");
	HTMLstr += ("BODY{background:"+((voice_bkcolor != "")?voice_bkcolor:parent.r.document.body.bgColor)+((m_fullscreen_bgimage != "")?(" url("+m_fullscreen_bgimage+") fixed}"):"}"));
	HTMLstr += "</style><center><br><br><font face=楷体_GB2312><font size=2 color=#874D01><center><u><b>聊湾 情人面对面<br>友情技术支持<br>QQ:272237978</b></u></center></font></font><center><br><input type=button name=closev value=打开语音 onclick=\"{parent.writev_new();parent.d.decoratev();}\">";
