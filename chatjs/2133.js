...
var room_owner="天外黑仙";			//室主名称
var room_name="心语情缘";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="*№聊湾∮";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2133";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = "<table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://xinyu.w5.mscn.cn/873077/tp/tou1.gif><BR><B>  <font color=#009900 size=5> </font><font color=#0000FF size=5>   </font><font color=#FF00FF size=5>   </font><font color=#CC00FF size=5>   </font></font></B><font color=#0000FF size=5></font></td><tr><td align=middle><br><img src=http://www.tydncn.com/leadbbs/images/upload/face/2004/02/20/2308118750000.gif><br><img src= http://pic.liaowan.com/gif/hx.gif></td></tr><tr><td align=middle><marquee scrollamount=1><font color=ff0000 size=2><b>站长*天外黑仙欢迎<font color=ff0000><b>〖"+document.inputform.USER.value+"〗</b></font>来到<font color=ff0000>★★</font><font color=aa00ff>心语情缘希望你们在这里玩的开心！要麦打999，试麦打666</font></marquee></td></tr></table>"; //聊友列表区头部显示
var userlist_bottom_html = "<marquee scrollamount='2' > <font color=2e8b57> "+room_name+"欢迎</font><font color=ff0000>『"+a_user+"』</font><font color=8B0A50>的到来！要麦向红衣管理打9999 </font></marquee></a>";

//	聊友列表区底部框内文字代码
var listbottem0="〓★室主★〓<BR>"+room_owner+"<BR>欢迎你的到来<BR>"+room_name+"<Br>是我们<Br>共同的家";

var userlist_bkcolor = "#e5fffd";	//	聊友列表区的背景色
var userlist_bkimage = "bg1.gif";			//	聊友列表区的背景图，设置为空串则使用输入区的图片
...
var default_admin_pass = "4223709";	//	默认的管理员上管口令
...
var div_msg1 = "本站广招管理主持 请向在线管理咨询<a target=_blank href='http://www.fuhaihua.qq11.com' title='天外黑仙欢迎您！'><IMG align=absMiddle src=http://bbs.wowotou.com/heixian.jpg></a><a target=_blank href='http://www.fuhaihua.qq11.com' title='黑仙歌曲网'><IMG align=absMiddle src=http://user3.163888.net/hd5/200411/1904287/2004111112111.jpg></a>";
var div_msg2 = "【心语情缘】站长:*天外黑仙欢迎您光临本聊天室！";
var div_msg3 = "【心语情缘】本聊天室招聘优秀的主持人，要有上管经验，有足够的上管时间（在家上网或有视平）优先。有意者请与在线室主或高管联系。站长马甲:*天外黑仙,所有管理必须加，QQ：109060403";
var div_msg4 = "本聊天室脚本全面改版中,如果聊友想加入本室管理队伍，必须先在本室留个言，在与天外黑仙联系，谢谢合作！如果无法正常显示语音插件请<a target=_blank href='http://www.bluesky.com.cn/download/bluesky.exe'><font color=ff0000><b>点击这里</b></font></a>"; //通知
var div_link = "";
...
(
	"主页","http://www.fuhaihua.qq11.com",
	"音乐","http://lmqw.com/chatjs/player/album1.htm",
	"注册","http://liaowan.com/USadmin/regadd.asp",
	"电影","http://202.101.234.106/club/movie/index.asp",
        "留言","http://www.1studio.net/gbook.asp?id=157932",
        "相册","http://www.qq11.com/v2/photo/?username=fuhaihua"
);
...
(
	0,	"在线主持",		"http://bsradio.net/jl/tb/t0.gif",     "#FF0000","#FFFFFF",	
	1,	"本室站长",		"http://ytyz.kmip.net/lmqw/chatpic/zhuguan.gif",           "#aa00FF","#FFFFFF",
	2,	"本室室主",		"http://t4112.nease.net/4112/06.jpg",	          "#00cd00","#FFFFFF",
	3,	"本室监察",             "http://bbsxp.wfeng.com/330462/001.gif",	        "#FF7F00","#FFFFFF",
	4,	"本室高管",		"http://219.149.64.81/bchat_img/ggtx.gif",	"#ff00ff","#FFFFFF",
	5,	"本室女管",		"http://t4112.nease.net/4112/35.jpg",	"#AA00ff","#FFFFFF",
	6,	"本室男管",		"http://t4112.nease.net/4112/10.jpg",    "#b47736","#FFFFFF",
	7,	"本室嘉宾",		"http://bsradio.net/jl/tb/t5.gif",	"#FF6666","#FFFFFF",
	8,	"本室过客",		"http://bsradio.net/jl/tb/t6.gif",         "#0000ff","#FFFFFF",
	9,	"本室过客",		"http://bsradio.net/jl/tb/t6.gif",         "#0000ff","#FFFFFF",
	10,	"本室房主",		"http://ytyz.kmip.net/lmqw/chatpic/zhuguan.gif",    "#8B8B00","#FFFFFF",
	11,	"执行室主",		"http://bsradio.net/jl/tb/t2.gif",	         "#FF69B4","#FFFFFF",
	12,	"本室监察",             "http://bsradio.net/jl/tb/shi.gif",	        "#FF7F00","#FFFFFF",
	13,	"本室高管",		"http://219.149.64.81/bchat_img/ggtx.gif",	"#ff00ff","#FFFFFF",
	14,	"本室女管",		"http://t4112.nease.net/4112/35.jpg",	"#AA00ff","#FFFFFF",
	15,	"站长的兄弟",		"http://t4112.nease.net/4112/08.jpg",    "#B03060","#FFFFFF",
        16,	"特别贵宾马甲",		"http://bsradio.net/jl/tb/57.gif",         "#8DEEEE","#FFFFFF",
	17,	"心情雨宝贝妹妹",		"http://pic.liaowan.com/tb/666.gif",         "#CD6090","#FFFFFF",
	18,	"黑仙老婆",		"http://bsradio.net/jl/tb/58.gif",         "#CD3700","#FFFFFF",
	19,	"本室过客",		"http://bsradio.net/jl/tb/17.gif",         "#0000ff","#FFFFFF"	   
);

// 不可踢马甲
var wudimajia=new Array("*天外黑仙","*‖巡站‖絕戀","*絕戀","*譕伈愛",
"*ゞ╲靜ぁ児ぺ","*ツぷ心むルぷツ","*絕訫","*‖巡站‖依溪",
"*‖巡站‖小依","*蹩脚Dē女巫","*RoseL-Baby","*╰☆大漠孤独☆╮","*月牙儿","*RoseL-流苏","恋");  
...
(
	...
	"心语情缘",	"http://2133.liaowan.com/RB/1/",
	"风",	"2133",
	"桃",	"2133",
	"天",	"2133",
	"秋",	"2133",
...
(
         "『黑仙工作室』",	"http://www.fuhaihua.qq11.com",
         "黑仙留言",	"http://www.qq11.com/v2/guestbook/?username=fuhaihua",
         "朋友相册",	"http://www.163888.net/sing/showuser.aspx?uid=1904287&s=4",
         "黑仙音乐",	"http://www.fuhaihua.qq11.com",
	"黑仙文章",		"http://www.qq11.com/v2/story/list.asp?username=fuhaihua",
	"聊湾帮助",		"http://liaowan.com/help/",
	"黑仙",		"http://",
	"黑仙日记",		"http://www.qq11.com/v2/diary/style1_old.Asp?username=fuhaihua",
       "黑仙音乐1",          "http://hexian.home.sunbo.net",
       "黑仙音乐2",          "http://jxfuhaihua5.home.sunbo.net",
       "黑仙音乐3",         "http://jxfuhaihua4.home.sunbo.net",
	"音乐网",		"http://bsradio.net/music",
...
(
	"心语网址",	"聊天室网址 "+ room_link_url ,"color:#009900",
...
(
	...
	"谢谢","http://web.aofa.net/www/fuhaihua/1058.gif",
    ...
    "邀请唱歌","http://sspace.bliao.com:2003/876805/yaoqing.gif",
    "再唱一首","http://sspace.bliao.com:2003/876805/zaichang.gif",
    "鼓掌","http://pic.liaowan.com/gif/mgygz.gif",
	"晚安",	"http://sspace.bliao.com:2003/876805/wanan.gif"
...
//	write_button("","答谢",304,60,35,20,"","快速答谢","autosend(a_da)");
	...
	write_button("","听见",339,80,35,20,"","快速听见","autosend(a_heart)");
       write_button("","网址",304,80,35,20,"","黑仙网址","autosend(a_wang)");
	...
	write_select("linkurl","黑仙链接",533,80,72,select_color,a_linkurl,"gotolinkurl(this)");
       for (var i = 0 ; i < 6 ; i ++)
...
var listbottem="<tr><td colspan=3 align=center><table width='126' border='1' cellspacing='1' cellpadding='1' bordercolordark='#ff66ff' bordercolorlight='#FFFFFF' height='15'><tr><td  colspan=3 width='130' align='center'><span style='font-size: 8.7pt;COLOR:#ff0000'><marquee direction=up height=70 onmouseout='this.start()' onmouseover=this.stop() scrollAmount=1 width=130 crolldelay=80><center>欢迎朋友们光临<BR>『心语情缘』<BR><BR>本室网址:<BR>http://2133.liaowan.com<BR><BR>〓★本室站长★〓:<BR>*天外黑仙<BR><BR>祝朋友们<BR>玩得开心！玩得愉快！<br>室主：*§№小糊□涂仙№§<br>QQ：29010231<br>室主：*℡じ☆飞ゆ龙<br>QQ：278513439<br>脚本维护：天外黑仙<a target=_blank href='http://2133.liaowan.com' title='天外黑仙'><IMG align=absMiddle src=http://bbs.wowotou.com/heixian.jpg></a><Br><a target=_blank href='http://2133.liaowan.com' title='心语情缘欢迎您!'><IMG align=absMiddle src=http://bbs.wowotou.com/heixian.jpg></a></marquee></font></SPAN></td></tr></table></td></tr>";
...
//	对聊友重新排序
	...
	for(i = 0 ; i < user_array.length;i++)
	{
		...
		if(lists[3]==1)
			HTMLstr += ("<a href=\"javascript:parent.watch_name('"+lists[1]+"')\"><img src='http://bsradio.net/jl/tb/v1.gif' border=0></a>");
                HTMLstr += "</div>";
	}
...
function writelistbase()//重写聊友列表区
{
	...
	HTMLstr += "<br><a title='在线朋友名单'><font color=000000> <b>本室在线</font><font color=red><B id='usercount'>0</B></font><font color=000000> 位</b></font></a>";
	...
	parent.r.document.writeln("<script language=javaScript>"); 
        parent.r.document.writeln("function Click(){alert('小样！不准偷看，有事找房主：*天外黑仙！')\;window.event.returnValue=false\;}  document.oncontextmenu=Click\;");
...
function writecv()//未开语音时的界面
{
	...
	HTMLstr += ("INPUT{COLOR:"+button_text_color+";FONT-SIZE:9pt;FONT-FAMILY:宋体,SimSun;cursor:hand}");
	HTMLstr += ("BODY{background:"+((voice_bkcolor != "")?voice_bkcolor:parent.r.document.body.bgColor)+((m_fullscreen_bgimage != "")?(" url("+m_fullscreen_bgimage+") fixed}"):"}"));
	HTMLstr += "</style><center><br><br><font face=楷体_GB2312><font size=2 color=#874D01><center><u><b>本室房中<br>天外黑仙<br>QQ：109060403</b></u></center></font></font><center><br><input type=button name=closev value=打开语音 onclick=\"{parent.writev_new();parent.d.decoratev();}\">";
...
//本脚本正在完善中 有问题请与*天外黑仙联系，提出2004.10.37.