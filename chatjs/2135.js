...
var room_owner="*ゞ褙妳寵坏み   ★天涯★";			//室主名称
var room_name="劲舞视频";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="*↘☆魅力⺷_⺷";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2135";			//	房间号
...
var userlist_top_html = "<table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://lianmao.ik8.com/lianmao/jw.gif height=70 width=130><BR></td><tr><td align=middle><img src= http://pic.liaowan.com/gif/hx.gif></td></tr><tr><td align=middle><marquee scrollamount=1><font color=ff0000 size=2><b>室主*ゞ褙你寵坏み★天涯★欢迎<font color=ff0000><b>〖"+document.inputform.USER.value+"〗</b></font>来到<font color=ff0000>★★</font><font color=aa00ff>劲舞视频希望你们在这里玩的开心！要麦打999，试麦打666</font></marquee></td></tr></table>";//聊友列表区头部显示
...
//	聊友列表区底部框内文字代码
var listbottem0="＝＝室主＝＝<BR><BR>"+room_owner+"<BR><BR>＝＝监理＝＝<BR><BR>逍遥<BR><BR>＝＝维护＝＝<BR><BR>*№月圆维护℡丰子<BR><BR>欢迎你的到来<BR><BR>"+room_name+"<Br><BR>是我们<BR><Br>共同的家";
...
var div_msg3 = "〖劲舞视频〗公告：本室招聘帅哥美女管理，有意者请联系在线高管或室主，管理马甲样式:男的马甲*↘☆魅力⺷_⺷XX 女的马甲*劲舞╬XX≈宝贝,所有管理请加管理群5942869 ，一星期不上管不请假全部下管处理！！";
var div_msg4 = "【劲舞视频】室主:ゞ褙你寵坏み ★天涯★QQ364988256 维护:№月圆维护℡丰子  欢迎您光临本聊天室";  //通知
var div_link = "";
...
(
	...
	"注册","http://www.liaowan.com/USadmin/regadd.asp",
         "留言板","http://yuandi.com/lyb6/index.asp?user=劲舞视频",
...
//——聊友说明，在此修改聊友名字的颜色——   （0到13）
var a_usertitle = new Array
(
	0,	"在线管理",
	"http://liaowan.com/bbs/upload/2004827-180723-$$C9$$D9$$C5$$F4.gif",	"#FF0000",	"#ffffff",
	1,	"本室站长",	"http://www.y88.info/tp/14.gif",           "#8B0A50","#FFFFFF",
         2,	"执行室主",		"http://www.y88.info/tp/16.gif",	         "#00cd00","#FFFFFF",
	3,	"本室督察",	"http://www.qq165.com/js/pic/004.gif",	"#00FF00",	"#ffffff",	
         4,	"本室高管",		"http://pic.liaowan.com/tb/031.gif",	"#AA00ff","#FFFFFF",
	5,	"本室管理",     "http://pic.liaowan.com/gif/016.gif",	 "#FF7F50",	"#ffffff",
	6,	"本室歌手",	"http://pic.liaowan.com/tb/gs.gif",	"#2c07fe",	"#ffffff",
	7,	"本室嘉宾",		"http://pic.liaowan.com/tb/016.gif",	"#0000ff","#FFFFFF",
	8,	"本室过客",	"http://pic.liaowan.com/gif/0003.gif",	"#228B22",	"#ffffff",
         9,	"特别贵宾",		"http://pic.liaowan.com/tb/009.gif",	"#EE1289","#FFFFFF",
         10,	"本室过客",		"http://www.y88.info/tp/17.gif",         "#0000ff","#FFFFFF",
	11,	"本室过客",		"http://www.y88.info/tp/17.gif",         "#0000ff","#FFFFFF",
         12,	"贵宾",             "http://www.y88.info/tp/shi.gif",	        "#FF7F00","#FFFFFF",
	13,	"本室过客",	"http://pic.liaowan.com/gif/0003.gif",	"#228B22",	"#ffffff"

);

// 不可踢马甲
var wudimajia=new Array("*☆⌒_⌒☆梦","*↘☆魅力⺷_⺷夏天","*ゞ褙妳寵坏み","*好╃→乖ル","*★海角★","*☆﹏禁唇﹏﹖","*2135","","*ゞ一啶流淚み","*_封鈊","*★天涯★","*↘☆魅力⺷_⺷传说","*※飙车王子※","*ゞ流淚老公み","*★★★★★★★★","*" 
 );  
...
(
	"欢迎",	"★《 "+room_name+" 》欢迎你！坐┳┳请坐┳┳┳请上坐┳┳┳┳！★ ( http://2135.liaowan.com)",
	"欢迎",	"☆"+room_name+"☆欢迎您的光临，愿您在这里玩儿的开心！玩儿的愉快！( http://2135.liaowan.com) ",
	"欢迎",	"你好，请坐，请上坐┳━┳━┳ .给您端上热咖啡一杯.免费赠送的哦~~~还有奶茶~！( http://2135.liaowan.com) ",
	"欢迎",	"●◢◤◥◣◢◤◥ "+room_name+" ◣◢◣◢◤◥◣聊◢◤◥◣天◢◤◥◣室◢◤◥◣欢◢◤◥◣迎◢◤◥◣您● ( http://2135.liaowan.com) " 
);
...
(
	"网址",	"聊天室网址：http://2135.liaowan.com ",
	"网址",	"聊天室 网址：http://2135.liaowan.com  "
);
