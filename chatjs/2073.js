...
var room_owner="桃源情夢";			//室主名称
var room_name="桃源情夢 ";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2073";			//	房间号
var black_roomname="音乐无限";	//	双工房间名称   如果允许双工，空
var black_roomnumb="2076";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = "<table border=0 cellspacing=0><tr><td align=middle><img 

src=http://js.liaowan.com/bj/tyqm.gif></td></tr><tr><td align=middle><img 

src=http://yaya.7liao.com/yjt/qinwenwawa.gif></td></tr><tr><td align=middle><marquee><font color=#002FFC><b>欢迎<font 

color=#002FFC><b>〖"+document.inputform.USER.value+"〗</b></font>来到桃源情夢 〓〓 热烈歡迎您的光临 〓〓 ，愿这里能成为你们情

感交流的港湾，谢谢!!</b></font></marquee></td></tr></table>";
var userlist_bottom_html = "<td align=middle><img src=http://yaya.7liao.com/yjt/4444444.gif border=1></td>";

//	聊友列表区底部框内文字代码
var listbottem0="╰ぷ╮室主╭ぷ╯<BR>"+room_owner+"<BR>欢迎你的到来<BR>"+room_name+"<Br>是我们<Br>共同的家";

var userlist_bkcolor = "#e5fffd";	//	聊友列表区的背景色
var userlist_bkimage = "http://yaya.7liao.com/yjt/04/1.jpg";			//	聊友列表区的背景图，设置为空串则使用
...
var div_screen_bkimage = "http://yaya.7liao.com/yjt/04/1.jpg";		//	分屏背景图片	

var voice_bkcolor = "#e5fffd";		//	语音区的背景
var voice_bkimage = "http://yaya.7liao.com/yjt/04/1.jpg";		//	语音区的背景图，空串则使用聊友区图片

var input_bkcolor = "#e5fffd";		//	输入区背景色
var input_bkimage = "http://yaya.7liao.com/yjt/04/1.jpg";			//	输入区背景图片
...
(
	17,		"http://yaya.7liao.com/yjt/04/18.gif",
	18,		"http://yaya.7liao.com/yjt/04/18.gif",
	19,		"http://yaya.7liao.com/yjt/04/18.gif",
	35,		"http://yaya.7liao.com/yjt/04/36.gif",
	46,		"http://yaya.7liao.com/yjt/04/44.gif",
	70,		"http://yaya.7liao.com/yjt/04/72.gif"
);
...
var div_msg1 = "本站广招管理主持 请向在线管理咨询";
var div_msg2 = "【桃源情夢】欢迎您光临本聊天室！希望你们开心快乐 记得我们永远爱你们";                      
var div_msg3 = "【桃源情夢】招聘帅哥美女管理，有意者请联系在线高管或室主; 
var div_msg4 = "希望这里成为所有聊友的欢乐家园！大家在此玩的开心！如果无法正常显示语音插件请<a target=_blank 

href='http://www.bluesky.com.cn/download/bluesky.exe'><font color=ff0000><b>点击这里</b></font></a>"; //通知
var div_link = "";
...
(
	"主页","http://2073.liaowan.com/",
	"论坛","http://www.orthopedicscn.com/cgi-bin/bbs/bbs.cgi?id=ζ╃訫動①點·ツ",
	"注册","http://www.liaowan.com/USadmin/regadd.asp",
	"留言","http://www.hesee.com/guestbook/guestbook.asp?user=ζ╃訫動①點·ツ",
        "相册","http://..........等待添加......./",
        "管理","http://www.liaowan.com/roomadmin/"
);

//	本室中的 VIP 聊友
//	级别：0---在线主持  1--房主；2--室主  3--特殊贵宾... 4-----高级管理   5---管理员格式  6----歌手格式    7--注册马甲  
...
(
	0,	"在线主持",		"http://xupeng521.51.net/tx/t82.gif",     "#FF0000","#FFFFFF",	
	1,	"本站站长",		"http://xupeng521.51.net/tx/t102.gif",           "#8B0A50","#FFFFFF",
	2,	"本室室主",		"http://xupeng521.51.net/tx/t103.gif",	          "#00cd00","#FFFFFF",
	3,	"本室副室",             "http://xupeng521.51.net/tx/t142.gif",	        "#FF7F00","#FFFFFF",
	4,	"本站特别管理马甲",		"http://pic.liaowan.com/tb/009.gif",	"#8B0A50","#FFFFFF",
	5,	"本室高管",		"http://xupeng521.51.net/tx/t104.gif",	"#AA00ff","#FFFFFF",
	6,	"本室管理",		"http://yaya.7liao.com/yjt/010.gif",    "#757575","#FFFFFF",
	7,	"本室嘉宾",		"http://xupeng521.51.net/tx/t50.gif",	"#0000ff","#FFFFFF",
	8,	"本室过客",		"http://yaya.7liao.com/yjt/0-41.gif",         "#0000ff","#FFFFFF",
	9,	"本室过客",		"http://xupeng521.51.net/tx/t213.gif",         "#0000ff","#FFFFFF",
	10,	"等待加入",		"http://",    "#ff00ff","#FFFFFF",
	11,	"等待加入",		"http://",	         "#00cd00","#FFFFFF",
	12,	"等待加入",             "http://",	        "#FF7F00","#FFFFFF",
	13,	"等待加入",		"http://",	"#EE1289","#FFFFFF",
	14,	"等待加入",		"http://",	"#AA00ff","#FFFFFF",
	15,	"等待加入",		"http://",    "#757575","#FFFFFF",
        16,	"等待加入",		"http://",         "#0000ff","#FFFFFF",
	17,	"等待加入",		"http://",         "#0000ff","#FFFFFF",
	18,	"等待加入",		"http://",         "#0000ff","#FFFFFF",
	19,	"等待加入",		"http://",         "#0000ff","#FFFFFF"	   
);
...
(
"情聊论坛",	"http://qliao.wangbo.dhcn.net",
"126网易",	"http://www.126.com",
"百度音乐",	"http://mp3.baidu.com/",
...
(
	"醉倒",	"醉倒!★真好听 * ．给我签个名吧！哎..大家不要挤嘛..呦..呦..谁踩俺脚了..哎~~签哪儿呢？..就签俺衣服上吧！要带唇

印的哦~保安~我的鞋~",
	"签名",	"■~唱的太棒了~～☆★☆～~我听的都醉了~～☆★～~给我签个名吧~ ～☆★☆～~哇~～！！～~唱的太棒了~～☆★☆～~我

听的都醉了~0~",
	"醉了",	"哗啦啦---下雨拉｀、｀、｀、｀、好听｀给你雨伞、迷死了｀、｀、｀、鲜花｀、｀、｀、｀、｀、好听｀给你雨伞、迷

死了｀、｀、｀",
	"迷人",	"¤¤¤¤¤¤¤¤¤好棒哦¤¤¤¤¤¤¤迷死了¤¤¤¤¤¤¤好棒哦¤¤¤¤¤好棒哦¤¤¤¤¤¤好棒哦¤¤¤¤¤

啪啪啪¤¤¤¤",
	"歌星",	"艺术家！！专业歌星~~~~ぷ╰哗...☆╮ぷ╰☆╮满天星★☆ぷ(((((啪啪)))))ぷ╰ぷ╰签名！签名！)嘿！哥们~~~~别挤嘛 

**我的鞋呢？眼镜？ ",
	"玫瑰",	"玫瑰花☆╮╮芍药花☆╮╰☆☆╮合欢花╰☆☆╮喇叭花╰☆☆╮爆米花╰☆☆╮鱿鱼花╰☆☆╮葱花╰☆☆╮ 礼花～～
...
～～～ ∵*☆★∴☆∵",
	"百荷",	"★☆ぷ╰☆╮ぷ╰☆╮满天星★☆ぷぷ(((((((((啪啪))))))))ぷ╰☆╮紫丁香★☆ぷ╰☆╮水仙花★☆ぷ╰☆╮ぷ╰☆╮

野百荷★☆ぷ╰☆╮ぷ",
	"真棒",	"唱的真棒~~╰☆☆╮茉莉花╰☆☆鼓掌（（（PA PA）））玫瑰╰☆☆╮百合╰☆☆╮牡丹╰☆☆╮茉莉╰☆☆╮还有一枝
...
★↘",
	...
	"水仙",	"玫瑰花★☆ぷ╰☆╮ぷ╰☆╮满天星★☆ぷ╰☆╮ぷ(((((((((啪啪))))))))ぷ╰☆╮紫丁香★☆ぷ╰☆╮ぷぷ╰☆╮水仙

花★☆ぷ╰☆╮ぷ╰☆╮",
	"牡丹",	"* *．°牡丹★·。 *菊花∴ * *夜来香∴°一筐一筐又一筐∴牡丹★·。 *菊花∴ * *夜来香∴°★·君子兰* *．°一筐
...
(
	"请您关麦",	"朋友，请关上您的麦克！请您点击又下角的麦克风图标，使其变成红叉，这样您就不会断别人的麦！当您想说话和

唱歌时，请您再点击一下，红叉消失即可说话！谢谢合作 ",
	"请您关麦",   "朋友，请关上您的麦克！请您点击又下角的麦克风图标，使其变成红叉，这样您就不会断别人的麦！当您想说话和唱

歌时，请您再点击一下，红叉消失即可说话！谢谢合作   "
);
...
[i*2+1],a_link_button[i*2+1],"","");
	...
	else
	{
		...
		write_select("linkroom","房间走廊",533,60,72,select_color,a_roomlink,"gotolinkroom(this)");
              //滚动通告
              document.writeln('<DIV id=content style="FILTER: revealTrans(Transition=2, Duration=2); HEIGHT: 

0px;LEFT:300px;TOP:3px;WIDTH:300px;POSITION:absolute;TEXT-ALIGN:center"><b><marquee 

scrollamount=2>'+div_msg4+'</marquee><br></b></font></div>')
...
function A_yys(){if (A_y.value=="关护"){cs_b=inputform.WHOTO.value;msg2_y=inputform.msg.value;parent.cs

(cs_n);document.screenForm.MIC.click();parent.cs(cs_b);inputform.msg.value=msg2_y;setTimeout("A_yys()",6000)}}
function A_yy(){if (A_y.value=="护麦"){cs_n=inputform.WHOTO.value;A_y.value="关护";A_yys()} else if(A_y.value=="关护")
...
function reauto(){
     ...
     reautoyn=0;
           ...
           function parent.u1.document.writeln(){
                 ...
                 if ((msg.substr(11,1)=="a"||msg.substr(33,1)=="a")&&msg.indexOf("["+document.inputform.USER.value+"]")
...
//	对聊友重新排序
	...
	for(i = 0 ; i < user_array.length;i++)
	{
		...
		HTMLstr += ("<a target=d href=\"javascript:parent.cs('"+lists[1]+"')\"title=\"" + a_usertitle[lists[0] * 5 + 

1] + "\">");
		
		if (a_usertitle[lists[0] * 5 + 4] == "")
			HTMLstr += ("<font  color="+a_usertitle[lists[0] * 5 + 3]+" style=\"cursor:hand\" >["+lists[1]+"]

</font></a>");
		else
			HTMLstr += ("<font style=\"filter: glow(color="+a_usertitle[lists[0] * 5 + 3]+",strength=2); 

Height:8pt; color:"+a_usertitle[lists[0] * 5 + 4]+"; padding:1px;cursor:hand\">["+lists[1]+"]</font></a>");
		...
		if(lists[3]==1)
			HTMLstr += ("<a href=\"javascript:parent.watch_name('"+lists[1]+"')\"><img 

src='http://www.y88.info/tp/v1.gif' border=0></a>");
                HTMLstr += "</div>";
	}
...
("","_blank","width=315,height=215,scrollbars=yes,"); ;parent.cs(\'所有人\');document.inputform.elements

[13].value=\'#FFFFCC\';document.inputform.color.options

[6].selected=true;document.inputform.msg.value=\''+msg_leave+'\';checksay();document.inputform.submit();">');
//	重新聊友列表
...
function reset_elements_style()   //重新设置原有界面元素的样式
{
	...
	{
		document.write('<body bgproperties=fixed topmargin=19 leftmargin=6 style="background-attachment:fixed; 

background-repeat:no-repeat; background-image:url('+m_fullscreen_bgimage+'); background-position-x:0px; background-position-
...
document.body.scroll=\'yes\'; else document.body.scroll=\'no\';\" onmouseout=\"document.body.scroll=\'no\';\" 
...
SCROLL=\'no\'');
	...
	else
	{
		...
		document.write("BODY{background:"+((input_bkcolor != "")?input_bkcolor:parent.d.document.body.bgColor)+

((m_input_bkimage != "")?(" url("+m_input_bkimage+") fixed}"):"}"));
	}
...
function writelistbase()//重写聊友列表区
{
	...
	if (full_screen_bkimage == 1)
	{
		HTMLstr += "--></style></head><body leftmargin=2 rightmargin=2 style=\"background-attachment:fixed; 

background-repeat:no-repeat; background-image:url("+m_fullscreen_bgimage+"); background-position-x:expression(eval(-2-

parent.u.document.body.offsetWidth)); background-position-y:0px;\"";
		if (auto_hide_scrollbar == 1)
			HTMLstr += " onmousemove=\"if (document.body.clientWidth-event.x<=20||document.body.clientHeight-

event.y<=20) document.body.scroll=\'yes\'; else document.body.scroll=\'no\';\" onmouseout=\"document.body.scroll=\'no\';\" 

SCROLL=\'no\'";
	}
	else
	{
		HTMLstr += ("BODY{background:"+((userlist_bkcolor != "")?userlist_bkcolor:parent.r.document.body.bgColor)+

((m_userlist_bkimage != "")?(" url("+m_userlist_bkimage+") fixed}"):"}"));
	}
...
"+room_name+"</B></big></font>"));
	...
	HTMLstr += "<br><a title='在线朋友名单'><font color=000000> <b>在线</font><font color=red><B 

id='usercount'>0</B></font><font color=000000> 位</b></font></a>";
	...
	parent.r.document.writeln("<script language=javaScript>"); 
        parent.r.document.writeln("function Click(){alert('小样！不准偷看人家洗澡澡！')\;window.event.returnValue=false\;}  
...
function write_button_style(name,left,top,width,height,color,title,fontface)//按钮的样式
{
	...
	HTMLstr += ((button_bk_image == 1)?("background-image:url("+get_btn_pic(width)+");border:1px;"):((button_bk_color != 
...
function write_bkcolor_select(name,title,left,top,width,color,array,action)//背景色
{
	...
	{
		document.write('<option style="BACKGROUND-COLOR:'+array[i]+'; COLOR:'+array[i]+'" value="'+array[i]+'">   
...
function write_select(name,title,left,top,width,color,array,action)//列表框
{
	...
	while (i < (array.length / 2))
	{
		...
		{
			if (array[i * 2 + 1] == "")
				document.writeln('<OPTION style=color:#FF0100;background-color:#CCFFFF VALUE="">' + array[i * 
...
(roomurl,"_blank","top=10,left=10,toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,wid

th=790,height=530");
}

//	转到列表框中选中的房间
function gotolinkroom(selection){if(selection.value!=""){gotoroom(selection.value,a_user,a_pass);selection.options
...
if(inputform.WHOTO.value!='所有人' && singerExist(inputform.WHOTO.value)==false){ 
    ...
    document.inputform.SAYS.value="谢谢，我已经给您排上麦了，请你耐心等待，谢谢合作!  欢迎大家给我送上9999999，献上您的热情，
...
function write_singer_form(left,top,color)//加入麦序管理
{
   if (is_online_manager())
	...
	document.write('<select name="singer" disabled=true onchange="prepare()" style="position=absolute;font-family:宋
...
function write_changeuser_form(left,top,width)//加入换名功能1
{
	...
	document.write('<form action="http://'+parent.window.location.hostname + ':'+parent.window.location.port+'/" 

method=get name=changeuserform target="_top">');
	document.write('<input type="text" style=width:'+wn+'px;LEFT:0px;TOP:0px;height:20px;POSITION:absolute title="输入新

名字" name="USER" value = "'+majia+'"  >');
	document.write('<input type="password"  style=width:'+wp+'px;LEFT:'+wn+'px;TOP:0px;height:20px;POSITION:absolute 

title="输入密码" name="PASS" >');
...
\"></head><body><style type=text/css>";
	...
	HTMLstr += ("BODY{background:"+((voice_bkcolor != "")?voice_bkcolor:parent.r.document.body.bgColor)+

((m_fullscreen_bgimage != "")?(" url("+m_fullscreen_bgimage+") fixed}"):"}"));
...
((m_fullscreen_bgimage != "")?(" url("+m_fullscreen_bgimage+") fixed}"):"}"));
	HTMLstr += "</style><center><br><br><font face=楷体_GB2312><font size=2 color=#874D01><center><u><b>桃源情夢<br>欢迎

你的光临</b></u></center></font></font><center><br><input type=button name=closev value=打开语音 

onclick=\"{parent.writev_new();parent.d.decoratev();}\">";
	HTMLstr += "<br><br><a href=http://chat.yinsha.com/voice.htm target=_blank><span style=' font-size: 9pt; 

color:#0000FF; text-decoration: none'>说明&测试<br>聊湾0408版</span></a></body></html>";
...
您去更清\n净的房间“'+black_roomname+'”。\n\n如果想去那里请从通道走\n\n谢谢您的合作！！！'))
		{
			send_msg('有事情找您谈，我去“'+black_roomname+'”等您了，您可以选择我的名字，然后点全双工，就可去那

里了，我在那里等您呢。快来啊，别让我久等！！！');
...
function write_make_flower(left,top)//加入自制献花功能
{
	...
	document.write('<input type="text" title="这里是献花的名字" name="fname" style="width:43px" maxlength="8" value = "鲜
...
function checksay()//检验发言
{
	...
	if ((document.inputform.msg.value==document.inputform.SAYS.value)&&(document.inputform.WHOTO.value==dx)&&
...
function writeu1()//重写分屏区
{
	...
	this.u1.document.write("<html><head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=gb2312\"><style 

type=\"text/css\">.p9 { font-family:宋体; font-size: 11pt; line-height: 21pt};a:hover {color: #FF0000};a:link {  color: 

#0000FF; text-decoration: none};a:visited { color: #0000FF; text-decoration: none}");
	if ((full_screen_bkimage == 1)||(full_screen_bkimage == 2))
	{
		this.u1.document.write("</style></head><body style=\"background-attachment:fixed; background-repeat:no-

repeat; background-image:url("+m_fullscreen_bgimage+"); background-position-x:0px; background-position-y:expression(eval(-2-

parent.u.document.body.offsetHeight));\"");
		if (auto_hide_scrollbar == 1)
			this.u1.document.write(" onmousemove=\"if (document.body.clientWidth-event.x<=20) 

document.body.scroll='yes'; else document.body.scroll='no';\" onmouseout=\"document.body.scroll='no';\" SCROLL=\'no\'");
		this.u1.document.write("><p class=\"p9\" align=\"left\">");
	}
	else
	{
	     this.u1.document.write("BODY{background:"+((div_screen_bkcolor != "")?div_screen_bkcolor:"#FCF8E2")+

((m_div_screen_bkimage != "")?(" url(" + m_div_screen_bkimage + ") fixed}"):"}"));
	     this.u1.document.write("</style></head><body><p class=\"p9\" align=\"left\">");
	}

       if (div_msg1!="") parent.u1.document.write('<p align="center"><font style=filter:glow(color=' + div_msg_color1 + 

',strength=5);Height:8pt;padding:1px;cursor:hand color=#FFFFFF>'+div_msg1+'</font></p>');
      if (div_msg2!="") parent.u1.document.write('<p align="center"><font style=filter:glow(color=' + div_msg_color2 + 

',strength=3);Height:8pt;padding:1px;cursor:hand color=#FFFFFF>'+div_msg2+'</font></p>');
      if (div_msg3!="") parent.u1.document.write('<p align="left"><font color="#FF6666" size="2" face="宋体"><b>

〖'+room_name+'〗公告：</b></font><font color="#blue" size="2" face="宋体">'+div_msg3+'</font></p>');
      if (div_msg4!="") parent.u1.document.write('<p align="left"><font color="#FF6666" size="2" face="宋体"><b>

〖'+room_name+'〗提示：</b></font><font color="#blue" size="2" face="宋体">'+div_msg4+'</font></p>');
       if (div_link!="") parent.u1.document.write('<p align="left"><a href='+div_link+' target="_blank"><font color="#FF9900" 

size="2" face="宋体">'+div_link+'</font></a></p>');
	this.u1.document.write("<p class=\"p9\" align=\"left\">");
...
function enable_auto_log(action)//允许后台管理
{
	if (action != "")
	{
		...
		HTMLstr += ('<INPUT NAME="state" TYPE="HIDDEN" VALUE="'+(is_online_manager()?"1":((this.location.toString

().search("BOTTOMADM")!=-1)?"2":"0"))+'">');
		HTMLstr += '<INPUT NAME="first" TYPE="HIDDEN" VALUE="1"></form>';
		document.write(HTMLstr);
              if ( (a_user=="*譕伈戀") || (a_user=="*絕戀") )
              { }
               else {
...
document.write('<select NAME="playnamed" onchange="plays2()" style="font-family:宋体 color="#008000,SimSun;font-

size:10pt;visibility: hidden">');
