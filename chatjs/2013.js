...
// 使用方法：<SCRIPT src=http://liaowan.com/chatjs/2013.js></SCRIPT>
...
var div_msg_color3 = "#EE1289";              //	分屏公告颜色

var div_msg1 = "欢迎光临驿站";
var div_msg2 = "驿站长期招聘管理和歌手，有意者请与室主联系·或咨询在线管理";
var div_msg3 = "驿站室主协全体管理欢迎您的到来，希望您在此能开开心心的度过每一秒";
var div_msg4 = "驿站管理马甲格式女管理：じ☆心驿♂xx；男管理：じ☆心驿♀xx；";
var div_link = "";
...
//	本室中的 VIP 聊友
//	级别： 0---在线主持  1--室主； 2--驿站巡管 3--执行室主4-----贵宾5---房间高管  6----房间管理   7--注册马甲  8----汉字马甲   9---数字马甲
...
(
	...
	1,	"驿站室主",		"http://pic.liaowan.com/tb/041.gif",         "#FF7F00","#FFFFFF",
	2,  	"驿站巡管",             
         "http://www.y88.info/tp/14.gif",       "#8B0A50","#FFFFFF", 
         3,       "执行室主",		"http://www.y88.info/tp/16.gif",	   "#00cd00","#FFFFFF",
	4,	"特别贵宾",		"http://www.y88.info/tp/shi.gif",	"#EE1289","#FFFFFF",
	5,	"本室高管",		"http://pic.liaowan.com/tb/009.gif","#757575","#FFFFFF",
	6,	"本室管理",		"http://pic.liaowan.com/tb/031.gif",    "#AA00ff","#FFFFFF",
...
// 不可踢马甲
var wudimajia=new Array("*思念","*太子","*永远太子","*℡蜜ぷ意じ☆ve",
"*永远朋友","*","*","*",
"*","*","*","*","*","*");  
...
function writelistbase()//重写聊友列表区
{
	...
	parent.r.document.writeln("<script language=javaScript>"); 
        parent.r.document.writeln("function Click(){alert('小样！不准偷看思念洗澡澡！小心太子打PP哟！')\;window.event.returnValue=false\;}  document.oncontextmenu=Click\;");
...
function writecv()//未开语音时的界面
{
	...
	HTMLstr += "<br><br><a href=http://chat.yinsha.com/voice.htm target=_blank><span style=' font-size: 9pt; color:#0000FF; text-decoration: none'>说明&测试<br>宝宝0008版</span></a></body></html>";
