...
var body_text_color	= "#353535";	//	输入区文字色
var select_color = "#353535";		//	列表框文字色
var select_text_color = "#353535";	//	列表框内文字色
var button_text_color = "#353535";	//	输入区按钮文字色
...
var div_msg3 = "欢迎朋友们光临【"+room_name+"】!~~视频连接请直接点名字后小眼睛";
var div_msg4 = "【聊湾会所】:*欢迎您光临本聊天室";  //通知
var div_link = "";
...
(
	...
	31,"http://pic.liaowan.com/anniu/16/2.gif",
...
(
	...
	1,	"聊湾巡站",	"http://liren.xiaoyao.com.cn/tu/175956.gif ",	"#DE55cc",	"",
	2,	"本室副室",	"tb/"+txlx_number+"/002.gif ",	"#DE55cc",	"",
	3,	"高级管理",	"tb/"+txlx_number+"/003.gif ",	"#DE55cc",	"",
...
// 不可踢马甲
var wudimajia=new Array("*‖巡站‖野猫","*‖巡站‖孖軒","*‖巡站‖有点病","*‖巡站‖漫步","*‖巡站‖酷儿","*‖巡站‖依然",
"*‖巡站‖浩繁","*‖巡站‖絕戀","*‖巡站‖飞龙","*国际米兰" ,"*‖巡站‖凉风有信","*‖巡站‖黑色阳光","*‖巡站‖依溪","*‖巡站‖老暴","*‖巡站‖小依"
 );  
...
var listbottem="<tr><center><marquee direction=up height=50 onmouseout='this.start()' onmouseover=this.stop() scrollAmount=1 width=140 crolldelay=60><center><span style='font-size: 9pt;COLOR:#8951B0'>///////////////<br>///////////////<br>///////////////<br>///////////////</font></marquee><br>  </tr>";
