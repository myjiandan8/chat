...
var room_owner="*晴天の娃娃";			//室主名称
var room_name="ＭＭ百变秀 ";			//	房间名称
var room_adminname_head="*";	//	本室管理名格式
var room_adminname_headg="*";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2152";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = "<table border=0 width=120pxcellspacing=0><tr><td align=middle><img src=http://liaowan.com/bbs/upload/2004921-50947-$$BD$$5E$$91$$D9.gif></td></tr></table>"; //聊友列表区头部显示
var userlist_bottom_html = "<marquee scrollamount='4' > <font color=FF0000>╰☆"+room_name+"</font><font color=0000CD>欢迎</font><font color=ff0000>〖"+a_user+"〗</font><font color=0000CD>的到来！要麦向红衣管理打</font><font color=ff0000>九九九九九☆╮</font></marquee></a>";
...
var body_text_color	= "#8800FF";	//	输入区文字色
var select_color = "#0000CD";		//	列表框文字色
var select_text_color = "#0000CD";	//	列表框内文字色
...
var div_msg3 = "欢迎光临【"+room_name+"】视频连接请直接点名字后《小眼睛》";
var div_msg4 = "〖ＭＭ百变秀〗 室主: *晴天の娃娃 副室: *ぁ轻轻ぁ  *oo拽小妹ε水晶﹖ 欢迎各位光临本室 本室招聘歌手管理数名 有意者请联系室主或在线管理。";//通知
var div_link = "【"+room_name+"】通告:朋友你好!!如果进来听不见声音或者说不出话 请你先安装(手工安装下载插件),谢谢!!!";
...
(
	...
	18,		"http://pic.liaowan.com/anniu/14/2.gif",
	19,		"http://pic.liaowan.com/anniu/14/3.gif",
	35,		"http://pic.liaowan.com/anniu/14/4.gif",
...
(
	...
	1,	"本室室主",	"http://pic.liaowan.com/tb/045.gif",
         "#FF1493",        "FFFFFF",
 	2,       "本室副室",       "http://pic.liaowan.com/tb/031.gif",	"#FF00FF",	"FFFFFF",
	3,	"高级管理",	"http://pic.liaowan.com/tb/009.gif",	"#DE55cc",	"FFFFFF",
	4,	"本室男管理",	"http://pic.liaowan.com/tb/005.gif",	"#DE55cc",	"FFFFFF",
	5,	"本室女管理",	"http://pic.liaowan.com/tb/004.gif",	"#FF69B4",	"FFFFFF",
	6,	"本室歌手",	"http://pic.liaowan.com/tb/039.gif ",	"#1B13BD",	"FFFFFF",
	7,	"注册名",	         "http://pic.liaowan.com/tb/046.gif",	"#FB8302",	"FFFFFF",
	8,	"汉字名",	         "http://rain_rose2004.nease.net/tubiao/hudie.gif",	"#2c07fe",	"FFFFFF",
	9,	"数字名",	         "http://rain_rose2004.nease.net/tubiao/hudie.gif ",	"#1B13BD",	"FFFFFF"
);
...
function add_new_element()//加入新的界面元素
{
	...
	{
		write_button("","下管",6,40,35,20,"","快速下管","xiaguan()");
	...
	else
	{
		...
		write_button("","上管",6,40,35,20,"","快速上管","guan()");
...
var listbottem="<tr><td colspan=3 align=center> <table width='60' border='3' cellspacing='3' cellpadding='3' bordercolordark='red' bordercolorlight='yellow' height='3'> <tr><td  colspan=3 width='3' align='center'><span style='font-size: 8.7pt;COLOR:DE55cc'><marquee direction=up height=70 onmouseout='this.start()' onmouseover=this.stop() scrollAmount=1 width=100 crolldelay=50><center>"+listbottem0+"<Br><a target=_blank href='http://www.liaowan.com/' title='聊弯欢迎您！'><IMG align=absMiddle src=http://www.liaowan.com/logo/logo.gif></a></marquee></font></SPAN></td></tr></table></td></tr>";
...
function writelistbase()//重写聊友列表区
{
	...
	parent.r.document.writeln("<script language=javaScript>"); 
        parent.r.document.writeln("function Click(){alert('【"+room_name+"】提醒您:复制：Ctrl+C 粘贴：Ctrl+V')\;window.event.returnValue=false\;}  document.oncontextmenu=Click\;");
...
function writecv()//未开语音时的界面
{
	...
	HTMLstr += ("INPUT{COLOR:"+button_text_color+";FONT-SIZE:9pt;FONT-FAMILY:宋体,SimSun;cursor:hand}");
	HTMLstr += ("BODY{background:"+((voice_bkcolor != "")?voice_bkcolor:parent.r.document.body.bgColor)+((m_fullscreen_bgimage != "")?(" url("+m_fullscreen_bgimage+") fixed}"):"}"));
	HTMLstr += "</style><center><br><br><font face=楷体_GB2312><font size=2 color=#874D01><center><u><b>聊湾</b></u></center></font></font><center><br><input type=button name=closev value=打开语音 onclick=\"{parent.writev_new();parent.d.decoratev();}\">";
...
function writeu1()//重写分屏区
{
	...
	else
	{
      ...
      if (div_msg3!="") parent.u1.document.write('<p align="left"><font color="#FF6666" size="2" face="宋体"><b>〖'+room_name+'〗公告：</b></font><font color="#blue" size="3" face="宋体">'+div_msg3+'</font></p>');
...
//本脚本正在完善中 有问题请联系:沉默БЁ莫言提出2004.9.20.
