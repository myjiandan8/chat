...
var room_owner="*梦中漫步";			//室主名称
var room_name="梦中漫步";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="*№聊湾∮";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2183";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = "<table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://www.liaowan.com/bbs/upload/2004930-20531-$$C1$$B9$$B7$$E7$$D3$$D0$$D0$$C5.gif><BR><B>  <font color=#009900 size=5> </font><font color=#0000FF size=5>   </font><font color=#FF00FF size=5>   </font><font color=#CC00FF size=5>   </font></font></B><font color=#0000FF size=5></font></td><tr><td align=middle><img src= http://www.6see.com/js/001/js/gif/lines02.gif ></td></tr><tr><td align=middle><marquee scrollamount=1><font color=ff0000 size=2><b>室主*梦中漫步欢迎<font color=ff0000><b>〖"+document.inputform.USER.value+"〗</b></font>来到<font color=ff0000>★★</font><font color=aa00ff>梦中漫步希望你们在这里玩的开心！要麦打999，试麦打666</font></marquee></td></tr></table>"; //聊友列表区头部显示
...
(
	"主页","http://www.y88.info",
	"论坛","http://www.y88.info/forum_list.asp?forum_id=14",
	"注册","http://www.liaowan.com/USadmin/regadd.asp",
	"电台","http://www.ibsr.cn",
        "舞曲","http://www.y88.info/dj.asp",
        "彩信","http://www.y88.info/sms.asp"
);
...
// 不可踢马甲
var wudimajia=new Array("*譕伈戀","*‖巡站‖絕戀","*絕戀","*譕伈愛",
"*ゞ╲靜ぁ児ぺ","*ゞ☆挑逗Ni的心ゞ","*絕訫","*‖巡站‖依溪",
"*‖巡站‖小依","*蹩脚Dē女巫","*RoseL-Baby","*╰☆大漠孤独☆╮","*月牙儿","*RoseL-流苏");  
