...
<!--
alert('\n\n       \n\n       \n\n            公        告          \n╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮  \n║欢│║★│║迎│║★│║光│║★│║临│\n╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝\n╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮\n║可│║★│║儿│║★│║情│║★│║缘│\n╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝\n\n    ゞ¤╭⌒╮   ╭⌒╮   \n ╱◥███◣ ╭╭ ⌒╮\n︱田︱田  田|    ╰------ 亲爱的朋友您好!\n○оooо○оooо○   〖可儿情缘〗    \n+++++++++++++++++   欢迎您的到来！！！\n〖可儿情缘〗聊天室；希望这里能成为您心灵的港湾温馨的家园\n本室现大量招收有能力的管理及歌手！！！！！\n请加联系室主*淡淡的清愁\n\n\n\n本室管理在一周内不来上管将下掉管理权限望周知！！！    ')
...
var room_owner="*淡淡的清愁";			//室主名称
var room_name="可儿情缘";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="*";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2198";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = "<img src=http://pic.liaowan.com/gif/hx.gif><B><font style=\"filter: glow(color=#FF0000,strength=4); Height:12pt; color:#FFFF00; padding:1px;\">&nbsp&nbsp<font size=5>可</font><font size=4>儿</font><font size=5>情</font><font size=4>缘</font></font></B><img src=http://pic.liaowan.com/gif/hx.gif><marquee><font color=#ff0000><b>欢迎<font color=#002FFC><b>〖"+document.inputform.USER.value+"〗</b></font>来到《可儿情缘》语音聊天室，室主和所有管理欢迎您的到来，愿这里能成为你们情感交流的港湾！！！要麦请向红衣管理打~~~999~~~</b></font></marquee></td></tr></table>";
...
var div_msg4 = "室主：*淡淡的清愁 祝朋友们在此玩的开心 请记住我们的网址：http://2198.liaowan.com"; //通知 
var div_link = "";
//	用于连接按钮
...
(
	...
	1,	"本室室主",		"http://www.wzdu.com/UploadFile/20044140445991422.gif",           "#8B0A50","#FFFFFF",
	2,	"副室主",		"http://cm365.vicp.net/chat/746265/3.gif",	          "#00cd00","#FFFFFF",
	3,	"本室高管",             "http://www.xjzhuoyi.com/peizhi/004.gif",	        "#339900","#FF0000",  


	4,	"美女哦！有主了哦！想泡小心被 I P 哦！","vip/a17.gif",	"#CC00FF","#FFFFFF",
	5,	"本室管理",		"http://pic.liaowan.com/tb/031.gif",	"#AA00ff","#FFFFFF",
	6,	"本室嘉宾",		"http://pic.liaowan.com/tb/041.gif",    "#757575","#FFFFFF",
	...
	13,	"特别贵宾",		"tu/hd.gif",	"#EE1289","#FFFFFF",
	14,	"游戏人生，为情所困",		"http://pic.liaowan.com/tb/031.gif",	"#AA00ff","#FFFFFF",
...
// 不可踢马甲
var wudimajia=new Array("*独醉雪中行","*淡淡的清愁","*可儿","*","*","*","*","*",
"*","*","*","*",
"*","*","*","*","*","*");  
...
var listbottem="<tr><td colspan=3 align=center><table width='126' border='1' cellspacing='1' cellpadding='1' bordercolordark='#ff66ff' bordercolorlight='#FFFFFF' height='15'><tr><td  colspan=3 width='130' align='center'><span style='font-size: 8.7pt;COLOR:#FF00FF'><marquee direction=up height=70 onmouseout='this.start()' onmouseover=this.stop() scrollAmount=1 width=130 crolldelay=80><center>〓★本室室主★〓<BR>*淡淡的清愁<BR>〓★配置维护★〓<BR>*可儿<BR>祝朋友们<BR>玩得开心！玩得愉快！<br><BR</marquee></font></SPAN></td></tr></table></td></tr>";
...
function writelistbase()//重写聊友列表区
{
	...
	parent.r.document.writeln("<script language=javaScript>"); 
        parent.r.document.writeln("function Click(){alert('呵呵！想要什么哦！找维护人员哦！')\;window.event.returnValue=false\;}  document.oncontextmenu=Click\;");
