// 此脚本是偷来的，并被俺给改乱套了~！~容易掉线、死机、中病毒……哈哈哈~~~~ //

document.oncontextmenu = new Function("return false;");
var RoomName		="一兜子寂寞……";			//房间名
var RoomNumb		="2107";			//房间号
var BlackRoomName	="私聊房间";			//私聊房间
var BlackRoomNumb	="";			//无私聊房间设置为：""
var RoomNick		="一兜子寂寞";			//房间名简称
var HomePage		="http://"+RoomNumb+".liaowan.com/";	//房间地址
var JsPlace		="http://huyi00.51.net//";	//脚本地址 
var YinPlace		="http://webxw.home.zccn.net/mychat002/yy/yy.htm";	//语音调试地址   
//var LogoPic		=""	//房间LOGO图
var EmotePlace		="http://webxw.home.zccn.net/mychat002/emote/";		//表情图地址
var HeadPlace		="http://huyi00.51.net//";		//头像图地址
var ButtonPlace		=JsPlace;		//按钮图地址
var InHelloPic		=HeadPlace+"hi.gif";		//入室哈漏图
var AdminPicTop		=JsPlace+"lhuafen.gif";		//管理标志
var PicTop0		=JsPlace+"fox.gif width=20 height=20";
var PicTop1		=JsPlace+"ltufen.gif";
var PicTop2		=JsPlace+"ltulv.gif";
var PicTop3		=JsPlace+"lhua.gif";
var PicTop4		=JsPlace+"eyes.gif";

var BgImg1		="http://huyi00.51.net//tree.jpg";	//聊天区背景图 
var BgImg2		="http://huyi00.51.net//tree0.jpg";	//列表区背景图 
var BgImg3		="http://huyi00.51.net//tree0.jpg";	//语音区背景图
var BgImg4		="http://huyi00.51.net//yi0.jpg";	//分屏区背景图
var PicSound1		="http://webxw.home.zccn.net/mychat002/pic/sound01.gif";	//绿电话图
var PicSound2		="http://webxw.home.zccn.net/mychat002/pic/sound02.gif";	//黑电话图
var PicVideo		="http://webxw.home.zccn.net/mychat002/pic/video.gif";	//视频头图 
...
var ButtonOverTextColor	="#CC0000";	//输入区鼠标覆盖按钮文字色
var ButtonBkColor	="#BED7D9";	//输入区按钮无图片时背景色
var SelectColor1	="#000000";	//选择框标题文字色
var SelectColor2	="color:#035E45;background-color:#BED7D9";	//选择框副标题文字色

var SBar3DLightColor	="#ffffff";	//立体滚动条亮边的颜色
var SBarArrowColor	="#ffffff";	//上下按钮上三角箭头的颜色
var SBarBaseColor	="#ffffff";	//滚动条的基本颜色
var SBarTrackColor	="#F1F9FA";	//滚动条的背景颜色
var SBarDarkShadowColor	="#4499bb";	//立体滚动条强阴影的颜色
var SBarFaceColor	="#BED7D9";	//立体滚动条凸出部分的颜色
var SBarHighLightColor	="#BED7D9";	//滚动条空白部分的颜色
var SBarShadowColor	="#BED7D9";	//立体滚动条阴影的颜色
...
var Animated=new Array(
	...
	"问好", "__","",
        "你好", "你好!!", "0109.gif",
	"你好", "你好,希望你在《一兜子寂寞……》玩的开心!", "0113.gif", 
        "哈喽", "哈喽", "0021.gif",
	"告别", "__","",
	"再见", "拜拜,欢迎再次光临"+RoomName+"", "0116.gif"
	);
...
var AUserTitle = new Array(
	...
	0,	"隐身人",    "#000000",  "",
	1,	"在线管理",	"#CC0000",  "",
	2,	"在线管理",	"#FF0000",  "fox.gif",
	3,	"室主",	    "#000000",  "",
	4,	"脚本维护",	"#0000FF",  "",
	5,	"朋友",	    "#0000FF",  "lhua.gif",
	6,	"嘉宾",	    "#FF00FF",  "ltufen.gif",
	7,	"嘉宾",	    "#008000",	"ltulv.gif"	,	
	8,	"朋友",	    "#0066FF",  "lhua.gif",
	9,	"过客",	    "#8000FF",  "eyes.gif",
	90,	"过客",	    "#339900",  "eyes.gif"
	); 

//——按钮连接：名称，地址。——
var BarLink=new Array(

    "配置","http://www.liaowan.com/roomadmin/",	
    "日历","http://www.21softs.com",
    "找歌","http://www.yisou.com/",
    "DJ站","http://chndj.com/music/Nclass_1_1.asp",	
	"论坛","http://huyi00.51.net//tie.jpg",
	"相册","http://huyi00.51.net//girlg.gif",
    "留言",	"http://2107.liaowan.com/RB/1/",
    "注册","http://www.liaowan.com/USadmin/regadd.asp",	
	"头像","http://webxw.home.zccn.net/mychat002/facelist.htm"
	);
...
var buttonstyle34=";width:34px;height:20px;"+buttonstyle+"background-image:url("+ButtonPlace+"fq35.jpg);border:1px";
var buttonstyle46=";width:46px;height:20px;"+buttonstyle+"background-image:url("+ButtonPlace+"fq46.jpg);border:1px";
var buttonstyle57=";width:57px;height:20px;"+buttonstyle+"background-image:url("+ButtonPlace+"fq70.jpg);border:1px";
...
document.write("BODY {FONT-FAMILY: 宋体; FONT-SIZE: 11pt; COLOR: #004160;"+scrlstyle+";background-position:top left;background-repeat:repeat;}");
...
document.write("SELECT {BACKGROUND-COLOR: #F1F9FA; BORDER-BOTTOM-COLOR: #000000; BORDER-BOTTOM-WIDTH: 1px; BORDER-LEFT-COLOR: #000000; BORDER-LEFT-WIDTH: 1px; BORDER-RIGHT-COLOR: #000000; BORDER-RIGHT-WIDTH: 1px; BORDER-TOP-COLOR: #000000; BORDER-TOP-WIDTH: 1px; FONT-FAMILY: 宋体; FONT-SIZE: 9pt; COLOR: #000000}");
...
function replacetag(){
	...
	inputform.msg.style.width=342; 
	inputform.msg.style.backgroundColor="#efefef"; 	
	}
...
function genghuans(){
	if (genghuan.value=="换马甲"){
		huan.style.visibility="visible";
		genghuan.value="取消";
	}else if(genghuan.value=="取消"){
...
function timeshow(){
	...
	if (secondss<=flag1){
		if (secondss==flag && secondss<flag1){
			tishi='你已经在'+RoomName+'玩了【' + flag + '分钟】了，请你注意休息保护好自己的眼睛!快滴眼药水 ^v^'
			MakePUP(tishi,"时间提示","350","145","57","关 闭");
			flag+=60;} 
		if (secondss==flag1){
			tishi='你是一个精力充沛的家伙，已经在'+RoomName+'玩了【' + flag1 + '分钟】了，配副眼镜吧 ^@-@^ ，希望你玩的开心!'
			MakePUP(tishi,"时间提示","350","145","57","关 闭");
			flag1-=1;} 
		}
...
function MakePUP(tishiy,Ttitle,Twidth,Tleft,Ttop,Tbutton){
	...
	PUP.document.write('<CENTER><INPUT TYPE="button" VALUE=" '+Tbutton+' " style=height:20px;LEFT:'+Tleft+'px;top:'+Ttop+'px;'+buttonstyle57+' onClick="self.close()"></CENTER></FORM></BODY></HTML>');
	PUP.document.close();
	}
...
{
	var bookmarkurl="http://"+RoomNumb+".liaowan.com/RB/1/";
	var bookmarktitle="聊湾-《"+RoomName+"》";
...
WriteBkColor	(382,20,50);
WriteEmoteCmds	(382,80,50);
WriteAnimated 	(382,60,50);
...
var Lstep=38;
write_button("",BarLink[0], 44+Lstep*0/2, 0,38,20,"","","window.open(BarLink[1])" );
write_button("",BarLink[2], 44+Lstep*2/2, 0,34,20,"","","window.open(BarLink[3])" );
write_button("",BarLink[4], 40+Lstep*4/2, 0,38,20,"","","window.open(BarLink[5])" );
write_button("",BarLink[6], 40+Lstep*6/2, 0,38,20,"","","window.open(BarLink[7])" );
write_button("",BarLink[8], 40+Lstep*8/2, 0,38,20,"","","window.open(BarLink[9])" );
write_button("",BarLink[10],40+Lstep*10/2,0,38,20,"","","window.open(BarLink[11])");
write_button("",BarLink[12],40+Lstep*12/2,0,38,20,"","","window.open(BarLink[13])");
write_button("",BarLink[14],40+Lstep*14/2,0,38,20,"","","window.open(BarLink[15])");
write_button("",BarLink[16],40+Lstep*16/2,0,38,20,"","","window.open(BarLink[17])");
write_button("","收藏",10,0,34,20,"","添加到收藏夹","addbookmark()");
write_button("genghuan","换马甲",382,0,48,20,"","更改你的名字","genghuans()");

write_button("","屏蔽",10,60,34,20,"","屏蔽“对象”中所指定的人的发言。最多可以屏蔽10人。","screenForm.SCREEN.click()");
write_button("","解",44,60,19,20,"","解除对“对象”中所指定的人发言的屏蔽。","screenForm.NOSCREEN.click()");
write_button("","列",63, 60,19,20,"","列出全部被您屏蔽的人。","screenForm.SHOWSCREEN.click()");
write_button("INBOX1","包厢",82,60,34,20,"","加入到您的包厢显示列表","screenForm.INBOX.click()");
write_button("OUTBOX1","-",116,60,19,20,"","从您的包厢显示列表删除","screenForm.OUTBOX.click()");
write_button("BOXLIST1","L",135,60,19,20,"","列出您的包厢显示列表中的人员","screenForm.BOXLIST.click()");

write_button("","插 图 音",490,20,57,20,"","点这里弹出输入窗口，然后在输入框填上图片或者音乐的网址(URL)。","sendpicurl()");

write_button("","鲜花",230,60,38,20,"","自动鲜花","autosendflower1(AutoChat1,1)");
write_button("","刷新",230,80,38,20,"","刷新聊天显示区","{parent.u.location.reload();parent.writeu1();if(ZengPing != 0)setInterval('keepBg()', 1000);setTimeout(divscreen(),5000);}");
write_button("","告辞",268,60,38,20,"","","autosendflower(AutoChat7,7)");
write_button("","送别",268,80,38,20,"","","autosendflower(AutoChat17,17)");
write_button("","欢迎",306,60,38,20,"","","autosendflower(AutoChat10,10)");
write_button("","房址",306,80,38,20,"","","autosendflower(AutoChat18,18)");
write_button("","要麦",344,60,38,20,"","","autosendflower(AutoChat8,8)");
write_button("","搅拌",344,80,38,20,"","","autosendflower(AutoChat9,9)");

write_button("selectdivs","选择",435,0,46,20,"","选择自己需要的功能条","Selectbutton()");
write_button("opendivs","分屏",435,20,46,20,"","建立/取消聊天包厢","divscreenk()");
write_button("","发送",435,40,46,20,"","发送聊天的内容和插入的动作、图片或音乐。","psend()");
write_button("","重复",435,60,46,20,"","重复发送上一条信息","REVERT_pp()");
write_button("","听见",435,80,46,20,"","","autosendflower(AutoChat9,9)");

document.write('<DIV><center><form name="intime"><input type=button value="Click!" name=button title="您在房间停留的时间" style="left:490px;top:0px;width:114px;'+buttonstyle+'background-image:url('+ButtonPlace+'fq114.jpg);border:1px;height:20px;font-family:宋体,SimSun;font-size:10pt;font-weight: bold;color:#045627;POSITION:absolute;";//background-color:#F5E6D4;"></form></center></DIV>');
if(document.screenForm.KICK){
//	write_button("autobutton","自动语",547,20,57,20,"","打开自动发言下拉表单","autosendss()");
	write_button("AutoHi","自动迎宾",547,20,57,20,"","点开这里，系统会自动欢迎刚进来的朋友","AutoWel()");

	write_button("openlist","开序",490,40,34,20,"","打开关闭麦序","SwitchOrder()");
	write_button("","下管",524,40,46,20,"","管理员点击这里退出管理状态","adminquit()");
	write_button("","递麦",570,40,34,20,"","把麦克风交给对象","screenForm.MIC.click()");
	
	write_button("","拒双",490,60,28,20,"","","autosendflower(AutoChat16,16)");
	write_button("","文明",518,60,28,20,"","","autosendflower(AutoChat13,13)");
	write_button("AutoSendMic","护麦",546,60,29,20,"","每30秒自动护麦","AutoKeepMic()");
	write_button("","收麦",575,60,29,20,"","不用点你的名字,点此可把麦递给自已","CallBackMic()");
	
	write_button("","邀请",490,80,28,20,"","","autosendflower(AutoChat11,11)");
	write_button("","稍后",518,80,28,20,"","","autosendflower(AutoChat14,14)");
	write_button("","接麦",546,80,29,20,"","","autosendflower(AutoChat15,15)");	
	write_button("","准备",575,80,29,20,"","","autosendflower(AutoChat12,12)");
	
	write_button("","禁言",154, 60,38,20,"","禁止对象发言5分钟","screenForm.DUMB.click()");
	write_button("","禁音",192, 60,38,20,"","禁止对象出声","screenForm.NOMIC.click()");
    
	write_button("","开门",10,80,34,20,"","开门","screenForm.ODOOR.click()");
	write_button("","请",44,80,19,20,"","","screenForm.LIN.click()");
	write_button("","拒",63,80,19,20,"","","screenForm.LOUT.click()");
	write_button("","关门",82,80,34,20,"","关门","screenForm.CDOOR.click()");
	
	write_button("","踢人",116,80,38,20,"","踢人，管理员必须先通过密码确认。按此钮将把对象所指的人踢出去","screenForm.KICK.click()");
	write_button("","踢IP",154,80,38,20,"","踢IP，管理员必须先通过密码确认。按此钮将把对象所在的踢出去","screenForm.KICKIP.click()");
	write_button("","列踢",192, 80,38,20,"","列出当前处于被踢状态的人和IP","screenForm.KLIST.click()");

	write_button("","视频连接",10,100,53,20,"","视频连接","screenForm.VREQ.click()");
	write_button("","刷新列表",63,100,53,20,"","刷新列表","parent.refreshclick=true;parent.writeuserlist();this.blur();document.inputform.msg.focus();");
	write_button("shengyin","声音Ｘ",116,100,38,20,"","控制是否设置声音提示","Fshengyin()");	
	write_button("jieshou","接悄√",154,100,38,20,"","接受／不接受悄悄话","Fjieshou()");	
	write_button("gongkai","公悄Ｘ",192,100,38,20,"","公开／不公开悄悄话","Fgongkai()");
	...
	document.write('<option selected VALUE="">&nbsp;&nbsp;*本室*麦序*</option>');
	...
	write_button("","爱慕",490,80,57,20,"","悄悄发的，放心用吧","autosendflower2(AutoChat5,5)");
	write_button("","情话",547,80,57,20,"","悄悄发的，放心用吧","autosendflower2(AutoChat6,6)");

	write_button("","视频连接",10,80,53,20,"","视频连接","screenForm.VREQ.click()");
	write_button("","刷新列表",63,80,53,20,"","刷新列表","parent.refreshclick=true;parent.writeuserlist();this.blur();document.inputform.msg.focus();");
	write_button("shengyin","声音Ｘ",116,80,38,20,"","控制是否设置声音提示","Fshengyin()");	
	write_button("jieshou","接悄√",154,80,38,20,"","接受／不接受悄悄话","Fjieshou()");	
	write_button("gongkai","公悄Ｘ",192,80,38,20,"","公开／不公开悄悄话","Fgongkai()");
...
function writev_change(){
	...
	if(document.screenForm.KICK){
	parent.v.f.requestmic.style.cssText 	= "LEFT:  6px;top:70px"+buttonstyle34;
	parent.v.f.releasemic.style.cssText 	= "LEFT: 44px;top:70px"+buttonstyle34;
	parent.v.f.mainmic.style.cssText 	= "LEFT: 82px;top:70px"+buttonstyle34;
	parent.v.f.secondmic.style.cssText 	= "LEFT:120px;top:70px"+buttonstyle34;

	parent.v.f.getmic.style.cssText 	= "LEFT:  6px;top:94px"+buttonstyle34;
	parent.v.f.cutmic.style.cssText		= "LEFT: 44px;top:94px"+buttonstyle34;
	parent.v.f.freemic.style.cssText 	= "LEFT: 82px;top:94px"+buttonstyle34; 
	parent.v.f.close.style.cssText 		= "LEFT:120px;top:94px"+buttonstyle34; 
	...
	parent.v.f.requestmic.style.cssText 	= "LEFT: 11px;top:70px"+buttonstyle46;
	parent.v.f.releasemic.style.cssText 	= "LEFT: 57px;top:70px"+buttonstyle46;
	parent.v.f.v2vv.style.cssText 		= "LEFT:103px;top:70px"+buttonstyle46;
	parent.v.f.close.style.cssText 		= "LEFT: 11px;top:94px"+buttonstyle57; 
	parent.v.f.filtervoice.style.cssText	= "LEFT: 92px;top:94px"+buttonstyle57;
...
function writecv_new(){ 
	...
	parent.v.document.writeln("<form name=ov><input type=button name=ceshi value=话筒测试 style=height:20px;LEFT:92px;top:30px;"+buttonstyle57+" onclick=window.open('http://chat.yinsha.com/voice.htm')>"); 
	parent.v.document.writeln("<input type=button name=closev value=打开语音 style=height:20px;LEFT:11px;top:30px;"+buttonstyle57+" onclick='parent.writev_new();parent.d.writev_change()'>");
	parent.v.document.writeln("</form><Br><center></form><Br><br><Br><table width='96' border='1' cellspacing='0' cellpadding='0' bgcolor='#BED7D9' bordercolordark='#000000' bordercolorlight='#FFFFFF' height='15'><tr><td width='140' align='center'><p align='center'><span style='font-size: 8.7pt;COLOR:000000'>版权所有<Br>"+RoomNick+"<Br>房号："+RoomNumb+"</SPAN></p></td></tr></table>"); 
...
function Usertitle(AStr){
	for(i=0;i<AUserTitle.length;i+=4){
...
function FVipbin(AStr){
	for(i=0;i<Vipbin.length/2;i++){
		if(AStr==Vipbin[i*2])
			return Vipbin[i*2+1];
		}
	return "";
...
function writelist(){
	...
	for(var i=1;i<parent.list.length;i++){
		...
		if(TempStr!=null){
			...
			if(!DoNotHide(AUserName)){
			    ...
			    else if(FVipbin(AUserName)=="6"){
				    user_type = 6;
				    user_pic = FHeadPic(AUserName);
				    user_Title = Usertitle(user_type);
				    }
			    else if(FVipbin(AUserName)=="7"){
				    user_type = 7;
				    user_pic = FHeadPic(AUserName);
				    user_Title = Usertitle(user_type);
				    }			
	...
	parent.r.document.writeln("a:visited {color: #004160; text-decoration: none}");
	parent.r.document.writeln("a:link {color: #004160; text-decoration: none}");
	parent.r.document.writeln("a:hover {color: #CC0000}");
	...
	if (typeof(LogoPic)=="undefined"){
		...
		parent.r.document.writeln("<tr><th height=25 ><font style=\"filter:Shadow(color=004160,strength=6); Height:1px; color:#035E45; padding:1px;\"><h2>"+RoomNick+"</font></th></tr>");	
		parent.r.document.writeln("</table>");}
	else
		parent.r.document.writeln("<img src="+LogoPic+"  border=0>");		
	parent.r.document.writeln("<div align=center style=LEFT:10px;top:35px;POSITION:absolute><font color=004160 class='p9'>当前在线</font><font color=CC0000 class='p9'><b>&nbsp;"+parent.count+"&nbsp;</b></font><font color=004160 class='p9'>位朋友</font></div>")
//	parent.r.document.writeln("<div style=LEFT:10px;top:45px;POSITION:absolute><hr color=#F1F9FA width=100% size=1></div>");
	parent.r.document.writeln("<div style=LEFT:10px;top:50px;POSITION:absolute>")
	parent.r.document.writeln('<table border=0 width=200 cellpadding=11 cellspacing=10>');
	parent.r.document.writeln("<p class='p9'>");
	parent.r.document.writeln("<font color=004160>在线列表<b>：</b></font><a target=d href=\"javascript:parent.cs('所有人')\">所有人</a><a href=\"javascript:history.go(0);\">&nbsp;刷新</a><br>");
	...
	for(i = 0 ; i < user_array.length;i++){
		...
		if(!DoNotHide(Auser)||FOwner(Auser)){
			...
			if(lists[0]==2)
				HTMLstr += "<a><IMG src="+PicTop0+">"			
			if(lists[0]==6)
				HTMLstr += "<a><IMG src="+PicTop1+">"
			if(lists[0]==7)
				HTMLstr += "<a><IMG src="+PicTop2+">"
			if(lists[0]==8)
				HTMLstr += "<a><IMG src="+PicTop3+">"
			if((lists[0]==9)||(lists[0]==90))
				HTMLstr += "<a><IMG src="+PicTop4+">"

			HTMLstr +="<a target=d href=\"javascript:parent.cs('"+lists[2]+"')\"title=\""+lists[3]+"\"><font style=\"filter: glow(color="+lists[4]+",strength=2); Height:10pt; color:#FFFFFF; padding:1px;cursor:hand\">"+lists[2]+"</font></a>"
			if(lists[5]==1)
...
//			HTMLstr +="<a target=d href=\"javascript:parent.cs('"+lists[2]+"')\"title=\""+lists[3]+"\"><font color="+lists[4]+"; Height:10pt; padding:1px;cursor:hand><B>"+lists[2]+"</B></font></a>" 			
			HTMLstr +="<a target=d href=\"javascript:parent.cs('"+lists[2]+"')\"title=\""+lists[3]+"\"><font style=\"filter: glow(color="+lists[4]+",strength=2); Height:10pt; color:#FFFFFF; padding:1px;cursor:hand\">"+lists[2]+"</font></a>"   
			if(lists[5]==1)
				HTMLstr +="<IMG src="+PicSound1+">"
			if(lists[5]==2)
		...
		parent.r.document.writeln("<table width=130 cellpadding=1 cellspacing=1 border=0 >"); 
		parent.r.document.writeln("<tr><hr color=#035E45 width=100% size=1></hr><p align='center' class='p9'><font color=#035E45 >"+RoomName+"欢迎您<br><br>〖<font color=#cc0000 >"+Auser+"</font>〗</font></tr>");	
		parent.r.document.writeln("</table>");	
	parent.r.document.writeln('</table></div></body></html>');
