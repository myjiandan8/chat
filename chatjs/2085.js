...
var room_owner="依軒閣";			//	室主名称
var room_name="依軒閣";		//	房间名称
var room_number="2085";			//	房间号码

var black_roomname="";			//	双工房间名称
var black_roomnumb="";			//	双工房间号码

//	图片等的存放位置，所有没有指定完全网址（http://.....）的图片都到此网址下寻找，但不包括下拉列表框。
var config_place = "http://aylm.ik8.com/aylm/image/f//832980/8889211.jpg";			//	语音区的背景图";
//	上管记录地址
var guan_record = "";
//	进门自动播放音乐的地址，没有就设置为空
var auto_player = "";
//	聊友列表区上方的房间名称，可设为图片，只要用HTML代码就可以
var userlist_top_html = "<B><font style=\"filter: glow(color=#009900,strength=4); Height:12pt; color:#FFFFCC; padding:1px;\">&nbsp&nbsp<font size=6>依</font><font size=6>軒</font><font size=6></font><font size=6>閣</font></font></B></td></B><BR>";
//	聊友列表下面的文字，如果不需要，请设置为空串
var userlist_bottom_html = "<p align='center' class='p9'><font color=#009900 >"+room_name+"欢迎您</font><br><tr><td colspan=3 align=center><table ><tr><td  colspan=3 width='103' align='center'><span style='font-size: 8.7pt;COLOR:red'><marquee direction=up height=70 onmouseout='this.start()' onmouseover=this.stop() scrollAmount=1 width=120 crolldelay=50><center>===室主===<br><font color=#FA8072><center>*依軒<font color=#FA8072><center>★房间☆配置★<font color=#FA8072><center>*聊湾孖軒<font color=#D15FEE><center>*<font color=#FA8072><center>*</font><br><font color=#2C16C9>祝朋友们开心<br>快乐每一天</font></marquee></b></td></td></tr></td></td></tr></font>&nbsp&nbsp&nbsp<img src=http://218.17.209.40:8080/mcard/images/41851.gif></td></tr></table>";
...
var btn_pic_18 = "http://pic.liaowan.com/anniu/12/1.gif";		//	18点宽
var btn_pic_35 = "http://pic.liaowan.com/anniu/12/4.gif";		//	35点宽
var btn_pic_45 = "http://pic.liaowan.com/anniu/12/2.gif";		//	45点宽
var btn_pic_60 = "http://pic.liaowan.com/anniu/12/3.gif";		//	60点宽
var btn_pic_72 = "http://pic.liaowan.com/anniu/12/3.gif";		//	72点宽
...
(
	0,	"在綫主持",		"http://bsradio.net/jl/tb/t0.gif",
	1,	"聊湾巡站",	        "http://liren.xiaoyao.com.cn/tu/175956.gif",
	2,	"依軒阁執行室主",		"http://bsradio.net/jl/tb/t61.gif",
	3,	"永恆之愛",		"http://pic.liaowan.com/tb/bsgl.gif",
	4,	"依軒阁管理",             "http://pic.liaowan.com/tb/041.gif",
	5,	"依軒阁",		"http://bsradio.net/jl/tb/t5.gif",
	6,	"依軒阁",	         "http://bsradio.net/jl/tb/t6.gif",
	7,	"依軒阁",		"http://bsradio.net/jl/tb/t1.gif", 
	8,	"依軒阁",		"http://bsradio.net/jl/tb/t2.gif",
	9,	"依軒阁",		"http://bsradio.net/jl/tb/57.gif"
);

//	分屏公告文字
var div_msg1 = "『　公  告　』";
var div_msg2 = "本室长期招聘管理，有意者请与在线室主联系或者留言本申请";
var div_msg3 = "管理馬甲格式：*┝依軒╬某某┥";
var div_msg4 = '';
var div_link = "";
//	自动迎宾语
...
(
"淫荡","傻逼","破鞋","塞","操","我操","操你","性欲","插死","日死","您好！","你好！",
...
(
"淫荡","傻逼","破鞋","塞","干","操","毛","我操","操你","性欲","插死","日死",
"鸡巴","滚蛋","妈的","奶奶的","做爱","鸡八","fuck","sex"
);
...
(
"不舍","真是舍不得你走啊....我会想你的..走好~~~~~有空常来玩，http://2085.liaowan.com/，别走错了哦~！",
"走好","真是舍不得，一路走好！我们会想你的~~~~~！有空常来玩，http://2085.liaowan.com/，别忘了哦~！"
);
...
(
"网址","请您牢记〖依軒家園〗聊天室网址 http://2085.liaowan.com/  ",
"网址","〖依軒家園〗语音视频聊天室网址 http://2085.liaowan.com/  "
);
...
(
"本室网址","依軒家園欢迎您，请记住本室网址http://2142.liaowan.com/","color:#009900",
...
if (userlist_top_html != "")
	...
	parent.r.document.write('<br><a title=\"当前聊天室在线人数\"><font color=000000>  依軒阁有 </font><font color=red><B>'+user_array.length+'</B></font><font color=000000> 位聊友</font><br>');
	parent.r.document.write("</td></tr><tr><td align=middle><marquee><font color=#002FFC><b>欢迎<font color=#002FFC><b>〖"+document.inputform.USER.value+"〗</b></font>来到《依軒阁》视频语聊天室，全体室主,管理欢迎您的到来，愿这里能成为你们情感交流的港湾!!</b></font></marquee></td></tr></table>");
