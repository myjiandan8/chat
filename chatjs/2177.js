...
var room_owner="*メ冷帅 *メ冷馨";			//室主名称
var room_name="~帅馨~欢乐bar";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="*№聊湾∮";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2177";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = "<table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://pic.liaowan.com/tb/010.gif><BR><B>  <font color=#009900 size=5>帅馨</font><font color=#0000FF size=4> 欢</font><font color=#FF00FF size=6>乐</font><font color=#CC00FF size=4> bar</font></font></B><font color=#0000FF size=4></font></td><tr><td align=middle><img src=http://pic.liaowan.com/gif/hx.gif></td></tr><tr><td align=middle><marquee scrollamount=1><font color=Olive size=2><b>室主*メ冷帅 *メ冷馨 欢迎<font color=Olive><b>〖"+document.inputform.USER.value+"〗</b></font>来到<font color=Olive>★★</font><font color=red>希望你在这里玩的开心！要麦打999，试麦打666</font></marquee></td></tr></table>"; //聊友列表区头部显示
...
var userlist_bkimage = "http://www.liaowan.com/bbs/upload/200495-132912-$$B4$$BD.jpg";			//	聊友列表区的背景图，设置为空串则使用输入区的图片
...
var input_bkimage = "http://www.liaowan.com/bbs/upload/200495-132912-$$B4$$BD.jpg";				//	输入区背景图片
...
var div_msg4 = "【~帅馨~欢乐bar】室主:*メ冷帅 *メ冷馨 欢迎您光临本聊天室";  //通知
var div_link = "";
...
(
	...
	1,	"站长巡管",	"http://web.fs169.net/xiongmaolei/liao/87383.gif",	"#000000",	"#ffffff",
	2,	"聊湾室主",	"http://web.fs169.net/xiongmaolei/liao/1111.gif",	"#ff00ff",	"#ffffff",
         3,	"聊湾副室",	"http://web.fs169.net/xiongmaolei/liao/fu.gif", "#ff00ff","#ffffff",
         4,	"聊湾高管",	"http://www.wzdu.com/UploadFile/2004121535988453.gif", "#2c07fe",	"#ffffff",
	5,	"聊湾主持",     "http://www.wzdu.com/UploadFile/20041215383698798.gif",	 "#2c07fe",	"#ffffff",	
	6,	"聊湾歌手",	"http://web.fs169.net/xiongmaolei/liao/jb.gif",	"#2c07fe",	"#ffffff",
	7,	"聊湾嘉宾",      "0004.gif",	"#2c07fe",	"#ffffff",
	8,	"聊湾过客",	"0004.gif",	"#2c07fe",	"#ffffff",
	9,	"聊湾过客",	"0004.gif",	"#2c07fe",	"#ffffff"
);

// 不可踢马甲
var wudimajia=new Array("*-依-","*メ冷帅","*~碧海","*メ冷馨","*絕戀",
"*冀人老刀","*小依","*依溪","*老刀～" 
 );  
