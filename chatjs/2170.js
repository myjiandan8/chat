...
var config_place = "";  //	图片等的存放位置，请设定为您存放图片的位置

var room_owner="*冰雪";			//室主名称
var room_name="心情依旧站 ";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="*№聊湾∮";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2170";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = "<table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><><BR><B>  <font color=#009900 size=5> </font><font color=#0000FF size=5>   </font><font color=#FF00FF size=5>   </font><font color=#CC00FF size=5>   </font></font></B><font color=#0000FF size=5></font></td><tr><td align=middle><img src= http://www.6see.com/js/001/js/gif/lines02.gif ></td></tr><tr><td align=middle><marquee scrollamount=1><font color=ff0000 size=2><b>室主*冰雪欢迎<font color=ff0000><b>〖"+document.inputform.USER.value+"〗</b></font>来到<font color=ff0000>★★</font><font color=aa00ff>心情依旧站希望你们在这里玩的开心！要麦打999，试麦打666</font></marquee></td></tr></table>"; //聊友列表区头部显示
...
var userlist_bkimage = "http://www.cnjwedu.net/~lscf//832980/8889211.jpg";			//	聊友列表区的背景图，设置为空串则使用输入区的图片
var voice_normal_color = "#00D000";	//	正常打开语音时的图标颜色
var voice_v2v_color = "#000000";	//	双工语音时的图标颜色
var voice_vr_color = "#00D000";		//	有视频时的图标颜色

var div_screen_bkcolor = "fff6ea";		//	分屏背景色
...
var input_msg_color	= "#CC4499";	//	输入区文字输入框文字色
...
var div_msg1 = "本站广招管理主持 请向在线管理咨询<a target=_blank href='http://www.liaowan.com/bbs/upload/2004830-213446-$$C9$$D9$$C5$$F4.gif' title='聊湾欢迎您！'><></a>";
var div_msg2 = "【心情依旧站】室主:* 冰雪 欢迎您光临本聊天室！";
var div_msg3 = "【心情依旧站】招聘帅哥美女管理，有意者请联系在线高管或室主，另招：执行室主一名、副室主一名、高管。有意请加QQ：85447408";
...
(
	"主页","http://yinyuling.qq11.com/",
	"留言","http://gbook.ik8.com/1/default.asp?userId=yinyuling",
	"注册","http://www.liaowan.com/USadmin/regadd.asp",
	"电台","",
        "碧绿站队","http://bilv.home.sunbo.net",
        "舞曲","http://bsradio.net/dj"
);
...
(
	...
	2,	"房主老婆",	
         "http://pic.liaowan.com/tb/bsgl.gif",	          "#00cd00","#FFFFFF",
	3,	"本室监察察",             "http://liren.xiaoyao.com.cn/tu/175956.gif",	        "#FF7F00","#FFFFFF",
	4,	"本室副室",		"http://pic.liaowan.com/tb/049.gif",	"#8B0A50","#FFFFFF",
	5,	"本室高管",		"http://pic.liaowan.com/tb/031.gif",	"#AA00ff","#FFFFFF",
	6,	"本室管理",		"http://xupeng521.51.net/tx/t62.gif",    "#757575","#FFFFFF",
	7,	"本室嘉宾",		"http://pic.liaowan.com/tb/019.gif",	"#0000ff","#FFFFFF",
	8,	"本室过客",		"http://www.y88.info/tp/10.gif",         "#0000ff","#FFFFFF",
	9,	"本室过客",		"http://www.y88.info/tp/17.gif",         "#0000ff","#FFFFFF",
	10,	"本室房主",		"http://pic.liaowan.com/gif/016.gif",    "#ff00ff","#FFFFFF",
	11,	"执行室主",		"http://xupeng521.51.net/tx/t103.gif",	         "#00cd00","#FFFFFF",
	12,	"本室歌手",             "http://www.y88.info/tp/shi.gif",	        "#FF7F00","#FFFFFF",
	13,	"特别贵宾",		"http://www.wzdu.com/UploadFile/20044140445991422.gif",
	"#EE1289","#FFFFFF",
	14,	"本室高管",		"http://pic.liaowan.com/tb/031.gif",	"#AA00ff","#FFFFFF",
	15,	"本室管理",		"http://xupeng521.51.net/tx/t62.gif",    "#757575","#FFFFFF",
...
// 不可踢马甲
var wudimajia=new Array("*冰雪","*≡淡淡☆回忆≡","*ˉ￠戀吻",
"*╃═じ☆ve猪猪═→",
"*子腾工作室","*","*","*",
"*","*","*","*","*","*");  
