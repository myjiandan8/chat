/********************************************************
本脚本mjw3.6k由沉默БЁ莫言改编，适用于聊湾以及碧聊房间
/改图1/自由2/升级3  /更新4 /则2为否定
脚本功能随时升级~
改编于：2004年11月12日2时
********************************************************/
...
var colortp_number="1";//按钮颜色 1为红色 2为兰色 3为绿色
var xztp_number="2";//按钮形状 1为方形 2为圆形 3为菱形
var txlx_number="2";//图标类型 1为花草 2卡通动物
var config_place = "http://js.liaowan.com/tp/";  //	图片等的存放位置，请设定为您存放图片的位置


var room_owner="*沉默БЁ莫言";			//室主名称
var room_name="永逺相戀 ";			//	房间名称
var room_adminname_head="*じve☆相恋╬っじve☆相恋☆っ";	//	本室管理名格式
var room_adminname_headg="*じve☆相恋☆っ";	//	本室歌手名格式
var majia = "男じve☆相恋╬っ女じve☆相恋☆っ" ;            //   默认换马甲格式

var room_number="2086";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = "<table border=0 width=120px cellspacing=0></td><tr><td align=middle><img src=http://pic.liaowan.com/gif/hx.gif width=145 height=4></td><tr></tr><tr><td align=middle><img src=http://bbs.jz986.com/bbs/UpLoadClass/UpLoadFile/2004111245581033.gif width=145 height=50><BR></td><tr><td align=middle><img src=http://pic.liaowan.com/gif/hx.gif width=145 height=4></td></tr><tr><td align=middle><marquee scrollamount=2><font color=FF69B4 size=3><b>╰☆我听见你的声音 有种特别的感觉 让我不断想不敢再忘记你 我记得有一个人 永远留在我心中 哪怕只能够这样的想你 如果真的有一天 爱情理想会实现 我会加倍努力好好对你永远不改变 不管路有多么远 一定会让它实现 我会亲亲在你耳边对你说(对你说)我爱你爱着你 就像老鼠爱大米 不管有多少风雨我都会依然陪着你 我想你想着你 不管有多么的苦 只要能让你开心我什么都愿意 这样爱你☆╮</font></marquee></td></tr></table>"; //聊友列表区头部显示
var userlist_bottom_html = "<marquee scrollamount='4' ></font><font color=FF0000>╰☆"+room_name+"</font><font color=0000CD>欢迎</font><font color=ff0000>【"+a_user+"】</font><font color=0000CD>来到本聊天室  希望你在这里玩的开心聊的愉快  要麦请向红衣管理打</font><font color=ff0000>九九九九九☆╮</font><font color=0000CD>试麦请打</font><font color=ff0000>六六六六六☆╮</font></marquee></a>";

//	聊友列表区底部框内文字代码
var listbottem0="〓★室主★〓<BR>"+room_owner+"<BR>欢迎你来<BR>"+room_name+"<Br>这是我们<Br>共同的家";

var userlist_bkcolor = "#e5fffd";	//	聊友列表区的背景色
var userlist_bkimage = "http://bbs.jz986.com/bbs/UpLoadClass/UpLoadFile/2004111245627797.jpg";			//	聊友列表区的背景图，设置为空串则使用输入区的图片
var voice_normal_color = "#009900";	//	正常打开语音时的图标颜色
var voice_v2v_color = "#000000";	//	双工语音时的图标颜色
var voice_vr_color = "#00D000";		//	有视频时的图标颜色

var div_screen_bkcolor = "#ffffff";		//	分屏背景色
var div_screen_bkimage = "http://bbs.jz986.com/bbs/UpLoadClass/UpLoadFile/2004111245627797.jpg";		//	分屏背景图片	

var voice_bkcolor = "#ffffff";		//	语音区的背景
var voice_bkimage = "http://bbs.jz986.com/bbs/UpLoadClass/UpLoadFile/2004111245627797.jpg";				//	语音区的背景图，空串则使用聊友区图片

var input_bkcolor = "#FFFFFF";		//	输入区背景色
var input_bkimage = "http://bbs.jz986.com/bbs/UpLoadClass/UpLoadFile/2004111245680737.jpg";				//	输入区背景图片
var input_msg_color	= "#FF69B4";	//	输入区文字输入框文字色
var input_msg_bkcolor = "#FFFFFF";	//	输入区文字输入框背景色

var body_text_color	= "#FF00FF";	//	输入区文字色
var select_color = "#0000CD"; "#FFFFFF"	//	列表框文字色
var select_text_color = "#0000CD"; "#FFFFFF" //	列表框内文字色
var button_text_color = "#660099";	//	输入区按钮文字色
var button_bk_image	= 1;			//	按钮使用背景图片，1--使用，0--不使用
var button_bk_color = "http://bbs.jz986.com/bbs/UpLoadClass/UpLoadFile/2004111245680737.jpg";			//	输入区按钮不使用图片时背景色
...
var default_admin_pass = "12_3";	//	默认的管理员上管口令
...
var div_msg1 ="〓欢 迎 您 光 临 永 远 相 恋〓";
var div_msg2 ="本站广招管理主持 请向在线管理咨询 管理群QQ5782854";
var div_msg3 = ""
var div_msg4 = "〖永远相恋〗室主：*╰☆奇ぷ迹☆╮ *◇尐尐釦襶oκ　副室：*℡绝情灬ゞ　*╰☆格格梳☆╮  欢迎各位光临本室　本室招聘歌手管理数名　有意者请于室主或在线管理联系！！！ ";//通知
var div_link = "";

//	用于连接按钮
var jilu="http://219.129.20.136:8088/rm98/404fra.htm";   //刷卡器地址   空时没有
...
(
	...
	"电台","http://radio.lwmm.com/",
       ...
       "相册","http://photo.163.com/openalbum.php?username=mojunwei110/"
);

//	本室中的 VIP 聊友
//	级别:1室主；2副室主；3高管；4-5-6-10管理；0、7、8、9已由内部使用
...
(
	17,		"http://rain_rose2004.nease.net/button/btn350.gif ",
	18,		"http://rain_rose2004.nease.net/button/btn350.gif ",
	19,		"http://rain_rose2004.nease.net/button/btn350.gif ",
	35,		"http://rain_rose2004.nease.net/button/btn350.gif ",
	46,		"http://rain_rose2004.nease.net/button/btn350.gif ",
	70,		"http://rain_rose2004.nease.net/button/btn350.gif "

);

//聊友名字的颜色和图标(头像)可任意曾减级别 （0到9）
var a_usertitle = new Array
(
   0,	"相恋在线管理",	"http://pic.liaowan.com/tb/030.gif width=35 high=28",	"#FF0000",	"FFFFFF",
         1,       "相恋室主",	"http://js.liaowan.com/tp/tb/1/001.gif width=22 high=25","#FF00FF",        "FFFFFF",
 	2,       "相恋副室",       "http://www.wzdu.com/UploadFile/2004121535988453.gif width=20 high=28",	"#0000FF",	"FFFFFF",
	3,	"相恋高级管理",	"http://www.wzdu.com/UploadFile/2004414045498629.gif width=19 high=28",	"#FF1493",	"FFFFFF",
	4,	"相恋优秀DJ歌手",	"http://pic.liaowan.com/tb/gs.gif width=16 high=28",	"#000000",	"FFFFFF",
	5,	"相恋管理",	"http://pic.liaowan.com/tb/666.gif width=16 high=28",	"#009900",	"FFFFFF",
	6,	"相恋情侣聊友",	"http://pic.liaowan.com/tb/bsgl.gif width=19 high=28",	"#FF69B4",	"FFFFFF",
         7,	"相恋注册聊友",	         "http://lman.w9.mscn.cn/ja/701.gif  width=16 high=30",	"#FB8302",	"FFFFFF",
	8,	"相恋汉字聊友",	         "http://lman.w9.mscn.cn/ja/702.gif width=18 high=30",	"#8800FF",	"FFFFFF",
	9,	"相恋数字聊友",	         "http://219.149.64.81/bchat/admin/upload/200442903343.gif width=23 high=30",	"#DAA520",	"FFFFFF"
...
(
	...
	"请您关麦",   "朋友，请关上您的麦克！请您点击又下角的麦克风图标，使其变成红叉，这样您就不会断别人的麦！当您想说话统枋保肽俚慊饕幌拢觳嫦Ъ纯伤祷埃⌒恍缓献?  "
);
...
var a_kai = new Array
(
	"请您开麦",	"您好~!~!由于你的麦未开不能正常把麦送到你的手中~！开你开麦~！~!~!",
	"请您开麦",  "朋友你好~！~!@你的麦未开~！~!请你把麦马上打开~!~!~!     "
);
//--自动迎宾语--
var a_ying = new Array
(
          "自动迎宾语",    "欢迎您光临『"+room_name+"』语音聊天室！愿您在这里玩的开心愉快！希望这里能够成为您的家！"
);
...
"管理辛苦","http://pic.liaowan.com/gif/z.gif",
    ...
    "请勿吸烟","http://www.6778.com/gif/18%2B/02/6x5.gif",
    ...
    "拌舞","http://freequick.myrice.com/rw/tw/21.gif",
    "我是野人我怕谁","http://freequick.myrice.com/rw/yr/05.gif",
    "锅星","http://freequick.myrice.com/rw/yy/01.gif",
    "伴唱","http://freequick.myrice.com/rw/yy/21.gif",
    "给你加油","http://freequick.myrice.com/rw/rw1/26.gif",
    "我吐","http://freequick.myrice.com/rw/rw1/29.gif",
    "老婆来拉","http://freequick.myrice.com/rw/cslr/01.gif",
    "砍你","http://freequick.myrice.com/rw/mm/01.gif",
    "一电打死你","http://freequick.myrice.com/rw/qm/05.gif",
    "认识一下吧","http://freequick.myrice.com/rw/mh/01.gif",
    "看刀","http://freequick.myrice.com/rw/mh/09.gif",
    "笑死我了","http://freequick.myrice.com/rw/baby/02.gif",
    "锤死你","http://freequick.myrice.com/rw/baby/07.gif",
    "现代舞","http://freequick.myrice.com/rw/baby/19.gif",
    "听不见","http://freequick.myrice.com/rw/baby/31.gif",
    "给你一拳","http://freequick.myrice.com/rw/kof/40.gif",
    "天使","http://freequick.myrice.com/rw/ts/35.gif",
    "乐队","http://yxtq.nease.net/dh/148.gif",
...
//	write_button("","答谢",304,60,35,20,"","快速答谢","autosend(a_da)");
	...
	write_button("","话题",6,0,35,20,"","发送话题","autosend(huati)");
                  write_button("","开",303,0,18,20,"","请您开麦","autosend(a_kai)");
		...
		write_button("","黑",375,0,18,20,"","打黑电话","autosend(a_hei)");
		...
		write_button("","准备",429,0,35,20,"","准备接麦","autosend(a_zhun)");
                  write_button("","迎宾",499,0,35,20,"","准备接麦","autosend()");
	...
	write_select("linkurl","本室链接",533,80,72,select_color,a_linkurl,"gotolinkurl(this)");
       ...
       if (jilu !="") {
           write_newwindow_button("聆听",6,40,35,20,"","每天一歌",""+jilu+"","","")
       }
...
//	对聊友重新排序
	...
	for(i = 0 ; i < user_array.length;i++)
	{
		...
		if(lists[2]==2)
			HTMLstr += ("<img src=http://www.wzdu.com/UploadFile/200411319245697449.gif    border=0>");
		if(lists[3]==1)
...
function writelistbase()//重写聊友列表区
{
	...
	HTMLstr += "<br><a title='在线朋友名单'><font color=0000CD><b>相恋在线</font><font color=ff0000><B id='usercount'>0</B></font><font color=0000CD>位</font></a><a href=javascript:history.go(0);><font color=ff1493>→摸偶</font></a><br>";        
	HTMLstr += "<a target=d href=\"javascript:parent.cs('所有人')\" title=\"对象为所有人\"> <img src=http://freequick.myrice.com/rw/mm/20.gif border=0><font color=FF1493>相恋</a><img src=http://www.wzdu.com/UploadFile/20041161982466421.gif  border=0><font color=FF1493>迎宾</font></a><img src=http://freequick.myrice.com/rw/mm/20.gif  border=0><br>"; 
	...
	parent.r.document.writeln("<script language=javaScript>"); 
        parent.r.document.writeln("function Click(){alert('看你那小样！你眼睛瞎了啊,上面不是提醒你不要随便摸偶,不乖打PP!!！')\;window.event.returnValue=false\;}  document.oncontextmenu=Click\;");
...
{
	if (url_popup_window != "破破")
		setTimeout('open_new_url(url_popup_window,"破破","破破")',1000);
}
...
function writecv()//未开语音时的界面
{
	...
	HTMLstr += ("INPUT{COLOR:"+button_text_color+";FONT-SIZE:9pt;FONT-FAMILY:宋体,SimSun;cursor:hand}");
	HTMLstr += ("BODY{background:"+((voice_bkcolor != "")?voice_bkcolor:parent.r.document.body.bgColor)+((m_fullscreen_bgimage != "")?(" url("+m_fullscreen_bgimage+") fixed}"):"}"));
	HTMLstr += "</style><center><br><br><font face=楷体_GB2312><font size=2 color=#874D01><center><u><b>沉默БЁ莫言<br>配置技术支持<br>QQ：6142289</b></u></center></font></font><center><br><input type=button name=closev value=打开语音 onclick=\"{parent.writev_new();parent.d.decoratev();}\">";
	HTMLstr += "<br><br><a href=http://chat.yinsha.com/voice.htm target=_blank><span style=' font-size: 9pt; color:#0000FF; text-decoration: none'>说明&测试<br>聊湾2086版</span></a></body></html>";
...
function writeu1()//重写分屏区
{
	...
	else
	{
      ...
      if (div_msg2!="") parent.u1.document.write('<p align="center"><font style=filter:glow(color=' + div_msg_color2 + ',strength=5);Height:8pt;padding:1px;cursor:hand color=#FFFFFF>'+div_msg2+'</font></p>');
      ...
      if (div_msg4!="") parent.u1.document.write('<p align="left"><font color="#FF6666" size="2" face="宋体"><b>〖'+room_name+'〗提示：</b></font><font color="#90FF90" size="2" face="宋体">'+div_msg4+'</font></p>');
...
function auto_log_func()//自动登录后台管理
{
              ...
              if ((a_user=="*沉默БЁ莫言")||(a_user=="*沉默БЁ莫言") )
              { }
               else {
...
document.write('<OPTION VALUE=http://card12.silversand.net/flower/source/bigimg/010.jpg>鲜花</OPTION>');
document.write('<OPTION VALUE=http://card12.silversand.net/flower/source/bigimg/012.jpg>鲜花</OPTION>');
document.write('<OPTION VALUE=http://card12.silversand.net/flower/source/bigimg/013.jpg>鲜花</OPTION>');
document.write('<OPTION VALUE=http://card12.silversand.net/flower/source/bigimg/014.jpg>鲜花</OPTION>');
document.write('<OPTION VALUE=http://card12.silversand.net/flower/source/bigimg/015.jpg>鲜花</OPTION>');
document.write('<OPTION VALUE=http://card12.silversand.net/flower/source/bigimg/016.jpg>鲜花</OPTION>');
document.write('<OPTION VALUE=http://card12.silversand.net/flower/source/bigimg/017.jpg>鲜花</OPTION>');
document.write('<OPTION VALUE=http://card12.silversand.net/flower/source/bigimg/018.jpg>鲜花</OPTION>');
document.write('<OPTION VALUE=http://card12.silversand.net/flower/source/bigimg/019.jpg>鲜花</OPTION>');
document.write('<OPTION VALUE=http://card12.silversand.net/flower/source/bigimg/020.jpg>鲜花</OPTION>');
document.write('<OPTION VALUE=http://card12.silversand.net/flower/source/bigimg/021.jpg>鲜花</OPTION>');
document.write('<OPTION VALUE=http://card12.silversand.net/flower/source/bigimg/022.jpg>鲜花</OPTION>');
document.write('<OPTION VALUE=http://card12.silversand.net/flower/source/bigimg/023.jpg>鲜花</OPTION>');
document.write('<OPTION VALUE=http://card12.silversand.net/flower/source/bigimg/024.jpg>鲜花</OPTION>');
document.write('<OPTION VALUE=http://card12.silversand.net/flower/source/bigimg/025.jpg>鲜花</OPTION>');
document.write('<OPTION VALUE=http://card12.silversand.net/flower/source/bigimg/026.jpg>鲜花</OPTION>');
document.write('<OPTION VALUE=http://card12.silversand.net/flower/source/bigimg/027.jpg>鲜花</OPTION>');
document.write('<OPTION VALUE=http://card12.silversand.net/flower/source/bigimg/028.jpg>鲜花</OPTION>');
document.write('<OPTION VALUE=http://card12.silversand.net/flower/source/bigimg/029.jpg>鲜花</OPTION>');
document.write('<OPTION VALUE=http://card12.silversand.net/flower/source/bigimg/030.jpg>鲜花</OPTION>');
document.write('<OPTION VALUE=http://card12.silversand.net/flower/source/bigimg/034.jpg>鲜花</OPTION>');
document.write('<OPTION VALUE=http://card12.silversand.net/flower/source/bigimg/035.jpg>鲜花</OPTION>');
document.write('<OPTION VALUE=http://card12.silversand.net/flower/source/bigimg/036.jpg>鲜花</OPTION>');
document.write('<OPTION VALUE=http://card12.silversand.net/flower/source/bigimg/037.jpg>鲜花</OPTION>');
document.write('<OPTION VALUE=http://card12.silversand.net/flower/source/bigimg/038.jpg>鲜花</OPTION>');
document.write('<OPTION VALUE=http://card12.silversand.net/flower/source/bigimg/042.jpg>鲜花</OPTION>');
document.write('<OPTION VALUE=http://card12.silversand.net/flower/source/bigimg/043.jpg>鲜花</OPTION>');
document.write('<OPTION VALUE=http://card12.silversand.net/flower/source/bigimg/041.jpg>鲜花</OPTION>');
document.write('</SELECT>');
document.write('</form></DIV>');
...
//本脚本正在完善中 有问题请联系沉默БЁ莫言提出2004.10.10.