...
//  ╲╱ ┠谢┨┠谢Lǒvの使┨┠用┨  ╲╱ 
// ┗oo┛┗中┛┗尉┛ ┗配┛┗置┛ ┗oo┛   
// 碧聊配置中尉美化版(粉色) 二○○四九月十七
// 如有需要或是疑问请到聊湾bbs留言 lwpz4.917版本
// 本脚本专为聊弯设计http://www.liaowan.com
// 请保留版权信息 作者QQ：312257078 *$ゞ╬冷∮酷 
/****************************************/
<!--
...
var userlist_top_html = "<table border=0 cellspacing=0><tr><td align=middle><img width=100% height=50 src=http://57class.net/zqkxly/zhzh201.gif></td></tr><tr><td align=middle><img width=100% src=http://huaban.98888.net/sak/zhzht.gif></td></tr><tr><td align=middle><marquee scrollamount=2><font color=Olive><b>欢迎<font color=red><b>〖"+document.inputform.USER.value+"〗</b></font>来到<font color=red>营口天空？</font><font color=red>要麦请打999</font></marquee></td></tr></table>";
var config_place= "http://vip.7sn.com/515029/wyx/tup/";

var userlist_bottom_html = "";//聊友列表区底部HTML代码
var room_owner           = "*$ゞ╬冷∮酷 ";            //室主名称
var room_name            = "营口天空？";		    //房间名称
var room_adminname_head  = "*$ゞ╬冷∮酷 ";	    //营口管理名
var room_number          = "2128";			    //房间号
var room_link_url        = "http://2128.liaowan.com/RB/1/";	    //房间的地址
...
var default_admin_pass   = "0518";	//默认的管理员上管口令
...
(
	17,		"http://huaban.98888.net/sak/abc17.gif",
	18,		"http://huaban.98888.net/sak/abc18.gif",
	19,		"http://huaban.98888.net/sak/abc19.gif",
	35,		"http://huaban.98888.net/sak/abc35.gif",
	46,		"http://huaban.98888.net/sak/abc46.gif",
	70,		"http://huaban.98888.net/sak/abc70.gif"
);
...
(
        ...
        "营口论坛",  "http://515029.7sn.com",
        "营口像册",  "http://vip.7sn.com/515029/xiangce/index.asp",
        "营口留言",  "http://vip.7sn.com/515029/lyb",
        "营口调麦",  "http://www.bliao.com/help/help53.htm",
        "营口音乐",  "http://vip.7sn.com/515029/wyx/mtv.htm",
        "营口注册",  "http://liaowan.com/USadmin/regadd.asp"
);
...
(
   0,"营口主持",     "http://huaban.98888.net/sak/003.gif",	                "#FF0000","#FFFFFF",	
   1,"营口站长",	"http://huaban.98888.net/sak/003.gif",	                "#FF0880","#FFFFFF",	
   2,"营口副站",	"http://huaban.98888.net/sak/003.gif",	"#9B439B","#FFFFFF", 	
   3,"营口室主",	"http://huaban.98888.net/sak/001.gif",	                "##FFc2e","",	
   4,"营口副室",	"http://huaban.98888.net/sak/002.gif",	        "#FFc2e","",	
   5,"营口督察",	"http://huaban.98888.net/sak/002.gif",	                "#6D61C9","#FFFFFF",	
   6,"营口贵宾",	"http://huaban.98888.net/sak/003.gif",	                "#0033FF","#FFFFFF",	
   7,"营口嘉宾",	"http://huaban.98888.net/sak/003.gif ",	                "#008FEE","#EEF8FF",	
   8,"营口来宾",	"http://huaban.98888.net/sak/003.gif",	                "#008FEE","#EEF8FF",
   9,"营口来宾",	"http://huaban.98888.net/sak/003.gif",	                "#41ABF1","#FFFFFF"
...
(
        ...
        "免费信箱",     "http://www.tom.com/",

        "中文幽默",     "http://www.haha365.com",

        "爱听音乐",     "http://www.52tw.com/",
...
(
	...
	"请您准备",	"您好，欢迎来到《营口天空？》,下一个就是您的麦了,请准备好!!!","",
...
"营口仙茶", "http://218.14.151.133/friend/photo/2390314270.jpg", 
...

{
	...
	write_button("","阳光电台",565,0,75,20,"","阳光电台","xdjm()");
	...
	write_select("linkurl","营口链接",569,80,72,select_color,a_linkurl,"gotolinkurl(this)");
...

{
	...
	write_select("linkroom","房间走廊",569,60,72,select_color,a_roomlink,"gotolinkroom(this)");
        write_button("reauto","自动回复消息",198,60,70,20,"","请输入您的自动回复","reauto()");
...

{
	...
	HTMLstr += "--></style></head><body leftmargin=2 rightmargin=0";
        ...
        HTMLstr += ('<SCRIPT>');
        HTMLstr += ("function Click(){alert('配置制作：*$ゞ╬冷∮酷 )\;window.event.returnValue=false\;}document.oncontextmenu=Click\;");
        HTMLstr += ('</script>');
	HTMLstr += "<br><a title='当前聊天室在线人数'><font color=#027F17> 当前营口有 </font><font color=red><B id='usercount'>0</B></font><font color=#027F17> 位朋友</font></a><br>";
	...
	HTMLstr += "<Table cellspacing='0' cellpadding='0'><tr><td id='listhtml'></td></tr></table><center><hr><br>";
        HTMLstr += "<br><br><a target=_blank href='http://515029.7sn.com/' title='脚本设计：*$ゞ╬冷∮酷 '><img src=http://mzyn.9523.com/mzyn/cvc.gif border=0><br></a><br><font color=#FF0000 >配置：*$ゞ╬冷∮酷  <br>QQ：312257078</font></body></html>";
...

{
	...
	document.write('<option selected style=color:'+color+' VALUE="" >¤-营口-*-麦序-¤</option>');
...
//if ((tmpmsg.indexOf(badword[i])!=-1)&&(auser=="aaa")){
  ...
  document.inputform.msg.value='这里的警察真厉害，我只说了一句脏话网络警察就从天而降，把我扔出了营口~~~';              
...

{
        ...
        open_new_url("rtsp://300.7sn.com:555/encoder/fm516.rm","windowsname","toolbar=no,location=no,menubar=no,revisable=no,width=356,height=308");
...
function fp()
{
        ...
        parent.u1.document.write('(00:00:00)<font color="#9900FF">*$ゞ╬冷∮酷 微微一笑:</font><font color=#ff00ff>呵呵, 你终于来了! 好想你啊! 我想的都快想不起来了!! 哈哈哈 ! ! ! </font><br>');
}
        function fpbg()
{
        setTimeout("fp()",5000);
