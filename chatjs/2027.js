...
var room_owner="*harry";			//	室主名称
var room_name="周杰伦歌迷联盟";		//	房间名称
var room_number="2007";			//	房间号码
...
//	进门自动播放音乐的地址，没有就设置为空
var auto_player = "";
var userlist_top_html = "<table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://jayfcchat.91i.net/chat/logo.gif></td><tr><td align=middle><img src=http://www.wodukom.com/zxg77/tupian/yanjinghengxiantu.gif></td></tr><tr><td align=middle><marquee scrollamount=1><font color=Olive size=2><b>室主*harry欢迎<font color=Olive><b>〖"+document.inputform.USER.value+"〗</b></font>来到<font color=Olive>★★</font><font color=red>周杰伦歌迷联盟希望你们在这里玩的开心！要麦打999，试麦打666</font></marquee></td></tr></table>"; //聊友列表区头部显示
var userlist_bottom_html = "";
//	聊友列表下面的文字，如果不需要，请设置为空串
var userlist_bottom_html="<tr><td colspan=3 align=center><table width='60' border='7' cellspacing='3' cellpadding='3' bordercolordark='red' bordercolorlight='yellow' height='3'><tr><td  colspan=3 width='3' align='center'><span style='font-size: 8.7pt;COLOR:red'><marquee direction=up height=70 onmouseout='this.start()' onmouseover=this.stop() scrollAmount=1 width=100 crolldelay=50><center>〓★室主★〓<BR>*harry<BR>〓★副室主★〓<BR>*Jayfc♀阿Sa⺌<Br>〓◆配置◆〓<Br>★*harry</marquee></font></SPAN></td></tr></table></td></tr>";
...
var btn_pic_18 = "http://pic.liaowan.com/anniu/14/1.gif";		//	18点宽
var btn_pic_35 = "http://pic.liaowan.com/anniu/14/2.gif";		//	34点宽
var btn_pic_45 = "http://pic.liaowan.com/anniu/14/3.gif";		//	44点宽
var btn_pic_60 = "http://pic.liaowan.com/anniu/14/3.gif";		//	60点宽
var btn_pic_72 = "http://pic.liaowan.com/anniu/14/4.gif";		//	70点宽

var url_popup_window = "";		//	进入聊天室时弹出的窗口，如果为空则不弹出
var only_registr_user = 0;		//	只允许注册用户进入,0否；1是
var only_chinese_name = 0;		//	只允许汉字名用户进入0否；1是
var default_admin_pass = "jayfc";		//	默认的管理员口令
...
(
"论坛","本室论坛",	"http://jayfc.com/bbs",
"主页","本室主页",	"http://jayfc.com",
"注册","本室留言",	"",
"搜歌","歌曲搜索",	"http://mp3.baidu.com",
...
(
0,"正在管理",	"http://liren.xiaoyao.com.cn/tp/023.gif",
1,"本室室主",	"http://www.chinaxtd.com/xajh/tp/18.gif",
2,"副室主",	"http://liren.xiaoyao.com.cn/tu/00222.gif",
3,"本室高管",	"gaoguan.gif",
4,"本室管理",	"http://chat.yeeyoo.com/chatimages/22.gif",
5,"本室嘉宾",	"http://chat.yeeyoo.com/chatimages/00.gif",
6,"本室嘉宾",	"http://liaowan.com/bbs/upload/2027829-235937-520521.gif",
7,"本室嘉宾",     "tx02.gif",
8,"本室嘉宾","http://www.woduhom.com/claudia9883/ftp/photo/photo/004.gif",
9,"本室嘉宾",	"http://liren.xiaoyao.com.cn/tp/004.gif"
);

//	分屏公告文字
var div_msg1 = "『　周杰伦歌迷联盟欢迎您　』";
var div_msg2 = "如果立体声语音不能正常运行，请点击下边说明";
var div_msg3 = "欢迎您光临『周杰伦歌迷联盟』语音聊天室！愿您在这里玩的开心愉快！希望这里能够成为您的家!";
var div_msg4 = "【本室消息】：上管基本要求：1－。2- 。3-。";
var div_link = "";
//	自动迎宾语
...
(
"不舍","真是舍不得你走啊....我会想你的..走好~~~~~有空常来玩，http://2007.liaowan.com/，别走错了哦~！",
"走好","真是舍不得，一路走好！我们会想你的~~~~~！有空常来玩，http://2007.liaowan.com/，别忘了哦~！"
);
...
(
"网址","请您牢记<<周杰伦歌迷联盟>>聊天室网址 http://2027.liaowan.com ，感觉这里不好，请对我们说！ ",
"网址","<<周杰伦歌迷联盟>>语音视频聊天室网址 http://2027.liaowan.com  ，感觉这里很好，请对你们的朋友说！"
);
...
(
"本室网址","欢迎您，请记住本室网址http://2027.liaowan.com","color:#009900",
...
if (!accept_right_click)
	parent.r.document.write('<SCRIPT>function about(){alert("《秋叶飘香》提示您：请使用Ctrl+C、Ctrl+V进行复制、粘贴！！");return false;} document.oncontextmenu = new Function("return false;");document.oncontextmenu=about;</script>');
...
//	禁止信息
function about(){alert("《*偷心中尉》提示您：请使用Ctrl+C、Ctrl+V进行复制、粘贴！ ");return false;}
...
//  ╲╱ ┠谢┨┠谢Lǒvの使┨┠用┨  ╲╱ 
// ┗oo┛┗中┛┗尉┛ ┗配┛┗置┛ ┗oo┛   
// 碧聊配置中尉美化版(蓝色) 二○○四八月十八
// 如有需要或是疑问请上bbs留言 515029.7sn.com
// 请保留版权信息 作者QQ：312257078 *偷心中尉
/****************************************/