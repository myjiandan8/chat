...
var cipdz="http://qrliao.com/time/index.asp?room=ぷ福建◎情缘ぷ" ;    //后台管理地址
enable_auto_log("http://qrliao.com/time/index.asp?room=ぷ福建◎情缘ぷ")

var config_place= "http://pic.liaowan.com/gif/";  //图片等的存放位置，请设定为您存放图片的位置

var room_owner="*≮情缘≯家族じ";		//	室主名称
var room_name="ぷ福建◎情缘ぷ";			//	房间名称
var room_adminname_head="*≮情缘∮≯";	//	本室管理名格式
var room_adminname_headg="*しovの情缘∮";	//	本室歌手名格式
var majia = "しovの情缘∮";          //   默认换马甲格式

var room_number="2060";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = " <table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://liaowan.com/bbs/upload/200498-145459-$$BF$$E1$$B6$$F9.gif><BR><tr><td align=middle><img src=http://pic.liaowan.com/gif/hx.gif>"; //聊友列表区头部显示
var userlist_bottom_html = "<marquee scrollamount='2' > <font color=2e8b57> "+room_name+"欢迎</font><font color=ff0000>『"+a_user+"』</font><font color=2e8b57>的到来！要麦请向红衣管理打9999 </font></marquee></a>";

//	聊友列表区底部框内文字代码
var listbottem0="〓★本室★〓<BR>"+room_owner+"<BR>欢迎您的到来<BR>"+room_name+"<Br>室主*蓝天白云<Br>QQ317513726";


var userlist_bkcolor = "#CAF5F2";	//	聊友列表区的背景色
var userlist_bkimage = "http://rings.nease.net/fj/s02.gif";			//	聊友列表区的背景图，设置为空串则使用输入区的图片
var voice_normal_color = "#00D000";	//	正常打开语音时的图标颜色
var voice_v2v_color = "#000000";	//	双工语音时的图标颜色
var voice_vr_color = "#00D000";		//	有视频时的图标颜色

var div_screen_bkcolor = "CAF5F2";		//	分屏背景色
var div_screen_bkimage = "http://rings.nease.net/fj/fp20601.jpg";		//	分屏背景图片	

var voice_bkcolor = "#CFE4C7";		//	语音区的背景
var voice_bkimage = "http://rings.nease.net/fj/s02.gif";				//	语音区的背景图，空串则使用聊友区图片

var input_bkcolor = "#e5fffd";		//	输入区背景色
var input_bkimage = "http://rings.nease.net/fj/s01.gif";				//	输入区背景图片
...
var div_msg1 = "";
var div_msg2 = "";
var div_msg3 = "《情缘家族》　室主：*蓝天白云　　顾问：*梦歌　　　　　　　　　　　　　                  技术维护：*fisher9011　　<a target=_blank href='http://p02.caishow.com/mmsimg/comm/7210/ah13.gif' title='聊湾欢迎您！'><IMG align=absMiddle src=http://www.liaowan.com/logo/logo.gif></a> ";
var div_msg4 = "欢迎光临聊湾聊天网【"+room_name+"】视频聊天室!　　　　　　　　　(若有事可问在线管理或点击下面的留言）";         //通知 
...
(
	"网站","http://sanchang.home.sunbo.net/",
	"留言","http://www.ltpc.net/tanshijin/gbook/guestbook.asp?user=ぷ福建◎情缘ぷ",
	"话题","http://www.touch.sh/gb/gbook.php?user=话题",
         "注册","http://www.liaowan.com/USadmin/regadd.asp",
	"论坛","http://xinyu.cliao.com/bbs/list.asp?boardid=23",
         "音乐","http://www.mp3tt.com/",
         "查歌","http://mp3.baidu.com/",
         "电台","http://radio.lwmm.com/",
         "留言","http://www.touch.sh/gb/gbook.php?user=福建情缘",
         "帮助","http://www.bluesky.com.cn/faq.htm"

);
//	本室中的 VIP 聊友
//	级别：0---在线主持  1--室主；2--顾问  3--特殊贵宾... 4-----高级管理   5---管理员格式  6----歌手格式    7--注册马甲  8----汉字马甲   9---数字马甲  10----歌手
var a_vip_user = new Array
(
     "*≮情缘≯梦歌じ",  2,     "*≮情缘≯可可じ",  2,
     "*≮情缘≯白云じ",  1,     "*≮情缘≯流浪じ",  2,
     "*しovの情缘∮啊童",  5,   "*しovの情缘∮红妆",  5,
     "*しovの情缘∮小雨",  3,    "*≮情缘≯蓝天じ",   1,
     "*しovの情缘∮紫嫣",    5,     "*しovの情缘∮阿芳",    6,
     "*↘¤春梦Θ无痕¤",  2,    "*≮情缘≯K∽Oじ",  2,
     "*しovの情缘∮紫玲萱",   6,   "*しovの情缘∮樱花",  6,
   "*しovの情缘∮公主",  3,      "*しovの情缘∮芳芳",  6,   
   "*しovの情缘∮幽幽",   5,       "*≮情缘∮梦歌≯",  6,
   "*╰☆泉水叮咚☆",   4,        "*しovの情缘∮雨心",   3,
     "*凉风有信",  1,               "*凉风无信",    2,
     "*≮情缘∮皓泽≯",   6,       "*しovの情缘∮雪儿",   3,
     "*xiaoyu",  4,  "*しovの情缘∮阿娇",  4,       "*蓉⌒_⺷蓉",  3,
     "*しovの情缘∮贝儿",  5,             "*しovの情缘∮飘梦",   3,  
     "*しovの情缘∮啊呆", 4,                "*5411111", 7      
);
...
(
	0,	"在线主持人（要麦请打999",  "http://pic.liaowan.com/tb/049.gif", 	"#FF0000", 	"#ffffff",
	1,	"本室室主",  "0001.gif", 	"#000000",	"#ffffff",
	2,	"执行室主",  "http://pic.liaowan.com/tb/031.gif", 	"#ff00ff",	"#ffffff",
	3,	"高级管理",  "0002.gif", 	 "#333333",	"#ffffff",
	4,	"金牌歌手", "0003.gif",    "#61598a",       "#ffffff",
	5,	"优秀歌手",   "http://pic.liaowan.com/tb/024.gif",    "#F3942E",	"#ffffff",

	6,	"本室管理（未上线主持人）", "http://pic.liaowan.com/tb/004.gif",   "#34c534",	"#ffffff",
	7,	"本室贵宾",  "http://pic.liaowan.com/tb/035.gif",  "#32c09fe",	"#ffffff",
	8,	"本室嘉宾",  "http://pic.liaowan.com/tb/040.gif",	  "#2c07fe",	"#ffffff",
	9,	"本室潜水员（聊友）",   "http://pic.liaowan.com/tb/032.gif ",   "#2c07fe",	"#ffffff",
        10,       "歌手",    "0005.gif",  "#F3942E",   "#ffffff",
        11,  "本室贵宾",  "alogo2.gif ",  "#2c07fe", "#ffffff",         
        12,	"执行室主",  "016.gif", 	"#ff00ff",	"#ffffff",
        13,	"在线管理",  "yg.gif", 	"#FF0000", 	"#ffffff",
        14,          "聊友",    "0004.gif",  "#F3942E",  ""
    

);      
// 不可踢马甲
var wudimajia=new Array("*≮情缘≯梦歌じ","*しovの情缘∮芳芳","*凉风无信","*≮情缘≯白云じ","*≮情缘≯蓝天じ","*凉风有信",
"*冀人老刀","*熏衣草","*依溪","*老刀～","*fisher9011"
 );  
//——房间走廊,请注意房间号的写法——
...
(
	...
	"子夜零点酒吧",                 "http://749584.chat.yinsha.com/",
         "后台管理",		""+cipdz+""
);
...
(
	"知音",	"高山流水韵依依，伯牙摔琴谢知音。陆游唐婉心相应，生离死别凄婉情。人生难得几知己，千古知音最难觅。百年修得同船过，千年修得眠共枕。有你陪伴，此生足矣。  ",
	"爱错",	"我想告诉你，其实我一直在心中喜欢你!我要给你一百个吻:o再送你一千朵玫瑰***然后再爱你一万年!啊!等等!对不起!我拨错号码了。  ",
	"旧梦",	"想你想你好想你 把你的名字写在水杯里 每天喝水亲亲你。想你想你好想你 把你写在内衣里 每天贴身保护你；",
	"网情",	"地球是转的人是会变的天是蓝的海是深的想你是真的嫁给你是不可能的如果你是有钱的我们还是有缘的 ",
	"讨好",	"宝贝宝贝我爱你，就象老鼠爱大米，你是天上的凤凰飞啊飞，我是地上的豺狼追啊追，我不打你也不骂你，我用感情折磨你。；",
	"思念",	"你是我的化蝶，我愿做你今生的传奇；你是我的音符，我愿做你的乐谱；伸出你的手，让我套你一生的幸福 ",
	...
	"四季",	"读这讯息，你已欠我一个拥抱；删这讯息，欠我一个吻；存这讯息，欠我一个约会；要是回复，你欠我全部；要不回复，你就是我的；",
	"红颜",	"你是那样的美，美得像一首抒情诗。你仪态万方，光彩照人，沉鱼落雁，闭月羞花。充满魅力的女人，就是一本让人爱不释手的好书，就是一道令人百赏不厌的风景。",
	...
	"网情",	"亲爱的，帮帮我，我的大脑终端遭遇相思病毒感染，感情扇区被格式化，所有文件被更名为《我爱你.exe》！",
	"讨好",	"亲爱的!医生说我得了相思病.药方如下:热吻三次＋情人眼泪2-3滴＋永恒的爱情熬开即可,我想…只有你能救我 。",
	...
	"唯一",	"听到你的音，动了我的心；见到你的人，掉了我的魂；转身不见你，浑身都在疼；洗脚都在想，成为你的人 ",
	"红颜",	"没有你，别人的关怀，都是徒然的。对于这些关怀，〖"+document.inputform.USER.value+"〗无意接受，也没有资格接受",
	"开心",	"你是船儿我是岸，你是太阳我为你转，幸福有你才能算，给我世界都不换，因为你是我的NO.1  ！",
...
(
	"不舍","真是舍不得你走啊....我会想你的..走好~~~~~有空常来玩，别忘了〖"+document.inputform.USER.value+"〗哦~！ ",
	"走好","走好呀，一路平安。有时间一定再来《ぷ福建◎情缘ぷ》串串门好吗！！ "
);
...
(
	...
	"告别",	"长叹一声,凄婉地说道:▅█拜拜●了█▅一曲离歌泪千行,不知何日再逢君.我这就去了,大家多保重▅█拜拜●了█▅··"
);
...
var a_dai = new Array
(
	"搅拌",	"管理员，我要搅拌啊999999999999999999999，可以吗？",
	"搅拌",	"唱得好哇！我也想唱歌了。领导可以搅伴吗?? "
);
...
(
	...
	"念经啊~",	"http://photo.cnmaya.com/piclib/pictures/pi_14631.gif",
	"偷心贼",	"http://www.cj888.com/photo/65/person/figure/male/9.gif",
	"闹鬼啊~", 	"http://www.5see.com/demo/gif/rwl/clown/clown1.gif",
	"追杀你",	"http://joke.163.com/cartoon/14499.gif",
	"送你彩灯",	"http://nwpj.nease.net/bj1/67.gif",
	"炸楼上的",	"http://yyt.myrice.com/tu/lou.jpg",
	"严重想你", 	"http://www.cj888.com/photo/65/person/figure/sissy/3.gif",
	"宰了你",	"http://yyt.myrice.com/tu/17.gif",
	"谁在摸虾",	"http://lgss.nease.net/bldhzy/DH/qrxh/0915/019.gif",
	"我帅吗？",	"http://yyt.myrice.com/tuyin/fengliu.gif",
         "男人命苦",
         "http://home.hnjzcrc.com/387829/chashe/tupian/048.gif",
	"急死了",	"http://yyt.myrice.com/tuyin/jisile.gif",
	"送你妹妹",	"http://rings.nease.net/fj/meimei.gif",
	"跳得开心",	"http://nwpj.nease.net/bj1/tw2.gif",
	"跳得开心", 	"http://nwpj.nease.net/bj1/tw7.gif",
	"送您葡萄",     "http://nwpj.nease.net/bj1/pd.gif",
	"送你西瓜", 	"http://nwpj.nease.net/bj1/xg.gif",
	"送你面条", 	"http://nwpj.nease.net/bj1/mt.gif",
	"你醉了",     "http://rings.nease.net/fj/zui.gif",
	"爱你万年", 	"http://nwpj.nease.net/bj1/b4.gif",
	"我好爱你",	"http://nwpj.nease.net/bj1/b5.gif",
	"好喜欢你",     "http://nwpj.nease.net/bj1/b6.gif",
	"我爱你",     "http://rings.nease.net/fj/love.gif",
	"送你戒子",     "http://rings.nease.net/fj/jiezi.jpg",
	"亲亲脸蛋",     "http://nwpj.nease.net/bj1/t2.gif",
	"你，你，你",     "http://freequick.myrice.com/rw/rw1/30.gif",
	"亲吻您哦",     "http://rings.nease.net/fj/kiss.gif",
	"一律封杀",	"http://yyt.myrice.com/tu/fengsha11.jpg",
	"打倒麦霸",   	"http://rings.nease.net/fj/mb.jpg",
	"多打电话", 	"http://nwpj.nease.net/bj1/d10.gif",
        "说不完话", 	"http://nwpj.nease.net/bj1/s.gif",
	"我好伤心", 	"http://nwpj.nease.net/bj1/b3.gif",
 	"我要踢你",	"http://nwpj.nease.net/bj1/26.gif",
	"堵住你嘴",	"http://nwpj.nease.net/bj1/28.gif",
	"我打我打", 	"http://nwpj.nease.net/bj1/27.gif",
	"狠狠揍你",	"http://nwpj.nease.net/bj1/64.gif",
	"不想理你",	"http://nwpj.nease.net/bj1/65.gif",
	"哈哈哈哈",	"http://nwpj.nease.net/bj1/50.gif",
	"送你汽车",	"http://nwpj.nease.net/bj1/61.gif",
...
{
         write_button("","情话",339,60,35,20,"","情话快递","autosend(a_love)");
...
//	write_button("","答谢",304,60,35,20,"","快速答谢","autosend(a_da)");
	...
	write_button("","要麦",304,80,35,20,"","快速要麦","autosend(a_wantmic)");
	write_button("","听见",339,80,35,20,"","快速听见","autosend(a_heart)");
       write_button("","网址",234,60,35,20,"","本室网址","autosend(a_wang)");
...
var listbottem="<tr><td colspan=3 align=center> <table width='60' border='3' cellspacing='3' cellpadding='3' bordercolordark='red' bordercolorlight='yellow' height='3'> <tr><td  colspan=3 width='3' align='center'><span style='font-size: 8.7pt;COLOR:red'><marquee direction=up height=70 onmouseout='this.start()' onmouseover=this.stop() scrollAmount=1 width=100 crolldelay=50><center>"+listbottem0+"<Br><a target=_blank href='http://www.369590.com/' title='依然小屋欢迎您！'><IMG align=absMiddle src=http://www.369590.com/bbs/zqlt.gif></a><Br><a target=_blank href='http://www.369590.com/' title='联系QQ：153251392！'><IMG align=absMiddle src=http://pic.liaowan.com/sb/ld.gif></a></marquee></font></SPAN></td></tr></table></td></tr>";
...
Merlin.Speak("欢迎进入☆Оοoぷ福建◎情缘ぷoοО☆聊天室"); 
Merlin.Play("Gestureright"); 
Merlin.Play("Pleased");
Merlin.Speak("只需输入本站域名：http://2060.liaowan.com便可进入!"); 
Merlin.Play("Idle1_1");
Merlin.MoveTo(630,320);
Merlin.Show();
Merlin.Play("Surprised"); 
Merlin.Speak("右下角的语音是自动打开的，您可以关闭");
Merlin.Play("Read");
Merlin.Speak("希望在这里你可以找到你真正的朋友!");
Merlin.Play("Read")
Merlin.Play("GestureUp");
Merlin.Speak("也希望大家会喜欢☆≤ぷ福建◎情缘ぷ≥聊天室☆"); 
Merlin.Play("DontRecognize");
Merlin.Speak("感谢您的光顾,谢谢你们,记的常来玩,再见!");
Merlin.Play("DontRecognize"); 
Merlin.Play("Greet");
Merlin.Speak("祝您天天快乐！");
Merlin.Play("Greet");
...
if (hrs<5) {window.alert(" ¤╭⌒╮　 ╭⌒╮　 \n ╱◥██◣ ╭╭ ⌒╮ “ぷ福建◎情缘ぷ≥”提醒您注意休息！\n︱田︱田田| ╰------ \n╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬");} 
if ((hrs>=5)&&(hrs<=8)){window.alert(" ¤╭⌒╮　 ╭⌒╮　 \n ╱◥██◣ ╭╭ ⌒╮ 早上好！欢迎光临ぷ福建◎情缘ぷ）≥！\n︱田︱田田| ╰------ \n╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬");} 
if ((hrs>8)&&(hrs<=11)){window.alert(" ¤╭⌒╮　 ╭⌒╮　 \n ╱◥██◣ ╭╭ ⌒╮ 上午好！欢迎光临ぷ福建◎情缘ぷ）≥！\n︱田︱田田| ╰------ \n╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬");} 
if ((hrs>11)&&(hrs<=13)){window.alert(" ¤╭⌒╮　 ╭⌒╮　 \n ╱◥██◣ ╭╭ ⌒╮ 中午好！来ぷ福建◎情缘ぷ≥想吃点什么？\n︱田︱田田| ╰------ \n╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬");} 
if ((hrs>13)&&(hrs<=17)){window.alert(" ¤╭⌒╮　 ╭⌒╮　 \n ╱◥██◣ ╭╭ ⌒╮ 下午好！ぷ福建◎情缘ぷ≥欢迎您！\n︱田︱田田| ╰------ \n╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬");} 
if ((hrs>17)&&(hrs<21)){window.alert(" ¤╭⌒╮　 ╭⌒╮　 \n ╱◥██◣ ╭╭ ⌒╮ 晚饭吃了么？ぷ福建◎情缘ぷ≥欢迎您！\n︱田︱田田| ╰------ \n╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬");} 
if ((hrs>=21)&&(hrs<24)){window.alert(" ¤╭⌒╮　 ╭⌒╮　 \n ╱◥██◣ ╭╭ ⌒╮ 夜已深，来ぷ福建◎情缘ぷ≥吃点夜宵吧！\n︱田︱田田| ╰------ \n╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬");}
//函数到此为止


复制代码加在寒江脚本最下面或做成js文件上传在你的空间里做个连接放在欢迎词里
