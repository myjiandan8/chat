...
var room_owner="";			//	室主名称	室主名称
var room_name="悠悠往事";		//	房间名称
var room_number="2040";			//	房间号码

var black_roomname="";			//	双工房间名称
var black_roomnumb="";			//	双工房间号码
alert('   \n\b       ╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮       \n\b       ║欢│║★│║迎│║★│║光\n\b       ╚～╝│║★│║临│       ╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝   \n\b       ╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮       \n\b       ║悠│║★│║悠│║★│║往│║★│║事│       \n\b       ╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝\n\n\b\b\b 欢迎您进入『悠悠往事』，室主：*╰☆御光听雨☆╮╰☆雾梦☆╮★驭风品霜★Ω銱児鎯噹Ω \n\n    希望您在这里能够玩的愉快开心！\n\n\b\b\b 本室欢迎有能力的朋友，加盟本室管理队伍\n\n    有意者请联系室主QQ:308525777！\n\n\b\b\b\ 请所有管理加《悠悠往事》的队伍')

//	图片等的存放位置，所有没有指定完全网址（http://.....）的图片都到此网址下寻找，但不包括下拉列表框。
var config_place = "http://www.wodukom.com/zxg77/tupian/";
//	上管记录地址
var guan_record = "http://qrliao.com/time/index.asp?room=悠悠往事";
//	进门自动播放音乐的地址，没有就设置为空
var auto_player = "";
var userlist_top_html = "<table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://jl.01www.net/yyws.gif></td><tr><td align=middle><img src=http://daoer.512j.com/line.gif></td></tr><tr><td align=middle><marquee scrollamount=1><font color=Olive size=2><b>室主*╰☆雾梦☆╮Ω銱児鎯噹Ω欢迎<font color=Olive><b>〖"+document.inputform.USER.value+"〗</b></font>来到<font color=Olive>★★</font><font color=red>悠悠往事希望你们在这里玩的开心！要麦打999，试麦打666</font></marquee></td></tr></table>"; //聊友列表区头部显示
var userlist_bottom_html = "";
//	聊友列表下面的文字，如果不需要，请设置为空串
var userlist_bottom_html="<tr><td colspan=3 align=center><table width='60' border='0' cellspacing='3' cellpadding='3' bordercolordark='#ADC2EB' bordercolorlight='#FFFFFF' height='3'><tr><td  colspan=3 width='3' align='center'><b><span style='font-size: 8.0pt;COLOR:red'></b><marquee direction=up height=70 onmouseout='this.start()' onmouseover=this.stop() scrollAmount=1 width=100 crolldelay=50><center>﹌﹌﹌﹌﹌﹌﹌﹌<Br>〓★室主★〓<BR>╰☆御光听雨☆╮<BR>※★室主★※<BR>*╰☆雾梦☆╮<BR>〓★室主★〓<BR>Ω銱児鎯噹Ω<BR>〓▲副室▲〓<Br>★驭风品霜★<BR>〓◆配置◆〓<Br>★御光制作★<Br>﹌﹌﹌﹌﹌﹌﹌﹌</marquee></font></SPAN></td></tr></table></td></tr>";
...
"注册","本室留言",	"http://www.liaowan.com/USadmin/regadd.asp",
...
(
"不舍","真是舍不得你走啊....我会想你的..走好~~~~~有空常来玩，http://2040.liaowan.com/，别走错了哦~！",
"走好","真是舍不得，一路走好！我们会想你的~~~~~！有空常来玩，http://2040.liaowan.com/，别忘了哦~！"
);
...
if (!accept_right_click)
	parent.r.document.write('<SCRIPT>function about(){alert("《温柔雾梦》提示您：请使用Ctrl+C、Ctrl+V进行复制、粘贴！！");return false;} document.oncontextmenu = new Function("return false;");document.oncontextmenu=about;</script>');
...
//	禁止信息
function about(){alert("《雾梦》提示您：请使用Ctrl+C、Ctrl+V进行复制、粘贴！ ");return false;}
