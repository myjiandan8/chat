/***********************************聊湾聊天室配置lwbh1.0版****************************
* 本配置脚本原属真情网真情相约聊室配置 特为聊湾修改制作.  *
* 重新修改整理,对代码进行了精简合理化,力求达到程序运行稳定快速而不失实用功*能和美观界面  本版本新增加了多个视频功能   *
* 由于作者水平有限,程序难免错漏,如果你在使用过程中发现任何问题,请至信*153251392@qq.com     *
* 本配置版权属真情论坛,你可以随意使用和传播.如用于商业用途请和作者联系                     *
* 修改此脚本请注明出处和解释                                        *
*                                           碧海  冀人老刀QQ:153251392                        *
*                                           真情论坛 http://www.369590.com     2004.9.5                *
*******************************************************************************************/
...
var room_owner="*╰╮激情╭╯";			//室主名称
var room_name="魅影劲舞";			//	房间名称
var room_adminname_head="じve☆情♂";	//	本室管理名格式
var room_adminname_headg="ve☆缘";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式
var room_number="2108";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";
//	聊友列表区顶部HTML代码
var userlist_top_html = " <table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://pic.liaowan.com/sb/2108.gif><BR><tr><td align=middle><img src=http://pic.liaowan.com/gif/hx.gif>"; //聊友列表区头部显示
...
// 不可踢马甲
var wudimajia=new Array("*╰╮激情╭╯","*5466966","*在线维护","*~依然","*5411111","*5400000",
"*冀人老刀","*","*依溪","*老刀～" 
 );  
//——房间走廊,请注意房间号的写法——
