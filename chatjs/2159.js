...
var userlist_top_html = "<table border=0 cellspacing=0><tr><td align=middle><img width=100% height=50 src=http://www.mflw.com/yuyin/tu/adlogo.gif></td></tr><tr><td align=middle><img width=100% src=http://vip.7sn.com/515029/wyx/tup/logo2.gif></td></tr><tr><td align=middle><img width=100% src=http://vip.7sn.com/515029/wyx/tup/logo2.gif></td></tr><tr><td align=middle><marquee scrollamount=2><font color=Olive><b>欢迎<font color=red><b>〖"+document.inputform.USER.value+"〗</b></font>来到<font color=red>慧明江湖语聊</font><font color=red>要麦请打999</font></marquee></td></tr></table>";
var config_place= "http://vip.7sn.com/515029/wyx/tup/";

var userlist_bottom_html = "";//聊友列表区底部HTML代码
var room_owner           = "*伯虎";            //室主名称
var room_name            = "慧明江湖语聊";		    //房间名称
var room_adminname_head  = "*伯虎";	    //慧明管理名
var room_number          = "2159";			    //房间号
var room_link_url        = "http://2159.liaowan.com";	    //房间的地址
...
var default_admin_pass   = "lzh520";	//默认的管理员上管口令
...
(
        ...
        "慧明江湖",  "http://jh.mflw.com",
        "慧明江湖",  "http://jh.mflw.com",
        "慧明江湖",  "http://jh.mflw.com",
        "慧明调麦",  "http://www.bliao.com/help/help53.htm",
        "慧明江湖",  "http://jh.mflw.com",
        "慧明江湖",  "http://jh.mflw.com"
);
...
(
   0,"慧明主持",     "xdguanl.gif",	                "#FF0000","#FFFFFF",	
   1,"慧明站长",	"87383.gif",	                "#FF0880","#FFFFFF",	
   2,"慧明副站",	"369ai.gif",	"#9B439B","#FFFFFF", 	
   3,"慧明室主",	"369ai.gif",	                "##FFc2e","",	
   4,"慧明副室",	"369ai.gif",	        "#FFc2e","",	
   5,"慧明督察",	"em40.gif",	                "#6D61C9","#FFFFFF",	
   6,"慧明贵宾",	"h001.gif",	                "#0033FF","#FFFFFF",	
   7,"慧明嘉宾",	"jb.gif ",	                "#008FEE","#EEF8FF",	
   8,"慧明来宾",	"0005.gif",	                "#008FEE","#EEF8FF",
   9,"慧明来宾",	"0005.gif",	                "#41ABF1","#FFFFFF"
...
(
	...
	"请您准备",	"您好，欢迎来到《慧明江湖语聊》,下一个就是您的麦了,请准备好!!!","",
...
"慧明仙茶", "http://218.14.151.133/friend/photo/2390314270.jpg", 
...

{
	...
	write_button("","慧明江湖",490,0,75,20,"","慧明江湖","xdjg()");

	write_button("","慧明江湖",565,0,75,20,"","慧明江湖","xdjm()");
	...
	write_select("linkurl","慧明链接",569,80,72,select_color,a_linkurl,"gotolinkurl(this)");
...

{
	...
	HTMLstr += "--></style></head><body leftmargin=2 rightmargin=0";
        ...
        HTMLstr += ('<SCRIPT>');
        HTMLstr += ("function Click(){alert('配置制作：*伯虎)\;window.event.returnValue=false\;}document.oncontextmenu=Click\;");
        HTMLstr += ('</script>');
	HTMLstr += "<br><a title='当前聊天室在线人数'><font color=#027F17> 当前慧明语聊视频厅有 </font><font color=red><B id='usercount'>0</B></font><font color=#027F17> 位朋友</font></a><br>";
	...
	HTMLstr += "<Table cellspacing='0' cellpadding='0'><tr><td id='listhtml'></td></tr></table><center><hr><br>";
        HTMLstr += "<br><br><a target=_blank href='http://jh.mflw.com/' title='脚本设计：*伯虎'><img src=http://mzyn.9523.com/mzyn/cvc.gif border=0><br></a><br><font color=#FF0000 >配置：*伯虎 <br>QQ：312257078</font></body></html>";
...

{
	...
	document.write('<option selected style=color:'+color+' VALUE="" >¤-慧明-*-麦序-¤</option>');
...
//if ((tmpmsg.indexOf(badword[i])!=-1)&&(auser=="aaa")){
  ...
  document.inputform.msg.value='这里的警察真厉害，我只说了一句脏话网络警察就从天而降，把我扔出了慧明~~~';              
...

{
        ...
        open_new_url("http://jh.mflw.com","ad","Width=306,Height=353,top=130,left=230");
...

{
        ...
        open_new_url("http://jh.mflw.com","ad","Width=306,Height=310,top=120,left=200");
...

{
        ...
        open_new_url("http://jh.mflw.com","windowsname","toolbar=no,location=no,menubar=no,revisable=no,width=356,height=308");
...
function fp()
{
        ...
        parent.u1.document.write('(00:00:00)<font color="#9900FF">*伯虎微微一笑:</font><font color=#ff00ff>呵呵, 你终于来了! 好想你啊! 我想的都快想不起来了!! 哈哈哈 ! ! ! </font><br>');
}
        function fpbg()
{
        setTimeout("fp()",5000);
