...
var room_owner="*!!!!!!影子";			//室主名称
var room_name="温馨小屋";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="*№聊湾∮";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2119";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = "<table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://pic.liaowan.com/tb/010.gif><BR><B>  <font color=#009900 size=5>温</font><font color=#0000FF size=4> 馨</font><font color=#FF00FF size=6> 小</font><font color=#CC00FF size=4> 屋</font></font></B><font color=#0000FF size=4></font></td><tr><td align=middle><img src=http://pic.liaowan.com/gif/hx.gif></td></tr><tr><td align=middle><marquee scrollamount=1><font color=Olive size=2><b>室主*!!!!!!影子 欢迎<font color=Olive><b>〖"+document.inputform.USER.value+"〗</b></font>来到<font color=Olive>★★</font><font color=red>希望你在这里玩的开心！要麦打999，试麦打666</font></marquee></td></tr></table>"; //聊友列表区头部显示
...
var div_msg4 = "【温馨小屋】室主:*!!!!!!影子 欢迎您光临本聊天室";  //通知
var div_link = "";
