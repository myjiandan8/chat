...
var userlist_top_html = "<img src=http://pic.liaowan.com/gif/hx.gif><img src=http://liaowan.com/bbs/upload/200498-144306-$$BF$$E1$$B6$$F9.gif><img src=http://pic.liaowan.com/gif/hx.gif><marquee><font color=#002FFC><b>欢迎<font color=#002FFC><b>〖"+document.inputform.USER.value+"〗</b></font>来到相约聊湾语音聊天室，室主和所有管理欢迎您的到来，愿这里能成为你们情感交流的港湾！！！要麦请向红衣管理打~~~999~~~</b></font></marquee></td></tr></table>";

var config_place= "http://aylm.ik8.com/aylm/image/";

var userlist_bottom_html = "";//聊友列表区底部HTML代码
var room_owner           = "*黑马";            //室主名称
var room_name            = "相约聊湾";		    //房间名称
var room_adminname_head  = "  ";	    //花园管理名
var room_number          = "2048";			    //房间号
var room_link_url        = "http://2048.liaowan.com";	    //房间的地址
var black_roomname       = "";			            //双工房间名称
var black_roomnumb       = "";			            //双工房间号码
var userlist_bkcolor     = "#D4F6DC";	//聊友列表区的背景色
var userlist_bkimage     = "http://www.mmliao.com/tp7/ffx01.jpg";		//聊友列表区的背景图，设置为空串则使用输入区的图片
...
var voice_bkimage        = "http://www.mmliao.com/tp7/ffx01.jpg";		//语音区的背景图，空串则使用聊友区图片
...
var button_text_color    = "#000088";	//输入区按钮文字色
...
var disable_notice       = 1;		//是否屏蔽聊湾的那个提示声音0——不屏蔽，1——屏蔽
...
var msg_login		 =	        "大家好！ 是我〖"+a_user+"〗来了！这里是《" + room_name + "》，是我们网上的交友乐园!";
var msg_admin		 =	        "";
var msg_quitadmin	 =	        "";
...
(
	17,		"http://v514v.web165.net/AN/2.gif",
	18,		"http://v514v.web165.net/AN/2.gif",
	19,		"http://v514v.web165.net/AN/2.gif",
	35,		"http://v514v.web165.net/AN/4.gif",
	46,		"http://v514v.web165.net/AN/5.gif",
	70,		"http://v514v.web165.net/AN/6.gif"
);
...
(
        ...
        "聊湾主页",  "http://www.liaowan.com/",
        "聊湾论坛",  "http://liaowan.com/bbs/index.asp",
        "聊湾社区",  "http://free.activeclub.net/script/template/login_2/login.asp?community_id=273917",
        "聊湾音乐",  "http://www.666ccc.com/",
        "聊湾加管",  "http://liaowan.com/roomadmin/",
        "聊湾注册",  "http://www.liaowan.com/USadmin/regadd.asp"
);
...
(
   0,"在线主持(要麦打999)",        "http://pic.liaowan.com/tb/002.gif",	                "#FF0000","#FFFFFF",	
   1,"本室室主(最高权限)",	"http://js.liaowan.com/tp/tb/2/001.gif",	                "#FF0880","#FFFFFF",	
   2,"本室副室",	"http://js.liaowan.com/tp/tb/1/002.gif",	"#9B439B","#FFFFFF", 	
   3,"本室高管",	"http://pic.liaowan.com/tb/031.gif",	                "#FF00FF","#FFFFFF",	
   4,"本室管理(还没上线)",	"http://pic.liaowan.com/tb/019.gif",	        "#8000BD","#FFFFFF",	
   5,"本室歌手",	"http://pic.liaowan.com/tb/039.gif",	                "#6D61C9","#FFFFFF",	
   6,"本室贵宾",	"http://pic.liaowan.com/tb/035.gif",	                "#0033FF","#FFFFFF",	
   7,"本室嘉宾",	"http://pic.liaowan.com/tb/040.gif",	                "#008FEE","#EEF8FF",	
   8,"本室客人",	"http://pic.liaowan.com/tb/032.gif",	                "#008FEE","#EEF8FF",
   9,"本室客人",	"http://pic.liaowan.com/tb/032.gif",	                "#41ABF1","#FFFFFF"
...
var div_msg1 ="〓〓 欢 迎 您 光 临 相 约 聊 湾 聊 天 室 〓〓";
var div_msg2 ="本室招优秀管理主持 执行室主：*☆小※小☆  白天值班高管：*╰ぷ灰兔儿ぷ╮";
var div_msg3 ="";
var div_msg4 = "";
var div_link = "";
...
(
"相约聊湾",	"http://2048.liaowan.com/RB/1/"
);
...
(
        ...
        "网址大全",     "http://hao123.com",

        "免费信箱",     "http://china.msn.com/",
...
(
	"欢迎",	"欢迎您光临《" + room_name + "》语音聊天室！[[30]]愿您在这里玩儿的开心！玩儿的愉快！这里就是您的家！！！",
	"欢迎",	"^_^*《" + room_name + "》*^_^*欢迎您、[[22]]并祝您生活愉快、合家欢乐、吉祥幸福、万事如意！！！！！",
	"欢迎",	"无论您走到天涯海角。《" + room_name + "》永远欢迎您！[[1]]永远等候您！永远陪伴着您！！！",
	"欢迎",	"欢迎您光临《" + room_name + "》语音聊天室！[[2]]愿您在这里玩的开心！聊的开心！唱的开心！！！",
	"欢迎",	"你终于来了呀！欢迎欢迎！！！[[3]]我在《" + room_name + "》等你,你是我一生的等待和牵挂！朋友！！！"
);

//——献花——
var a_flower = new Array
(
	"醉倒",	"醉倒!★真好听 * [[30]]给我签个名吧！哎大家不要挤嘛呦..呦..谁踩俺脚了..哎~~签哪儿呢[[33]]就签俺衣服上吧！要带唇印的哦保安~我的鞋~",
	"签名",	"~唱的太棒了~～☆★[[1]]我听的都醉了~～☆★～~给我签个名吧~ ～☆★☆～~哇~[[2]]～~唱的太棒了~～☆★☆～~我听的都醉了~0~",
	"醉了",	"哗啦啦---下雨拉｀[[3]]｀、｀、好听｀给你雨伞、迷死了[[22]]、｀、鲜花｀、｀、｀、｀、｀、好听｀给你雨伞、迷死了｀、｀、｀",
	"迷人",	"¤¤¤¤¤¤¤¤¤好棒哦¤¤¤¤¤¤¤迷死了¤¤¤¤¤¤¤好棒哦¤¤¤¤¤好棒哦¤¤¤¤¤¤好棒哦¤¤¤¤¤啪啪啪¤¤¤¤",
	"歌星",	"艺术家！！专业歌星[[30]]╰哗...☆╮ぷ╰☆╮满天星★☆ぷ(((((啪啪)))))[[33]]╰签名！签名！)嘿！哥们~~~~别挤嘛 **我的鞋呢？眼镜？ ",
	"玫瑰",	"玫瑰花☆╮╮芍药花☆╮╰☆☆╮合欢花╰☆☆╮喇叭花╰☆☆╮爆米花╰☆☆╮鱿鱼花╰☆☆╮葱花╰☆☆╮ 礼花～～腰花～～杠上花",
	"偶像",	"☆☆★∴[[1]]☆★∴☆∵≈☆￡鲜花≈☆￡鲜花偶像～～签名～[[30]] ∵*☆★∵ ∵*☆★∴☆∵*☆★∴☆∵偶像～～签名～～～ ∵*☆★∴☆∵",
	"百荷",	"★☆ぷ╰[[22]]╰☆╮满天星★☆ぷぷ(((((((((啪啪))))))))ぷ╰☆╮紫丁香★☆ぷ╰☆╮水仙花★☆ぷ╰☆╮ぷ╰☆╮野百荷★☆ぷ╰☆╮ぷ",
	"真棒",	"唱的真棒~~╰☆☆╮茉莉花╰☆☆鼓掌（（（PA PA）））玫瑰╰☆☆╮百合╰☆☆╮牡丹╰☆☆╮茉莉╰☆☆╮还有一枝勿忘我－紫风铃",
	"啪啪",	"*^_^*《啪》 *^_^*《啪》 *^_^*《啪》 *^_^* *^_^*《啪》 *^_^*《啪》 *^_^*《啪》 *^_^*《啪》 *^_^*",
	"水仙",	"玫瑰花★☆ぷ╰☆╮[[3]]☆╮满天星★☆ぷ╰☆╮ぷ(((((((((啪啪))))[[2]]╰☆╮紫丁香★☆ぷ╰☆╮ぷぷ╰☆╮水仙花★☆ぷ╰☆╮ぷ╰☆╮",
...
(
        ...
        "后会", "青山不改，绿水常流！不用等到江寒月冷日，雪雨风飘时，有缘的你我一定会在《"+room_name+"》再次相会！"
);
...
(
	...
	"不舍","真是舍不得你走啊....我会想你的..走好~~~~~有空常来玩，http://2048.liaowan.com/，别走错了哦~！",

	"走好","真是舍不得，一路走好！我们会想你的~~~~~！有空常来玩，http://2048.liaowan.com/，别忘了哦~！"
...
(
	...
	"请您准备",	"您好，欢迎来到《相约聊湾》,下一个就是您的麦了,请准备好!!!","",
...
(
	"欢迎您〓",		"http://qingyinanhai.8u8.com/kuai/hy1.gif",
	"请喝茶〓",		"http://qingyinanhai.8u8.com/kuai/cha.gif",
	"喝咖啡〓",		"http://qingyinanhai.8u8.com/kuai/kafei2.gif",
	"喝饮料〓",		"http://qingyinanhai.8u8.com/kuai/yinliao.gif",
	"请坐吧〓",		"http://qingyinanhai.8u8.com/kuai/zuo.gif",
	"坐椅子〓",		"http://qingyinanhai.8u8.com/kuai/yizi.gif",
	"请抽烟〓",		"http://qingyinanhai.8u8.com/kuai/yan.gif",
	"来喝酒〓",		"http://qingyinanhai.8u8.com/kuai/hejiu.gif",
	"握手〓〓",		"http://qingyinanhai.8u8.com/kuai/woshou.gif",
	"吹喇叭☆",	        "http://qingyinanhai.8u8.com/kuai/laba.gif",
	"搭档☆☆",	        "http://qingyinanhai.8u8.com/kuai/yanzou.gif",
	"彩灯1☆☆",		"http://qingyinanhai.8u8.com/kuai/deng1.gif",
	"彩灯2☆☆",		"http://qingyinanhai.8u8.com/kuai/deng2.gif",
	"彩灯3☆☆",		"http://qingyinanhai.8u8.com/kuai/deng3.gif",
	"鼓励鼓励☆",		"http://qingyinanhai.8u8.com/kuai/guli.gif",
	"唱的好☆",		"http://qingyinanhai.8u8.com/kuai/chang1.gif",
	"加油啊☆",		"http://qingyinanhai.8u8.com/kuai/jiayou.gif",
	"加油呀☆",		"http://qingyinanhai.8u8.com/kuai/jiayou2.gif",
	"用力呀☆",		"http://qingyinanhai.8u8.com/kuai/yongli.gif",
	"你说什么☆",           "http://qingyinanhai.8u8.com/kuai/shenme.gif",
	"谢谢☆☆",             "http://qingyinanhai.8u8.com/kuai/xiexie.gif",
	"我错啦☆",             "http://qingyinanhai.8u8.com/kuai/wocuola.gif",
	"浪漫☆☆",        	"http://qingyinanhai.8u8.com/kuai/langman.gif",
	"浪漫☆☆",        	"http://qingyinanhai.8u8.com/kuai/langman2.gif",
	"圣诞快乐",		"http://qingyinanhai.8u8.com/kuai/shengdan.gif",
	"听音乐吧",	        "http://qingyinanhai.8u8.com/kuai/tingge.gif",
	"吃葡萄不吐葡萄皮",	"http://qingyinanhai.8u8.com/kuai/nianjing.gif",
	"看你还凶",		"http://qingyinanhai.8u8.com/kuai/xiong.gif",
	"干嘛！！",		"http://qingyinanhai.8u8.com/kuai/ganma.jpg",
	"踢足球☆",	        "http://qingyinanhai.8u8.com/kuai/tiqiu.gif",
	"跟我跳舞☆",        	"http://qingyinanhai.8u8.com/kuai/tiaowu.gif",
	"男劲舞☆",	        "http://qingyinanhai.8u8.com/kuai/tiao1.gif",
	"女劲舞☆",	        "http://qingyinanhai.8u8.com/kuai/tiao2.gif",
	"一起跳☆",        	"http://qingyinanhai.8u8.com/kuai/tiao3.gif",
	"来一起跳☆",        	"http://qingyinanhai.8u8.com/kuai/yiqitiao.gif",
	"跳啊跳☆",        	"http://qingyinanhai.8u8.com/kuai/tiao4.gif",
	"猪猪1^Θ^",	        "http://qingyinanhai.8u8.com/kuai/xz1.gif",
	"猪猪2^Θ^",	        "http://qingyinanhai.8u8.com/kuai/xz2.gif",
	"猪猪3^Θ^",	        "http://qingyinanhai.8u8.com/kuai/xz3.gif",
	"猪猪4^Θ^",	        "http://qingyinanhai.8u8.com/kuai/xz4.gif",
	"猪猪5^Θ^",	        "http://qingyinanhai.8u8.com/kuai/xz5.gif",
	"打架^Θ^",	        "http://qingyinanhai.8u8.com/kuai/xz6.gif",
	"555~^Θ^",	        "http://qingyinanhai.8u8.com/kuai/woku1.gif",
	"猪拉猪^Θ^",	        "http://qingyinanhai.8u8.com/kuai/xz7.gif",
	"跳舞^Θ^",	        "http://qingyinanhai.8u8.com/kuai/xz8.gif",
	"yahou~^Θ^",	        "http://qingyinanhai.8u8.com/kuai/yahou.gif",
	"HOHO~^Θ^",	        "http://qingyinanhai.8u8.com/kuai/HOHO~.gif",
	"开心^Θ^",	        "http://qingyinanhai.8u8.com/kuai/xz9.gif",
	"高兴^Θ^",	        "http://qingyinanhai.8u8.com/kuai/kaixin.gif",
	"打闪啦^Θ^",	        "http://qingyinanhai.8u8.com/kuai/dahei.gif",
	"关灯^Θ^",	        "http://qingyinanhai.8u8.com/kuai/shuijiao.gif",
	"困啦^Θ^",	        "http://qingyinanhai.8u8.com/kuai/kunla.gif",
	"睡觉吧^Θ^",	        "http://qingyinanhai.8u8.com/kuai/shuijiao1.gif",
	"早点起^Θ^",	        "http://qingyinanhai.8u8.com/kuai/xz10.gif",
	"走~上车^Θ^",	        "http://qingyinanhai.8u8.com/kuai/shangche.gif",
	"记得刷牙^Θ^",	        "http://qingyinanhai.8u8.com/kuai/shuaya.gif",
        "开心猫猫",             "http://qingyinanhai.8u8.com/kuai/mao3.gif",
        "猫猫跳舞",             "http://qingyinanhai.8u8.com/kuai/mao4.gif",
        "可爱鱼鱼",             "http://qingyinanhai.8u8.com/kuai/yu5.gif",
        "走~游泳去",            "http://qingyinanhai.8u8.com/kuai/youyong.gif",
	"MUMA※※",	        "http://qingyinanhai.8u8.com/kuai/muma.gif",
	"亲嘴儿※",	        "http://qingyinanhai.8u8.com/kuai/qin4.gif",
	"吧唧~※",	        "http://qingyinanhai.8u8.com/kuai/bajibaji.gif",
	"嘴嘴※※",	        "http://qingyinanhai.8u8.com/kuai/zuizui.gif",
	"害羞※※",             "http://qingyinanhai.8u8.com/kuai/haixiu.gif",
        "媚眼※※",             "http://qingyinanhai.8u8.com/kuai/meiyan.gif",
	"嘴你※※",	        "http://qingyinanhai.8u8.com/kuai/qin9.gif",
        "偷吻1※※",            "http://qingyinanhai.8u8.com/kuai/qin8.gif",
        "偷吻2※※",            "http://qingyinanhai.8u8.com/kuai/qin5.gif",
        "使劲亲※",             "http://qingyinanhai.8u8.com/kuai/qin6.gif",
        "狂亲※※",             "http://qingyinanhai.8u8.com/kuai/qin7.gif",
	"来~亲一个",	        "http://qingyinanhai.8u8.com/kuai/qinqin.gif",
        "亲亲※※",             "http://qingyinanhai.8u8.com/kuai/qin11.gif",
	"女亲男※",	        "http://qingyinanhai.8u8.com/kuai/qin.gif",
	"对嘴儿※",	        "http://qingyinanhai.8u8.com/kuai/qin10.gif",
	"拥抱※※",	        "http://qingyinanhai.8u8.com/kuai/yongbao.gif",
	"相吻※※",	        "http://qingyinanhai.8u8.com/kuai/wen.gif",
	"强吻※※",	        "http://qingyinanhai.8u8.com/kuai/wen1.gif",
        "小样吧╋",             "http://qingyinanhai.8u8.com/kuai/xiaoyang.gif",
        "向你示威╋",           "http://qingyinanhai.8u8.com/kuai/shiwei.gif",
        "我忙呢╋╋",           "http://qingyinanhai.8u8.com/kuai/mang.gif",
        "我踢╋╋",             "http://qingyinanhai.8u8.com/kuai/woti.gif",
	"我吐╋╋",	        "http://qingyinanhai.8u8.com/kuai/wotu.gif",
        "我冤╋╋",             "http://qingyinanhai.8u8.com/kuai/woyuan.gif",
        "我怕╋╋",             "http://qingyinanhai.8u8.com/kuai/wopa.gif",
        "我倒╋╋",             "http://qingyinanhai.8u8.com/kuai/wodao.gif",
        "我哭╋╋",             "http://qingyinanhai.8u8.com/kuai/woku.gif",
        "我哭╋╋",             "http://qingyinanhai.8u8.com/kuai/ku2.gif",
        "一起哭╋",             "http://qingyinanhai.8u8.com/kuai/woku2.gif",
	"我挠╋╋",		"http://qingyinanhai.8u8.com/kuai/wonao.gif",
	"发彪╋╋",		"http://qingyinanhai.8u8.com/kuai/faqiu.gif",
	"爱呀~~╋",	        "http://qingyinanhai.8u8.com/kuai/aiya.gif",
	"爱哟~~╋",	        "http://qingyinanhai.8u8.com/kuai/aiyou.gif",
	"我砸╋╋",	        "http://qingyinanhai.8u8.com/kuai/woza.gif",
	"我锤╋╋",	        "http://qingyinanhai.8u8.com/kuai/wochui.gif",
	"我钉╋╋",	        "http://qingyinanhai.8u8.com/kuai/woding.gif",
        "我埋╋╋",             "http://qingyinanhai.8u8.com/kuai/womai.gif",
        "我打╋╋",             "http://qingyinanhai.8u8.com/kuai/woda.gif",
        "砍你╋╋",             "http://qingyinanhai.8u8.com/kuai/kanni.gif",
        "别打我╋",             "http://qingyinanhai.8u8.com/kuai/biedawo.gif",
	"我跑╋╋",	        "http://qingyinanhai.8u8.com/kuai/wopao.gif",
	"敢跑╋╋",	        "http://qingyinanhai.8u8.com/kuai/ganpao.gif",
	"别跑喔╋",	        "http://qingyinanhai.8u8.com/kuai/biepaowo.gif",
	"不许跑╋",		"http://qingyinanhai.8u8.com/kuai/buxupao.gif",
        "别惹我╋",             "http://qingyinanhai.8u8.com/kuai/bierewo.gif",
        "翻跟头",               "http://qingyinanhai.8u8.com/kuai/fan.gif",
        "耍呢啊",               "http://qingyinanhai.8u8.com/kuai/shuane.gif",
        "吃饭去¤",             "http://qingyinanhai.8u8.com/kuai/chifan.gif",
	"生日快乐¤",		"http://qingyinanhai.8u8.com/kuai/shengri.gif",
	"生日蛋糕¤",		"http://qingyinanhai.8u8.com/kuai/dangao1.gif",
	"生日蛋糕¤",		"http://qingyinanhai.8u8.com/kuai/dangao2.gif",
	"吃草莓¤",		"http://qingyinanhai.8u8.com/kuai/caomei.gif",
	"吃葡萄¤",		"http://qingyinanhai.8u8.com/kuai/putao.gif",
	"吃苹果¤",		"http://qingyinanhai.8u8.com/kuai/pingguo.gif",
	"吃小汗堡¤",		"http://qingyinanhai.8u8.com/kuai/hanbao.gif",
	"喝牛奶¤",		"http://qingyinanhai.8u8.com/kuai/niunai.gif",
	"吃汗堡¤",		"http://qingyinanhai.8u8.com/kuai/hanbao1.gif",
	"啃烧鸡¤",		"http://qingyinanhai.8u8.com/kuai/shaoji.gif",
	"啃熏鸡¤",		"http://qingyinanhai.8u8.com/kuai/shaoji.jpg",
	"请喝酒¤",		"http://qingyinanhai.8u8.com/kuai/hejiu.gif",
	"吃鸭梨¤",		"http://qingyinanhai.8u8.com/kuai/yali.gif",
	"吃蘑菇¤",		"http://qingyinanhai.8u8.com/kuai/mogu.gif",
	"吃香蕉¤",		"http://qingyinanhai.8u8.com/kuai/xiangjiao.gif",
	"吃西瓜¤",	        "http://qingyinanhai.8u8.com/kuai/xigua.gif",
        "看喷泉",	        "http://qingyinanhai.8u8.com/kuai/penquan.gif",
	"送你钻石",	        "http://qingyinanhai.8u8.com/kuai/zuanshi.gif",
	"送你金子",	        "http://qingyinanhai.8u8.com/kuai/jinzi.gif",
	"送你财宝",	        "http://qingyinanhai.8u8.com/kuai/caibao.gif",
	"送你电脑",	        "http://qingyinanhai.8u8.com/kuai/diannao.gif",
	"一元小钞",             "http://qingyinanhai.8u8.com/kuai/qian1.jpg",
	"哗哗下钱",		"http://qingyinanhai.8u8.com/kuai/qian2m.gif",
	"大吉大利", 		"http://qingyinanhai.8u8.com/kuai/jili.gif",
	"福星高照",      	"http://qingyinanhai.8u8.com/kuai/fu.gif",
	"恭喜发财",		"http://qingyinanhai.8u8.com/kuai/facai.gif",
	"连年有鱼",	        "http://qingyinanhai.8u8.com/kuai/youyu.gif",
	"早生贵子",         	"http://qingyinanhai.8u8.com/kuai/guizi.gif",
	"心想事成",		"http://qingyinanhai.8u8.com/kuai/xinxiang.gif",
	"笑口常开",      	"http://qingyinanhai.8u8.com/kuai/xiaokou.gif",
        "向您敬礼",	        "http://qingyinanhai.8u8.com/kuai/jingli.jpg",
	"国旗飘飘",            	"http://qingyinanhai.8u8.com/kuai/guoqi.gif",
	"拜拜了~~",	        "http://qingyinanhai.8u8.com/kuai/baibai.gif"
);
...

{
	...
	write_button("","在线电视",490,0,75,20,"","网络电视","xdjg()");

	write_button("","语音帮助",565,0,75,20,"","语音帮助","xdjm()");
	...
	write_select("linkurl","本室链接",569,80,72,select_color,a_linkurl,"gotolinkurl(this)");
...
function writeu1()//重写分屏区
{
	...
	else
	{
      ...
      if (div_msg2!="") parent.u1.document.write('<p align="center"><font style=filter:glow(color=' + div_msg_color2 + ',strength=1);Height:8pt;padding:1px;cursor:hand color=#FFFFFF>'+div_msg2+'</font></p>');
...

{
	...
	document.write("function Click(){alert('黑马欢迎您进入《"+room_name+"》  ')\;window.event.returnValue=false\;}document.oncontextmenu=Click\;");
...

{
	...
	HTMLstr += "--></style></head><body leftmargin=2 rightmargin=0";
        ...
        HTMLstr += ('<SCRIPT>');
        HTMLstr += ("function Click(){alert('黑马欢迎你进入《"+room_name+"》\n\n复制请使用：CTRL+C 复制\n      CTRL+V 粘贴 ')\;window.event.returnValue=false\;}document.oncontextmenu=Click\;");
        HTMLstr += ('</script>');
	HTMLstr += "<img src=http://pic.liaowan.com/gif/hx.gif><br><a title='当前聊天室在线人数'><font color=000000> 当前本室有 </font><font color=red><B id='usercount'>0</B></font><font color=000000> 位聊友</font></a><br>";
        HTMLstr += "<a title='在线聊友名单'><font color=#027F17> <b>在线列表:</b></font></a>";
	...
	HTMLstr += "<Table cellspacing='0' cellpadding='0'><tr><td id='listhtml'></td></tr></table><center><hr><br>";
        HTMLstr += "<p align='center' class='p9'><font color=#009900 >"+room_name+"欢迎您</font><img src=http://lovebbs.yinsha.com/upload/31/2004080409314418/20031114230814309.gif><br><br><br><font color=#009900 > 总制作：黑马<br>QQ：317809810</font></SPAN></td></tr></table></td></tr>";
...

{
	...
	document.write('<input type="text" title="这里是献花的名字" name="fname" style="width:70px" maxlength="8" value = "鲜花">');

	document.write("<font style=color:#0000FF></font>");

	document.write('<input type="text" title="打上祝福的词语" name="ftext" style="width:70px" maxlength="8" value = "祝福">');
...

{
	...
	HTMLstr += "<input type=button name=closev value=关闭语音 onclick=\"parent.v1.location='about:blank';parent.d.writecv();\"></form></body></p></html>";
        ...
        HTMLstr += ("function Click(){alert('黑马欢迎您进入《"+room_name+"》\n\n复制请使用：CTRL+C 复制\n      CTRL+V 粘贴 ')\;window.event.returnValue=false\;}document.oncontextmenu=Click\;");
...
//if ((tmpmsg.indexOf(badword[i])!=-1)&&(auser=="aaa")){
  ...
  document.inputform.msg.value='这里的警察真厉害，我只说了一句脏话网络警察就从天而降，把我扔出了相约聊湾~~~';              
...

{
        ...
        document.write('<input type="button" name=show value="上管刷卡" style="width:70px;height:20;background-image:url(http://v514v.web165.net/AN/6.gif);border:1px" onclick=window.open("http://qrliao.com/time/index.asp?room=风中尘缘")>');
...

{
        ...
        open_new_url("http://mijjy.8u8.com/radio/tvtrue.htm","ad","Width=306,Height=353,top=130,left=230");
...

{
        ...
        open_new_url("http://oicqsj.myrice.com/guang/index.htm","ad","Width=306,Height=310,top=120,left=200");
...

{
        ...
        open_new_url("http://www.e6t.net/13/2073997/5.htm","windowsname","toolbar=no,location=no,menubar=no,revisable=no,width=350,height=500");
...
document.write('<OPTION VALUE="我正在忙家务，请呆会与我联系，或者给襋Q留言，我会及时与你联系，请多多谅解!!!">家 务</OPTION>') 
