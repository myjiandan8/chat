...
var config_place = "http://web.fs169.net/xiongmaolei/2233gif/";  //	图片等的存放位置，请设定为您存放图片的位置

var room_owner="*流窜犯野人";			//室主名称
var room_name="流窜犯家园";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="*";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2197";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = "<table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://tianrbbs.go.zccn.net/811391/456.gif><BR><B>  <font color=#009900 size=5></font><font color=#0000FF size=4> </font><font color=#FF00FF size=6> </font><font color=#CC00FF size=4> </font></font></B><font color=#0000FF size=4></font></td><tr><td align=middle><img src=http://tianrbbs.go.zccn.net/811391/456.gif></td></tr><tr><td align=middle><marquee scrollamount=1><font color=Olive size=2><b>室主*流窜犯野人*流窜犯野猫*流窜犯野狗 欢迎<font color=Olive><b>〖"+document.inputform.USER.value+"〗</b></font>来到<font color=Olive>★★</font><font color=red>希望你在这里玩的开心！要麦打999，试麦打666</font></marquee></td></tr></table>"; //聊友列表区头部显示
...
//	聊友列表区底部框内文字代码
var listbottem0="〓★室主★〓<BR>"+room_owner+"<BR>欢迎你的到来<BR>"+room_name+"<Br>是我们<Br>共同的家园";
...
(
	17,		"http://tianrbbs.go.zccn.net/811391/btn18a.gif",
	18,		"http://tianrbbs.go.zccn.net/811391/btn18a.gif",
	19,		"http://tianrbbs.go.zccn.net/811391/btn18a.gif",
	35,		"http://tianrbbs.go.zccn.net/811391/btn35a.gif",
	46,		"http://tianrbbs.go.zccn.net/811391/btn46a.gif",
	70,		"http://tianrbbs.go.zccn.net/811391/btn70a.gif"
);
...
var default_admin_pass = "666";	//	默认的管理员上管口令
...
var div_msg1 = "<img src=http://tianrbbs.go.zccn.net/811391/456.gif></a>";
var div_msg2 = "【流窜犯家园】感谢管理们的辛勤付出。";
var div_msg3 = "由于网速的原因有些聊友进来听不到声音，请关了语音然后再打开";
var div_msg4 = "";
var div_link = "";
...
(
	...
	"注冊","http://www.liaowan.com/USadmin/regadd.asp",
	"论坛","http://tianrbbs.go.zccn.net/bbs1/index.asp",
        "留言","http://tianrbbs.go.zccn.net/zihan/flashbook.htm",
        "音樂","http://www.bucuo.net/"
);

//	本室中的 VIP 聊友
//	级别：0---在线主持  1--房主；2--室主  3--特殊贵宾... 4-----高级管理   5---管理员格式  6----歌手格式    7--注册马甲  8----汉字马甲   9---数字马甲   10---领队马甲   11---歌手马甲
...
(
   0,"在綫主持",        "http://tianrbbs.go.zccn.net/811391/op.gif",	                "#FF0000","#FFFFFF",	
   1,"室主",	"http://tianrbbs.go.zccn.net/811391/shizhu.gif",	                "#000000","#FFFFFF",	
   2,"副室",	"http://web.fs169.net/xiongmaolei/2233gif/gw.gif",	"#FF00FF","#FFFFFF", 	
   3,"高管",	"http://tianrbbs.go.zccn.net/811391/fus.gif",	                "#00A0FF","#FFFFFF",	
   4,"配置",	"http://web.fs169.net/xiongmaolei/2233gif/gw.gif",	        "#993300","#FFFFFF",	
   5,"管理",	"http://tianrbbs.go.zccn.net/0/2.gif",	                "#0099FF","#FFFFFF",	
   6,"贵宾",	"http://tianrbbs.go.zccn.net/0/1.gif",	                "#8800FF","#FFFFFF",	
   7,"嘉宾",	"http://tianrbbs.go.zccn.net/0/3gif",	                "#8800FF","#FFFFFF",	
   8,"客人",	"http://tianrbbs.go.zccn.net/0/4.gif",	                "#0033FF","#FFFFFF",
   9,"客人",	"http://tianrbbs.go.zccn.net/0/5.gif",	                "#0033FF","#FFFFFF"

);

// 不可踢马甲
var wudimajia=new Array("*","*qiufen","*","*~","*",
"*流窜犯野人","*","*","*","*","*","*","*","*","*","*","*","*","*","*"
 );  
...
(
	"狂嘴",	"扳倒狂嘴————吧唧吧唧————Mu~~ma~",
	"呱唧",	"呱唧呱唧——————{{{{{{动感咣啵}}}}}} ",
	"摸摸",	"吼吼吼~~~~{{{{{{动感摸摸}}}}}}——————吼吼吼~~~~{{{{{{动感摸摸}}}}}} 、｀",
	"迷人",	"哈哈哈~~~~~~狂摸PP中~~~~~~喜欢你才摸呢~~~~~~~嘿嘿",
...
(
	"要麦",	"999999999999999999999999我要麥呀9999999",
	"唱歌",	"999999999999999999999999我要麥呀99999999"
);
...
var a_yao = new Array
(
	"邀麦",	"☆⌒_⌒．☆°您好!亲爱的朋友,欢迎你的到来,你可以给大家表演个节目吗？谢谢☆⌒_⌒．☆",
	"邀麦",	"☆⌒_⌒．☆°您好!亲爱的朋友,欢迎你的到来,你可以给表演个节目吗？谢谢☆⌒_⌒☆"
);
...
(
    ...
    "女双对抗","http://tianrbbs.go.zccn.net/tu2/1.gif",
    "我脱","http://tianrbbs.go.zccn.net/tu2/2.gif",
    "让我看看","http://tianrbbs.go.zccn.net/tu2/3.jpg",
    "我画你","http://tianrbbs.go.zccn.net/tu2/4.jpg",
    "好玩","http://tianrbbs.go.zccn.net/tu2/5.jpg",
    "非礼我","http://tianrbbs.go.zccn.net/tu2/6.gif",
    "想干吗","http://tianrbbs.go.zccn.net/tu2/7.gif",
    "你的头","http://tianrbbs.go.zccn.net/tu2/8.gif",
    "男女主角","http://tianrbbs.go.zccn.net/tu2/9.gif",
    "我让你爆光","http://tianrbbs.go.zccn.net/tu2/10.gif",
    "讨厌","http://tianrbbs.go.zccn.net/tu2/11.gif",
    "小样","http://tianrbbs.go.zccn.net/tu2/12.jpg",
    "爆头","http://tianrbbs.go.zccn.net/tu2/13.gif",
    "不许看","http://tianrbbs.go.zccn.net/tu2/14.gif",
    "我哭","http://tianrbbs.go.zccn.net/tu2/15.gif",
    "打爆你","http://tianrbbs.go.zccn.net/tu2/16.gif",
    "看刀","http://tianrbbs.go.zccn.net/tu2/17.jpg",
    "别小看女人","http://tianrbbs.go.zccn.net/tu2/18.gif",
    "野蛮丫头","http://tianrbbs.go.zccn.net/tu2/19.jpg",
    "先上车后买票","http://tianrbbs.go.zccn.net/tu2/20.gif",
    "让你小子看","http://tianrbbs.go.zccn.net/tu2/21.gif",
    "绝对美女","http://tianrbbs.go.zccn.net/tu2/22.gif",
    "倒下吧你~~","http://tianrbbs.go.zccn.net/tu2/23.gif",
    "跳舞","http://tianrbbs.go.zccn.net/tu2/24.gif",
    "斗牛","http://tianrbbs.go.zccn.net/tu2/25.gif",
    "露光","http://tianrbbs.go.zccn.net/tu2/26.gif",
    "别惹我","http://tianrbbs.go.zccn.net/tu2/27.gif",
    "好伤心","http://tianrbbs.go.zccn.net/tu2/28.jpg",
    "我杀","http://tianrbbs.go.zccn.net/tu2/33.gif",
    "色狼","http://tianrbbs.go.zccn.net/tu2/30.jpg",
...
//	对聊友重新排序
	...
	for(i = 0 ; i < user_array.length;i++)
	{
		...
		if(lists[2]==1)
			HTMLstr += ("<img src=http://web.fs169.net/xiongmaolei/2233gif/84.gif border=0>");
		if(lists[2]==2)
...
function writelistbase()//重写聊友列表区
{
	...
	HTMLstr += "<br><a title='在线朋友名单'><font color=000000> <b>帅哥美女</font><font color=red><B id='usercount'>0</B></font><font color=000000> 位</b></font></a>";
	...
	parent.r.document.writeln("<script language=javaScript>"); 
        parent.r.document.writeln("function Click(){alert('配置维护:紫寒 QQ:25072275！')\;window.event.returnValue=false\;}  document.oncontextmenu=Click\;");
...
function write_singer_form(left,top,color)//加入麦序管理
{
   if (is_online_manager())
	...
	document.write('<option selected style=color:'+color+' VALUE="" >¤-视舞-*-麦序-¤</option>');
...
function writecv()//未开语音时的界面
{
	...
	HTMLstr += ("INPUT{COLOR:"+button_text_color+";FONT-SIZE:9pt;FONT-FAMILY:宋体,SimSun;cursor:hand}");
	HTMLstr += ("BODY{background:"+((voice_bkcolor != "")?voice_bkcolor:parent.r.document.body.bgColor)+((m_fullscreen_bgimage != "")?(" url("+m_fullscreen_bgimage+") fixed}"):"}"));
	HTMLstr += "</style><center><br><br><font face=楷体_GB2312><font size=2 color=#874D01><center><u><b>聊湾 流窜犯家园<br>友情技术支持<br>QQ:25072275</b></u></center></font></font><center><br><input type=button name=closev value=打开语音 onclick=\"{parent.writev_new();parent.d.decoratev();}\">";
