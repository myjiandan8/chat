...
* 由于作者水平有限,程序难免错漏,如果你在使用过程中发现任何问题,请在聊湾论坛发贴或至信153251392@qq.com     *
...
var room_owner="*★魅力玫媚★";			//室主名称
var room_name="四十情缘";			//	房间名称
var room_adminname_head="*情缘←╬∞";	//	本室管理名格式
var room_adminname_headg="*№聊湾∮";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2022";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = " <table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://pic.liaowan.com/sb/2022.gif><BR><tr><td align=middle><img src=http://pic.liaowan.com/gif/hx.gif>"; //聊友列表区头部显示
...
var div_msg1 = "本站广招管理主持 请向在线管理咨询<a target=_blank href='http://liaowan.com/' title='聊湾欢迎您！'><IMG align=absMiddle src=http://liaowan.com/logo/logo.gif></a>";
var div_msg2 = "如果立体声语音不能正常运行，请点击下边帮助";
var div_msg3 = "欢迎光临聊湾聊天网【"+room_name+"】多视频聊天室!~~连接多视频请直接点名字后小眼睛";
var div_msg4 = "*★魅力玫媚★欢迎朋友们的光临和支持 愿你开心快乐";  //通知
var div_link = "";
...
(
	...
	3,	"副室",	"016.gif",	 "#333333",	"#ffffff",
	4,	"金牌管理",	"0003.gif","#F3942E",	"#ffffff",
	5,	"管理成员",	"0004.gif",	"#34c534",	"#ffffff",
	6,	"本室嘉宾",	"alogo2.gif ", "#61598a",	"#ffffff",
	7,	"注册名",	"qq.gif ",	"#2c07fe",	"#ffffff",
