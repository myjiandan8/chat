...
*******************************************************************************************/
//////////本脚本*凤鸣楚天 改编，适用于聊湾房间//////////////2004.8.31///////////

// 使用方法：<SCRIPT src=http://liaowan.com/chatjs/2172.js></SCRIPT> 
...
var room_owner="*梦幻星空";			//室主名称
var room_name="梦幻星空";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="*";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2172";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = "<table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://pic.liaowan.com/gif/hx.gif><BR><B>  <font color=#009900 size=5>梦</font><font color=#0000FF size=4>幻</font><font color=#FF00FF size=6>星</font><font color=#CC00FF size=4>空</font></font></B><font color=#0000FF size=4></font></td><tr><td align=middle><img src=http://pic.liaowan.com/gif/hx.gif></td></tr><tr><td align=middle><marquee scrollamount=1><font color=Olive size=2><b>室主:*冷小少爷 欢迎<font color=Olive><b>〖"+document.inputform.USER.value+"〗</b></font>来到<font color=Olive>★★</font><font color=red>希望你在这里玩的开心！要麦打999，试麦打666</font></marquee></td></tr></table>"; //聊友列表区头部显示
...
var userlist_bkimage = "http://www.baby1518.com/js/bj0.jpg";			//	聊友列表区的背景图，设置为空串则使用输入区的图片
...
var div_screen_bkimage = "http://www.cnjwedu.net/~huangzi//tp/fmct.jpg";		//	分屏背景图片	

var voice_bkcolor = "#e5fffd";		//	语音区的背景
var voice_bkimage = "http://www.cnjwedu.net/~huangzi//tp/fmct.jpg";				//	语音区的背景图，空串则使用聊友区图片

var input_bkcolor = "#e5fffd";		//	输入区背景色
var input_bkimage = "http://www.cnjwedu.net/~huangzi//tp/fmct.jpg";				//	输入区背景图片
...
var default_admin_pass = "761143";	//	默认的管理员上管口令
...
var div_msg3 = "欢迎光临【"+room_name+"】多视频聊天室!本室诚招 监管 高管 在线管理各数名 对房间有贡献的管理一律加级管理 望有意者加盟~";
var div_msg4 = "室主:*冷小少爷 副室主：*圝┺鹏鹏╃圝 欢迎您光临本聊天室 本站广招管理主持，有意者请联系Q：11357364 Q：184750023 梦幻星空管理齐心合力 共同维护 美好家园";  //通知
...
(
	"主页","http://2172.liaowan.com",
	"论坛","http://www1.ly924.com/bbs/Boards.asp",
	"楚之源","http://chu.china3r.com/",
	"电台","http://www.ctbs.cn/",
        "留言","http://www.urs.cn/free/gb3/index.asp?user=fmct",
        "嗨曲","http://ggdj.com"
);
...
(
	0,	"梦幻管理",	"http://pic.liaowan.com/tb/030.gif",	"#FF0000",	"#ffffff",
	1,	"梦幻室主",	"http://web.fs169.net/xiongmaolei/liao/87383.gif",	"#888888",	"#ffffff",
	2,	"梦幻副室主",	"http://web.fs169.net/xiongmaolei/liao/fu.gif",	"#888888",	"#ffffff",
         3,	"本室配置 吃闲饭 打扫房间的清洁工",	"http://pic.liaowan.com/tb/049.gif", "#f500ff","#ffffff",
         4,	"梦幻高管",	"http://www.wzdu.com/UploadFile/2004121535988453.gif", "#2c07fe",	"#ffffff",
	5,	"梦幻主持",     "http://pic.liaowan.com/tb/007.gif",	 "#000088",	"#ffffff",	
	6,	"梦幻嘉宾",	"http://pic.liaowan.com/tb/035.gif",	"#2c07fe",	"#ffffff",
	7,	"梦幻歌手",      "http://pic.liaowan.com/tb/gs.gif",	"#2547dg",	"#ffffff",
	8,	"梦幻过客",	"http://pic.liaowan.com/tb/032.gif",	"#2c07fe",	"#ffffff",
	9,	"梦幻过客",	"http://pic.liaowan.com/tb/032.gif",	"#2c07fe",	"#ffffff"
);

// 不可踢马甲
var wudimajia=new Array("*-依-","*失色天空","*凤鸣楚天","*冷小少爷","*DJ小鱼",
"*梦幻星空","*圝┺鹏鹏╃圝","*★寶★","*︶ㄣ夢在飛" 
 );  
...
(
	"楚天文化",		"http://www.chuculture.net/",
	"湖北人才热线",		"http://www.hbjob.net/",
	"聊湾注册",		"http://liaowan.com/USadmin/regadd.asp",
	"荆楚网",		"http://www.cnhubei.com/",
	"荆州热线",		"http://www.jzinfo.com/",
...
(
	"网址",	"梦幻星空 聊天室网址："+room_link_url+" ",
	"网址",	"梦幻星空聊天室 网址："+room_link_url+" "
);
...
function writecv()//未开语音时的界面
{
	...
	HTMLstr += ("INPUT{COLOR:"+button_text_color+";FONT-SIZE:9pt;FONT-FAMILY:宋体,SimSun;cursor:hand}");
	HTMLstr += ("BODY{background:"+((voice_bkcolor != "")?voice_bkcolor:parent.r.document.body.bgColor)+((m_fullscreen_bgimage != "")?(" url("+m_fullscreen_bgimage+") fixed}"):"}"));
	HTMLstr += "</style><center><br><br><font face=楷体_GB2312><font size=2 color=#874D01><center><u><b>本室配置：*凤鸣楚天<br>QQ：282676797</b></u></center></font></font><center><br><input type=button name=closev value=打开语音 onclick=\"{parent.writev_new();parent.d.decoratev();}\">";
