...
var config_place = "http://piy.512j.com/";  //	图片等的存放位置，请设定为您存放图片的位置

var room_owner="*~寳妮~ ";			//室主名称
var room_name="一见钟情";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2058";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";
alert('〓欢迎您光临 一见钟情 语音聊天室〓       \n\n\n◆◆◆◆◆◆◆◆◆我们的口号◆◆◆◆◆◆◆◆◆       \n\n提高个人素质，体现精神文明，请文明聊天\n你们是幸福的，我们就是快乐的，为你们付出的，再多也值得\n\n◆◆◆◆◆◆◆◆◆我们的口号◆◆◆◆◆◆◆◆◆       \n\n              ★★★　　　★★★       \n            ★★★★★  ★★★★★       \n            ★★★★★★★★★★★       \n            　★★★★★★★★★       \n　            　★★★★★★★       \n　            　　★★★★★       \n　　            　　★★★       \n　　            　　　★       \n有建议请与室主:"~寳妮~ 联系       \n\n         *☆"~寳妮~☆QQ：261907942^Θ^             \n\n ╱◥█◣　╱◥█◣        \n︱田︱田︱︱田︱田︱        \n╬╬╬╬╬╬╬╬╬╬╬╬╬╬   一见钟情^Θ^聊天室名');
//	聊友列表区顶部HTML代码
var userlist_top_html = " <B><td align=middle><img src=http://piy.512j.com/sb/2058.gif></td></B><BR>"; //聊友列表区头部显示
...
var div_msg1 = "　一见钟情欢迎您　 ";
var div_msg2 = "  本室长期招收管理，有意者请与在线管理及室主联系  ";
var div_msg3 = "室主→~寳妮~◆欢迎大家的光临◆本室管理加管理群6811224 本室管理马甲格式①見鍾情★↖XX 本室歌手马甲格式╭┳≡歌手¤XX  ";
var div_msg4 = "";  
var div_link = "";
...
(
	...
	1,	"室主",		"http://xupeng521.51.net/tx/t103.gif",           "#FF00FF","#FFFFFF",
	2,	"副室",		"http://xupeng521.51.net/tx/t288.gif",	          "#330033","#FFFFFF",
	3,	"聊湾无名",             "http://xupeng521.51.net/tx/t50.gif",	        "#FF00FF","#FFFFFF",
	4,	"一见钟情管理",		"http://xupeng521.51.net/tx/t50.gif",	"#8B0A50","#FFFFFF",
	5,	"一见钟情歌手",		"http://xupeng521.51.net/tx/t254.gif",	"#008000","#FFFFFF",
	6,	"一见钟情高管",		"http://xupeng521.51.net/tx/t104.gif",    "#8800FF","#FFFFFF",
	7,	"本室嘉宾",		"http://xupeng521.51.net/tx/t252.gif",	"#8800FF","#FFFFFF",
	8,	"本室过客",		"http://xupeng521.51.net/tx/t30.gif",         "#C71585","#FFFFFF",
	9,	"本室过客",		"http://xupeng521.51.net/tx/t88.gif",         "#8B4513","#FFFFFF",
	10,	"",		"http://pic.liaowan.com/gif/plnvlb1.gif",    "#ff00ff","#FFFFFF",
	11,	"执行副室",		"http://www.y88.info/tp/16.gif",	         "#00cd00","#FFFFFF",
	12,	"",             "http://www.y88.info/tp/shi.gif",	        "#FF7F00","#FFFFFF",
	13,	"",		"http://pic.liaowan.com/tb/009.gif",	"#EE1289","#FFFFFF",
	14,	"",		"http://pic.liaowan.com/tb/031.gif",	"#AA00ff","#FFFFFF",
	15,	"本室管理",		"http://pic.liaowan.com/tb/041.gif",    "#757575","#FFFFFF",
        16,	"本室过客",		"http://www.y88.info/tp/10.gif",         "#0000ff","#FFFFFF",
	17,	"本室过客",		"http://www.y88.info/tp/10.gif",         "#0000ff","#FFFFFF",
	18,	"本室过客",		"http://www.y88.info/tp/10.gif",         "#0000ff","#FFFFFF",
	19,	"本室过客",		"http://www.y88.info/tp/10.gif",         "#0000ff","#FFFFFF"	   
);
...
"不舍","真是舍不得你走啊....我会想你的..走好~~~~~有空常来玩，http://2004.liaowan.com/，别走错了哦~！",
"走好","真是舍不得，一路走好！我们会想你的~~~~~！有空常来玩，http://2004.liaowan.com/，别忘了哦~！"
);
...
//	write_button("","答谢",304,60,35,20,"","快速答谢","autosend(a_da)");
	...
	write_select("linkurl","本室链接",533,80,72,select_color,a_linkurl,"gotolinkurl(this)");
       for (var i = 0 ; i < 5 ; i ++)
           write_newwindow_button(a_link_button[i*2],5+35+35 * i,0,35,20,"",a_link_button[i*2] + "\n" + a_link_button[i*2+1],a_link_button[i*2+1],"","");
       if (jilu !="") {
