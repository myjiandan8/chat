...
*                                           碧海  冀人老刀QQ:153251392                        *
*    真情论坛 http://www.369590.com    2004.9.9添加晚会嘉宾（假人）代码                *
*******************************************************************************************/
//////////本脚本lwbh1.0由碧海主编，冀人老刀修改适用于聊湾房间//////////////2004.8.31///////////
...
var room_owner="*~★☆司〓令☆★~";			//室主名称
var room_name="晴人电台";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2080";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = " <table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://qrdt600.cliao.com/bbs/UploadFile/20049811135221310.gif><BR><tr><td align=middle><img src=http://pic.liaowan.com/gif/hx.gif>"; //聊友列表区头部显示
...
(
	...
	18,		"http://pic.liaowan.com/anniu/22/2.gif",
	19,		"http://pic.liaowan.com/anniu/22/2.gif",
...
(
	...
	8,	"汉字名",	"4.gif ",	"green",	"#ffffff",
	9,	"数字名",	"http://pic.liaowan.com/tb/011.gif",	"green",	""
);
...
now = new Date();
          ...
          for (var i=1;i<j+1;i++)
           {if (i==1) {user1="*冀人老刀";}if (i==2) {user1="*依溪";} if (i==3) {user1="*feilong";} if (i==4) {user1="*laobao";}if (i==5) {user1="2569.";}if (i==6) {user1="*letian";}if (i==7) {user1="*★黑色陽光★";}if (i==8) {user1="*小依";}
