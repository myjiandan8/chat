...
var cipdz="http://pic.liaowan.com/houdai/showadmin.asp" ;
var config_place = "http://pdsyr.02835.com/chat/";
var room_owner="*鋭→不可鐺";
var room_name="音乐无限";
var room_adminname_head="";
var room_adminname_headg="";
var majia = "" ;
var room_number="2076";
var black_roomname="";
var black_roomnumb="";
var room_link_url = "http://"+room_number+".liaowan.com";
var userlist_top_html = " <table border=0 width=115px cellspacing=0></td><tr></tr><tr><td align=left><img src=http://pdsyr.02835.com/chat/music.gif><BR><tr><td align=left><img src=http://pic.liaowan.com/gif/hx.gif>"; 
var userlist_bottom_html = "<marquee scrollamount='2'> <font color=ff00FF> "+room_name+"欢迎</font><font color=ff00ff>『"+a_user+"』</font><font color=ff00FF>的到来！要麦向红衣管理打9999.广招管理主持，歌手请向在线管理咨询或与QQ：249877567联系</font></marquee></a>";
var listbottem0="";
var userlist_bkcolor = "#e5fffd";
var userlist_bkimage = "";
var voice_normal_color = "#000000";
var voice_v2v_color = "#000000";
var voice_vr_color = "#00aafF";
var div_screen_bkcolor = "e5fffd";
var div_screen_bkimage = "";
var voice_bkcolor = "#e5fffd";
var voice_bkimage = "";
var input_bkcolor = "#e5fffd";
var input_bkimage = "";
var input_msg_color	= "#000000";
var input_msg_bkcolor = "#ffffff";
var body_text_color	= "#038ffe";
var select_color = "#038ffe";
var select_text_color = "#038ffe";
var button_text_color = "#660099";
...
var default_admin_pass = "7878143";
var auto_open_ai = 1;
var auto_open_div = 1;
...
var div_msg_color1 = "#000000";
var div_msg_color2 = "#000000";
var div_msg1 = "  "+a_user+"   ，您好~欢迎来到『音乐无限』，现本室广招管理主持，歌手请向在线管理咨询,我们的马甲模式是男管理  ╰☆XぷX⺷_⺷音樂，女管理  ╰★XぷX⺷o⺷音樂,男歌手  ╰☆XぷX⺷_⺷歌手，女歌手  ╰★XぷX⺷o⺷歌手";
var div_msg2 = "";
var div_msg3 = "";
var div_msg4 = " "+room_name+"欢迎</font><font color=ff0000>『"+a_user+"』</font><font color=FF00ff>的到来！我们的QQ群是：<font color=ff0000>4995413</font>，欢迎大家加入哦~";
var div_link = "";
var jilu="http://pic.liaowan.com/houdai/showadmin.asp";
var a_link_button = new Array
(
	"主页","http://www.liaowan.com/",
	"论坛","http://liaowan.com/bbs/topiclist.asp?bd=19",
...
(
	0,	"在线管理",	      "0.gif","",	"#ff0000",
	1,	"音乐室主,有事偶说的算~","1.gif ","",	"#9900FF",
	2,	"无限副室","2.gif ","",	"#FF00FF",
	3,	"偶高管,请大家多多指教~",	"3.gif ","",	"#0077FF",
	4,	"我是音乐的管理,hoho~~",	"4.gif ","",	"#0000FF",
	5,	"偶是歌手.偶来吼两曲!",	"5.gif ","",	"#34c534",
	6,	"看俺漂亮不?要不咋当嘉宾叻~",	"6.gif ","","#8800FF",
	7,	"别看偶~偶就是喜欢这里~",	"7.gif ","","#000000",
	8,	"看什么看?没有见过吗?",	"9.gif ","","#0000FF",
	9,	"偶是谁?自己猜去~",	"9.gif ","","#0000FF"
);
var wudimajia=new Array("*钅兑","*鋭→不可鐺"
 );  
...
(
	"热线连接",		"",
	"真情论坛",		"http://liaowan.com/bbs/topiclist.asp?bd=19",
...
(
	"要麦",	"我要麦呀999，我要麦呀999，快给我麦呀，9999999",
	"唱歌",	"我要吼呀999，偶要唱歌999，我要麦呀999"
);
var a_heart = new Array
(
	"听见",	"听见了，111，呵呵 ：）~",
	"听见",	"听见了,111,好清晰,声音好清楚哦~"
);
var a_dai = new Array
(
	"搅拌",	"我要搅拌999，可以吗？搅拌，搅拌，偶只唱一段~(麦序超过5个俺就不搅拌了) ",
...
var a_yao = new Array
(
	"邀麦",	"您好!亲爱的朋友,欢迎你的到来,你可以给大家唱一首歌吗？谢谢",
	"邀麦",	"您好!亲爱的朋友,欢迎你的到来,你可以给大家唱一首歌吗？谢谢"
);
...
var a_shi = new Array
(
	"试麦",	"我要试麦666，我要试麦666，我要试麦666~~ ",
	"试麦",	"偶要试麦666，偶要试麦666，先给偶啦~ "
);
var a_ju = new Array
(
...
function add_new_element()
{
	...
	else
	{
		...
		write_select("linkroom","房间走廊",533,60,72,select_color,a_roomlink,"gotolinkroom(this)");
              document.writeln('<DIV id=content style="FILTER: revealTrans(Transition=2, Duration=2); HEIGHT: 0px;LEFT:300px;TOP:3px;WIDTH:300px;POSITION:absolute;TEXT-ALIGN:left"><b><marquee scrollamount=2>'+div_msg4+'</marquee><br></b></font></div>')
	}
}
...
var user_b;
var reautoyn=0;
var reautowordb="HOHO~偶去喝水,顺便去CC了,:)!";
...
var listbottem="<tr>"+listbottem0+"</tr>";
function writelist()
{
...
function writelistbase()
{
	...
	HTMLstr += ((userlist_top_html != "")?userlist_top_html:("<font color=#ff00ff><big><B>  "+room_name+"</B></big></font>"));
	...
	parent.r.document.writeln("<script language=javaScript>"); 
        parent.r.document.writeln("function Click(){alert('~看什么看啊?想看先来吼首歌!')\;window.event.returnValue=false\;}  document.oncontextmenu=Click\;");
...
function write_select(name,title,left,top,width,color,array,action)//列表框
{
	...
	while (i < (array.length / 2))
	{
		...
		{
			if (array[i * 2 + 1] == "")
				document.writeln('<OPTION style=color:#FF0055;background-color:#CCFFFF VALUE="">' + array[i * 2] + '</OPTION>');
			else
...
function write_singer_form(left,top,color)//加入麦序管理
{
   if (is_online_manager())
    {
	var ll,bw;
	document.write('<DIV align=left style=width:0px;LEFT:'+left+'px;TOP:'+top+'px;POSITION:absolute>');
	...
	document.write('<option selected style=color:'+color+' VALUE="" >¤-音乐-*-麦序-¤</option>');
...
function writecv()
{
	...
	HTMLstr += ("INPUT{COLOR:"+button_text_color+";FONT-SIZE:9pt;FONT-FAMILY:宋体,SimSun;cursor:hand}");
	HTMLstr += ("BODY{background:"+((voice_bkcolor != "")?voice_bkcolor:parent.r.document.body.bgColor)+((m_fullscreen_bgimage != "")?(" url("+m_fullscreen_bgimage+") fixed}"):"}"));
	HTMLstr += "</style><center><br><br><font face=楷体_GB2312><font size=2 color=#874D01><center><b>QQ：249877567</b></center></font></font><center><br><input type=button name=closev value=打开语音 onclick=\"{parent.writev_new();parent.d.decoratev();}\">";
	HTMLstr += "<br><br><a href=http://chat.yinsha.com/voice.htm target=_blank><span style=' font-size: 9pt; color:#0000FF; text-decoration: none'>说明&测试</span></a></body></html>";
...
function write_make_flower(left,top)//加入自制献花功能
{
	...
	document.write("<form name = \"custom_flower_form\"><font style=color:#FF0055></font>");
	document.write('<input type="text" title="这里是献花的名字" name="fname" style="width:43px" maxlength="8" value = "鲜花">');
	document.write("<font style=color:#FF0055></font>");
...
function writeu1()//重写分屏区
{
	...
	this.u1.document.write("<html><head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=gb2312\"><style type=\"text/css\">.p9 { font-family:宋体; font-size: 11pt; line-height: 21pt};a:hover {color: #FF0055};a:link {  color: #0000FF; text-decoration: none};a:visited { color: #0000FF; text-decoration: none}");
	...
	else
	{
       ...
       if (div_msg1!="") parent.u1.document.write('<p align="left"><font style=filter:glow(color="#red",strength=5);Height:8pt;padding:1px;cursor:hand color=#FFFFFF>'+div_msg1+'</font></p>');
      if (div_msg2!="") parent.u1.document.write('<p align="left"><font style=filter:glow(color="#blue",strength=3);Height:8pt;padding:1px;cursor:hand color=#FFFFFF>'+div_msg2+'</font></p>');
      if (div_msg3!="") parent.u1.document.write('<p align="left"><font color="#FF99FF" size="2" face="宋体"><b>〖'+room_name+'〗公告：</b></font><font color="#blue" size="2" face="宋体">'+div_msg3+'</font></p>');
      if (div_msg4!="") parent.u1.document.write('<p align="left"><font color="#FF99FF" size="2" face="宋体"><b>〖'+room_name+'〗提示：</b></font><font color="#blue" size="2" face="宋体">'+div_msg4+'</font></p>');
...
//-->
for(
i=0; i<screenForm.elements.length; i++
) 
     { 
           obj=screenForm.elements(i);
