...
var room_owner="*☆伯ぺ虎☆";			//室主名称
var room_name="伯虎点秋香";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="*";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2070";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = "<table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://lmang.com/tp/lm.gif><BR><B>  <font color=#009900 size=5></font><font color=#0000FF size=4> </font><font color=#FF00FF size=6> </font><font color=#CC00FF size=4> </font></font></B><font color=#0000FF size=4></font></td><tr><td align=middle><img src=http://pic.liaowan.com/gif/hx.gif></td></tr><tr><td align=middle><marquee scrollamount=1><font color=Olive size=2><b>室主*☆伯ぺ虎☆ 欢迎<font color=Olive><b>〖"+document.inputform.USER.value+"〗</b></font>来到<font color=Olive>★★</font><font color=red>希望你在这里玩的开心！要麦打999，试麦打666</font></marquee></td></tr></table>"; //聊友列表区头部显示
...
var div_msg1 = "『伯虎点秋香 全 体 管 理 员 欢 迎 你』<img src=http://lmang.com/tp/qf2.gif></a>";
var div_msg2 = "【伯虎点秋香】室主: *☆伯ぺ虎☆    欢迎您光临本聊天室...";
var div_msg3 = "本房间是双人视频房间，点击聊友后面的视频图标就可以看到对方的视频";
var div_msg4 = "朋友在你进入聊天室时可能因为网速的不好，而听不到语音，请关了语音重新打开，问题就得到解决";
var div_link = "";
...
(
   0,"在綫主持",        "http://pic.liaowan.com/tb/013.gif",	                "#FF0000","#FFFFFF",	
   1,"执行室主",	"http://pic.liaowan.com/gif/plnvlb1.gif",	                "#000000","#FFFFFF",	
   2,"真情副室",	"http://pic.liaowan.com/tb/009.gif",	"#FF00FF","#FFFFFF", 	
   3,"真情高管",	"http://pic.liaowan.com/tb/031.gif",	                "#993399","#FFFFFF",	
   4,"真情巡管",	"http://pic.liaowan.com/tb/gw.gif",	        "#339933","#FFFFFF",	
   5,"真情管理",	"http://www.y88.info/tp/shi.gif",	                "#0099FF","#FFFFFF",	
   6,"真情贵宾",	"http://pic.liaowan.com/tb/016.gif",	                "#8800FF","#FFFFFF",	
   7,"真情嘉宾",	"http://pic.liaowan.com/tb/016.gif",	                "#8800FF","#FFFFFF",	
   8,"真情客人",	"http://www.y88.info/tp/10.gif",	                "#0033FF","#FFFFFF",
   9,"真情客人",	"http://www.y88.info/tp/10.gif",	                "#0033FF","#FFFFFF"
...
function writecv()//未开语音时的界面
{
	...
	HTMLstr += ("INPUT{COLOR:"+button_text_color+";FONT-SIZE:9pt;FONT-FAMILY:宋体,SimSun;cursor:hand}");
	HTMLstr += ("BODY{background:"+((voice_bkcolor != "")?voice_bkcolor:parent.r.document.body.bgColor)+((m_fullscreen_bgimage != "")?(" url("+m_fullscreen_bgimage+") fixed}"):"}"));
	HTMLstr += "</style><center><br><br><font face=楷体_GB2312><font size=2 color=#874D01><center><u><b>聊湾 伯虎点秋香<br>友情技术支持<br>QQ:275755593</b></u></center></font></font><center><br><input type=button name=closev value=打开语音 onclick=\"{parent.writev_new();parent.d.decoratev();}\">";
