...
var room_owner="*艷児  *疯夜";			//室主名称
var room_name="空间随想";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="*№聊湾∮";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2006";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = " <table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://pic.liaowan.com/sb/2006.gif><BR><tr><td align=middle><img src=http://pic.liaowan.com/gif/hx.gif>"; //聊友列表区头部显示
...
var div_msg4 = "【空间随想】<= 室主*艷児  *疯夜 及全体管理人员欢迎您的到来!本室现阶段招聘有视频,麦音清晰,网时长对房间负责的优秀管理!具体事宜请与在线管理联络.谢谢!";  //通知
var div_link = "";
...
(
	...
	1,	"站长巡管",	"http://free.efile.com.cn/ronnie9951/shi.gif",	"#000000",	"#ffffff",
	2,	"室主",	"http://liren.xiaoyao.com.cn/tu/yg00.gif",	"#ff00ff",	"#ffffff",
          3,	"副室主",	"http://free.efile.com.cn/ronnie9951/11.gif","#F3942E",	"#ffffff",
          4,	"空间秘密管理",	"http://www.wzdu.com/UploadFile/2004121535988453.gif", "#61598a",	"#ffffff",

	5,	"空间管理",            "http://free.efile.com.cn/ronnie9951/111.gif",	 "#AC8c7b",	"#ffffff",
	
	6,	"空间主持",	"0003.gif",	"#34c534",	"#ffffff",
...
// 不可踢马甲
var wudimajia=new Array("*-依-","*艷児","*疯夜","*ミ譆譆",
"*冀人老刀","*小依","*依溪","*老刀～" 
 );  
