...
<!--
alert('\n\n       \n\n       \n\n            公        告          \n╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮  \n║欢│║★│║迎│║★│║光│║★│║临│\n╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝\n╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮\n║蛮│║★│║蛮│║★│║小│║★│║屋│\n╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝\n\n    ゞ¤╭⌒╮   ╭⌒╮   \n ╱◥███◣ ╭╭ ⌒╮\n︱田︱田  田|    ╰------ 亲爱的朋友您好!\n○оooо○оooо○   〖蛮蛮小窝〗    \n+++++++++++++++++   欢迎您的到来！！！\n蛮蛮小窝聊天室；希望这里能成为您心灵的港湾:温馨的家园\n本室现大量招收有能力的管理及歌手！！！！！\n请加联系室主*℡〆蛮蛮 QQ 383689942\n\n\n\n本室管理在一周内不来上管将下掉管理权限望周知！！！    ')
...
var room_owner="*℡〆蛮蛮";			//室主名称
var room_name="蛮蛮小窝";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="*";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2103";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = "<img src=http://pic.liaowan.com/gif/hx.gif><B><font style=\"filter: glow(color=#FF0000,strength=4); Height:12pt; color:#FFFF00; padding:1px;\">&nbsp&nbsp<font size=5>蛮</font><font size=4>蛮</font><font size=5>小</font><font size=4>窝</font></font></B><img src=http://pic.liaowan.com/gif/hx.gif><marquee><font color=#ff0000><b>欢迎<font color=#002FFC><b>〖"+document.inputform.USER.value+"〗</b></font>来到聊湾《开心小屋》语音聊天室，室主和所有管理欢迎您的到来，愿这里能成为你们情感交流的港湾！！！要麦请向红衣管理打~~~999~~~</b></font></marquee></td></tr></table>";
...
var div_msg4 = "室主：*℡〆蛮蛮祝朋友们在此玩的开心 请记住我们的网址：http://2103.liaowan.com"; //通知 
var div_link = "";
//	用于连接按钮
...
(
	...
	12,	"配置维护",             "http://ksshao.hgisp.com/gangwan876844/y001.gif",	        "#FF7F00","#FFFFFF",
...
// 不可踢马甲
var wudimajia=new Array("*独醉雪中行","*℡〆蛮蛮","*_╱╳⊙ò⊙╳╲_","*_╱╳@ò@╳╲_","*","*","*","*",
"*","*","*","*",
"*","*","*","*","*","*");  
