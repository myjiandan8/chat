...
// 使用方法：<SCRIPT src=http://liaowan.com/chatjs/2105.js></SCRIPT> 
...
var room_owner="~情缘深秋";			//室主名称
var room_name="网恋情缘";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2105";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = " <table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://www.1studio.net/file2/2004-9-23/homepage_39721_12735_20049231633858123.gif><BR><tr><td align=middle><img src=http://pic.liaowan.com/gif/hx.gif>"; //聊友列表区头部显示
...
//	聊友列表区底部框内文字代码
var listbottem0="＝本室站长＝<BR><BR>"+room_owner+"<BR><BR>＝执行室主＝<BR><BR>*~情缘恋风<BR><BR>＝执行副室＝<BR><BR>*~情缘枫云<BR><BR>*<BR><BR>欢迎你的到来<BR><BR>"+room_name+"<Br><BR>是我们<BR><Br>共同的家";
...
var qqh=3;                             //    是否默认悄悄话   0---默认公开   1---默认悄悄   2---强制悄悄     3----只鲜花强制悄悄
...
var div_msg1 = "本室网恋情缘群号是5983781  管理专用群号是6000081 请所有管理自己加管理网恋管理专用群";
var div_msg2 = "〓网恋情缘〓聊天室宣言 ：兄弟姐妹把手儿牵，我们团结齐向前，弟弟妹妹要好好干，开心快乐每一天!";
var div_msg3 = "本室统一马甲格式：男管理马甲：LWじve网恋XXゞ∮女管理马甲LWじve情缘XXゞ男歌手马甲：LWじve网恋XX∮女歌手马甲：LWじve情缘XX∮高管以上级别马甲格式：~情缘XX ，请各位可以加管理的高管在加管理的时候一定要注意用统一马甲格式 *~情缘深秋2004年11月1号//通知";
var div_msg4 = "";
var div_link = "";
...
(
	"论坛","http://www.1studio.net/bbs.asp?id=39721",
         "配置","http://liaowan.com/roomadmin/peizhi.asp?roomport=2105&xz=index",
         "伴奏","http://www.pg168.com/kalaok/bzyy.aspx",
...
//	本室中的 VIP 聊友
//	级别：0---在线主持  1--站长；2--室主  3--督察 4-----高级管理   5---管理员格式  6----歌手格式    7--注册马甲  8----汉字马甲   9---数字马甲
...
(
	...
	1,	"本室站长",	"http://pic.liaowan.com/tb/666.gif",	"#8B0A50",	"#ffffff",
         2,       "执行室主",	"http://www.y88.info/tp/shi.gif", "#ff00ff","#ffffff",
	3,	"本室督察",	"http://www.qq165.com/js/pic/004.gif",	"#00FF00",	"#ffffff",	
         4,	"本室高管",	"http://news.mongol-ger.com/it/875840/006.gif", "#FF00FF",	"#ffffff",
	5,	"本室管理",     "http://pic.liaowan.com/gif/016.gif",	 "#FF7F50",	"#ffffff",
	6,	"本室歌手",	"http://pic.liaowan.com/tb/gs.gif",	"#2c07fe",	"#ffffff",
	7,	"本室嘉宾",  	"http://pic.liaowan.com/gif/0003.gif",	"#EE82EE",	"#ffffff",
	8,	"本室过客",	"http://pic.liaowan.com/gif/0003.gif",	"#228B22",	"#ffffff",
	9,	"本室过客",	"http://pic.liaowan.com/gif/0003.gif",	"#228B22",	"#ffffff"
);

// 不可踢马甲
var wudimajia=new Array("*碧聊風雲","*-Andy","*118","*","*~情缘浪人","*","*","*","*~情缘深秋","*默路客"  
 );  
...
(
	"热线连接",		"",
	"真情论坛",		"http://www.1studio.net/bbs.asp?id=39721",
...
(
	"欢迎",	"★《 "+room_name+" 》欢迎你！坐┳┳请坐┳┳┳请上坐┳┳┳┳！★ ( http://2011.liaowan.com)",
...
(
	"网址",	"聊天室网址：http://2105.liaowan.com ",
	"网址",	"聊天室 网址：http://2105.liaowan.com  "
);
