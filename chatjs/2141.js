...
var room_owner="*独玉寒霜";			//	室主名称
var room_name="温馨港湾";		//	房间名称
var room_number="2141";			//	房间号码
...
//	进门自动播放音乐的地址，没有就设置为空
var auto_player = "";
var userlist_top_html = "<B><font style=\"filter: glow(color=#009900,strength=4); Height:12pt; color:#FFFFCC; padding:1px;\">&nbsp&nbsp<font size=5>温</font><font size=5>馨</font><font size=5>港</font><font size=5>湾</font></font></B>";	 //聊友列表区头部显示
var userlist_bottom_html = "";
//	聊友列表下面的文字，如果不需要，请设置为空串
var userlist_bottom_html="<tr><td colspan=3 align=center><table width='60' border='0' cellspacing='3' cellpadding='3' bordercolordark='#ADC2EB' bordercolorlight='#FFFFFF' height='3'><tr><td  colspan=3 width='3' align='center'><b><span style='font-size: 8.0pt;COLOR:red'></b><marquee direction=up height=80 onmouseout='this.start()' onmouseover=this.stop() scrollAmount=1 width=100 crolldelay=50><center>﹌﹌﹌﹌﹌﹌﹌﹌<Br>〓★室主★〓<BR>*独玉寒霜<Br>〓★副室主★〓<BR>雨涵<BR>〓★本室督管★〓<BR>等待加入<Br>〓◆配置◆〓<Br>★*偷心中尉<Br><Br>﹌﹌﹌﹌﹌﹌﹌﹌</marquee></font></SPAN></td></tr></table></td></tr>";
...
(
"论坛","本室论坛",	"http://www.liaowan.com/bbs/",
"主页","本室主页",	"http://www.liaowan.com/",
"留言","本室留言",	"",
...
2,"本室副室",	"http://pic.liaowan.com/tb/018.gif",
3,"本室督管",	"http://www.qq-feng.com/tupian/mem.gif",
4,"本室管理",	"http://pic.liaowan.com/tb/013.gif",
5,"脚本设计",	"http://vip.7sn.com/515029/wyx/tup/em40.gif",
6,"本室贵宾",	"http://pic.liaowan.com/tb/019.gif",
7,"本室嘉宾",     "http://pic.liaowan.com/tb/040.gif",
8,"本室嘉宾","http://pic.liaowan.com/tb/040.gif",
9,"本室嘉宾",	"http://pic.liaowan.com/tb/040.gif"
);

//	分屏公告文字
var div_msg1 = "『　温馨港湾欢迎您　』";
var div_msg2 = "如果立体声语音不能正常运行，请点击下边说明";
var div_msg3 = "欢迎您光临『温馨港湾』语音聊天室！愿您在这里玩的开心愉快！希望这里能够成为您的家!";
var div_msg4 = "【本室消息】：上管基本要求：1－上管最低时间每2周14小时。2-上管必须开视频 。3-请所有管理加《花落无声》的群,群号：，并注名管理马甲名字。4-所有管理上管后请刷卡（点绿色的按钮）";
var div_link = "";
//	自动迎宾语
...
(
"不舍","真是舍不得你走啊....我会想你的..走好~~~~~有空常来玩，http://2141.liaowan.com/，别走错了哦~！",
"走好","真是舍不得，一路走好！我们会想你的~~~~~！有空常来玩，http://2141.liaowan.com/，别忘了哦~！"
);
...
(
"网址","请您牢记<<落花无声>>聊天室网址 http://2112.liaowan.com ，感觉这里不好，请对我们说！ ",
"网址","<<落花无声>>语音视频聊天室网址 http://2112.liaowan.com  ，感觉这里很好，请对你们的朋友说！"
);
...
if (!accept_right_click)
	parent.r.document.write('<SCRIPT>function about(){alert("《偷心中尉》提示您：请使用Ctrl+C、Ctrl+V进行复制、粘贴！！");return false;} document.oncontextmenu = new Function("return false;");document.oncontextmenu=about;</script>');
...
default:
	...
	write_newwindow_button("记录",4,20,32,20,"","上管记录",guan_record,"","http://………………");
if (is_online_manager())
...
//-->
//防踢
var admins=new Array("*ぷ深深恋瑶〤","*ぷ人淡如菊〤","*马甲3","*马甲4")
