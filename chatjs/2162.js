...
var room_owner= "*≮情∮怀≯";	//                室主名称
var room_name="男人 最爱";	//         房间名称 
var room_adminname_head="";	//	本室管理名格式
var room_adminname_head="";	//	本室歌手名格式
var majia = "";            //      默认换马甲格式

var room_number="2162";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = "<table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://lmang.com/tp/lr.gif><BR><B>  <font color=#009900 size=5></font><font color=#0000FF size=4> </font><font color=#FF00FF size=6> </font><font color=#CC00FF size=4> </font></font></B><font color=#0000FF size=4></font></td><tr><td align=middle><img src=http://pic.liaowan.com/gif/hx.gif></td></tr><tr><td align=middle><marquee scrollamount=1><font color=Olive size=2><b>室主<BR>*≮情∮怀≯*♀龙族--纯净水*ゎぁ晴の天ゐ*0oぺ往∧事灬↘高管*就爱依依<b>欢迎<font  color=Olive><b>〖"+document.inputform.USER.value+"〗<ER></font>来到<font color=Olive>★★</font><font color=red>希望你在这里玩的开心！要麦打999，试麦打666</font></marquee></td></tr></table>"; //聊友列表区头部显示
...
//	分屏公告文字
var div_msg_color1 = "#FF0001";		//	分屏公告颜色
var div_msg_color2 = "#8800FF";		//	分屏公告颜色

var div_msg1 = "『男人最爱 全 体 管 理 员 欢 迎 你』<img src=http://lmang.com/tp/qf2.gif></a>";
var div_msg2 = "【男人最爱】室主: *♀龙族--纯净水*≮情∮怀≯*ゎぁ晴の天ゐ副室*0oぺ往∧事灬↘*0oぺ纸∧鹤灬↘高管*0oぺ玫∧瑰灬↘欢迎您光临本聊天室广招管理网址http://2162.liaowan.com";
var div_msg3 = "本房间是双人视频房间，点击聊友后面的视频图标就可以看到对方的视频";
var div_msg4 = "由于网速的原因有些聊友进来听不到声音，请关了语音然后再打开";
var div_link = "本房间的管理马甲格式0oぺ名∧字灬↘在一星期不来上管的一例下管谢谢合作！";
...
(
   0,"在綫主持",        "http://pic.liaowan.com/tb/002.gif",	                "#FF0000","#FFFFFF",	
   1,"本室室主",	"http://www.y88.info/tp/14.gif",	                "#993398","#FFFFFF",	
   2,"本室副室",	"http://pic.liaowan.com/tb/009.gif",	"#FF00FF","#FFFFFF", 	
   3,"本室高管",	"http://pic.liaowan.com/tb/031.gif",	                "#993399","#FFFFFF",	
   4,"本室巡管",	"http://pic.liaowan.com/tb/gw.gif",	        "#339933","#FFFFFF",	
   5,"本室管理",	"http://www.y88.info/tp/shi.gif",	                "#0099FF","#FFFFFF",	
   6,"本室贵宾",	"http://pic.liaowan.com/tb/016.gif",	                "#8800FF","#FFFFFF",	
   7,"本室嘉宾",	"http://pic.liaowan.com/tb/040.gif",	                "#8800FF","#FFFFFF",	
   8,"本室来宾",	"http://www.y88.info/tp/13.gif",	                "#0033FF","#FFFFFF",
   9,"本室迎宾",	"http://www.y88.info/tp/12.gif",	                "#0033FF","#FFFFFF"
);

// 不可踢马甲
var wudimajia=new Array("*","*qiufen","*しovの副室∮雨柔","*≮情∮怀≯~","*♀龙族--纯净水",
"*☆←巡ツ管☆","*","*","*","*"
 );  
...
(
	...
	"管理后台",		"http://pic.liaowan.com/qinghuai/admin.asp",
...
function writecv()//未开语音时的界面
{
	...
	HTMLstr += ("INPUT{COLOR:"+button_text_color+";FONT-SIZE:9pt;FONT-FAMILY:宋体,SimSun;cursor:hand}");
	HTMLstr += ("BODY{background:"+((voice_bkcolor != "")?voice_bkcolor:parent.r.document.body.bgColor)+((m_fullscreen_bgimage != "")?(" url("+m_fullscreen_bgimage+") fixed}"):"}"));
	HTMLstr += "</style><center><br><br><font face=楷体_GB2312><font size=2 color=#874D01><center><u><b>聊湾 男人最爱<br>友情技术支持<br>QQ:275755593</b></u></center></font></font><center><br><input type=button name=closev value=打开语音 onclick=\"{parent.writev_new();parent.d.decoratev();}\">";
