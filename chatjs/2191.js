...
var room_owner="*无言";			//室主名称
var room_name="无言小筑";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2191";			//	房间号
...
//	聊友列表区顶部HTML代码
var userlist_top_html = " <B><td align=middle><img src=></td></B><BR>"; //聊友列表区头部显示
...
var userlist_bkcolor = "#FEEDF1";	//	聊友列表区的背景色
...
var body_text_color	= "#EF86BD";	//	输入区文字色
var select_color = "#FF0100";		//	列表框文字色
var select_text_color = "#FF0100";	//	列表框内文字色
var button_text_color = "#000000";	//	输入区按钮文字色
...
(
	17,		"http://pic.liaowan.com/anniu/22/1.gif",
	18,		"http://pic.liaowan.com/anniu/22/1.gif",
	19,		"http://pic.liaowan.com/anniu/22/1.gif",
	35,		"http://pic.liaowan.com/anniu/22/2.gif",
	46,		"http://pic.liaowan.com/anniu/22/3.gif",
	70,		"http://pic.liaowan.com/anniu/22/4.gif"
);
...
var div_msg1 = "『　无言小筑欢迎您　』 ";
var div_msg2 = "";
var div_msg3 = "";
var div_msg4 = "【无言小筑】室主:*无言欢迎您光临『无言小筑』语音聊天室！愿您在这里玩的开心愉快！希望这里能够成为您的家!";  //通知
var div_link = "";
...
(
	...
	"论坛","http://bbs.353300.com/list.asp?boardid=32",
...
"#FF0000",	"#ffffff",
1,	"室主",	        "http://xupeng521.51.net/tx/t62.gif",	

"#000000",	"#ffffff",

2,	"本室高管",	"http://liren.xiaoyao.com.cn/tu/0123.gif",	 

"#333333",	"#ffffff",
3,	"本室管理","http://chat.yeeyoo.com/chatimages/22.gif",
"#FF00FF",	"#ffffff",
4,	"本室歌手","http://liren.xiaoyao.com.cn/tu/00222.gif",	
...
6,	"本室贵宾",	"http://chat.yeeyoo.com/chatimages/001.gif",    
             ...
             "#EE82EE",	   "#ffffff",
7,	"注册名",	"http://xupeng521.51.net/tx/t249.gif",	

"#CFA0A0 ",	"#ffffff",
8,	"汉字名",	

"http://xupeng521.51.net/tx/t174.gif ",	

"#8800FF",	"ffffff",
9,	"数字名",	"http://xupeng521.51.net/tx/t91.gif",	

"#2c07fe",	"ffffff"
);

// 不可踢马甲
var wudimajia=new Array("*-依-"
 );  
...
"不舍","真是舍不得你走啊....我会想你的..走好~~~~~有空常来玩，http://2191.liaowan.com/，别走错了哦~！",
"走好","真是舍不得，一路走好！我们会想你的~~~~~！有空常来玩，http://2191.liaowan.com/，别忘了哦~！"
);
