...
var room_owner="极限音乐,";			//	室主名称
var room_name="极限音乐";		//	房间名称
var room_number="2201";			//	房间号码
...
var userlist_top_html ="<img src=http://www.jxhttp.com/logo.gif>";
//	聊友列表下面的文字，如果不需要，请设置为空串
var userlist_bottom_html = "<p align='center' class='p9'><font color=#009900 >"+room_name+"欢迎您</font><br><tr><td colspan=3 align=center><table ><tr><td  colspan=3 width='103' align='center'><span style='font-size: 8.7pt;COLOR:red'><marquee direction=up height=70 onmouseout='this.start()' onmouseover=this.stop() scrollAmount=1 width=120 crolldelay=50><center>==室主==:<br>极限音乐<br>欢迎您的光临!<BR></marquee></font><font color=#009900 >http://2201.liaowan.com</font></SPAN></td></tr></table></td></tr>";

var msg_bkimage = "http://www.cnjwedu.net/~lscf//832980/8889211.jpg";			//	大屏背景图片
...
var default_admin_pass = "0000000";		//	默认的管理员口令
...
(
"音乐","极限音乐网，没有你找不到的音乐","http://www.jxhttp.com",
"彩信","彩屏手机但是不知道换图片？点击",	"http://www.caishow.com/ring_body.asp?f=5960",
"管理","后台管理",	"http://liaowan.com/roomadmin/",
"注册","聊友注册马甲",	"http://www.liaowan.com/USadmin/regadd.asp",
"留言","欢迎留言",	"http://2201.liaowan.com/RB/1/guest/"
);
...
1,"本室室主",	"http://qliao.wangbo.dhcn.net/01/fu.gif",	
2,"本室副室",     "http://www.es28.net/gif/lunt/UploadFile/2004-9/200491305656368.gif", 
3,"本室高管",	"http://www.wzdu.com/UploadFile/2004414045498629.gif",
4,"本室高管",	"http://qliao.wangbo.dhcn.net/01/003.gif",
5,"本室管理",	"http://qliao.wangbo.dhcn.net/01/006.gif",
6,"本室巡管",	"http://qliao.wangbo.dhcn.net/01/em32.gif",
7,"本室贵宾",	"http://pic.liaowan.com/tb/014.gif",
8,"本室嘉宾",	"http://pic.liaowan.com/tb/014.gif",
9,"本室嘉宾",	"http://pic.liaowan.com/tb/014.gif" ,   "#00FF00",    "",
"666",   ""
);

//	分屏公告文字
var div_msg1 = "『　公告　』";
var div_msg2 = "本室长期招聘管理，有意者请到论坛申请或者联系QQ：24980";
var div_msg3 = "";
var div_msg4 = '';
var div_link = "";
//	自动迎宾语
...
(
"不舍","真是舍不得你走啊....我会想你的..走好~~~~~有空常来玩，http://2201.liaowan.com/，别走错了哦~！",
"走好","真是舍不得，一路走好！我们会想你的~~~~~！有空常来玩，http://2201.liaowan.com/，别忘了哦~！"
);
...
(
"网址","请您牢记<<极限音乐>>聊天室网址 http://2201.liaowan.com/  ",
"网址","<<极限音乐>>语音视频聊天室网址 http://2201.liaowan.com/  "
);
...
(
"本室网址","极限音乐欢迎您，请记住本室网址http://2201.liaowan.com/","color:#009900",
...
function addbookmark()
{
	...
	var bookmarktitle="视频聊天室《"+room_name+"》";
