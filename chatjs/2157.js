...
var room_owner="*￠玫儿";			//室主名称
var room_name="【野蛮女生】";			//	房间名称
var room_adminname_head="ぺo野蛮→oノ";	//	本室管理名格式
var room_adminname_headg="*№聊湾∮";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2157";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = "<table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://www.y88.info/11/tp/ymns.gif><BR></td><tr><td align=middle><img src=http://pic.liaowan.com/gif/hx.gif></td></tr><tr><td align=middle><marquee scrollamount=1><font color=Olive size=2><b>室主*￠玫儿 执行室主*ミ☆思浓☆ミ 欢迎<font color=Olive><b>〖"+document.inputform.USER.value+"〗</b></font>来到<font color=Olive>★★</font><font color=red>希望你在这里玩的开心！要麦打999，试麦打666</font></marquee></td></tr></table>"; //聊友列表区头部显示
...
var div_msg3 = "欢迎光临聊湾聊天网【"+room_name+"】多视频聊天室～连接多视频请直接点名字后面的《小眼睛》";
var div_msg4 = "【野蛮女生】室主:*￠玫儿 执行室主*ミ☆思浓☆ミ 副室*小竹欢迎您光临本聊天室 因本室的需要现招聘有素质的管理数名  有意者请联系室主或在线管理   申管QQ号(35446729)期待您的参与!!!";  //通知
var div_link = "";
...
(
	...
	2,	"野蛮室主",	"http://web.fs169.net/xiongmaolei/liao/1111.gif",	"#ff00ff",	"#ffffff",
         3,	"野蛮副室",	"http://web.fs169.net/xiongmaolei/liao/fu.gif", "#ff00ff","#ffffff",
         4,	"野蛮高管",	"http://www.wzdu.com/UploadFile/2004121535988453.gif", "#30FF00",	"#ffffff",
	5,	"野蛮主持",     "http://www.wzdu.com/UploadFile/20041215383698798.gif",	 "#00FF0C",	"#ffffff",	
	6,	"野蛮歌手",	"http://web.fs169.net/xiongmaolei/liao/jb.gif",	"#DF2CFF",	"#ffffff",
