...
// 使用方法：<SCRIPT src=http://liaowan.com/chatjs/2169.js></SCRIPT>
...
var room_owner="*子腾工作室";			//室主名称
var room_name="伊甸情缘";			//	房间名称
var room_adminname_head="*";	//	本室管理名格式
var room_adminname_headg="*";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2169";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";
alert('   \n\b       ╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮       \n\b       ║欢│║★│║迎│║★│║光│║★│║临│       \n\b       ╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝   \n\b       ╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮       \n\b       ║伊│║★│║甸│║★│║情│║★│║缘│       \n\b       ╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝\n\n\b\b\b 欢迎您进入『伊甸情缘』，室主：*子腾工作室    \n\n    希望您在这里能够玩的愉快开心！\n\n\b\b\b本聊天室诚招管理,有意者请和室主*子腾工作室 QQ 2689890\n\n\b\b\b考管:*╰☆梦☆╮QQ:270588921\n\n\b\b\b执行室主：*だ☆情缘ю寒风√ QQ 334155278\n\n\b\b\b伊甸情缘是一个温馨浪漫的小屋,愿朋友玩的开心！') 


//	聊友列表区顶部HTML代码
var userlist_top_html = "<table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><b><font color=#009900 size=5>伊</font><font color=#0000FF size=5>甸</font><font color=#FF00FF size=5>情</font><font color=#CC00FF size=5>缘</font></font></B><font color=#0000FF size=5></font></td><tr><td align=middle><img src= http://gudao.512j.com/logo2.gif></td></tr><tr><td align=middle><marquee scrollamount=1><font color=ff0000 size=2><b>欢迎<font color=ff0000><b>〖"+document.inputform.USER.value+"〗</b></font>来到<font color=ff0000>★伊甸情缘★</font><font color=aa00ff>希望这里成为你们开心的乐园,记住我们的约定哦!</font></marquee></td></tr></table>"; //聊友列表区头部显示
...
//	聊友列表区底部框内文字代码
var listbottem0="〓★室主★〓\n\n子腾工作室\n\n执行室主\n\n*だ☆情缘ю寒风√<BR>欢迎你的到来<BR>伊甸情缘<Br>是我们<Br>共同的家";
...
var input_msg_color	= "#0000AA";	//	输入区文字输入框文字色
var input_msg_bkcolor = "#F8F8FF";	//	输入区文字输入框背景色

var body_text_color	= "#0000AA";	//	输入区文字色
var select_color = "#0000AA";		//	列表框文字色
var select_text_color = "#038ffe";	//	列表框内文字色
var button_text_color = "#0000AA";	//	输入区按钮文字色
var button_bk_image	= 1;			//	按钮使用背景图片，1--使用，0--不使用
var button_bk_color = "87CEFA";			//	输入区按钮不使用图片时背景色
...
(
	17,		"http://js.liaowan.com/bj/18.gif",
	18,		"http://js.liaowan.com/bj/18.gif",
	19,		"http://js.liaowan.com/bj/18.gif",
	35,		"http://js.liaowan.com/bj/35.gif",
	46,		"http://js.liaowan.com/bj/46.gif",
	70,		"http://js.liaowan.com/bj/10.gif"
);
...
//	分屏公告文字
var div_msg_color1 = "#OOFFFF";		//	分屏公告颜色
var div_msg_color2 = "#OOFFFF";		//	分屏公告颜色

var div_msg1 = "欢迎光临.本室网址：2169.liaowan.com";
var div_msg2 = "本室管理马甲*だ☆情缘ю男式√ *だ☆情缘♀女式√！";
var div_msg3 = "本室疯狂招收有能力的主持与歌手！有能力者可与室主联系！有管理队伍者优先！";
var div_msg4 = "新来管理必须去论坛看管理守则和发报道贴！管理Q群1111309所有管理必须加"; //通知
var div_link = "歌手马甲格式*oО℃缘樂D☆J名字‰ ！！！";
...
(
	"主页","http://www.duziteng.fangwen.com",
	"伴奏","http://ok.wo99.com/",
	"注册","http://www.liaowan.com/USadmin/regadd.asp",
	"后台","http://www.liaowan.com/roomadmin/",
         "歌词","http://mp3.baidu.com",
         "论坛","http://www.0561888/bbs.com"
        
);

//	本室中的 VIP 聊友
//	级别：0---在线主持  1--室主；2--执行室主  3--贵宾... 4-----房间监察5---房间管理  6----房间高管    7--注册马甲  8----汉字马甲   9---数字马甲
...
(
	0,	"在线主持",		"http://pic.liaowan.com/tb/002.gif",     "#FF0000","#FFFFFF",
         1,	"本室室主",		
         "http://xupeng521.51.net/tx/t103.gif",	        "#7FFF00","#FFFFFF",
	2,	"执行室主",		"http://pic.liaowan.com/tb/028.gif",           "#0000FF","#FFFFFF",
         3,	"本室高管",		"http://xupeng521.51.net/tx/t104.gif",    "#757575","#FFFFFF",
	4,	"本室管理",	
	"http://pic.liaowan.com/tb/007.gif",	"#00BFFF","#FFFFFF",
	5,	"本室歌手",		"http://pic.liaowan.com/tb/gs.gif",	"#AA00ff","#FFFFFF",
	6,	"贵宾",             "http://www.y88.info/tp/shi.gif",	        "#FF7F00","#FFFFFF",
	7,	"本室嘉宾",		"http://pic.liaowan.com/tb/039.gif",	"#0000ff","#FFFFFF",
	8,	"本室过客",		"http://www.y88.info/tp/10.gif",         "#0000ff","#FFFFFF",
	9,	"本室过客",		"http://www.y88.info/tp/17.gif",         "#0000ff","#FFFFFF",
	10,	"(_少鈎鈏ωǒ",		"http://www.y88.info/tp/shi.gif",    "#000000","#FFFFFF",
	11,	"副室",		
         "http://www.y88.info/tp/9.gif",	         "#AA00ff","#FFFFFF",
	12,	"本室监察",             
         "http://www.y88.info/tp/12.gif",	        "#8B0A50","#FFFFFF",
	13,	"本室督察",		"http://www.fengyu.org/pixel/material2/pic105.gif",	"#EE1289","#FFFFFF",
	14,	"音乐小乖々酷",		"http://www.fengyu.org/pixel/material2/pic015.gif",	"#AA00ff","#FFFFFF",
	15,	"本室管理",		"http://www.y88.info/tp/15.gif",    "#757575","#FFFFFF",
...
// 不可踢马甲
var wudimajia=new Array("*子腾工作室","*だ☆情缘ю寒风√","","*","*","*","*","*",
"*","*","*","*","*","*");  
...
(
         "心情驿站",	"http://2102.liaowan.com",
         "雨季心情",	"http://2016.liaowan.com",
...
function writelistbase()//重写聊友列表区
{
	...
	parent.r.document.writeln("<script language=javaScript>"); 
        parent.r.document.writeln("function Click(){alert('小样！不准偷看猫猫洗澡澡！小心宝宝打PP哟！')\;window.event.returnValue=false\;}  document.oncontextmenu=Click\;");
