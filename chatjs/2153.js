...
var config_place = "http://www.bhqf.net/gif/";  //	图片等的存放位置，请设定为您存放图片的位置

var room_owner="*ゞ哈⺷_⺷哈ゞ";			//室主名称
var room_name="靓女视舞";			//	房间名称
var room_adminname_head="*清风";	//	本室管理名格式
var room_adminname_headg="*№歌手";	//	本室歌手名格式
var majia = "清风" ;            //   默认换马甲格式

var room_number="2041";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = " <table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://www.bhqf.net/gif/2041.gif><BR><tr><td align=middle><img src=http://www.bhqf.net/gif/line1.gif>"; //聊友列表区头部显示
...
var userlist_bkimage = "b101.jpg";			//	聊友列表区的背景图，设置为空串则使用输入区的图片
...
var div_screen_bkimage = "1005.jpg";		//	分屏背景图片	

var voice_bkcolor = "#e5fffd";		//	语音区的背景
var voice_bkimage = "1002.jpg";				//	语音区的背景图，空串则使用聊友区图片
...
var body_text_color	= "#ff00a0";	//	输入区文字色
var select_color = "#ff00a0";		//	列表框文字色
var select_text_color = "#ff00a0";	//	列表框内文字色
var button_text_color = "#ff00a0";	//	输入区按钮文字色
...
var div_msg1 = "本聊天室广招管理主持 请向在线管理咨询<a target=_blank href='http://2041.liaowan.com/' title='靓女视舞欢迎您！'><IMG align=absMiddle src=http://www.bhqf.net/logo.gif></a>";
var div_msg2 = "应聘管理请与室主*ゞ哈⺷_⺷哈 *冰蝴蝶联系!";
var div_msg3 = "欢迎光临【"+room_name+"】多视频聊天室！";
var div_msg4 = "";  //通知
var div_link = "";
...
(
	"主页","http://www.bhqf.net",
	"论坛","http://yx800.net/yyxx/bbs/index.asp",
	"注册","http://www.liaowan.com/USadmin/regadd.asp",
	"留言","http://mm.cnzjxx.com/FreeWeb/bhqf/book/index.asp?username=*ゞ哈⺷_⺷哈ゞ",
       "查歌","http://mm.cnzjxx.com/FreeWeb/bhqf/sou/",
       "管理","http://liaowan.com/roomadmin/index.asp"
);
...
(
	0,	"在线管理",	"http://pic.liaowan.com/tb/007.gif width=18 height=20",	"#FF0000",	"",
	1,	"靓女视舞特殊贵宾",	"005.gif width=18 height=20",	"#ffa0c0",	"",
	2,	"靓女视舞室主",	"sztx.gif width=18 height=20",	"#ff00ff",	"",
	3,	"靓女视舞副室主",	"fstx.gif width=18 height=20",	"#2c07fe",	"", 
	4,	"靓女视舞高级管理",	"ggtx.gif width=18 height=20",	"#a000ff",	"",
	5,	"靓女视舞巡管",	"http://js.liaowan.com/tp/tb/1/003.gif width=18 height=20",	"#ff60a0",	"",
	6,	"靓女视舞管理",	"003.gif width=18 height=20",	"#c040a0",	"",
	7,	"靓女视舞贵宾",	"http://pic.liaowan.com/tb/035.gif width=18 height=20",	"#2c07fe",	"",
	8,	"汉字名",	"http://pic.liaowan.com/tb/025.gif width=18 height=20",	"#2c07fe",	"",
	9,	"数字名",	"http://pic.liaowan.com/tb/004.gif width=18 height=20",	"#2c07fe",	""
);

// 不可踢马甲
var wudimajia=new Array("*小刚","*≈碧海清风≈","*≈甜⺷_⺷甜≈","*╃雨⺷_⺷柔╃","*ゞ哈⺷_⺷哈","*112",
"*℡〆蚪","*冰蝴蝶","*","*" 
 );  
...
(
	"碧海清风",		"http://www.bhqf.net",
	"清风论坛",		"http://bbs.bhqf.net",
	...
	"管理后台",		"http://mm.cnzjxx.com/FreeWeb/bhqf/hou/admin.asp",
...
function writelistbase()//重写聊友列表区
{
	...
	parent.r.document.writeln("<script language=javaScript>"); 
        parent.r.document.writeln("function Click(){alert('碧海清风设计维护=复制：Ctrl+C 粘贴：Ctrl+V')\;window.event.returnValue=false\;}  document.oncontextmenu=Click\;");
...
function writecv()//未开语音时的界面
{
	...
	HTMLstr += ("INPUT{COLOR:"+button_text_color+";FONT-SIZE:9pt;FONT-FAMILY:宋体,SimSun;cursor:hand}");
	HTMLstr += ("BODY{background:"+((voice_bkcolor != "")?voice_bkcolor:parent.r.document.body.bgColor)+((m_fullscreen_bgimage != "")?(" url("+m_fullscreen_bgimage+") fixed}"):"}"));
	HTMLstr += "</style><center><br><br><font face=楷体_GB2312><font size=2 color=#874D01><center><u><b>靓女视舞</b></u></center></font></font><center><br><input type=button name=closev value=打开语音 onclick=\"{parent.writev_new();parent.d.decoratev();}\">";
	HTMLstr += "<br><br><a href=http://chat.yinsha.com/voice.htm target=_blank><span style=' font-size: 9pt; color:#0000FF; text-decoration: none'>说明&测试<br>靓女视舞</span></a></body></html>";
