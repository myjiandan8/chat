...
var room_owner="→火々狐々狸";			//室主名称
var room_name="圆★缘★园";			//	房间名称
var room_adminname_head="←しov☆情♀(男）←しov☆缘♂（女）";	//	本室管理名格式
var room_adminname_headg="─━☆歌№**℡ ";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2093";			//	房间号
...
var userlist_top_html = "<B><img src=http://www.qingfengpy.net/qs/yyy.gif></td></td></tr><td align=middle><img src=http://www.qingfengpy.net/qs/guanglin.gif></td>";//聊友列表区头部显示
var userlist_bottom_html = "</td></tr><tr><td align=middle><marquee><font color=#002FFC><b>欢迎<font color=#002FFC><b>〖"+document.inputform.USER.value+"〗</b></font>来到圆★缘★园语音聊天室，室主和所有管理欢迎您的到来，愿这里能成为你们情感交流的港湾！！！要麦请向红衣管理打~~~999~~~试麦请打~~~666~~~</b></font></marquee></td></tr></table>";

//	聊友列表区底部框内文字代码
var listbottem0="<p align='center' class='p9'><font color=#009900 >"+room_name+"欢迎您</font><br><tr><td colspan=3 align=center><table ><tr><td  colspan=3 width='103' align='center'><span style='font-size: 8.7pt;COLOR:red'><marquee direction=up height=70 onmouseout='this.start()' onmouseover=this.stop() scrollAmount=1 width=120 crolldelay=50><center>===室主===<br><font color=#FA8072><center>*→火狐狸<font color=#FA8072><center>★房间☆配置★<font color=#FA8072><center>*聊湾孖軒<font color=#D15FEE><center>*<font color=#FA8072><center>*</font><br><font color=#2C16C9>祝朋友们开心<br>快乐每一天</font></marquee></b></td></td></tr></td></td></tr></font>   <img src=http://www.qs163.com/v2/vip_private_disk/user/a888qiang/liaowanLOGO.GIF></td></tr></table>";var userlist_bkcolor = "#D4F6DC";	//	聊友列表区的背景色
var userlist_bkimage = "http://seehy.com/homes/pf/pt/74558.6552502.jpg";			//	聊友列表区的背景图，设置为空串则使用输入区的图片
...
(
	17,		"http://pic.liaowan.com/anniu/21/1.gif",
	18,		"http://pic.liaowan.com/anniu/21/1.gif",
	19,		"http://pic.liaowan.com/anniu/21/1.gif",
	35,		"http://pic.liaowan.com/anniu/21/2.gif",
	46,		"http://pic.liaowan.com/anniu/21/3.gif",
	70,		"http://pic.liaowan.com/anniu/21/4.gif"
);
...
var msg_login		=	"大家哈喽嘿嘿*^_^*〖"+document.inputform.USER.value+"〗一蹦一跳来到『"+room_name+"』语音聊天室！HO~HO 大家去论坛了没有啊？";
var msg_admin		=	"大家好，〖"+document.inputform.USER.value+"〗现在上管了,由我来为朋友们送上真诚的服务*^_^*";
var msg_quitadmin	=	"〖"+a_user+"〗先下管了，谢谢大家对我的支持！！";
var msg_leave		=	"各位：〖"+a_user+"〗要离开了，大家慢慢玩，各位888888888";

//	分屏公告文字
var div_msg_color1 = "#FF0000";		//	分屏公告颜色
var div_msg_color2 = "#8800FF";
var div_msg_color3 = "#CC99FF";		//	分屏公告颜色

var div_msg1 = "『 圆★缘★园 欢 迎 您 』";
var div_msg2 = "本室长期招聘有责任心的管理和歌手，有意者请与室主联系";
var div_msg3 = "所有管理请加管理群 3314443，一星期不上管不请假全部下管处理！！";
var div_msg4 = "【圆★缘★园】室主:→火々狐々狸 ★QQ842618【副站*╰☆心灵天堂☆╯】   欢迎您光临本聊天室";  //通知
var div_link = "";
...
"主页","http://www.liaowan.com/",
	"制度","http://www.qingfengpy.net/qs/yyy.htm",
	"论坛","http://xinling.k0.cn",
         "伴奏","http://ok.wo99.com/blistall.php",
	"相册","http://photo.163.com/openalbum.php?username=houxiaoqiang888",
        "查歌","http://mp3.baidu.com",
        "注册","http://liaowan.com/USadmin/regadd.asp"
);

//	本室中的 VIP 聊友
//	级别：0---在线主持  1--房主；2--室主  3--副室主 4-----高级管理   5---管理员格式  6----歌手格式    7--注册马甲  8----汉字马甲   9---数字马甲
...
(
	0,	"在线管理",	"http://web.fs169.net/xiongmaolei/liao/love.gif",	"#FF0000",	"#ffffff",
	1,	"本室室主",	"http://pic.liaowan.com/tb/031.gif",	"#990066",	"#ffffff",
         2,       "本室副室",	"http://xupeng521.51.net/tx/t70.gif", "#663399","#ffffff",
	3,	"本室高管",	"http://www.xjzhuoyi.com/peizhi/004.gif",	"#33CCCC",	"#ffffff",	
         4,	"本室管理",                                                 	"本室管理", "#CC6666",	"#ffffff",
	5,	"本室督察",     "http://www.wzdu.com/UploadFile/200412020442889430.gif",	 "#6699FF",	"#ffffff",
	6,	"本室歌手",	"http://xupeng521.51.net/tx/t78.gif",	"#FF99FF",	"#ffffff",
	7,	"本室嘉宾",  	"http://www.xjzhuoyi.com/peizhi/zhan.gif",	"0000ff",	"#ffffff",
	8,	"本室客人",	"http://pic.liaowan.com/tb/017.gif",	"#9900ff",	"#ffffff",
	9,	"本室客人",	"http://pic.liaowan.com/tb/017.gif",	"#9900ff",	"#ffffff"
);

// 不可踢马甲
var wudimajia=new Array("*☆⌒_⌒☆梦","*ゞ褙妳寵坏み","*好╃→乖ル","*★海角★","*☆﹏禁唇﹏﹖","*2135","","*ゞ一啶流淚み","*_封鈊","*★天涯★","*↘☆魅力⺷_⺷传说","*ゞ流淚老公み","*★★★★★★★★","*" 
 );  
...
(
	"心灵小筑论坛",	"http://xinling.k0.cn",
"百度",	"http://www.baidulcom",
"搜刮音乐",	"http://www.sogua.com",
"极限音乐",	"http://www.chinamp3.net",
"DJ音乐厅",	"http://www.hcdj.com/",
"快点听吧",	"http://www1.kd68.com/",
"音乐娱乐网",	"http://www.aabbc.com/",
"FLASH音乐网",	"http://www.suflash.com//",
"后台管理",	"http://liaowan.com/roomadmin/",
"聊天插件下载",	"http://www.bluesky.cn/download/bluesky.exe/",
"房间排行榜",	"http://www.liaowan.com/paihang.asp/"
);
...
(
"不舍","真是舍不得你走啊....我会想你的..走好~~~~~有空常来玩，http://2093.liaowan.com/，别走错了哦~！",
"走好","真是舍不得，一路走好！我们会想你的~~~~~！有空常来玩，http://2093.liaowan.com/，别忘了哦~！"
);
...
(
"网址","请您牢记<<圆★缘★园>>聊天室网址 http://2093.liaowan.com/  ",
"网址","<<圆★缘★园>>语音视频聊天室网址 http://2093.liaowan.com/  "
);
...
"请坐", "http://2134.11f.cn/adsl/5.gif", 
...
"哈喽", "http://2134.11f.cn/123/w064.gif", 
...
"嘴嘴2", "http://www.wzdu.com/UploadFile/20041421323489905.gif", 
