...
var config_place = "http://pic.liaowan.com/bj/2126.jpg";  //	图片等的存放位置，请设定为您存放图片的位置

var room_owner="--月影--";			//室主名称
var room_name="LES-华娱";			//	房间名称
var room_adminname_head="*华娱∮";	//	本室管理名格式
var room_adminname_headg="*∮MUSIC♀";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2126";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = " <table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://pic.liaowan.com/sb/2126.gif><BR><tr><td align=middle><img src=http://pic.liaowan.com/gif/hx.gif>"; //聊友列表区头部显示
...
(
	17,		"http://qcznrs.nease.net/luntan/an/17.gif",
	18,		"http://qcznrs.nease.net/luntan/an/18.gif",
	19,		"http://qcznrs.nease.net/luntan/an/19.gif",
	35,		"http://qcznrs.nease.net/luntan/an/35.gif",
	46,		"http://qcznrs.nease.net/luntan/an/46.gif",
	70,		"http://qcznrs.nease.net/luntan/an/70.gif"
);
...
var msg_login		=	"姐妹们好～，我〖"+a_user+"〗来咯《" + room_name + "》是我们的家~~（本房间是纯女性房间，男士请回避）~";
...
var div_msg1 = "";
var div_msg2 = "";
var div_msg3 = "欢迎光临聊湾聊天网【"+room_name+"】多视频聊天室!";
var div_msg4 = "本房间是纯女性聊天室，男士请回避！！本室室主：*--月影--";  //通知
var div_link = "";
//	用于连接按钮
...
(
	...
	"留言","http://www.touch.sh/gb/gbook.php?user=2126", 
...
(
	0,	"--月影--室主",	"yg.gif",	"#FF0000",	"#ffffff",
	1,	"№1∮巡管",	"0002.gif",	"#000000",	"#ffffff",
	2,	"№1☆9级管理",	"0001.gif",	"#ff00ff",	"#ffffff",
	3,	"华娱∮1级管理",	"0003.gif",	 "#333333",	"#ffffff",
	4,	"华娱∮0级主持",	"0004.gif","#F3942E",	"#ffffff",
	5,	"∮MUSIC♂歌手",	"016.gif",	"#34c534",	"#ffffff",
...
// 不可踢马甲
var wudimajia=new Array("*ぷ月影","*在线维护","","","","",
"*冀人老刀","","*依溪","*老刀～" 
 );  
//——房间走廊,请注意房间号的写法——
