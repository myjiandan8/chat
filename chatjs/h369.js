...
("提示"," 请记注本站网址---情聊 http://www.aliao.net ");
...
HTMLstr += ((userlist_top_html != "")?userlist_top_html:("<big><B><font style=\"filter: glow(color=#009900,strength=4); Height:12pt; color:#FFFFCC; padding:1px;\">&nbsp&nbsp<font size=5>"+room_name+"</font></font></B></big><tr><td align=middle><img src=http://js.aliao.net/sb/lines.gif></td></tr>"));
...
document.inputform.msg.value='[提示]:欢迎光临情聊：http://www.aliao.net';
