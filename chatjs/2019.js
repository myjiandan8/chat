...
var room_owner="*老暴";			//室主名称
var room_name="轻敲三十 ";			//	房间名称
var room_adminname_head="*轻敲╅";	//	本室管理名格式
var room_adminname_headg="*№三十∮";	//	本室歌手名格式
var majia = "三十╅名ぶめ" ;            //   默认换马甲格式

var room_number="2019";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = " <B><td align=middle><img src=http://js.liaowan.com/bj/qqss.gif></td></B><BR>"; //聊友列表区头部显示
...
(
	...
	6,	"本室歌手",	"http://www.xjzhuoyi.com/peizhi/039.gif",	"#2c07fe",	"",
	7,	"注册名",	         "tb/"+txlx_number+"/007.gif ",	"#2c07fe",	"",
	8,	"汉字名",	         "tb/"+txlx_number+"/008.gif ",	"#2c07fe",	"",
	9,	"数字名",	         "tb/"+txlx_number+"/008.gif ",	"#2c07fe",	""
);

// 不可踢马甲
var wudimajia=new Array("*来个","*浅曲","*老暴","*亦芸","*laobao","*xiaoxi",
"*laobao","~","*依溪","*溪" 
 );  
...
(
	...
	"换名","我们的房间不欢迎这样的名字，请您换个名字进来，不然我请您出去换了恍荒暮献? "
);
