...
* 由于作者水平有限,程序难免错漏,如果你在使用过程中发现任何问题,请至信 153251392@qq.com     *
...
var room_owner="*el真亦轩va";			//室主名称
var room_name="X.T.Y.M歌友会";			//	房间名称
var room_adminname_head="*聊湾╅";	//	本室管理名格式
var room_adminname_headg="*№聊湾∮";	//	本室歌手名格式
var majia = "X.T.Y.M╅名ぶめ" ;            //   默认换马甲格式

var room_number="2109";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = " <table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://pic.liaowan.com/sb/gy.gif><BR><tr><td align=middle><img src=http://pic.liaowan.com/gif/hx.gif>"; //聊友列表区头部显示
...
var userlist_bkcolor = "#EFF5FE";	//	聊友列表区的背景色
...
var div_screen_bkcolor = "#EFF5FE";		//	分屏背景色
var div_screen_bkimage = "";		//	分屏背景图片	

var voice_bkcolor = "#EFF5FE";		//	语音区的背景
...
var input_msg_bkcolor = "#EFF5FE";	//	输入区文字输入框背景色
...
var auto_open_div = 0;				//	自动分屏,0——不分屏；1——自动分屏
...
var div_msg_color2 = "#4B0082";		//	分屏公告颜色

var div_msg1 = "本站广招管理主持 请向在线管理咨询<a target=_blank href='http://www.liaowan.com/' title='聊湾欢迎您！'><IMG align=absMiddle src=http://liaowan.com/logo/logo.gif></a>";
var div_msg3 = "欢迎光临聊湾聊天网【"+room_name+"】多视频聊天室!~~有不道之处，欢迎你给我们在留言本里提出你宝贵的意见！！";
var div_msg4 = "本室招聘有责任心强的室主和执行室主各一名，有意者请与QQ79382495联系，谢谢~！";  //通知
var div_link = "";
...
//	本室中的 VIP 聊友
//	级别：0---在线主持  1--室主；2--执行室主  3--副室主... 4-----特殊嘉宾   5---管理员格式  6----歌手格式    7--注册马甲  8----汉字马甲   9---数字马甲
...
(
	0,	"在线管理",	"http://pic.liaowan.com/tb/030.gif",	"#FF0000",	"#ffffff",
	1,	"室主",	"http://pic.liaowan.com/tb/ly.gif",	"#000000",	"#ffffff",
	2,	"执行室主",	"http://pic.liaowan.com/tb/ly.gif",	"#ff00ff",	"#ffffff",
	3,	"副室主",	"http://pic.liaowan.com/tb/ly.gif",	 "#333333",	"#ffffff",
	4,	"特殊嘉宾",	"http://pic.liaowan.com/tb/006.gif","#F3942E",	"#ffffff",
	5,	"管理成员",	"http://pic.liaowan.com/tb/006.gif",	"#34c534",	"#ffffff",
	6,	"本室嘉宾",	"http://pic.liaowan.com/tb/006.gif",                  "#61598a",	   "#ffffff",
	7,	"注册名",	"http://pic.liaowan.com/tb/006.gif",	"#2c07fe",	"#ffffff",
	8,	"汉字名",	"http://pic.liaowan.com/tb/006.gif ",	"#2c07fe",	"#ffffff",
	9,	"数字名",	"http://pic.liaowan.com/tb/006.gif",	"#2c07fe",	""
);
...
(
	"兔兔论坛",	
         "http://www.ttlovecn.com/bbs/index.asp",
	"兔兔论坛",		"http://www.369590.com",
...
(
	...
	"你好","http://pic.liaowan.com/gif/0021.gif", 
         "嗨~","http://www.mypcera.com/photo/65/nature/rests/yeti/6.gif",
    ...
    "唱的太好了",	"http://pic.liaowan.com/gif/jiayou.gif",
   "伴舞1","http://www.mypcera.com/photo/65/culture/art/nautch/5.gif",
    "伴舞2","http://www.mypcera.com/photo/65/culture/art/nautch/2.gif",
    "伴舞3","http://www.mypcera.com/photo/65/culture/art/nautch/28.gif",
    "伴舞4","http://www.mypcera.com/photo/65/culture/art/nautch/35.gif",
    "伴舞5","http://www.mypcera.com/photo/65/culture/art/nautch/33.gif",
    "伴舞6","http://www.mypcera.com/photo/65/culture/art/nautch/38.gif",
    "玫瑰1","http://www.mypcera.com/photo/65/nature/phytum/bloom/1.gif",
