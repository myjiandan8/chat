...
var room_owner="*刀刀";			//室主名称
var room_name="教师之家";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="*";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2208";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = "<table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://www.1230.org/images/1120.gif><BR><B>  <font color=#009900 size=5></font><font color=#0000FF size=4> </font><font color=#FF00FF size=6> </font><font color=#CC00FF size=4> </font></font></B><font color=#0000FF size=4></font></td><tr><td align=middle><img src=http://web.fs169.net/xiongmaolei/2233gif/hx.gif></td></tr><tr><td align=middle><marquee scrollamount=1><font color=Olive size=2><b>室主*刀刀 欢迎<font color=Olive><b>〖"+document.inputform.USER.value+"〗</b></font>来到<font color=Olive>★★</font><font color=red>希望你在这里玩的开心！要麦打999，试麦打666</font></marquee></td></tr></table>"; //聊友列表区头部显示
...
(
	17,		"http://web.fs169.net/xiongmaolei/2233gif/1.gif",
	18,		"http://web.fs169.net/xiongmaolei/2233gif/1.gif",
	19,		"http://web.fs169.net/xiongmaolei/2233gif/1.gif",
	35,		"http://web.fs169.net/xiongmaolei/2233gif/2.gif",
	46,		"http://web.fs169.net/xiongmaolei/2233gif/3.gif",
	70,		"http://web.fs169.net/xiongmaolei/2233gif/4.gif"
);
...
var default_admin_pass = "1230";	//	默认的管理员上管口令
...
var div_msg1 = "<img src=http://www.1230.org/images/1120.gif></a>";
var div_msg2 = "【教师之家】本站聊天室全新开张，申请管理请加QQ3261500";
...
(
	...
	"首页","http://www.1230.org/",
	"注冊","http://www.liaowan.com/USadmin/regadd.asp",
	"论坛","http://www.1230.org/bbs",
        "下载","http://www.1230.org/soft",
        "留言","http://2208.liaowan.com/RB/1/guest//"
);
...
(
   0,"主持",        "http://web.fs169.net/xiongmaolei/2233gif/013.gif",	                "#FF0000","#FFFFFF",	
   1,"室主",	"http://web.fs169.net/xiongmaolei/2233gif/plnvlb1.gif",	                "#000000","#FFFFFF",	
   2,"副室",	"http://web.fs169.net/xiongmaolei/2233gif/009.gif",	"#FF00FF","#FFFFFF", 	
   3,"高管",	"http://web.fs169.net/xiongmaolei/2233gif/031.gif",	                "#993399","#FFFFFF",	
   4,"巡管",	"http://web.fs169.net/xiongmaolei/2233gif/gw.gif",	        "#339933","#FFFFFF",	
   5,"管理",	"http://web.fs169.net/xiongmaolei/2233gif/shi.gif",	                "#0099FF","#FFFFFF",	
   6,"贵宾",	"http://web.fs169.net/xiongmaolei/2233gif/016.gif",	                "#8800FF","#FFFFFF",	
   7,"嘉宾",	"http://web.fs169.net/xiongmaolei/2233gif/016.gif",	                "#8800FF","#FFFFFF",	
   8,"客人",	"http://web.fs169.net/xiongmaolei/2233gif/10.gif",	                "#0033FF","#FFFFFF",
   9,"客人",	"http://web.fs169.net/xiongmaolei/2233gif/10.gif",	                "#0033FF","#FFFFFF"
...
function writelistbase()//重写聊友列表区
{
	...
	parent.r.document.writeln("<script language=javaScript>"); 
        parent.r.document.writeln("function Click(){alert('配置维护:*qiufen QQ:272237978！')\;window.event.returnValue=false\;}  document.oncontextmenu=Click\;");
...
function write_singer_form(left,top,color)//加入麦序管理
{
   if (is_online_manager())
	...
	document.write('<option selected style=color:'+color+' VALUE="" >¤-当前-*-麦序-¤</option>');
...
function writecv()//未开语音时的界面
{
	...
	HTMLstr += ("INPUT{COLOR:"+button_text_color+";FONT-SIZE:9pt;FONT-FAMILY:宋体,SimSun;cursor:hand}");
	HTMLstr += ("BODY{background:"+((voice_bkcolor != "")?voice_bkcolor:parent.r.document.body.bgColor)+((m_fullscreen_bgimage != "")?(" url("+m_fullscreen_bgimage+") fixed}"):"}"));
	HTMLstr += "</style><center><br><br><font face=楷体_GB2312><font size=2 color=#874D01><center><u><b>聊湾聊天网络<br>友情技术支持<br>QQ:275755593</b></u></center></font></font><center><br><input type=button name=closev value=打开语音 onclick=\"{parent.writev_new();parent.d.decoratev();}\">";
