//////////本脚本lwbh1.0由沉默БЁ莫言改编，适用于聊湾房间//////////////2004.9.20/////////
...
var cipdz="http://nj.pwdns.com/js/admin/showadmin.asp" ;    //后台管理地址
enable_auto_log("http://nj.pwdns.com/js/admin/showadmin.asp")

var config_place = "http://nj.pwdns.com/js/";  //	图片等的存放位置，请设定为您存放图片的位置

var room_owner="*flying的感觉";			//室主名称
var room_name="碧落星空";			//	房间名称
var room_adminname_head="じ聊湾主持☆、*じ聊湾主持╬";	//	本室管理名格式
var room_adminname_headg="*じ☆ve樂隊ゞㄨㄨゞ";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2163";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = " <table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://nj.pwdns.com/js/loge001.gif><BR><tr><td align=middle><img src=http://pic.liaowan.com/gif/hx.gif>";  //聊友列表区头部显示
var userlist_bottom_html = "<marquee scrollamount='3' > <font color=ff0000> ╰☆"+room_name+"</font><font color=0000cd>欢迎</font><font color=ff0000>〖"+a_user+"〗</font><font color=0000cd>的到来！要麦向在线管理打</font><font color=ff0000>九九九九九☆╮</font><font color=0000cd>试麦请打</font><font color=ff0000>六六六六六☆╮</font></marquee></a>";
//	聊友列表区底部框内文字代码
var listbottem0="你还记得吗<br>那年你的话<br>你是我一生一世的牵挂<br>你曾含着泪<br>说出这句话<br>你是我<br>一生一世的牵挂<br>岁月磨去了青春的年华<br>你和我<br>被命运分隔天涯<br>心中的感觉<br>却从没变化 你是我<br>一生一世的牵挂<br>我多么牵挂你啊<br>想着你心里痛啊<br>求上天保佑你啊<br>一个人好好过啊<br>我多么牵挂你啊<br>呼唤你听得见吗<br>我只想告诉你啊<br>你是我<br>一生一世的<br>牵挂";
...
var select_color = "#009900";		//	列表框文字色
var select_text_color = "#009900";	//	列表框内文字色
var button_text_color = "#660099";	//	输入区按钮文字色
var button_bk_image	= 0;			//	按钮使用背景图片，1--使用，0--不使用
...
(
	17,"http://nj.pwdns.com/js/btn17.gif",
	18,"http://nj.pwdns.com/js/btn18.gif",
	19,"http://nj.pwdns.com/js/btn19.gif",
	35,"http://nj.pwdns.com/js/btn35.gif",
	46,"http://nj.pwdns.com/js/btn46.gif",
	70,"http://nj.pwdns.com/js/btn70.gif"
);
...
var default_admin_pass = "blxk";	//	默认的管理员上管口令
...
var div_msg2 = "";
var div_msg3 = "";
var div_msg4 = "   欢迎各位光临本室  本室招聘在线管理数名  有意者请联系室主或在线管理或者去论坛发帖申请";//通知
var div_link = "";

//	用于连接按钮
var jilu="http://nj.pwdns.com/js/admin/showadmin.asp";   //刷卡器地址   空时没有

/////6项/////
var a_link_button = new Array
(
	"主页","http://www.blxk.com/",
	"论坛","http://www.tsyl.net/bbs1//Default.asp?id=152",
	"注册","http://www.liaowan.com/USadmin/regadd.asp",
	"电台","http://www.nj998.com/",
        "查歌","http://mp3.baidu.com",
        "相册","http://photo.163.com/openalbum.php?username=chenyu52077"
);
...
(
	0,	"与狼共舞在线管理",	"http://pic.liaowan.com/tb/049.gif ",	"#FF0000",	"FFFFFF",
	1,	"与狼共舞室主",	"http://js.liaowan.com/tp/tb/1/001.gif",
         "#DC143C",        "FFFFFF",
 	2,       "与狼共舞副室",       "http://pic.liaowan.com/tb/009.gif",	"#FF00FF",	"FFFFFF",
	3,	"与狼共舞高级管理",	"http://www.wzdu.com/UploadFile/20041161982466421.gif",	"#FF1493",	"FFFFFF",
	4,	"与狼共舞歌手",	"http://www.wzdu.com/UploadFile/2004116198146060.gif",	"#98FB98",	"FFFFFF",
	5,	"与狼共舞帅哥",	"http://www.wzdu.com/UploadFile/20041161981972329.gif",	"#DE55cc",	"FFFFFF",
	6,	"与狼共舞美眉",	"http://www.wzdu.com/UploadFile/200411319103866583.gif",	"#FF69B4",	"FFFFFF",
	7,	"与狼共舞注册聊友",	         "http://www.wzdu.com/UploadFile/2004116199984394.gif",	"#FB8302",	"FFFFFF",
	8,	"与狼共舞汉字聊友",	         "http://www.wzdu.com/UploadFile/2004116199087979.gif",	"#8800FF",	"FFFFFF",
	9,	"与狼共舞数字聊友",	         "http://www.wzdu.com/UploadFile/200411619133272860.gif",	"#EEE8AA",	"FFFFFF"
);

// 不可踢马甲
var wudimajia=new Array("沉默БЁ莫言" 
 );  
...
(
	"欢迎",	"★《 "+room_name+" 》欢迎你！欢迎你的到来是我们最开心的事( http://"+room_number+".liaowan.com)",
...
function writelistbase()//重写聊友列表区
{
	...
	HTMLstr += "<br><a title='在线朋友名单'><font color=009900> <b>碧落星空在线</font><font color=red><B id='usercount'>0</B></font><font color=009900> 位</b></font></a>";
...
function writecv()//未开语音时的界面
{
	...
	HTMLstr += ("INPUT{COLOR:"+button_text_color+";FONT-SIZE:9pt;FONT-FAMILY:宋体,SimSun;cursor:hand}");
	HTMLstr += ("BODY{background:"+((voice_bkcolor != "")?voice_bkcolor:parent.r.document.body.bgColor)+((m_fullscreen_bgimage != "")?(" url("+m_fullscreen_bgimage+") fixed}"):"}"));
	HTMLstr += "</style><center><br><br><font face=楷体_GB2312><font size=2 color=#874D01><center><u><b>沉默БЁ莫言<br>友情技术支持<br>QQ：6142289</b></u></center></font></font><center><br><input type=button name=closev value=打开语音 onclick=\"{parent.writev_new();parent.d.decoratev();}\">";
...
//本脚本正在完善中 有问题请联系沉默БЁ莫言 6142289提出2004.9.20.
