...
var room_name="疯狂视舞";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="*";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2233";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = "<table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://web.fs169.net/xiongmaolei/2233gif/sw.gif><BR><B>  <font color=#009900 size=5></font><font color=#0000FF size=4> </font><font color=#FF00FF size=6> </font><font color=#CC00FF size=4> </font></font></B><font color=#0000FF size=4></font></td><tr><td align=middle><img src=http://web.fs169.net/xiongmaolei/2233gif/hx.gif></td></tr><tr><td align=middle><marquee scrollamount=1><font color=Olive size=2><b>室主*凉风有信 欢迎<font color=Olive><b>〖"+document.inputform.USER.value+"〗</b></font>来到<font color=Olive>★★</font><font color=red>希望你在这里玩的开心！要麦打999，试麦打666</font></marquee></td></tr></table>"; //聊友列表区头部显示
...
var div_msg1 = "<img src=http://web.fs169.net/xiongmaolei/2233gif/sw.gif></a>";
var div_msg2 = "【疯狂视舞】感谢管理们的辛勤付出,对于优秀的管理可以向凉风有信提出申请聊天室";
...
(
   0,"在綫主持",        "http://web.fs169.net/xiongmaolei/2233gif/013.gif",	                "#FF0000","#FFFFFF",	
   1,"执行室主",	"http://web.fs169.net/xiongmaolei/2233gif/plnvlb1.gif",	                "#000000","#FFFFFF",	
   2,"视舞副室",	"http://web.fs169.net/xiongmaolei/2233gif/009.gif",	"#FF00FF","#FFFFFF", 	
   3,"视舞高管",	"http://web.fs169.net/xiongmaolei/2233gif/031.gif",	                "#993399","#FFFFFF",	
   4,"视舞巡管",	"http://web.fs169.net/xiongmaolei/2233gif/gw.gif",	        "#339933","#FFFFFF",	
   5,"视舞管理",	"http://web.fs169.net/xiongmaolei/2233gif/shi.gif",	                "#0099FF","#FFFFFF",	
   6,"视舞贵宾",	"http://web.fs169.net/xiongmaolei/2233gif/016.gif",	                "#8800FF","#FFFFFF",	
   7,"视舞嘉宾",	"http://web.fs169.net/xiongmaolei/2233gif/016.gif",	                "#8800FF","#FFFFFF",	
   8,"视舞客人",	"http://web.fs169.net/xiongmaolei/2233gif/10.gif",	                "#0033FF","#FFFFFF",
   9,"视舞客人",	"http://web.fs169.net/xiongmaolei/2233gif/10.gif",	                "#0033FF","#FFFFFF"

);

// 不可踢马甲
var wudimajia=new Array("*","*qiufen","*","*~","*",
"*凉风有信","*ˉ￠戀吻","*牵头牛到处跑","*骑着大象的蚊子","*开车撞大树","*9394","*ヾ☆Ｍc尐白№☆じ","*华南一杆红缨枪","*⺌嗯￠哼⺻灬","*メ為你ゞ變乖","*","*","*","*","*","*","*"
 );  
...
function writecv()//未开语音时的界面
{
	...
	HTMLstr += ("INPUT{COLOR:"+button_text_color+";FONT-SIZE:9pt;FONT-FAMILY:宋体,SimSun;cursor:hand}");
	HTMLstr += ("BODY{background:"+((voice_bkcolor != "")?voice_bkcolor:parent.r.document.body.bgColor)+((m_fullscreen_bgimage != "")?(" url("+m_fullscreen_bgimage+") fixed}"):"}"));
	HTMLstr += "</style><center><br><br><font face=楷体_GB2312><font size=2 color=#874D01><center><u><b>聊湾 疯狂视舞<br>友情技术支持<br>QQ:275755593</b></u></center></font></font><center><br><input type=button name=closev value=打开语音 onclick=\"{parent.writev_new();parent.d.decoratev();}\">";
