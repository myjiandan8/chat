...
var room_owner="*℡ぷ真愛⺷_⺷无悔  *℡ぷ真愛⺷_⺷伊人";			//室主名称
var room_name="死神精英 ";			//	房间名称
var room_adminname_head="*";	//	本室管理名格式
var room_adminname_headg="*";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2035";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";
//	聊友列表区顶部HTML代码
var userlist_top_html ="<img src=http://www.xiaohuai.com/822545/pic/shen.gif><br>";//聊友列表区头部显示
...
//	聊友列表区底部框内文字代码
var listbottem0="〓★配置★〓<BR>〓★室主★〓<BR><BR>* *℡ぷ真愛⺷_⺷无悔 *℡ぷ真愛⺷_⺷伊人<BR>"+room_owner+"<BR>欢迎你的到来<BR>"+room_name+"<Br>是我们<Br>共同的家";
var userlist_bkcolor = "#8800FF";	//	聊友列表区的背景色
var userlist_bkimage = "http://liaowan.com/bbs/upload/2004831-201130-wind.jpg";			//	聊友列表区的背景图，设置为空串则使用输入区的图片
...
var div_screen_bkimage = "http://liaowan.com/bbs/upload/2004831-193641-wind.jpg";		//	分屏背景图片	

var voice_bkcolor = "#e5fffd";		//	语音区的背景
var voice_bkimage = "http://www.cnjwedu.net/~lscf//832980/8889211.jpg";				//	语音区的背景图，空串则使用聊友区图片

var input_bkcolor = "#e5fffd";		//	输入区背景色
var input_bkimage = "http://liaowan.com/bbs/upload/2004831-193713-wind.jpg";				//	输入区背景图片
...
var button_text_color = "#006699";	//	输入区按钮文字色
...
(
	...
	70,		"http://pic.liaowan.com/anniu/21/6.gif"
);
...
var div_msg1 = "『   死神精英 　』 祝大家快乐每一天！";
var div_msg2 = "本室室主：*!!太子、";
var div_msg3 = "所有管理请加管理群：4974399，请注名是管理，在群里的管理的QQ名字必须是管理名字，请互相转告!!!";
var div_msg4 = "【死神精英 】室主:*太子欢迎您光临『死神精英』语音聊天室！愿您在这里玩的开心愉快！希望这里能够成为您的家!本室招收管理，特别是夜间管理，有意者请与在线管理及室主联系！一周内不上管自动取消管理马甲，请相互转告！";  //通知
var div_link = "";
...
(
	...
	"电台","http://radio.lwmm.com",
        ...
        "留言","http://lingjian.shixun.net/jlbook/index.asp?user=死神精英总部"
);
...
(
	0,	"在线管理",	"http://web.fs169.net/xiongmaolei/liao/love.gif",	

"#FF0000",	"#ffffff",
1,	"室主",	        "http://qliao.wangbo.dhcn.net/01/fu.gif",	

"#FF8C00",	"#ffffff",

2,	"本室副室",	"http://www.10146.com.cn/ysj/photo/xin.gif",	 

"#333333",	"#ffffff",
3,	"特殊贵宾... ","http://www.wodutom.com/lgz18/0017.gif",
"#FF00FF",	"#ffffff",
4,	"本室高管","http://219.149.64.81/bchat_img/ggtx.gif",	

"#000000",	"#ffffff",
5,	"本室贵宾",	

"http://www.liaowan.com/bbs/upload/2004829-235937-520521.gif",	

"#800000",	"#ffffff",
6,	"本室贵宾",	"http://chat.yeeyoo.com/chatimages/001.gif",    

             "#EE82EE",	   "#ffffff",
7,	"注册名",	"http://daoer.512j.com/peizhi/011.gif",	

"#2c07fe",	"#ffffff",
8,	"汉字名",	

"http://pic.liaowan.com/tb/004.gif ",	

"#228B22",	"",
9,	"数字名",	"http://js.liaowan.com/tp/tb/1/008.gif",	

"#228B22",	""
);

// 不可踢马甲
var wudimajia=new Array("*!!大少"
);  
...
"不舍","真是舍不得你走啊....我会想你的..走好~~~~~有空常来玩，http://2035.liaowan.com/，别走错了哦~！",
"走好","真是舍不得，一路走好！我们会想你的~~~~~！有空常来玩，http://2035.liaowan.com/，别忘了哦~！"
);
...
function writecv()//未开语音时的界面
{
	...
	HTMLstr += ("INPUT{COLOR:"+button_text_color+";FONT-SIZE:9pt;FONT-FAMILY:宋体,SimSun;cursor:hand}");
	HTMLstr += ("BODY{background:"+((voice_bkcolor != "")?voice_bkcolor:parent.r.document.body.bgColor)+((m_fullscreen_bgimage != "")?(" url("+m_fullscreen_bgimage+") fixed}"):"}"));
	HTMLstr += "</style><center><br><br><font face=楷体_GB2312><font size=2 color=#874D01><center><u><b>*!!太子*!!大少<br>友情技术支持<br>QQ：508427</b></u></center></font></font><center><br><input type=button name=closev value=打开语音 onclick=\"{parent.writev_new();parent.d.decoratev();}\">";
