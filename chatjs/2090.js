...
var room_owner="*儸颮噺嫏♂";			//	室主名称
var room_name="红粉佳人";		//	房间名称
var room_number="2090";			//	房间号码

var black_roomname="";			//	双工房间名称
var black_roomnumb="";			//	双工房间号码
alert('   \n\b       ╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮       \n\b       ║欢│║★│║迎│║★│║光│║★│║临│       \n\b       ╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝   \n\b       ╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮       \n\b       ║红│║★│║粉│║★│║佳│║★│║人│       \n\b       ╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝\n\n\b\b\b 欢迎您进入『红粉佳人』，室主：儸颮噺嫏♂     \n\n    希望您在这里能够玩的愉快开心！\n\n\b\b\b 本室欢迎有能力的朋友，加盟本室管理队伍\n\n    有意者请联系执行室主：随风之泪QQ:37118806\n\n\b\b\b\ 希望您在红粉佳人开心快乐，谢谢您的支持！欢迎你的加入！！')

//	图片等的存放位置，所有没有指定完全网址（http://.....）的图片都到此网址下寻找，但不包括下拉列表框。
var config_place = "http://www.wodukom.com/zxg77/tupian/";
//	上管记录地址
var guan_record = "http://";
//	进门自动播放音乐的地址，没有就设置为空
var auto_player = "http://my.6to23.com/liuyue2001/2004/1.wav";
var userlist_top_html = "<table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://www.wodukom.com/zxg77/tupian/yj26.gif><BR><B>&nbsp&nbsp<font color=#009900 size=5>红</font><font color=#0000FF size=4>&nbsp粉</font><font color=#FF00FF size=6>&nbsp佳</font><font color=#CC00FF size=4>&nbsp人</font></font></B><font color=#0000FF size=4></font></td><tr><td align=middle><img src=http://www.wodukom.com/zxg77/tupian/yanjinghengxiantu.gif></td></tr><tr><td align=middle><marquee scrollamount=1><font color=Olive size=2><b>室主随风之泪欢迎<font color=Olive><b>〖"+document.inputform.USER.value+"〗</b></font>来到<font color=Olive>★★</font><font color=red>希望你在这里玩的开心！要麦打999，试麦打666</font></marquee></td></tr></table>"; //聊友列表区头部显示
var userlist_bottom_html = "";
//	聊友列表下面的文字，如果不需要，请设置为空串
var userlist_bottom_html="<tr><td colspan=3 align=center><table width='60' border='7' cellspacing='3' cellpadding='3' bordercolordark='red' bordercolorlight='yellow' height='3'><tr><td  colspan=3 width='3' <align='center'><span style='font-size: 8.7pt;COLOR:red'><marquee direction=up height=70 onmouseout='this.start()' onmouseover=this.stop() scrollAmount=1 width=100 crolldelay=50><center></marquee></font></SPAN></td></tr></table></td></tr>";
...
var button_over_color = "#006699";	//	输入区鼠标覆盖时按钮文字色
...
var btn_pic_18 = "http://www.wodukom.com/zxg77/tupian/c18.gif";		//	18点宽
var btn_pic_35 = "http://www.wodukom.com/zxg77/tupian/c36.gif";		//	34点宽
var btn_pic_45 = "http://www.wodukom.com/zxg77/tupian/c44.gif";		//	44点宽
var btn_pic_60 = "http://www.wodukom.com/zxg77/tupian/c72.gif";		//	60点宽
var btn_pic_72 = "http://www.wodukom.com/zxg77/tupian/c72.gif";		//	70点宽
...
var auto_open_notice = 1;		//	自动打开提示,0不打开；1自动打开
...
(
"论坛","本室论坛",	"http://liaowan.com/bbs",
"主页","本室主页",	"http://www.33cc.net/web/lmylw",
"留言","本室留言",	"http://2090.liaowan.com/RB/1/guest/add.asp",
"搜歌","歌曲搜索",	"http://www.chinamp3.com/search/index.php",
"说明","立体声语音说明",	"http://www.bliao.com/help/help17.htm"
);

//	本室中的 VIP 聊友
//	级别：1室主；2名誉室主；3执行室主；4红粉宝贝；5红粉高管；6红粉佳人；7红粉管理；0、8、9已由内部使用
...
(
0,"在线主持",	"http://web.fs169.net/xiongmaolei/liao/jb.gif",
1,"红粉室主",	"http://liren.xiaoyao.com.cn/tu/yg00.gif",
2,"名誉室主",	"shizhu.gif",
3,"执行室主",	"http://liren.xiaoyao.com.cn/tu/yg00.gif",
4,"本室高管",	"gaoguan.gif",
5,"本室管理",	"http://www.wzdu.com/UploadFile/2004121535988453.gif", 
6,"红粉佳人",	"http://web.fs169.net/xiongmaolei/liao/87383.gif",
7,"红粉贵宾",	"http://www.liaowan.com/bbs/upload/2004827-180723-$$C9$$D9$$C5$$F4.gif",
8,"红粉嘉宾",	"http://js.liaowan.com/js/vip/17.gif",
9,"红粉嘉宾",	"http://js.liaowan.com/js/vip/009.gif"
);

//	分屏公告文字
var div_msg1 = "『　縁分天空美丽的夢〓欢迎您来到红粉佳人　』";
var div_msg2 = "如果立体声语音不能正常运行，请点击下边说明";
var div_msg3 = "欢迎您光临『红粉佳人』语音聊天室！本室全体员工感谢大家支持，本聊室诚聘带薪高级职业主持管理人员，希望天南海北有能力有事业心的朋友积极踊跃应聘，祝福所有光临本室朋友开心快乐，愿您在这里结交天下朋友，畅所欲言！希望这里能够成为您的家";
var div_msg4 = "";
var div_link = "";
//	自动迎宾语
...
(
"网址","请您牢记<<悠悠往事>>聊天室网址 http://2040.liaowan.com ，感觉这里不好，请对我们说！ ",
"网址","<<悠悠往事>>语音视频聊天室网址 http://2040.liaowan.com  ，感觉这里很好，请对你们的朋友说！"
);
...
if (!accept_right_click)
	parent.r.document.write('<SCRIPT>function about(){alert("《成人随想》提示您：请使用Ctrl+C、Ctrl+V进行复制、粘贴！！");return false;} document.oncontextmenu = new Function("return false;");document.oncontextmenu=about;</script>');
...
//	禁止信息
function about(){alert("《成人随想》提示您：请使用Ctrl+C、Ctrl+V进行复制、粘贴！ ");return false;}
