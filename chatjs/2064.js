...
var room_owner="*阿龍";			//室主名称
var room_name="缘分天空";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2064";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = "<table border=0 width=120px cellspacing=0><tr><td align=middle><p align=center><img src=http://www.woduhom.com/claudia9883/ftp/photo/photo/55555.gif></td></tr></table>"; //聊友列表区头部显示
...
(
	17,		"http://www.woduhom.com/claudia9883/ftp/photo/photo/hui18.gif",
	18,		"http://www.woduhom.com/claudia9883/ftp/photo/photo/hui18.gif",
	19,		"http://www.woduhom.com/claudia9883/ftp/photo/photo/hui18.gif",
	35,		"http://www.woduhom.com/claudia9883/ftp/photo/photo/hui35.gif",
	46,		"http://www.woduhom.com/claudia9883/ftp/photo/photo/hui45.gif",
	70,		"http://www.woduhom.com/claudia9883/ftp/photo/photo/hui70.gif"
);
...
var default_admin_pass = "301408";	//	默认的管理员上管口令
...
//	本室中的 VIP 聊友
//	级别：1室主；2聊湾巡管；3贵宾；4高管；5歌手；6管理；0、7、8、9已由内部使用
...
(
0,"在线管理","http://www.woduhom.com/claudia9883/ftp/photo/photo/zhuchi8.gif","red","#FFFFFF",
1,"缘分室主","http://www.woduhom.com/claudia9883/ftp/photo/photo/051.gif","#C1207B","#FFFFFF",
2,"神秘人物","http://www.woduhom.com/claudia9883/ftp/photo/photo/rose.gif","#158953","#FFFFFF",
3,"缘分高层管理","http://www.woduhom.com/claudia9883/ftp/photo/photo/0031.gif","#158953","#FFFFFF",
4,"缘分管理主持","http://www.woduhom.com/claudia9883/ftp/photo/photo/tuzi2015.gif","#AD457C","#FFFFFF",
5,"缘分嘉宾","http://www.woduhom.com/claudia9883/ftp/photo/photo/t481.gif","#D62A2A","#FFFFFF",
6,"特别贵宾","http://www.woduhom.com/claudia9883/ftp/photo/photo/002.gif","red","#FFFFFF",
7,"缘分朋友","http://www.woduhom.com/claudia9883/ftp/photo/photo/003.gif","1458CC","#FFFFFF",
8,"缘分朋友","http://www.woduhom.com/claudia9883/ftp/photo/photo/004.gif","1661E2","#FFFFFF",
9,"缘分朋友","http://www.woduhom.com/claudia9883/ftp/photo/photo/004.gif","196EFF","#FFFFFF"
);

// 不可踢马甲
var wudimajia=new Array("*国际米兰","*絕戀","*","*",
"*冀人老刀","*小依","*依溪","*老刀～" 
 );  
...
var a_wen = new Array
(
	"文明","『缘分天空』提醒**请您文明聊天,注意自己的语言或名称,是和朋友开玩笑请用悄悄话,谢谢合作!!!!! ",
	"文明","『缘分天空』提醒**请您文明聊天,注意自己的语言或名称,是和朋友开玩笑请用悄悄话,谢谢合作!!!!!! "
);
...
function writelistbase()//重写聊友列表区
{
	...
	parent.r.document.writeln("<script language=javaScript>"); 
        parent.r.document.writeln("function Click(){alert('缘分天空设计维护=复制：Ctrl+C 粘贴：Ctrl+V')\;window.event.returnValue=false\;}  document.oncontextmenu=Click\;");
