...
// 使用方法：<SCRIPT src=http://liaowan.com/chatjs/2135.js></SCRIPT> 
...
var room_owner="*Оo︶︵︶oО";   //室主名称
var room_name="浪漫小屋";   // 房间名称
var room_adminname_head=""; // 本室管理名格式
var room_adminname_headg="*─━※樂隊⺷_⌒"; // 本室歌手名格式
var majia = "" ;            //   默认换马甲格式
var room_number="2011";   // 房间号
...
var userlist_top_html = "<B><font style=\"filter: glow(color=#FF0000,strength=4); Height:12pt; color:#fdd242; padding:1px;\">  <font size=5>浪</font> <font size=4>漫</font> <font size=6>小</font> <font size=4>屋</font></font></B></td></tr></table><br><img src=http://js.liaowan.com/bj/lmxw.gif>";//聊友列表区头部显示
...
// 聊友列表区底部框内文字代码
var listbottem0="＝＝室主＝＝<BR><BR>"+room_owner+"<BR><BR>＝＝维护＝＝<BR><BR>逍遥<BR><BR>欢迎你的到来<BR><BR>"+room_name+"<Br><BR>是我们<BR><Br>共同的家";
var userlist_bkcolor = "#e5fffd"; // 聊友列表区的背景色
var userlist_bkimage = "http://www.wzdu.com/UploadFile/200451317162280423.jpg";   // 聊友列表区的背景图，设置为空串则使用输入区的图片
...
var div_screen_bkimage = "http://seehy.com/homes/pf/pt/74558.6552502.jpg";  // 分屏背景图片 
var voice_bkcolor = "#e5fffd";  // 语音区的背景
var voice_bkimage = "http://seehy.com/homes/pf/pt/74558.6552502.jpg";    // 语音区的背景图，空串则使用聊友区图片
var input_bkcolor = "#e5fffd";  // 输入区背景色
var input_bkimage = "http://seehy.com/homes/pf/pt/74558.6552502.jpg";    // 输入区背景图片
...
(
 17,  "http://pic.liaowan.com/anniu/16/1.gif",
 18,  "http://pic.liaowan.com/anniu/16/1.gif",
 19,  "http://pic.liaowan.com/anniu/16/1.gif",
 35,  "http://pic.liaowan.com/anniu/16/2.gif",
 46,  "http://pic.liaowan.com/anniu/16/3.gif",
 70,  "http://pic.liaowan.com/anniu/16/4.gif"
);
...
var div_msg3 = "欢迎光临聊湾聊天网【"+room_name+"】本聊天室长期招收有责任心！在线时间长的优秀管理！有意者请与室主:*~~萧劍QQ:306973310 *Оo︶︵︶oОQQ:309015426，副室_少勾搭ωǒ QQ:75251703或者加管理群6333604实习马甲男管理马甲样子：℡¤实习♂名字女管理马甲样子：℡¤实习♀名字";
var div_msg4 = "【浪漫小屋】室主:*Оo︶︵︶oО*~~萧劍 维护:逍遥。管理每天必须上管3个小时！一周不来或者一周不上管！我会下掉管理马甲以及管理权！希望管理做好自己的工作！大家相互转告！";  //通知
var div_link = "";
// 用于连接按钮
var jilu="http://pic.liaowan.com/houdai/showadmin.as";   //刷卡器地址   空时没有
/////6项/////
var a_link_button = new Array
(
 "主页","http://fayi1125.qs163.com/",
 "论坛","http://2134.11f.cn/bbs/list.asp?boardid=27",
 "注册","http://www.liaowan.com/USadmin/regadd.asp",
 "相册","http://www.qs163.com/v2/photo/?username=fayi1125",
        "上管规定","http://www.qs163.com/v2/story/Read_NO1.Asp?U_ID=fayi1125&ID=228936",
        "管理守则","http://www.qs163.com/v2/story/Read_NO2.Asp?U_ID=fayi1125&ID=228931"
);
// 本室中的 VIP 聊友
// 级别：0---在线主持  1--房主；2--室主  3--副室主 4-----高级管理   5---管理员格式  6----拒泡MM    7--本室贵宾  8----邀请嘉宾   9---数字马甲
...
(
 0, "在线管理", "http://liaowan.com/bbs/upload/2004827-180723-$$C9$$D9$$C5$$F4.gif", "#FF0000", "#ffffff",
 1, "本室最拽人物别点我", "http://cnjwedu.net/~zixuan//tp2/duzhan.gif", "#000000", "#ffffff",
         2,       "室主", "http://www.qq165.com/js/pic/004.gif", "#ff00ff","#ffffff",
 3, "副室", "http://pic.liaowan.com/gif/016.gif", "#9370DB", "#ffffff", 
         4, "情侣", "http://pic.liaowan.com/tb/zxgl.gif", "#a000ff", "#ffffff",
 5, "主持",     "http://pic.liaowan.com/tb/031.gif",  "#00FF7F", "#ffffff",
 6, "拒泡MM", "http://pic.liaowan.com/tb/006.gif", "#2c07fe", "#ffffff",
 7, "本室贵宾", "http://xupeng521.51.net/tx/t50.gif0004.gif", "#EE82EE", "#ffffff",
 8, "过客", "0004.gif", "#228B22", "#ffffff",
 9, "过客", "0004.gif", "#228B22", "#ffffff"
);
// 不可踢马甲
var wudimajia=new Array("*_少勾搭ωǒ","*~~萧劍","*Оo︶︵︶oО","*","*","*逍遥","","*","*","*","*","*" 
 );  
//——房间走廊,请注意房间号的写法——
...
(
 "欢迎", "★《 "+room_name+" 》欢迎你！坐┳┳请坐┳┳┳请上坐┳┳┳┳茶！敬茶！喝茶！烟！请抽烟！★ (欢迎您来到 http://2011.liaowan.com浪漫小屋)",
 "欢迎", "☆"+room_name+"☆欢迎您的光临，愿您在这里玩儿的开心！玩儿的愉快！( http://2011.liaowan.com) ",
 "欢迎", "你好，请坐，请上坐┳━┳━┳ .给您端上热咖啡一杯.免费赠送的哦~~~还有奶茶~！( http://2011.liaowan.com) ",
 "欢迎", "●◢◤◥◣◢◤◥ "+room_name+" ◣◢◣◢◤◥◣聊◢◤◥◣天◢◤◥◣室◢◤◥◣欢◢◤◥◣迎◢◤◥◣您● ( http://2011.liaowan.com) " 
);
//--献花--
...
(
 "不舍","真是舍不得你走啊....我会想你的..走好~~~~~有空常来玩，http://www.2011.liaowan.com，别忘了哦~ ",
 "走好","走好呀，天黑了，留神脚底下。有时间一定再来《浪漫小屋》串串门好吗！！ "
);
//--告辞--
var a_leave = new Array
(
 "想留", "长叹一声,凄婉地说道:▅█拜拜●了█▅一曲离歌泪千行,不知何日再逢君.我这就去了,大家多保重▅█拜拜●了█▅··有红包收吗，有的话，可以再多留三秒······ ",
 "告别", "青山不改，绿水常流，山高水长，后会有期！不用等到江寒月冷日，雪雨风飘时，有缘的你我一定会在《浪漫小屋》再次相会！ "
);
//--答谢--
var a_da = new Array
(
...
(
 "网址", "聊天室网址：http://2011.liaowan.com ",
 "网址", "聊天室 网址：http://2011.liaowan.com  "
);
//--试麦--
var a_shi = new Array
(
...
(
 ...
 "可爱米奇", "http://pic.liaowan.com/gif/jiayou.gif", "管理辛苦","http://pic.liaowan.com/gif/z.gif",
        "爱我就告诉我","http://im.qq.com/face/authed/0/b414.gif",
         "爱情物语","http://www.wzdu.com/UploadFile/200412815164317603.gif",
         "哇","http://liaowan.com/bbs/upload/200493-94543-$$C9$$D9$$C5$$F4.gif",
         "思念","http://liaowan.com/bbs/upload/200492-211742-$$C9$$D9$$C5$$F4.jpg",
         "恋爱物语","http://www.wzdu.com/UploadFile/20048295441820101.jpg",
         "你好可爱","http://www.wzdu.com/UploadFile/20043221923370973.gif",
 "你好","http://pic.liaowan.com/gif/0021.gif",
          "请喝咖啡","http://www.wzdu.com/UploadFile/20041421322135295.gif",
          "送你点心","http://www.wzdu.com/UploadFile/20041421315767870.gif",
 "欢迎光临","http://pic.liaowan.com/gif/-07.gif",
 "我哭啊","http://www.wzdu.com/UploadFile/20041421582392357.gif",
 "请您喝茶",  "http://pic.liaowan.com/gif/j003.gif",
 "请喝咖啡","http://pic.liaowan.com/gif/hkf.gif",
    "恋爱物语","http://www.wzdu.com/UploadFile/2004142215276347.gif",
    "请坐","http://pic.liaowan.com/gif/20_2396_103.gif",
    "伤心了","http://sjlang.51.net/tpkd/003.gif",
    "爱情物语","http://www.wzdu.com/UploadFile/20041281516135643.gif",
    "一帆风顺","http://www.wzdu.com/UploadFile/20041421314882622.gif",
    "我来找你","http://www.wzdu.com/UploadFile/20041281538398381.gif",
    "送你玫瑰","http://www.wzdu.com/UploadFile/200432218582443768.gif",
    "晕倒了","http://www.wzdu.com/UploadFile/20041421584285847.gif",
    "我靓不靓","http://www.wzdu.com/UploadFile/200412611175863597.gif",
    "开车接你","http://www.wzdu.com/UploadFile/200412611234970263.gif",
 "做个好梦", "http://www.wzdu.com/UploadFile/2004322191524682.gif"
);
//--背景色--
...
function writecv()//未开语音时的界面
{
 ...
 HTMLstr += ("INPUT{COLOR:"+button_text_color+";FONT-SIZE:9pt;FONT-FAMILY:宋体,SimSun;cursor:hand}");
 HTMLstr += ("BODY{background:"+((voice_bkcolor != "")?voice_bkcolor:parent.r.document.body.bgColor)+((m_fullscreen_bgimage != "")?(" url("+m_fullscreen_bgimage+") fixed}"):"}"));
 HTMLstr += "</style><center><br><br><font face=楷体_GB2312><font size=2 color=#874D01><center><u><b>_0077<br>友情技术支持<br>QQ：153251392</b></u></center></font></font><center><br><input type=button name=closev value=打开语音 onclick=\"{parent.writev_new();parent.d.decoratev();}\">";
