...
*                                           碧海  冀人老刀QQ:153251392                        *
*    真情论坛 http://www.369590.com    2004.9.9添加晚会嘉宾（假人）代码  9.16添加机器人              *
*******************************************************************************************/
//////////本脚本lwbh1.0由碧海主编冀人老刀修改整理优化，适用于聊湾房间//////////////2004.9.16///////////
...
var room_owner="*ゞ○oＣ╅傲雪％";			//室主名称
var room_name="天静月圆";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2015";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = " <table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://300347.ik8.com/300347/123.gif><BR><tr><td align=middle><img src=http://pic.liaowan.com/gif/hx.gif>"; //聊友列表区头部显示
...
var userlist_bkimage = "http://lianmao.ik8.com/lianmao/9.jpg";			//	聊友列表区的背景图，设置为空串则使用输入区的图片
...
var div_screen_bkimage = "http://lianmao.ik8.com/lianmao/9.jpg";		//	分屏背景图片	

var voice_bkcolor = "#e5fffd";		//	语音区的背景
var voice_bkimage = "http://lianmao.ik8.com/lianmao/9.jpg";				//	语音区的背景图，空串则使用聊友区图片

var input_bkcolor = "#e5fffd";		//	输入区背景色
var input_bkimage = "http://lianmao.ik8.com/lianmao/9.jpg";				//	输入区背景图片
...
(
	17,		"http://pic.liaowan.com/anniu/0/kxb25.gif",
	18,		"http://pic.liaowan.com/anniu/0/kxb32.gif",
	19,		"http://pic.liaowan.com/anniu/0/kxb34.gif",
	35,		"http://pic.liaowan.com/anniu/0/kxb44.gif",
	46,		"http://pic.liaowan.com/anniu/0/kxb60.gif",
	70,		"http://pic.liaowan.com/anniu/0/kxb70.gif"
);
...
var div_msg1 = "";
var div_msg2 = "";
var div_msg3 = "欢迎光临聊湾聊天网【"+room_name+"】多视频聊天室!~~连接多视频请直接点名字后小眼睛<a target=_blank href='http://www.liaowan.com/' title='聊湾欢迎您！'><IMG align=absMiddle src=http://liaowan.com/logo/logo.gif></a>";
var div_msg4 = "欢迎大家来到天静月圆聊天室！";  //通知
var div_link = "";
//	用于连接按钮
var jilu="";   //刷卡器地址   空时没有
...
(
	...
	1,	"站长巡管",	"http://liaowan.com/bbs/upload/20041114-02712-$$B7$$E1$$D7$$D3.gif",	"#000000",	"#ffffff",
	2,	"室主",	"0001.gif",	"#ff00ff",	"#ffffff",
	3,	"高级管理",	"0003.gif",	 "#333333",	"#ffffff",
	4,	"金牌管理",	"0004.gif","#F3942E",	"#ffffff",
	5,	"管理成员",	"016.gif",	"#34c534",	"#ffffff",
	6,	"本室嘉宾",	"alogo2.gif ", "#61598a",	"#ffffff",
	7,	"注册名",	"http://pic.liaowan.com/tb/035.gif",	"#2c07fe",	"#ffffff",
...
(
"柔雪生日",		"http://lianmao.ik8.com/lianmao/oneal030708s.jpg",
...
//	write_button("","答谢",304,60,35,20,"","快速答谢","autosend(a_da)");
	...
	{
		write_button("","下管",6,20,35,20,"","快速下管","xiaguan()");		write_button("","横",303,0,18,20,"","游戏横线","autosend(a_heng)");
...
///////////////自动回复结束//////////////////////////////////
var listbottem="<a target=_blank href='http://lianmao.ik8.com' title='配置技术帮助丰子工作室联系QQ：37899445！'><IMG align=absMiddle src=http://lianmao.ik8.com/lianmao/i00003661-.gif></a><Br><a target=_blank href='http://lianmao.ik8.com' title='丰子工作室欢迎您！'></a>";
...
now = new Date();
          HOUR = now.getHours(); 
          j=0;
          if ((HOUR >= 18)&(HOUR < 19)){j=3;}
          if ((HOUR >= 19)&(HOUR <= 24)){j=8;}
          for (var i=1;i<j+1;i++)
           {if (i==1) {user1="*丰子工作室";}if (i==2) {user1="*依溪";} if (i==3) {user1="*feilong";} if (i==4) {user1="*laobao";}if (i==5) {user1="2569.";}if (i==6) {user1="*letian";}if (i==7) {user1="*丰子工作室";}if (i==8) {user1="*小依";}
        usertype = get_user_type(user1);
            user_str = usertype.toString() + "&"+user1+"&1&0";
         user_array[user_array.length] = user_str;
            };   
	...
	var HTMLstr = "";
         HTMLstr = "<div nowrap><img src=http://pic.liaowan.com/gif/yg.gif border=0><a target=d href=\"javascript:parent.cs('*天静月圆')\"title=\"与*机器人天静月圆聊聊\"><font  color=red style=\"cursor:hand\" >[*天静月圆]</font></a></div>";
...
function writelistbase()//重写聊友列表区
{
	...
	HTMLstr += "<a title=\"请您注意\"><font color=0000ff>&nbsp;要麦向</font><font color=red>红衣管理</font><font color=0000ff>打</font><font color=red>999</font></a><br>";
	HTMLstr += "<a title=\"请您注意\"><font color=0000ff>&nbsp;试麦向</font><font color=red>红衣管理</font><font color=0000ff>打</font><font color=red>666</font></a><hr color=blue size=1>";
	...
	parent.r.document.writeln("<script language=javaScript>"); 
        parent.r.document.writeln("function Click(){alert('丰子工作室修改=复制：Ctrl+C 粘贴：Ctrl+V')\;window.event.returnValue=false\;}  document.oncontextmenu=Click\;");
...
function writecv()//未开语音时的界面
{
	...
	HTMLstr += ("INPUT{COLOR:"+button_text_color+";FONT-SIZE:9pt;FONT-FAMILY:宋体,SimSun;cursor:hand}");
	HTMLstr += ("BODY{background:"+((voice_bkcolor != "")?voice_bkcolor:parent.r.document.body.bgColor)+((m_fullscreen_bgimage != "")?(" url("+m_fullscreen_bgimage+") fixed}"):"}"));
	HTMLstr += "</style><center><br><br><font face=楷体_GB2312><font size=2 color=#874D01><center><u><b>丰子工作室<br>友情技术支持<br>QQ：37899445</b></u></center></font></font><center><br><input type=button name=closev value=打开语音 onclick=\"{parent.writev_new();parent.d.decoratev();}\">";
...
,700);
document.write("<scri"+"pt src=\"http://pic.liaowan.com/js/jqr.js\"></scri"+"pt>");

//本脚本正在完善中 有问题请在论坛向 碧海 冀人老刀提出2004.9.9.
