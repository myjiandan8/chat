...
var room_owner="*国际米兰 *依然";			//室主名称
var room_name="成人随想";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="*№聊湾∮";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="9999";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = "<table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://js.liaowan.com/bj/crsx.gif><BR><B>  <font color=#009900 size=5> </font><font color=#0000FF size=5>   </font><font color=#FF00FF size=5>   </font><font color=#CC00FF size=5>   </font></font></B><font color=#0000FF size=5></font></td><tr><td align=middle><img src= http://www.6see.com/js/001/js/gif/lines02.gif ></td></tr><tr><td align=middle><marquee scrollamount=1><font color=ff0000 size=2><b>欢迎<font color=ff0000><b>〖"+document.inputform.USER.value+"〗</b></font>来到<font color=ff0000>★★</font><font color=aa00ff>希望这里成为你们开心的乐园,记住我们的约定哦!</font></marquee></td></tr></table>"; //聊友列表区头部显示
var userlist_bottom_html = "<p align='center' class='p9'><font color=#009900 >《成人随想》<br>欢 迎 您</font>";
...
var div_msg1 = "欢迎光临成人语音聊天室！";
var div_msg2 = "情聊社区已经开通,点击论坛进去,你会有意想不到的收获!";
var div_msg3 = "";
var div_msg4 = "网站相册已经开通,请朋友进去注册,轻松拥有自己的天空"; //通知
var div_link = "本室长期高素质招聘管理：在线时间长，有责任心，有意者请于在线管理或依然联系QQ：535124！    !维护*‖维护‖蓝天 "; 
...
(
	...
	"留言","http://js.liaowan.com/xinye/index.asp",
        "社区","http://qliao.wangbo.dhcn.net/show.asp?boardid=0",
        "随想","http://www.71mm.com/bbs/list.asp?boardid=14"
);
...
(
	0,	"在线主持",		"http://www.wzdu.com/UploadFile/20049921445730353.gif",     "#FF0000","#FFFFFF",	
	1,	"聊湾巡站",		"http://cctony.jiu8.com/leon/bbs/images/upfile/2004-10/2004107127198.gif",           "#8B0A50","#FFFFFF",
	2,	"随想歌手",		"http://cctony.jiu8.com/leon/bbs/images/upfile/2004-10/2004107128162.gif",	          "#00cd00","#FFFFFF",
	3,	"本室监察",             "http://www.y88.info/tp/shi.gif",	        "#FF7F00","#FFFFFF",
	4,	"本室配置",		"http://cctony.jiu8.com/leon/bbs/images/Emotions/77.gif",	"#8B0A50","#FFFFFF",
	5,	"随想特别嘉宾",		"http://www.wzdu.com/UploadFile/200451312242212676.gif",	"#AA00ff","#FFFFFF",
	6,	"本室管理",		"http://www.wzdu.com/UploadFile/200411319121023993.gif",    "#757575","#FFFFFF",
	7,	"本室嘉宾",		"http://cctony.jiu8.com/leon/bbs/images/upfile/2004-10/2004107128370.gif",	"#0000ff","#FFFFFF",
	8,	"本室过客",		"http://cctony.jiu8.com/leon/bbs/images/upfile/2004-10/2004107128527.gif",         "#0000ff","#FFFFFF",
	9,	"本室过客",		"http://cctony.jiu8.com/leon/bbs/images/upfile/2004-10/2004107128527.gif",         "#0000ff","#FFFFFF",
	10,	"随想壞壞",		"http://www.wzdu.com/UploadFile/200492219591538570.gif",    "#ff00ff","#FFFFFF",
	11,	"执行室主",		"http://www.y88.info/tp/16.gif",	         "#00cd00","#FFFFFF",
	12,	"本室监察",             "http://www.y88.info/tp/shi.gif",	        "#FF7F00","#FFFFFF",
	13,	"随想副室",		"http://pic.liaowan.com/tb/009.gif",	"#EE1289","#FFFFFF",
	14,	"随想歌手总管",		"http://www.wzdu.com/UploadFile/2004513216750260.gif",	"#AA00ff","#FFFFFF",
	15,	"随想高管",		"http://www.wzdu.com/UploadFile/2004530534588214.gif",    "#757575","#FFFFFF",
        16,	"本室过客",		"http://www.y88.info/tp/17.gif",         "#0000ff","#FFFFFF",
	17,	"本室过客",		"http://cctony.jiu8.com/leon/bbs/images/upfile/2004-10/2004107128527.gif",         "#0000ff","#FFFFFF",
	18,	"本室过客",		"http://cctony.jiu8.com/leon/bbs/images/upfile/2004-10/2004107128527.gif",         "#0000ff","#FFFFFF",
	19,	"随想领舞",		"http://www.wzdu.com/UploadFile/20044140451027627.gif",         "#0000ff","#FFFFFF"	   
);

// 不可踢马甲
var wudimajia=new Array("*凉风有信","*‖巡站‖飞龙","*絕戀","*‖巡站‖小依",
"*","*","*絕訫","*‖巡站‖依溪",
"*‖巡站‖老暴","*‖巡站‖有点病","*‖巡站‖野猫","*依然","*骑着大象的蚊子","*⑨③⑨④");  
...
function writelistbase()//重写聊友列表区
{
	...
	HTMLstr += "<tr><td colspan=3 align=center><table width='60' border='7' cellspacing='3' cellpadding='3' bordercolordark='red' bordercolorlight='yellow' height='3'><tr><td  colspan=3 width='3' align='center'><span style='font-size: 8.7pt;COLOR:red'><marquee direction=up height=70 onmouseout='this.start()' onmouseover=this.stop() scrollAmount=1 width=100 crolldelay=50><center>〓★室主★〓<BR>*依然<BR>〓★副室主★〓<BR>*空缺<Br>〓◆配置◆〓<Br>*小小东<Br>〓◆联系◆〓<Br>252244095</marquee></font></SPAN></td></tr></table></td></tr>";
...
window.parent.document.body.onbeforeunload=myfunction;
function myfunction(){
window.open('http://2042.liaowan.com') 
}
