/***********************************聊湾聊天室配置lwbh1.0版**************************** * 本配置脚本收集于各聊室脚本程序,主要参考了旨梦.寒江.只易.热炕头及些不知名作者的脚本程序. * * 重新修改整理,对代码进行了精简合理化,力求达到程序运行稳定快速而不失实用功能和美观界面 本版本新增加了多个视频功能 * * 由于作者水平有限,程序难免错漏,如果你在使用过程中发现任何问题,请至信153251392@qq.com * * 本配置版权属真情论坛,你可以随意使用和传播.如用于商业用途请和作者联系 * * 在此特别感谢以上脚本作者,如有冒犯之处,还请见凉 * * 碧海 冀人老刀QQ:153251392 * * 真情论坛 http://www.369590.com 2004.9.5修正 便衣马甲代码 * *******************************************************************************************/ //////////本脚本lwbh1.0由碧海改编，适用于聊湾房间//////////////2004.8.31/////////// // 
...
var config_place = "http://njxiang.02835.com/";  //	图片等的存放位置，请设定为您存放图片的位置

var room_owner="*微苦的甜点";			//室主名称
var room_name="*《爱情实验室》*";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="*№聊湾∮";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2132";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

var userlist_top_html = "<B><font style=\"filter: glow(color=#009900,strength=4); Height:12pt; color:#FFFFCC; padding:1px;\">  <font size=5>欢</font><font size=5>迎</font><font size=5>光</font><font size=5>临</font></font></B></td></tr></table>";//聊友列表区头部显示
...
var div_msg4 = "【爱情实验室】<= 站长*微苦的甜点 *灞滊←海蓝 助理*聊湾我最不要脸 室主*天使←笨笨 *℡◇浪漫┅ 及全体管理人员欢迎您的到来!本室现阶段招聘有视频,麦音清晰,网时长对房间负责的优秀管理!具体事宜请与在线管理联络.谢谢!";  //通知
var div_link = "";
...
(
	"后台","http://www.liaowan.com/roomadmin",
         ...
         "人气排行","http://www.liaowan.com/paihang.asp",
	"歌站","http://liaowan.com/bbs/index.asp",
	"有缘之地","http://yuandi.com/index.html",
	"留言本","http://yuandi.com/lyb6/index.asp?user=爱情实验室",
);
...
//--聊友说明，在此修改聊友名字的颜色--   （0到19）
var a_usertitle = new Array
(0,"本室主持","http://njxiang.02835.com/nj-555zhuchi.gif width=20 high=20","#FFc2e","#FFFFFF",
1,"室主","http://219.149.64.81/bchat_img/sztx.gif",  "#FF00ff","#FFFFFF",
2,"副室主","http://js.205449.com/pic/53.gif",     "#FF00ff",        "#FFFFFF",
3,"本室最牛B人物，没事勿扰","http://yiefeng.cliao.com/bliaoroom/bpz/js.gif",   "#970097","#FFFFFF",
4,"本室高管","http://219.149.64.81/bchat_img/ggtx.gif",   "#009900","#FFFFFF",
5,"本室管理","http://js.205449.com/pic/19.gif","#009900","#FFFFFF",
6,"聊湾最牛B家族","http://js.205449.com/pic/11.gif","#0033FF","#FFFFFF",
7,"贵宾","nj-555guibin.gif",   "#9B30FF","",
8,"嘉宾","nj-555jiabin.gif",   "#9B30FF","",
9,"嘉宾","nj-555jiabin.gif",   "#0000FF","",
10,"本室站长,","http://317323.ie-china.com/UploadFile/2004-6/200462001719572.gif",	"#FF00FF","#FFFFFF",
11,"代理室主,","http://219.149.64.81/bchat_img/gif.gif width=22 high=0",	"#0000ff","#ffffff",
12,"优秀高管","http://219.149.64.81/bchat_img/txa.gif width=20 high=0",   "#9900ff","#FFFFFF",
13,"本室副室主","http://219.149.64.81/bchat/admin/upload/20047130044.jpg width=20 high=0",   "#9900ff","#FFFFFF",
14,"星级主持，在线上管时长","http://219.149.64.81/bchat_img/guanli.gif width=28 high=0",  "#1E90FF","#FFFFFF",
15,"优秀高管,","http://219.149.64.81/js/317323/gg.gif width=20 high=0",   "#0000FF","#FFFFFF",
16,"爱情高管","http://219.149.64.81/js/317323/gg.gif","#ff00ff","#FFFFFF",
17,"家族成员","http://219.149.64.81/bchat/admin/upload/200442903304.gif","#ff00ff","#FFFFFF",
18,"爱情歌手","http://219.149.64.81/bchat/admin/upload/200442903343.gif",   "#0000FF","#FFFFFF",
19,"本室最牛B人物，没事勿扰","http://219.149.64.81/bchat/admin/upload/20047121648.gif width=21 high=0",   "#1E90FF","#FFFFFF"
);

// 不可踢马甲
var wudimajia=new Array("*","*","*☆","",
"*微苦的甜点","*灞滊←海蓝","*2135","*聊湾我最不要脸" 
 );  
...
(
	"要麦",	"管理给我排个麦序9999999999999999999999999999999",
	"唱歌",	"要麦啦:九酒久0+9.8+1.7+2.6+3.5+4.4+5.3+6.2+7.1+8.0+9"
         "唱歌",	"管理我要唱歌9999999999999999999999999999999"
);

//--听见--
var a_heart = new Array
(          
	"听见",	"1111111111111111111您的麦好清楚啊"
         "听见",	"||||||||||||听见了您的声音真动人",
	"听见",	"|||||||||||||||||||||||||好美丽的声音"
);
...
function add_new_element()//加入新的界面元素
{
	...
	else
	{
		...
		write_button("","上管",6,20,35,20,"","快速上管","guan()");
              write_button("","试麦",517,39,35,20,"","试麦","autosend(a_shi)");
              write_button("","答谢",482,39,35,20,"","搅拌","autosend(a_dai)");
	       write_button("","答谢",568,39,18,20,"","快速答谢","autosend(a_da)");
		write_button("reauto","自答",552,39,35,20,"","不在自动答复","reauto()");
...
function writelistbase()//重写聊友列表区
{
	...
	parent.r.document.writeln("<script language=javaScript>"); 
        parent.r.document.writeln("function Click(){alert('聊湾=复制：Ctrl+C 粘贴：Ctrl+V')\;window.event.returnValue=false\;}  document.oncontextmenu=Click\;");
