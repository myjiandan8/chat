...
var config_place = "http://wxc.ik8.com/wxc/";  //	图片等的存放位置，请设定为您存放图片的位置

var room_owner="*【顠流】";			//室主名称
var room_name="“E”網情缘";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="*";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2149";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = "<img src=http://pic.liaowan.com/gif/hx.gif><B><font style=\"filter: glow(color=#FF0000,strength=4); Height:12pt; color:#FFFF00; padding:1px;\">&nbsp&nbsp<font size=5>“E”</font><font size=4>網</font><font size=5>情</font><font size=4>缘</font></font></B><img src=http://pic.liaowan.com/gif/hx.gif><marquee><font color=#ff0000><b>欢迎<font color=#002FFC><b>〖"+document.inputform.USER.value+"〗</b></font>来到聊湾《开心小屋》语音聊天室，室主和所有管理欢迎您的到来，愿这里能成为你们情感交流的港湾！！！要麦请向红衣管理打~~~999~~~</b></font></marquee></td></tr></table>";
...
var default_admin_pass = "2149";	//	默认的管理员上管口令
...
var div_msg4 = "室主：*【顠流】祝朋友们在此玩的开心 请记住我们的网址：http://2149.liaowan.com"; //通知 
var div_link = "";
//	用于连接按钮
...
(
	...
	5,	"本室管理",		"http://pic.liaowan.com/tb/031.gif",	"#ff66ff","#FFFFFF",
...
// 不可踢马甲
var wudimajia=new Array("*独醉雪中行","*","*【顠流】","*ωǒ拖个┯┯等mm","*","*","*","*",
"*","*","*","*",
"*","*","*","*","*","*");  
...
var listbottem="<tr><td colspan=3 align=center><table width='126' border='1' cellspacing='1' cellpadding='1' bordercolordark='#ff66ff' bordercolorlight='#FFFFFF' height='15'><tr><td  colspan=3 width='130' align='center'><span style='font-size: 8.7pt;COLOR:#FF00FF'><marquee direction=up height=70 onmouseout='this.start()' onmouseover=this.stop() scrollAmount=1 width=130 crolldelay=80><center>〓★本室室主★〓<BR>*【漂流】<BR>〓★本室副室★〓<BR>*【菲児】<BR>〓★本室高管★〓<BR>*【雨夢】<BR>〓★本室高管★〓<BR>*【淸揚】<BR>〓★配置维护★〓<BR>*独醉雪中行<BR>祝朋友们<BR>玩得开心！玩得愉快！<br><BR</marquee></font></SPAN></td></tr></table></td></tr>";
