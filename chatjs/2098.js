...
var room_owner="*情飞扬";			//	室主名称
var room_name="秋枫谷";		//	房间名称
var room_number="2098";			//	房间号码
...
var userlist_top_html = " <table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://lmang.com/ja/qf.gif><BR><tr><td align=middle><img src=http://www.6see.com/js/001/js/gif/lines02.gif>";
//	聊友列表下面的文字，如果不需要，请设置为空串
var userlist_bottom_html ="<font color<DIV ZD=divl><H4><marquee direction=up scrollamount=1.7 height=200 scoolldelay=10><center><strong><BR><FONT color<font color='#FF00FF' face='Arial'>秋枫谷<br><br><br><table border=5 width=135px cellspacing=5><tr><td align=middle class='p9'><font color=#0000ff >秋枫室主<BR><font color=#FF00FF>*情飞扬<BR><font color=#0000ff>本室副室<BR><font color=#FF00FF><BR><font color=#0000ff>本室高管<BR><font color=#FF00FF><BR></i></streng></marquee></H2></DIV></FONT><b </body></td></tr></table>";

var msg_bkimage = "http://lmang.com/tp/fy.gif";			//	大屏背景图片
...
(
	...
	1,	"秋枫族长欢迎您的到来",      "http://sqc.xinzhiwang.com/webpage/hy7425/10.jpg",
	...
	4,	"本室高管愿您玩的愉快",	 "http://www.wzdu.com/UploadFile/2004414045498629.gif",
        5,	"秋枫家族是您温暧的家",      "http://pic.liaowan.com/tb/032.gif",
	6,	"特邀嘉宾",      "http://www.cnjwedu.net/~zhaoyun//bj/0018.gif",
	7,      "秋枫谷是俺永远的家",      "http://pic.liaowan.com/tb/035.gif",
...
//	分屏公告文字
var div_msg1 = "『　公告　』";
var div_msg2 = "本房间是集唱歌，朗读，话题及午夜场为一体的房间，祝大家玩的开心。";
var div_msg3 = "<IMG align=absMiddle src=http://www.lmang.com/tp/qf2.gif></a>";
var div_msg4 = '';
var div_link = "";
//	自动迎宾语
...
(
"浪漫舞厅",	"http://2070.liaowan.com",
"真情庄园",	"http://2052.liaowan.com",
"那天你的样子",	"http://2075.liaowan.com",
"男人最爱",       "http://2162.liaowan.com",
"情人面对面",	"http://2069.liaowan.com"
...
(
"不舍","真是舍不得你走啊....我会想你的..走好~~~~~有空常来玩，http://2098.liaowan.com/，别走错了哦~！",
"走好","真是舍不得，一路走好！我们会想你的~~~~~！有空常来玩，http://2098.liaowan.com/，别忘了哦~！"
);
...
(
"网址","请您牢记<<秋枫小屋>>聊天室网址 http://2098.liaowan.com/  ",
"网址","<<秋枫小屋>>语音视频聊天室网址 http://2098.liaowan.com/  "
);
...
(
"本室网址","秋枫谷欢迎您，请记住本室网址http://2098.liaowan.com/","color:#009900",
...
"秋枫一吻","http://219.149.64.81/bchat_img/1-02.gif",
...
if (is_online_manager())
{
	...
	write_autosend_button("网址",269,80,35,20,"","秋枫网址","a_address");
	...
	write_select("picture","秋枫图片",479,60,72,"FF0000",a_picture,"play_pic(this)");
	write_select("linkroom","秋枫走廊",533,60,72,"FF0000",a_roomlink,"gotolinkroom(this)");
	write_select("playemote","秋枫表情",479,80,72,"FF0000",a_emote,"send_selection_msg(this)");
	write_select("linkurl","秋枫链接",533,80,72,"FF0000",a_linkurl,"gotolinkurl(this)");
