...
var room_owner="*戀芯";			//	室主名称
var room_name="那天你的样子、、";		//	房间名称
var room_number="2075";			//	房间号码
...
var userlist_top_html = " <table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://www.lmang.com/ja/la.gif><BR><tr><td align=middle><img src=http://www.bhqf.net/gif/line1.gif>"; //聊友列表区头部显示
//	聊友列表下面的文字，如果不需要，请设置为空串
var userlist_bottom_html ="<font color<DIV ZD=divl><H4><marquee direction=up scrollamount=1.7 height=200 scoolldelay=10><center><strong><BR><FONT color<font color='#FF00FF' face='Arial'>〈那天你的样子、、〉<br><br><br><table border=5 width=135px cellspacing=5><tr><td align=middle class='p9'><font color=#0000ff >碧海室主<BR><font color=#FF00FF>*戀芯<BR><font color=#0000ff>本室副室<BR><font color=#FF00FF>*戒戀<BR><font color=#0000ff>本室高管<BR><font color=#FF00FF>*<BR></i></streng></marquee></H2></DIV></FONT><b </body></td></tr></table>";

var msg_bkimage = "http://lmang.com/tp/bh.gif";			//	大屏背景图片
...
(
"主页","秋枫主页","http://www.lmang.com",
"论坛","秋枫论坛",	"http://lmang.com/qfbs",
...
(
	...
	1,	"真情族长欢迎您的到来",      "http://sqc.xinzhiwang.com/webpage/hy7425/10.jpg",
	2,	"本室室主祝您玩的开心",	 "http://www.cnjwedu.net/~zhaoyun//bj/301.gif",
	3,	"本室副室愿您一生开心",	 "http://asp.6to23.com/lanben0753/001/1114.gif",
	4,	"本室高管愿您玩的愉快",	 "http://www.wzdu.com/UploadFile/2004414045498629.gif",
        5,	"真情家族是您温暧的家",      "http://pic.liaowan.com/tb/032.gif",
	6,	"特邀嘉宾",      "http://www.cnjwedu.net/~zhaoyun//bj/0018.gif",
	7,      "那天你的样子、、是俺永远的家",      "http://pic.liaowan.com/tb/035.gif",
...
//	分屏公告文字
var div_msg1 = "『　公告　』";
var div_msg2 = "本房间是集唱歌，朗读，话题及午夜场为一体的房间，祝大家玩的开心<IMG align=absMiddle src=http://www.lmang.com/tp/qf2.gif></a>";
var div_msg3 = "";
var div_msg4 = '';
var div_link = "";
//	自动迎宾语
...
(
"真情清角",	"http://2101.liaowan.com",
"真情快乐",	"http://2151.liaowan.com",
...
(
"不舍","真是舍不得你走啊....我会想你的..走好~~~~~有空常来玩，http://2075.liaowan.com/，别走错了哦~！",
"走好","真是舍不得，一路走好！我们会想你的~~~~~！有空常来玩，http://2075.liaowan.com/，别忘了哦~！"
);
...
(
"网址","请您牢记<<那天你的样子、、>>聊天室网址 http://2075.liaowan.com/  ",
"网址","<<那天你的样子、、>>语音视频聊天室网址 http://2075.liaowan.com/  "
);
...
(
"本室网址","真情庄园欢迎您，请记住本室网址http://2075.liaowan.com/","color:#009900",
...
"真情一吻","http://219.149.64.81/bchat_img/1-02.gif",
...
if (is_online_manager())
{
	...
	write_autosend_button("网址",269,80,35,20,"","蓝天网址","a_address");
	...
	write_select("picture","蓝天图片",479,60,72,"FF0000",a_picture,"play_pic(this)");
	write_select("linkroom","蓝天走廊",533,60,72,"FF0000",a_roomlink,"gotolinkroom(this)");
	write_select("playemote","蓝天表情",479,80,72,"FF0000",a_emote,"send_selection_msg(this)");
	write_select("linkurl","蓝天链接",533,80,72,"FF0000",a_linkurl,"gotolinkurl(this)");
