...
var room_owner="*-伊ツ人-    *灵魂§雨妖";			//	室主名称
var room_name="";		//	房间名称
var room_number="726457";			//	房间号码
...
//	进门自动播放音乐的地址，没有就设置为空
var auto_player = "";
var userlist_top_html = "<B><font style=\"filter: glow(color=#009900,strength=4); Height:12pt; color:#FFFFCC; padding:1px;\">&nbsp&nbsp<font size=5>灵</font><font size=5>魂</font><font size=5>深</font><font size=5>处</font></font></B>";	 //聊友列表区头部显示
var userlist_bottom_html = "";
//	聊友列表下面的文字，如果不需要，请设置为空串
var userlist_bottom_html="<tr><td colspan=3 align=center><table width='60' border='0' cellspacing='3' cellpadding='3' bordercolordark='#ADC2EB' bordercolorlight='#FFFFFF' height='3'><tr><td  colspan=3 width='3' align='center'><b><span style='font-size: 8.0pt;COLOR:red'></b><marquee direction=up height=80 onmouseout='this.start()' onmouseover=this.stop() scrollAmount=1 width=100 crolldelay=50><center>﹌﹌﹌﹌﹌﹌﹌﹌<Br>〓★室主★〓<BR>*-伊ツ人-<BR>〓★室主★〓<BR>*灵魂§雨妖<Br>〓★执行室主★〓<BR>*@冬天的海@<BR>〓◆技术维护◆〓<Br>★*绝对好T<Br><Br>﹌﹌﹌﹌﹌﹌﹌﹌</marquee></font></SPAN></td></tr></table></td></tr>";

var msg_bkimage = "http://liaowan.com/bbs/upload/200498-113757-$$B4$$BD.jpg";			//	大屏背景图片
...
(
"论坛","本室论坛",	"http://www.xnidc.com/bbs/list.asp?boardid=74",
"音乐","在线听歌",	"http://www.dj99.com",
"留言","本室留言",	"http://www.xnidc.com/jb/znlx/index.asp ",
"管理","本室加管",	"http://admin.bliao.com/admin/s_admintor.php",
"管则","管理条例",	"http://www.xnidc.com/bbs/dispbbs.asp?boardID=74&ID=8458"
);

//	本室中的 VIP 聊友
//	级别：1本室室主；2执行室主；3技术维护；4九级高管；5正式管理；6实习管理；0、7、8、9已由内部使用
...
(
0,"正在管理",	"http://pic.liaowan.com/tb/049.gif",
1,"本室室主",	"http://pic.liaowan.com/tb/019.gif",
2,"执行室主",	"http://pic.liaowan.com/tb/018.gif",
3,"技术维护",	"http://www.qq-feng.com/tupian/mem.gif",
4,"九级高管",	"http://pic.liaowan.com/tb/013.gif",
5,"正式管理",	"http://vip.7sn.com/515029/wyx/tup/em40.gif",
6,"实习管理",	"http://pic.liaowan.com/tb/019.gif",
7,"注册聊友",      "http://pic.liaowan.com/tb/040.gif",
8,"非注册聊友",      "http://www.52les.com/277783/chat/004.gif",
9,"非注册聊友",	"http://www.52les.com/277783/chat/004.gif"
);

//	分屏公告文字
var div_msg1 = "『　爱在灵魂深处中年女性聊天室欢迎您　』";
var div_msg2 = "如果立体声语音不能正常运行，请点击下边说明";
var div_msg3 = "欢迎您光临『爱在灵魂深处中年女性』语音聊天室！愿您在这里玩的开心愉快！希望这里能够成为您的家!";
var div_msg4 = "【本室消息】：上管基本要求：1－上管最低时间每2周14小时。2-上管必须开麦。";
var div_link = "";
//	自动迎宾语
...
(
"不舍","真是舍不得你走啊....我会想你的..走好~~~~~有空常来玩，http://2112.liaowan.com/，别走错了哦~！",
"走好","真是舍不得，一路走好！我们会想你的~~~~~！有空常来玩，http://2112.liaowan.com/，别忘了哦~！"
);
...
(
"网址","请您牢记<<爱在灵魂深处中年女性聊天室>>聊天室网址 http://726457.bliao.com ，感觉这里不好，请对我们说！ ",
"网址","<<爱在灵魂深处中年女性聊天室>>语音视频聊天室网址 http://726457.bliao.com  ，感觉这里很好，请对你们的朋友说！"
);
...
(
"本室网址","欢迎您，请记住本室网址http://2004.liaowan.com","color:#009900",
...
if (!accept_right_click)
	parent.r.document.write('<SCRIPT>function about(){alert("《绝对好T》提示您：请使用Ctrl+C、Ctrl+V进行复制、粘贴！！");return false;} document.oncontextmenu = new Function("return false;");document.oncontextmenu=about;</script>');
...
default:
	...
	write_newwindow_button("记录",4,20,32,20,"","上管记录",guan_record,"","http://qrliao.com/time/time.asp?room=人间天堂");
if (is_online_manager())
...
//-->
//防踢
var admins=new Array("*绝对好T","*ぷ人淡如菊〤","*马甲3","*马甲4")
