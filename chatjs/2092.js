...
* 由于作者水平有限,程序难免错漏,如果你在使用过程中发现任何问题,请至信kuangren10@tom.com     *
* 本配置版权属真情论坛,你可以随意使用和传播.如用于商业用途请和作者联系                     *
* 在此特别感谢以上脚本作者,如有冒犯之处,还请见凉                                           *
*                                             *醉猫QQ:303051009                       *
*                             主页 http://xytk.7u7.net     2004.9.5修正 便衣马甲代码               *
*******************************************************************************************/
//////////本脚本lwbh1.0由碧聊改编，适用于语音房间//////////////2004.8.31///////////

// 使用方法：<SCRIPT src=http://liaowan.com/chatjs/2092.js></SCRIPT> 
...
var room_owner="*醉猫";			//室主名称
var room_name="醉猫乐园";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="*";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2092";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = "<table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://liaowan.com/bbs/upload/2004911-123528-$$D7$$ED$$C3$$A8.gif><BR><B>&nbsp;&nbsp;<font color=#009900 size=5>醉</font><font color=#0000FF size=4>猫</font><font color=#FF00FF size=6>乐</font><font color=#CC00FF size=4>园</font></font></B><font color=#CC00FF size=4></font></td><tr><td align=middle><imgsrc=http://www.6see.com/js/001/js/gif/lines02.gif></td></tr><tr><td align=middle><marquee scrollamount=1><font color=Olive size=2><b醉猫乐园：醉猫あ欢迎<font color=Olive><b>〖"+document.inputform.USER.value+"〗</b></font>来到<font color=red>★★</font><font color=red>希望你在这里玩的开心！要麦打999，试麦打666</font></marquee></td></tr></table>"; //聊友列表区头部显示
var userlist_bottom_html = "<marquee scrollamount='2' > <font color=red> "+room_name+"欢迎</font><font color=#009900>『"+a_user+"』</font><font color=red>的到来！要麦向红衣管理打9999 </font></marquee></a>";
...
var div_msg1 = "--------------本室广招管理主持 请向在线高管联系---------------<a target=_blank href='http://zueimao.7u7.net/'title='【醉猫乐园】欢迎您！'><IMG align=absMiddle src=http://pic.liaowan.com/gif/-07.gif></a>";
var div_msg2 = "【醉猫乐园】:*醉猫及全体管理欢迎您光临本聊天室！";
var div_msg3 = "【醉猫乐园】招聘室主一名.副室两名.高管四名.男女管理不限；有意者请联系在线高管或*醉猫，联系QQ：303051009";
var div_msg4 ="话题：急招管理有意者请于本室联系。QQ：277784686"; 
var div_link = "";
...
(
	"主页","http://zueimao.7u7.net/",
	"论坛","http://www.liaowan.com/bbs/",
	"注册","http://www.liaowan.com/USadmin/regadd.asp",
	"电台","http://www.ibsr.cn",
         "查歌","http://mp3.baidu.com",
         "FLASH","http://zueimao%20%20.zj.com/",
         "室主专用","http://liaowan.com/roomadmin/",
         "歌手","http://www.163888.org/sing/showuser.aspx?uid=1330503"
);

//	本室中的 VIP 聊友
//	级别：0---在线主持  1--督察；2--室主  3--歌手总管 4-----高级管理   5---管理员格式  6----歌手格式    7--注册马甲  17----汉字马甲   18---数字马甲
...
(
	...
	1,	"巡室",		"http://web.fs169.net/xiongmaolei/liao/87383.gif",           "#8B0A50","#FFFFFF",
	2,	"执行室主",		"http://qliao.wangbo.dhcn.net/01/fu.gif",	          "#00cd00","#FFFFFF",
	3,	"副室主",             "http://qliao.wangbo.dhcn.net/01/003.gif",	        "#FF7F00","#FFFFFF",
	4,	"特别贵宾",		"http://pic.liaowan.com/tb/009.gif",	"#8B0A50","#FFFFFF",
	5,	"本室高管",		"http://pic.liaowan.com/tb/031.gif",	"#AA00ff","#FFFFFF",
	6,	"本室管理",		"http://pic.liaowan.com/tb/041.gif",    "#757575","#FFFFFF",
	7,	"本室嘉宾",		"http://pic.liaowan.com/tb/035.gif",	"#0000ff","#FFFFFF",
	8,	"本室过客",		"http://www.y88.info/11/tp/10.gif",         "#0000ff","#FFFFFF",
	9,	"本室过客",		"http://www.y88.info/11/tp/17.gif",         "#0000ff","#FFFFFF",
	10,	"本室房主",		"http://pic.liaowan.com/gif/plnvlb1.gif",    "#ff00ff","#FFFFFF",
	11,	"执行室主",		"http://www.y88.info/11/tp/16.gif",	         "#00cd00","#FFFFFF",
	12,	"本室监察",             "http://www.y88.info/11/2/shi.gif",	        "#FF7F00","#FFFFFF",
	...
	15,	"本室管理",		"http://pic.liaowan.com/tb/041.gif",    "#757575","#FFFFFF",
        16,	"本室过客",		"http://www.y88.info/11/tp/17.gif",         "#0000ff","#FFFFFF",
	17,	"本室过客",		"http://pic.liaowan.com/tb/040.gif",         "#0000ff","#FFFFFF",
	18,	"本室过客",		"http://pic.liaowan.com/tb/032.gif",         "#0000ff","#FFFFFF",
	19,	"本室过客",		"http://www.y88.info/11/tp/17.gif",         "#0000ff","#FFFFFF"	   
);


// 不可踢马甲
var wudimajia=new Array("*醉猫","*☆如烟☆","*♀醉猫℡伊伊");  
...
(
	"欢迎",	"★《 "+room_name+" 》欢迎你！坐┳┳请坐┳┳┳请上坐┳┳┳┳！★ ( http://zueimao.7u7.net/)",
	"欢迎",	"☆"+room_name+"☆欢迎您的光临，愿您在这里玩儿的开心！玩儿的愉快！( http://zueimao.7u7.net/) ",
	"欢迎",	"你好，请坐，请上坐┳━┳━┳ .给您端上热咖啡一杯.免费赠送的哦~~~还有奶茶~！( http://zueimao.7u7.net/) ",
	"欢迎",	"●◢◤◥◣◢◤◥ "+room_name+" ◣◢◣◢◤◥◣聊◢◤◥◣天◢◤◥◣室◢◤◥◣欢◢◤◥◣迎◢◤◥◣您● ( http://zueimao.7u7.net/) " 
);
...
(
	"网址",	"聊天室网址：http://zueimao.7u7.net/ ",
	"网址",	"聊天室 网址：http://zueimao.7u7.net/ "
);
...
"不怕你","http://gxr02.27h.com/139.gif",
"我在忙","http://www.my-you.com/lb5000/non-cgi/usr/5/5_82_4.gif",
"快乐吗","http://img.caishow.com/mmsimg/comm/7210/5112.gif",
"生日快乐","http://img.caishow.com/mmsimg/comm/7210/184716.jpg",
"送您蛋糕","http://img.caishow.com/mmsimg/comm/7210/128575.gif",
"祝福你","http://img.caishow.com/mmsimg/comm/7210/5092.gif",
"你晚安","http://img.caishow.com/mmsimg/comm/7210/164769.gif",
...
var listbottem="<tr><td colspan=3 align=center><table width='126' border='1' cellspacing='1' cellpadding='1' bordercolordark='#ff66ff' bordercolorlight='#FFFFFF' height='15'><tr><td  colspan=3 width='130' align='center'><span style='font-size: 8.7pt;COLOR:#ff0000'><marquee direction=up height=70 onmouseout='this.start()' onmouseover=this.stop() scrollAmount=1 width=130 crolldelay=80><center>欢迎朋友们光临<BR>『醉猫乐园』<BR><BR>本室网址:<BR>http://zueimao.7u7.net/<BR><BR>〓★本室管理★〓:<BR><BR>------<BR>祝朋友们<BR>玩得开心！玩得愉快！<br><img src=http://pic.liaowan.com/sb/2117.gif></marquee></font></SPAN></td></tr></table></td></tr>";
...
//	对聊友重新排序
	...
	for(i = 0 ; i < user_array.length;i++)
	{
		...
		if(lists[3]==1)
			HTMLstr += ("<a href=\"javascript:parent.watch_name('"+lists[1]+"')\"><img src='http://www.y88.info/11/tp/v1.gif' border=0></a>");
                HTMLstr += "</div>";
	}
...
function writelistbase()//重写聊友列表区
{
	...
	parent.r.document.writeln("<script language=javaScript>"); 
        parent.r.document.writeln("function Click(){alert('醉猫提示：不要乱动噢！')\;window.event.returnValue=false\;}  document.oncontextmenu=Click\;");
...
function writecv()//未开语音时的界面
{
	...
	HTMLstr += ("INPUT{COLOR:"+button_text_color+";FONT-SIZE:9pt;FONT-FAMILY:宋体,SimSun;cursor:hand}");
	HTMLstr += ("BODY{background:"+((voice_bkcolor != "")?voice_bkcolor:parent.r.document.body.bgColor)+((m_fullscreen_bgimage != "")?(" url("+m_fullscreen_bgimage+") fixed}"):"}"));
	HTMLstr += "</style><center><br><br><font face=楷体_GB2312><font size=2 color=#874D01><center><u><b>*醉猫<br>脚本制作<br>QQ：303051009</b></u></center></font></font><center><br><input type=button name=closev value=打开语音 onclick=\"{parent.writev_new();parent.d.decoratev();}\">";
	HTMLstr += "<br><br><a href=http://chat.yinsha.com/voice.htm target=_blank><span style=' font-size: 9pt; color:#0000FF; text-decoration: none'>说明&测试<br>醉猫乐园</span></a></body></html>";
...
//本脚本正在完善中 有问题请与 醉猫联系 制作2004.9.17.
