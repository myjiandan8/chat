...
* 重新修改整理,对代码进行司蚝侠砘?力求达到程序运行稳定快速而不失实用功能和美观界面  本版本新增加了多个视频功能   *
...
var room_owner="*黑道军师";			//室主名称
var room_name="黑道之家";			//	房间名称
var room_adminname_head="*聊湾╅";	//	本室管理名格式
var room_adminname_headg="*№聊湾∮";	//	本室歌手名格式
var majia = "黑道╅名ぶめ" ;            //   默认换马甲格式

var room_number="2050";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = " <table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://pic.liaowan.com/sb/2050.gif><BR><tr><td align=middle><img src=http://pic.liaowan.com/gif/hx.gif>"; //聊友列表区头部显示
...
var default_admin_pass = "5212";	//	默认的管理员上管口令
...
var div_msg2 = "室主〖黑道…訫柔〗真诚欢迎你来到黑道之家~！";
var div_msg3 = "欢迎光临聊湾聊天网【"+room_name+"】多视频聊天室!~~有不道之处，欢迎你给我们在留言本里提出你宝贵的意见！！";
var div_msg4 = "本室招聘有责任心强的高管，管理，主持，歌手若干名，有意者请与QQ45657252联系，谢谢~！";  //通知
var div_link = "";
...
(
    ...
    "留言","http://www.ice-book.com/bookMX/icemxice.asp?userid=黑道之家",
...
//	本室中的 VIP 聊友
//	级别：0---在线主持  1--站长；2--执行室主  3--嘉宾管理... 4-----特殊嘉宾   5---管理员格式  6----歌手格式    7--注册马甲  8----汉字马甲   9---数字马甲
...
(
	0,	"在线管理",	"http://xupeng521.51.net/tx/t209.gif",	"#FF0000",	"#ffffff",
	1,	"站长",	"0002.gif",	"#000000",	"#ffffff",
	2,	"执行室主",	"http://liaowan.com/bbs/upload/2004106-183804-$$B4$$BD.gif",	"#ff00ff",	"#ffffff",
	3,	"嘉宾管理",	"http://xupeng521.51.net/tx/t19.gif",	 "#333333",	"#ffffff",
	4,	"特殊嘉宾",	"0004.gif","#F3942E",	"#ffffff",
	5,	"管理成员",	"016.gif",	"#34c534",	"#ffffff",
	6,	"本室嘉宾",	"http://www.wzdu.com/UploadFile/200411619143371311.gif",                  "#61598a",	   "#ffffff",
	7,	"注册名",	"http://xupeng521.51.net/tx/t67.gif",	"#2c07fe",	"#ffffff",
	8,	"汉字名",	"4.gif ",	"#2c07fe",	"#ffffff",
	9,	"数字名",	"http://pic.liaowan.com/tb/010.gif",	"#2c07fe",	""
);

// 不可踢马甲
var wudimajia=new Array("*黑道军师","*5212",
"*↗〖黑道…訫柔〗","*","*","*",
"*冀人老刀","*","*","*" 
 );  
