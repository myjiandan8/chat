...
// 使用方法：<SCRIPT src=http://liaowan.com/chatjs/2096.js></SCRIPT>
...
var room_owner="*〓绝★傲〓";			//室主名称
var room_name="美丽心情";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2096";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = "<B><font style=\"filter: glow(color=#FF0000,strength=4); Height:12pt; color:#FFFFCC; padding:1px;\">&nbsp;&nbsp;<font size=6>美</font><font size=3>丽</font><font size=5>心</font><font size=4>情</font></font></B>";
...
//	聊友列表区底部框内文字代码
var listbottem0="〓★站长★〓<BR>"+room_owner+"<BR>欢迎你的到来<BR>"+room_name+"<Br>是我们<Br>共同的家";

var userlist_bkcolor = "#e5fffd";	//	聊友列表区的背景色
var userlist_bkimage = "http://www.7liao.net/415445.gif";			//	聊友列表区的背景图，设置为空串则使用输入区的图片
...
var div_screen_bkimage = "http://www.7liao.net/415445.gif";		//	分屏背景图片	

var voice_bkcolor = "#e5fffd";		//	语音区的背景
var voice_bkimage = "http://www.7liao.net/415445.gif";				//	语音区的背景图，空串则使用聊友区图片

var input_bkcolor = "#e5fffd";		//	输入区背景色
var input_bkimage = "http://www.7liao.net/415445.gif";				//	输入区背景图片
...
var button_text_color = "#9C0008";	//	输入区按钮文字色
...
(
	17,		"http://www.7liao.com/js/images/n18.gif",
	18,		"http://www.7liao.com/js/images/n18.gif",
	19,		"http://www.7liao.com/js/images/n18.gif",
	35,		"http://www.7liao.com/js/images/n35.gif",
	46,		"http://www.7liao.com/js/images/n46.gif",
	70,		"http://www.7liao.com/js/images/n70.gif"
);
...
var div_msg1 = "本站广招管理主持 请向在线管理咨询<a target=_blank href='http://www.y88.info/' title='聊湾欢迎您！'><IMG align=absMiddle src=http://xing_yu.9629.com/xing_yu//baidu.gif></a>";
var div_msg2 = "【美丽心情】站长:*〓绝★傲〓  室主：*ξ☆淡墨☆清荷ξ *‰不是那条鱼。°○  欢迎您光临本聊天室！";
var div_msg3 = "【美丽心情】招聘帅哥美女管理，有意者请联系在线高管或室主，管理马甲样式:*ぺ☆心情〆**☆ぺ,所有管理必须加群，群号：6403367";
...
//	用于连接按钮
var jilu="http://vs.pp5.cn/vs1/admin/show.asp?user=xingyu";   //刷卡器地址   空时没有

/////6项/////
var a_link_button = new Array
(
	"主页","http://www.liaowan.com",
	"论坛","http://xingyu.Getbbs.com",
	"注册","http://www.liaowan.com/USadmin/regadd.asp",
	"留言","http://gbook.ik8.com/1/default.asp?userId=jueao",
        "暂停","http://m24m.com/bbsq/ShowForum.asp?forumid=519",
        "相册","http://jueao.ik8.com/jueao/photo/index.htm"
);
...
(
	...
	1,	"站长",		"http://www.y88.info/tp/14.gif",           "#8B0A50","#FFFFFF",
	2,	"室主",		"http://js.liaowan.com/tp/tb/2/001.gif",	          "#00cd00","#FFFFFF",
	3,	"心情副室",             "http://www.lndd.org/bchat_img/fstx.gif",	        "#FF7F00","#FFFFFF",
	4,	"心情贵宾",		"http://pic.liaowan.com/tb/009.gif",	"#8B0A50","#FFFFFF",
	5,	"心情高管",		"http://pic.liaowan.com/tb/031.gif",	"#AA00ff","#FFFFFF",
	6,	"心情管理",		"http://pic.liaowan.com/tb/041.gif",    "#757575","#FFFFFF",
	7,	"心情嘉宾",		"http://pic.liaowan.com/tb/016.gif",	"#0000ff","#FFFFFF",
	8,	"心情过客",		"http://www.jznet110.com/taoqi/kl/354938/711.gif",         "#0000ff","#FFFFFF",
	9,	"心情过客",		"http://www.jznet110.com/taoqi/kl/354938/711.gif",         "#0000ff","#FFFFFF",
	10,	"心情室主",		"http://js.liaowan.com/tp/tb/2/001.gif",    "#ff00ff","#FFFFFF",
	11,	"心情副室",		"http://www.y88.info/tp/14.gif",	         "#00cd00","#FFFFFF",
	12,	"心情高管",             "http://pic.liaowan.com/tb/031.gif",	        "#FF7F00","#FFFFFF",
	13,	"心情贵宾",		"http://pic.liaowan.com/tb/009.gif",	"#EE1289","#FFFFFF",
	14,	"特殊管理",		"http://pic.liaowan.com/tb/031.gif",	"#AA00ff","#FFFFFF",
	15,	"心情管理",		"http://pic.liaowan.com/tb/041.gif",    "#757575","#FFFFFF",
        16,	"心情歌手",		"http://pic.liaowan.com/tb/666.gif",         "#CD6090","#FFFFFF",
	17,	"心情过客",		"http://www.jznet110.com/taoqi/kl/354938/711.gif",         "#0000ff","#FFFFFF",
	18,	"心情过客",		"http://www.jznet110.com/taoqi/kl/354938/711.gif",         "#0000ff","#FFFFFF",
	19,	"心情过客",		"http://www.jznet110.com/taoqi/kl/354938/711.gif",         "#0000ff","#FFFFFF"	   
);

// 不可踢马甲
var wudimajia=new Array("*〓绝★傲〓","*七月豆","*ξ☆淡墨☆清荷ξ","*淡泊","*～龙∮飞～","*╰☆↙雪Θ菲↘☆╮","*絕訫","*",
"*","*","*","*","*","*");  
...
var listbottem="<tr><td colspan=3 align=center><table width='126' border='1' cellspacing='1' cellpadding='1' bordercolordark='#ff66ff' bordercolorlight='#FFFFFF' height='15'><tr><td  colspan=3 width='130' align='center'><span style='font-size: 8.7pt;COLOR:#ff0000'><marquee direction=up height=70 onmouseout='this.start()' onmouseover=this.stop() scrollAmount=1 width=130 crolldelay=80><center>欢迎朋友们光临<BR>『美丽心情』<BR><BR>本室网址:<BR>http://2096.liaowan.com<BR><BR>〓★站长★〓:<BR>*〓绝★傲〓 <BR><BR>祝朋友们<BR>玩得开心！玩得愉快！<br><a target=_blank href='http://www.y88.info' title='星雨网络 '><IMG align=absMiddle src=http://xing_yu.9629.com/xing_yu//baidu.gif></a><Br><a target=_blank href='http://www.2dj.info/' title='爱DJ舞曲网欢迎您!'><IMG align=absMiddle src=http://www.2dj.info/images/logo.gif></a></marquee></font></SPAN></td></tr></table></td></tr>";
...
function writecv()//未开语音时的界面
{
	...
	HTMLstr += ("INPUT{COLOR:"+button_text_color+";FONT-SIZE:9pt;FONT-FAMILY:宋体,SimSun;cursor:hand}");
	HTMLstr += ("BODY{background:"+((voice_bkcolor != "")?voice_bkcolor:parent.r.document.body.bgColor)+((m_fullscreen_bgimage != "")?(" url("+m_fullscreen_bgimage+") fixed}"):"}"));
	HTMLstr += "</style><center><br><br><font face=楷体_GB2312><font size=2 color=#874D01><center><u><b>星雨网络 *==星雨==<br>友情技术支持<br>QQ：393119064</b></u></center></font></font><center><br><input type=button name=closev value=打开语音 onclick=\"{parent.writev_new();parent.d.decoratev();}\">";
...
//本脚本正在完善中 有问题请在论坛 星雨网络 *==星雨==提出2004.8.31.
