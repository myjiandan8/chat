...
var room_owner="*─☆蕾儿";			//室主名称
var room_name="与你有约";			//	房间名称
var room_adminname_head="*↘  の  ↙";	//	本室管理名格式
var room_adminname_headg="*№聊湾∮";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2089";			//	房间号
...
//	聊友列表区顶部HTML代码
var userlist_top_html = "<table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://pic.liaowan.com/tb/010.gif><BR><B>  <font color=#009900 size=5>与</font><font color=#0000FF size=4> 你</font><font color=#FF00FF size=6> 有</font><font color=#CC00FF size=4> 约</font></font></B><font color=#0000FF size=4></font></td><tr><td align=middle><img src=http://pic.liaowan.com/gif/hx.gif></td></tr><tr><td align=middle><marquee scrollamount=1><font color=Olive size=2><b>室主*─☆蕾儿づ 欢迎<font color=Olive><b>〖"+document.inputform.USER.value+"〗</b></font>来到<font color=Olive>★★</font><font color=red>希望你在这里玩的开心！要麦打999，试麦打666</font></marquee></td></tr></table>"; //聊友列表区头部显示
...
//	聊友列表区底部框内文字代码
var listbottem0="〓★室主★〓<BR>"+room_owner+"<BR>〓★副室主★〓<BR>*-02-<BR>欢迎你的到来<BR>"+room_name+"<Br>是我们<Br>共同的家";

var userlist_bkcolor = "#e5fffd";	//	聊友列表区的背景色
var userlist_bkimage = "http://t4112.nease.net/4112/3.jpg";			//	聊友列表区的背景图，设置为空串则使用输入区的图片
...
var div_msg1 = "本站广招管理主持 有意者请在留言簿里留言<a target=_blank href='http://www.liaowan.com/' title='聊湾欢迎您！'><IMG align=absMiddle src=http://liaowan.com/logo/logo.gif></a>";
var div_msg2 = "如果立体声语音不能正常运行，请点击下边帮助";
var div_msg3 = "欢迎光临聊湾聊天网【"+room_name+"】多视频聊天室!~~连接多视频请直接点名字后小眼睛";
var div_msg4 = "【与你有约】室主:*─☆蕾儿づ 欢迎您光临本聊天室";  //通知
var div_link = "";
...
(
	"留言簿","http://www.youthe.com/asp/ly/index.asp?user=与你相约",
	"论坛","http://bingchun.bbs.xilu.com ",
...
//	本室中的 VIP 聊友
//	级别：0---在线主持  1--房主 2--室主  7--特殊贵宾... 4-----高级管理   5---管理员格式  6----歌手格式    3--注册马甲  8----汉字马甲   9---数字马甲
...
(
	...
	1,	"站长巡管",	"http://web.fs169.net/xiongmaolei/liao/87383.gif",	"#A0FF70",	"#ffffff",
	2,	"美女室主",	"http://www.tw666.net/lom/0001.gif",	"#ff00ff",	"#ffffff",
         3,	"可爱副室",	"http://pic.liaowan.com/tb/031.gif", "#FF99CC","#ffffff",
         4,	"最靓高管",	"http://www.wzdu.com/UploadFile/2004121535988453.gif", "#009999",	"#ffffff",
	7,	"注册用户",     "http://pic.liaowan.com/tb/035.gif",	 "#CC99FF",	"#ffffff",	
	6,	"注册用户",	"http://web.fs169.net/xiongmaolei/liao/jb.gif",	"#2c07fe",	"#ffffff",
	5,	"金牌主持",      "http://www.y88.info/tp/14.gif",	"#009933",	"#ffffff",
	8,	"相约过客",	"http://chat.yeeyoo.com/chatimages/22.gif ",	"#2c07fe",	"#ffffff",
	9,	"快乐游客",	"http://www.y88.info/tp/17.gif",	"#CCFFCC",	"#ffffff",
         	11,	"注册用户",	"http://www.y88.info/tp/17.gif",	"#CCFFCC",	"#ffffff"

);

// 不可踢马甲
var wudimajia=new Array("*-依-","*旮旯","*~碧海","*~依然","*絕戀",
"*冀人老刀","*小依","*依溪","*老刀～" ,"*~可人~","*№ゞ缘梦DJ冰冰≈","*─☆蕾儿づ"
 );  
...
function writecv()//未开语音时的界面
{
	...
	HTMLstr += ("INPUT{COLOR:"+button_text_color+";FONT-SIZE:9pt;FONT-FAMILY:宋体,SimSun;cursor:hand}");
	HTMLstr += ("BODY{background:"+((voice_bkcolor != "")?voice_bkcolor:parent.r.document.body.bgColor)+((m_fullscreen_bgimage != "")?(" url("+m_fullscreen_bgimage+") fixed}"):"}"));
	HTMLstr += "</style><center><br><br><font face=楷体_GB2312><font size=2 color=#874D01><center><u><b>*-01-<br>脚本维护<br></b></u></center></font></font><center><br><input type=button name=closev value=打开语音 onclick=\"{parent.writev_new();parent.d.decoratev();}\">";
