...
// 使用方法：<SCRIPT src=http://liaowan.com/chatjs/2044.js></SCRIPT> 
...
var room_owner="~情缘冰月";			//室主名称
var room_name="青春飞扬";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2044";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = " <table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><body leftmargin=2 rightmargin=0><font color=#ff0000><big><B>  青春飞扬<BR><tr><td align=middle><img src=http://pic.liaowan.com/gif/hx.gif>"; //聊友列表区头部显示
...
var div_msg2 = "〓网恋情缘〓聊天室宣言 ：青春是有限的,请把握你现在的美好
var div_msg3 = "欢迎光临聊湾聊天网【"+room_name+"】多视频聊天室!~~连接多视频请直接点名字后小眼睛";
var div_msg4 = "〓执行室主〓*~情缘冰月 QQ; 271252718〓执行副室〓一个人 ; 349010739欢迎光临聊湾聊天网【"+room_name+"】";  //通知
var div_link = "";
...
(
	...
	1,	"本室站长",	"http://cnjwedu.net/~zixuan//tp2/duzhan.gif",	"#8B0A50",	"#ffffff",
	...
	5,	"本室管理",     "http://pic.liaowan.com/tb/020.gif",	 "#00FF7F",	"#ffffff",
	6,	"本室歌手",	"http://web.fs169.net/xiongmaolei/liao/jb.gif",	"#2c07fe",	"#ffffff",
	7,	"本室嘉宾",  	"0004.gif",	"#EE82EE",	"#ffffff",
	8,	"本室过客",	"0004.gif",	"#228B22",	"#ffffff",
	9,	"本室过客",	"0004.gif",	"#228B22",	"#ffffff"
);

// 不可踢马甲
var wudimajia=new Array("*碧聊風雲","*-Andy","*118","*~情缘天涯","*116","*~情缘浪人","*",
"*深秋","*~情缘深秋","*~爱为深秋留","*默路客"  
 );  
...
(
	"网址",	"聊天室网址：http://2044.liaowan.com ",
	"网址",	"聊天室 网址：http://2044.liaowan.com  "
);
