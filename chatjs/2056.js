<!--
var vers = "￡爱如潮水￡为你服务  QQ:335763793";			//	配置版本号
var config_style = 0;			//	配置的风格

var room_owner="缘分天空";			//	室主名称
var room_name="缘分天空";		//	房间名称
var room_number="2056";			//	房间号码
...
var userlist_top_html = "<B><font style=\"filter: glow(color=#009900,strength=4); Height:12pt; color:#FFFFCC; padding:1px;\">&nbsp&nbsp<font size=5>缘</font><font size=5>分</font><font size=5>天</font><font size=5>空</font></font></B>";
//缘的世界，分得天堂。‘：	

var userlist_bottom_html = "<p align='center' class='p9'><font color=#009900 >"+room_name+"欢迎您</font><br><tr><td colspan=3 align=center><table ><tr><td  colspan=3 width='103' align='center'><span style='font-size: 8.7pt;COLOR:red'><marquee direction=up height=70 onmouseout='this.start()' onmouseover=this.stop() scrollAmount=1 width=120 crolldelay=50><center>===室主===<br><font color=#FA8072><center>*~~萧剑<font color=#FA8072><center>☆房间★监管☆<font color=#FA8072><center>*俊杰<font color=#D15FEE><center>★房间☆配置★<font color=#FA8072><center>*￡爱如潮水￡</font><br><font color=#2C16C9>祝朋友们开心<br>快乐每一天</font></marquee></b></td></td></tr></td></td></tr></font>&nbsp&nbsp&nbsp<img src=http://liaowan.com/logo/logo.gif></td></tr></table>";
...
var multi_singer_list = 0; 		// 	是否允许重复排麦,0辉市恚?允许
var accept_right_click = 0;		//	是否允许右键菜单,0不允许；1允许

//	用于连接按钮
var a_link_button = new Array
(
"论坛","情聊论坛",	"http://www.liaowan.com/bbs/",
"相册","本室相册",	"http://..........等待添加......./",
...
(
	"http://cnjwedu.net/~zixuan//tp2/zc.gif",	
	1,	"本站站长",		"http://cnjwedu.net/~zixuan//tp2/ee2.gif", 
	2,	"本站特别管理马甲",		"http://cnjwedu.net/~zixuan//tp2/000.gif",                                3,	"本室室主",
         "http://www.wzdu.com/UploadFile/20044140445991422.gif",      	
         4,	"本室副室",		"http://cnjwedu.net/~zixuan//tp2/fs.gif",	
	5,	"本室监管",		"http://cnjwedu.net/~zixuan//tp2/gaoguan.gif",	
	6,	"本室歌手",		"http://pic.liaowan.com/tb/039.gif",
	7,	"本室嘉宾",		"http://pic.liaowan.com/tb/035.gif",	
...
var msg_back_speak = "哈哈，回家的感觉！妙不可言...";
...
(
"不舍","真是舍不得你走啊....我会想你的..走好~~~~~有空常来玩，http://2052.liaowan.com/，别走错了哦~！",
"走好","真是舍不得，一路走好！我们会想你的~~~~~！有空常来玩，http://2052.liaowan.com/，别忘了哦~！"
);
...
(
"网址","请您牢记<<缘分天空>>聊天室网址 http://2056.liaowan.com/  ",
"网址","<<缘分天空>>语音视频聊天室网址 http://2056.liaowan.com/  "
);
...
(
"本室网址","诱舞夜总会欢迎您，请记住本室网址http://2052.liaowan.com/","color:#009900",
...
function user_name_filter()
{
	...
	leaverom('您好['+a_user+']！\n万分抱歉，本房间现在只允许使用文明的名字进入！\n请您换用文明的名字进入本房间，愿您在此开心愉快！');
}
...
{
	var bookmarkurl="http://"+room_number+".liaowan.com.com/";
...
if (userlist_top_html != "")
	...
	parent.r.document.write('<br><a title=\"当前聊天室在线人数\"><font color=000000>  缘分天空有 </font><font color=red><B>'+user_array.length+'</B></font><font color=000000> 位聊友</font><br>');
	parent.r.document.write("</td></tr><tr><td align=middle><marquee><font color=#002FFC><b>欢迎<font color=#002FFC><b>〖"+document.inputform.USER.value+"〗</b></font>来到《缘分天空》视频语聊天室，全体室主,管理欢迎您的到来，愿这里能成为你们情感交流的港湾!!</b></font></marquee></td></tr></table>");
