...
var room_owner="*菲菲";                   //室主名称
 
var room_name="我心为谁";               //     房间名称
...
var userlist_top_html = "<table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://yufeifei81.88165.com/uploads/images/115/ced2d0c42.gif><BR><B>  <font color=#009900 size=5> </font><font color=#0000FF size=5>   </font><font color=#FF00FF size=5>   </font><font color=#CC00FF size=5>   </font></font></B><font color=#0000FF size=5></font></td><tr><td align=middle><img src= http://www.6see.com/js/001/js/gif/lines02.gif ></td></tr><tr><td align=middle><marquee scrollamount=1><font color=ff0000 size=2><b>欢迎<font color=ff0000><b>〖"+document.inputform.USER.value+"〗</b></font>来到<font color=ff0000>★★</font><font color=aa00ff>希望这里成为你们开心的乐园,记住我们的约定哦!</font></marquee></td></tr></table>"; //聊友列表区头部显示
...
var div_msg1 = "欢迎光临【我心为谁】!愿这成为你的网上家园,祝大家玩得愉快!";
 
var div_msg2 = "初次进入本聊天室，如果听不到声音，请安装提示的语音插件或手动安装，如果安装后听不到，请重进！谢谢!";
 
var div_msg3 = "本室11月14日晚上21：00~22：00举行自备酒宴，有兴趣的朋友带上视频一起参与我们的活动，";
 
var div_msg4 = "本室招聘白天在线管理及高管，有意者请联系及留言。室主：*☆菲╰☆╮菲☆，QQ：358376132"; //通知
...
(
       ...
       "考管","http://yufeifei81.88165.com/WebGUIAdmin/index.pl/b9dcc0edd6c6b6c8",
...
(
       ...
       3,    "本室歌手",             "http://bbs.yuzi.net/images/upfile/2004-8/200481514553.gif",               "#FF7F00","#FFFFFF",
 
       4,    "特别贵宾",            "http://pic.liaowan.com/tb/009.gif",       "#8B0A50","#FFFFFF",
 
       5,    "本室高管",            "http://pic.liaowan.com/tb/031.gif",       "#9966FF","#FFFFFF",
 
       6,    "本室管理",            "http://pic.liaowan.com/tb/041.gif",    "#ff66ff","#FFFFFF",
 
       7,    "临时管理",            "http://pic.liaowan.com/tb/016.gif",       "#0000ff","#FFFFFF",
...
(
    ...
    "送您鲜花1","http://vip.6to23.com/zhangtianyun/852161/image/dz/hua3.gif",
...
var listbottem="<tr><td colspan=3 align=center><table width='126' border='1' cellspacing='1' cellpadding='1' bordercolordark='#ff66ff' bordercolorlight='#FFFFFF' height='15'><tr><td  colspan=3 width='130' align='center'><span style='font-size: 8.7pt;COLOR:#ff0000'><marquee direction=up height=70 onmouseout='this.start()' onmouseover=this.stop() scrollAmount=1 width=130 crolldelay=80><center>★★本室室主★★:<BR>*☆菲╰☆╮菲☆<BR>★★本室副室★★:<BR>*liaowanKK<BR>祝朋友们<BR>玩得开心!玩得快乐!<BR><img src=http://img.3721.com/mms/color/99/1/3o0cqkjd1366.gif></font></SPAN></td></tr></table></td></tr>";
