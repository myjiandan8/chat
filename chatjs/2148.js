...
var room_owner="*往事如烟";			//室主名称
var room_name="中年人的港湾";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="*№聊湾∮";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2148";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = "<B><font style=\"filter: glow(color=#009900,strength=4); Height:12pt; color:#FFFFCC; padding:1px;\">  <font size=4>中年</font><font size=5>人</font><font size=4>的</font><font size=4>港湾</font></font></B>";//聊友列表区头部显示
...
var userlist_bkcolor = "#f5EDff";	//	聊友列表区的背景色
var userlist_bkimage = "http://www.liaowan.com/bbs/upload/200498-114136-$$B4$$BD.jpg";			//	聊友列表区的背景图，设置为空串则使用输入区的图片
...
var div_screen_bkimage = "http://www.liaowan.com/bbs/upload/200498-114136-$$B4$$BD.jpg";		//	分屏背景图片	

var voice_bkcolor = "#e5fffd";		//	语音区的背景
var voice_bkimage = "";				//	语音区的背景图，空串则使用聊友区图片

var input_bkcolor = "#ffafB4";		//	输入区背景色
...
var div_msg4 = "【中年人的港湾】室主:*往事如烟  副室主：紫儿 欢迎您的光临，希望您在这里玩的开心！";  //通知
var div_link = "";
...
(
	...
	"翻唱","http://show.9sky.com/info/info.asp?id=8290",
...
(
	...
	2,	"聊湾室主",	"http://www.poppip.com/330/sz.gif",	"#ff00ff",	"#ffffff",
         3,	"聊湾副室",	"http://web.fs169.net/xiongmaolei/liao/fu.gif", "#ff00ff","#ffffff",
         4,	"聊湾高管",	"http://www.wzdu.com/UploadFile/2004121535988453.gif", "#8Bd577",	"#ffffff",
	5,	"聊湾主持",     "http://www.wzdu.com/UploadFile/20041215383698798.gif",	 "#8b6A77",	"#ffffff",	
...
// 不可踢马甲
var wudimajia=new Array("*‖巡站‖飞龙","*‖巡站‖小依","*‖巡站‖凉风有信","*‖巡站‖老暴","*‖巡站‖絕戀",
"*‖巡站‖冀人老刀","*","*‖巡站‖依溪","*‖巡站‖乐天", "*往事如烟"
 );  
...
var listbottem="<tr><td colspan=3 align=center> <table width='65' border='3' cellspacing='3' cellpadding='3' bordercolordark='#FF7F50' bordercolorlight='#FF7F50' height='3'> <tr><td  colspan=3 width='3' align='center'><span style='font-size: 8.7pt;COLOR:red'><marquee direction=up height=70 onmouseout='this.start()' onmouseover=this.stop() scrollAmount=1 width=100 crolldelay=50><center>"+listbottem0+"<Br><a target=_blank href='http://free.efile.com.cn/ronnie9951/21484.JPG' title='聊湾欢迎您！'><IMG align=absMiddle src=http://www.liaowan.com/logo/liaowanlogo.jpg></a></marquee></font></SPAN></td></tr></table></td></tr>";
