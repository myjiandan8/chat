...
var room_owner="*╱︶ㄣ依╱︶";			//室主名称
var room_name="超凡國度";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="*Lw℡超凡←╬";	//	本室歌手名格式
var majia = "Lw℡超凡←╬";          //   默认换马甲格式

var room_number="2052";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";

//	聊友列表区顶部HTML代码
var userlist_top_html = " <table border=0 width=120px cellspacing=0></td><tr></tr><tr><td align=middle><img src=http://free.efile.com.cn/ronnie9951/11.gif><BR><tr><td align=middle><img src=http://pic.liaowan.com/gif/hx.gif>"; //聊友列表区头部显示
...
var div_msg1 = "本聊天室广招管理主持 请向在线管理咨询<a target=_blank href='http://www.liaowan.com/' title='聊湾欢迎您！'><IMG align=absMiddle src=http://liaowan.com/logo/logo.gif></a>";
var div_msg2 = "如果立体声语音不能正常运行，请反复开关闭语音,超凡国度友情提示您,在主持人递麦给你的同时,你可以将右下角第三个勾去掉再勾上,以确保不因网速的原因卡麦!";
var div_msg3 = "欢迎光临聊湾聊天网【"+room_name+"】多视频聊天室!~~连接多视频请直接点名字后小眼睛,女管理马夹格式:Lw℡超凡←╬X★X  男管理马夹格式:Lw℡超凡←╬X☆X";
var div_msg4 = "【超凡國度】<=室主*②０④⑥  *╚╲米老鼠╱╝　欢迎您光临本聊天室,申管QQ:214986889 77611909 ";  //通知
var div_link = "";
...
(
	...
	1,	"聊灣工作人員",	"http://web.fs169.net/xiongmaolei/liao/87383.gif",	"#000000",	"#ffffff",
	2,	"帅哥室主",	"http://web.fs169.net/xiongmaolei/liao/87383.gif",	"#ff00ff",	"#ffffff",
          3,	"美女室主",	"016.gif","#F3942E",	"#ffffff",
          4,	"打雜的，讓開！掃帚不長眼",	"http://free.efile.com.cn/ronnie9951/024.gif", "#61598a",	"#ffffff",

	5,	"本室主持",            "http://free.efile.com.cn/ronnie9951/200.gif",	 "#AC8c7b",	"#ffffff",
	
	6,	"管理成员",	"0003.gif",	"#34c534",	"#ffffff",
		7,	"注册名","0004.gif",	"#2c07fe",	"#ffffff",
	8,	"汉字名",	"4.gif ",	"#2c07fe",	"#ffffff",
	9,	"数字名",	"alogo2.gif ",	"#2c07fe",	""
);

// 不可踢马甲
var wudimajia=new Array("*-依-","*旮旯","*~碧海","*~依然","*5411111","*5400000",
"*冀人老刀","*小依","*依溪","*老刀～" 
 );  
