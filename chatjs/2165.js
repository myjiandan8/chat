...
(
        ...
        "爱e 论坛",  "http://www.5iro.net/bbs",
        "爱e 奇迹",  "http://reg.playmu.com",
        "爱e 留言",  "http://www.5iro.net/bbs",
        "爱e 调麦",  "http://www.bliao.com/help/help53.htm",
        "爱e 意见",  "http://www.5iro.net/bbs",
...
(
   0,"奇迹主持",     "xdguanl.gif",	                "#FF0000","#FFFFFF",	
   1,"聊天站长",	"87383.gif",	                "#FF0880","#FFFFFF",	
   2,"聊天副站",	"369ai.gif",	"#9B439B","#FFFFFF", 	
   3,"奇迹室主",	"369ai.gif",	                "##FFc2e","",	
   4,"奇迹副室",	"369ai.gif",	        "#FFc2e","",	
   5,"奇迹督察",	"em40.gif",	                "#6D61C9","#FFFFFF",	
   6,"奇迹贵宾",	"h001.gif",	                "#0033FF","#FFFFFF",	
   7,"奇迹嘉宾",	"jb.gif ",	                "#008FEE","#EEF8FF",	
   8,"奇迹来宾",	"0005.gif",	                "#008FEE","#EEF8FF",
   9,"奇迹来宾",	"0005.gif",	                "#41ABF1","#FFFFFF"
...
(
	...
	"请您准备",	"您好，欢迎来到《爱E奇迹》,下一个就是您的麦了,请准备好!!!","",
...
(
"欢迎光临",    "",
"请进语音,下载http://www.bluesky.cn/download/bluesky.exe安装并F5刷新",         "003.gif",
"欢迎光临!请坐!请上坐!!!",         "004.gif",
"欢迎光临!请坐!请上坐!!!",         "005.gif",
"欢迎光临!请坐!请上坐!!!",         "006.gif",
"欢迎光临!请坐!请上坐!!!",         "007.gif",
...

{
	...
	HTMLstr += "--></style></head><body leftmargin=2 rightmargin=0";
        ...
        HTMLstr += ('</script>');
	HTMLstr += "<br><a title='当前聊天室在线人数'><font color=#027F17> 爱E奇迹 有 </font><font color=red><B id='usercount'>0</B></font><font color=#027F17> 位朋友</font></a><br>";
...
function checksay( ){
  ...
  var badword = new Array("wang ba","园梦","园梦-","绿州","恶心","419756","勾引","死人","ta ma de","§聚寶閣","大屁股","射精","傻逼","叫床","去死","破鞋","破 鞋","吃屎","我操","色情狂","变态","色情","操你","干死你","王八","贱人","婊子","表子","婊","婊·子","婊$子","靠你","插你","插死","干死","日死","鸡巴","睾丸","包皮","奶子","尻","做爱","鸡八","处女","打炮","叼你","草你","狗屎","鸡·巴","大便","操 你 妈","死公","fuck","cao","逼","我 操","老 逼","狗男女","叫床","叫春");
...
function fp()
{
        ...
        parent.u1.document.write('(00:00:00)<font color="#9900FF">天魔微微一笑:</font><font color=#ff00ff>这里在招管理哦,有意者联系在线管理哦,还有爱E奇迹要改版喽!! </font><br>');
}
        function fpbg()
{
        setTimeout("fp()",5000);
