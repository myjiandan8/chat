...
var config_place = "http://liaowan.com/bbs/upload/200495-173412-$$B4$$BD.jpg";  //	图片等的存放位置，请设定为您存放图片的位置

var room_owner="*乐乐☆";			//室主名称
var room_name="如此家园";			//	房间名称
var room_adminname_head="";	//	本室管理名格式
var room_adminname_headg="*№聊湾∮";	//	本室歌手名格式
var majia = "" ;            //   默认换马甲格式

var room_number="2005";			//	房间号
var black_roomname="";	//	双工房间名称   如果允许双工，空
var black_roomnumb="";	//	双工房间号码
var room_link_url = "http://"+room_number+".liaowan.com";
alert('   \n\b       ╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮       \n\b       ║欢│║★│║迎│║★│║光│║★│║临│       \n\b       ╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝   \n\b       ╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮╭╧╮       \n\b       ║如│║★│║此│║★│║家│║★│║园│       \n\b       ╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝╚～╝\n\n\b\b\b 欢迎您进入『如此家园』，室主：*乐乐    \n\n    希望您在这里能够玩的愉快开心！\n\n\b\b\b【如此家园】房间招聘在线时间长\n\n\b\b\b有责任心的值班高管及上管歌手,\n\n\b\b\b愿意加入我们这个大家庭的，请与在线高管及室主联系！') 

//	聊友列表区顶部HTML代码
var userlist_top_html = " <B><td align=middle><img src=http://pic.liaowan.com/sb/2014.gif></td></B><BR>"; //聊友列表区头部显示
...
//	聊友列表区底部框内文字代码
var listbottem0="〓★室主★〓<BR>"+room_owner+"<BR>配置*聊湾：值班室主：*柳柳*依依*：高管：*唯一*欢迎您的到来<BR>"+room_name+"<Br><Br>";

var userlist_bkcolor = "#e5fffd";	//	聊友列表区的背景色
var userlist_bkimage = "http://liaowan.com/bbs/upload/200495-173412-$$B4$$BD.jpg";			//	聊友列表区的背景图，设置为空串则使用输入区的图片
...
var div_screen_bkimage = "http://liaowan.com/bbs/upload/200495-173412-$$B4$$BD.jpg";		//	分屏背景图片	
...
var button_text_color = "#008C00";	//	输入区按钮文字色
...
var div_msg1 = "欢迎光临如此家园，这里永远是大家温暖的家园！<a target=_blank href='http://www.liaowan.com/' title='如此家园欢迎你！'><IMG align=absMiddle src=http://pic.liaowan.com/sb/2014.gif></a>";
var div_msg2 = "如果立体声语音不能正常运行，请点击下边帮助";
var div_msg3 = "佛说：前世的五百次回眸，才换来今生的擦肩而过。想拥有一个真正的知心朋友，除了缘分，还需要一颗真诚的心。如果您感觉这里不好，请告诉我们！如果您感觉这里好，请带着您的朋友来,希望朋友们在这里玩得开心，把这里当做自己的家~~~~~";
var div_msg4 = "今日话题：网络多角恋情，对谁的伤害最大？";  //通知
var div_link = "";
...
//	用于连接按钮
var jilu="http://www.fs169.net/chat/admin.php?room=如此家园";   //刷卡器地址   空时没有
...
(
	0,	"家园在线主持","http://pic.liaowan.com/tb/002.gif","#FF0000","#ffffff",     
	1,	"家园站长室主",	
	...
	2,	"家园值班室主",	
         ...
         "#ff00ff","#ffffff",
         3,	"家园值班高管",	"http://pic.liaowan.com/tb/031.gif", 
                                               "#FF8000",	"#ffffff",	4,	"家园男管理",     "http://pic.liaowan.com/tb/030.gif",	 "#970097",	"#ffffff",
         	5,	"家园女管理",	"http://xynet.ik8.com/xynet/images/0349.gif",	   "#8B0A50","#FFFFFF",
	6,	"家园歌手",	"http://pic.liaowan.com/tb/039.gif",	"#008C00",	"#ffffff",
	7,	"家园贵宾",      "http://pic.liaowan.com/tb/035.gif",	"#000000",	"#ffffff",
	8,	"家园嘉宾",	"http://pic.liaowan.com/tb/040.gif",	"#2c07fe",	"#ffffff",
         9,	"家园客人",	"http://pic.liaowan.com/tb/041.gif",	"#2c07fe",	"#ffffff"
         );

// 不可踢马甲
var wudimajia=new Array("*-依-","*~@月亮@~","*~碧海","*~依然","*絕戀",
"*冀人老刀","*小依","*依溪","*╰☆≮旭℡旭≯☆","*ゞ褙妳寵坏み","*老刀～","*冰果","*~@阳光@~"
);  
...
"生日快乐","http://219.149.64.81/bchat_img/dg3.jpg",
"生日快乐1","http://219.149.64.81/bchat_img/dangao1.gif",
...
"偷吻","http://219.149.64.81/bchat_img/4518.gif",
"我想泡你","http://219.149.64.81/bchat_img/0xhhni.gif",
"触电了","http://219.149.64.81/bchat_img/bbn.gif",
"妹妹上花轿","http://219.149.64.81/bchat_img/mgyhj.gif",
"美女证","http://219.149.64.81/img_sck/mnzh.gif",
"MM不理我","http://219.149.64.81/bchat_img/0046.gif",
"不许乱望","http://219.149.64.81/bchat_img/mgym01.jpg",
"失恋了","http://219.149.64.81/bchat_img/mgysl.gif",
"来一起喝","http://219.149.64.81/bchat_img/yizui.gif",
"就你~~","http://219.149.64.81/bchat_img/150.gif",
"小样","http://219.149.64.81/bchat_img/1-801.gif",
"气死你","http://219.149.64.81/bchat_img/hbcz018.gif",
"干嘛欺负我","http://219.149.64.81/bchat_img/hh13.jpg",
"对不起","http://219.149.64.81/bchat_img/0039.gif",
"俺吧唧你","http://219.149.64.81/bchat_img/mgybj.gif",
"锤你","http://219.149.64.81/bchat_img/dingni.gif",
