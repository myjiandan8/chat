...
//	聊友列表区顶部HTML代码
var userlist_top_html="<table border=0 width=138 HEIGHT=50 cellspacing=0 valign=top ><tr><td valign=top ><img src=http://pic.liaowan.com/sb/2190.gif></td></tr></table>";

//	房间号码，请注意正确写法
var room_number="2190";
...
//	聊友列表区底部HTML代码
var userlist_bottom_html="<a target=_blank href='http://www.liaowan.com/bbs/' title='配置技术帮助联系QQ：153251392！'><IMG align=absMiddle src=http://pic.liaowan.com/sb/ld.gif></a>";
//	聊友列表区的背景色
...
var msg_login="俺〖"+a_user+"〗来啦~聊湾 交友聊天的港湾~《"+room_name+"》就是偶滴家~，";
...
//	级别,	说明,		图标序号,	字色,		字边缘色
	...
	1,		"在线管理辛苦了捏，雨点给你们倒水喝，嘿嘿~",		0,		"#FF0000",	"#FFFFFF",
	2,		"今日寿星",		2,		"#FF0000",	"#FFFFFF",
	3,		"本室室主声音甜不？西西，拒泡的哇~",                 3,		"#ff00ff",	"#FFFFFF",
	4,		"本室歌手~声音嗷嗷棒，唱歌嗷嗷棒~",		4,		"#F3942E",	"#FFFFFF",
	5,		"本室管理~西西，帅哥美女多多。。见者有份哇~",		4,		"#34c534",	"#FFFFFF",
	-1,		"本室嘉宾",		4,		"#2c07fe",	"#FFFFFF"
);
...
//	序号,	图片文件,	宽度,	高度,	预载的图片数量,
	...
	1,		"http://pic.liaowan.com/tb/030.gif",	20,		15,		0,
	2,		"http://pic.liaowan.com/gif/0007.gif",	20,		15,		0,
	3,		"http://pic.liaowan.com/tb/044.gif",	20,		15,		1,
	4,		"http://pic.liaowan.com/tb/gs.gif",	20,		15,		29
);
...
var a_flower=new Array(
	...
	"天音",	"、°．∴° ．∮*．° ．∴°* °天外飞音·。 ∮．°° ．∴°* ．° ．∴ * ∮．° * ． 太*．°．°．美∴° ．* ∮．了 *．° ｀",
	"旋律",	"°*ゅ.。ゅoОゅ.。旋律.ゅoОゅ。ゅoОゅゅoОゅ.蹁跹。ゅoОゅ.。.。ゅoОCOOL~~oОゅ.。 ゅoОゅ.乐声。ゅoОゅ.。ゅoОゅ.。 ゅ.。飘扬ゅoОゅoОゅ ぷ",
	"绕梁",	"°、｀、｀、｀余、｀、｀、、∮｀、音｀、｀、｀、｀、｀缭、｀∮、｀、｀、｀、｀绕、｀、｀、∮｀、｀、｀、｀、｀、｀∮、｀、｀",
	"加油",	"°·°∴° ∴扔鲜花·°∴° ∴★°扔帅哥·°∴° ∴扔美女·°∴° ∴★°哦·°∴° ∴好喜欢·°∴°好喜欢 ∴★°这旋律·°∴▁",
	"好听",	"╭°*∴*°*∴此°*°*曲∴°*°*只∴°*☆╮°应*°*∴°天*°*∴°上*☆╮°*°*有∴°*°*∴°*☆╮° *°ぷ.`.",
	"动人",	"｀、╱╲°*∴°人°*°*╲间╱°*∴°能*╭★°*°得*∴°*°几*∴°╱╲回°*°*∴°*闻°*∴°*╭★°*°°*╲╱ *☆",
	"音乐",	"~Ψ~°｀╭爱╮ `∴°☆ ·╭音╮∴°☆ ·╭乐╮∴°☆ ·╭不╮∴°☆ ·╭需╮∴°☆ ·╭要╮∴°☆ ·╭理╮∴°☆ ·╭由╮｀、");
...
function writelistbase()//聊友列表区固定的部分
{
	...
	HTMLstr += "<a title=\"请您注意\"><font color=0000ff> 试麦向</font><font color=red>红衣管理</font><font color=0000ff>打</font><font color=red>666</font></a><hr color=blue size=1>";
       ...
       HTMLstr += "<center><IMG src=http://pic.liaowan.com/gif/line0.gif></center>"; 	
       HTMLstr+="<Table cellspacing='0' cellpadding='0'><tr><td id='listhtml'></td></tr></table><center></center>";
	HTMLstr += "<center><IMG src=http://pic.liaowan.com/gif/line1.gif>";
...
function writeu1()//写U1区
{
 ...
 parent.u1.document.write('<font color=#009933>欢迎光临</font><font color=#FF0000>【蓝色小屋】</font><font color=#009933>聊天室!品一杯茶吧!~~歇会吧~~!</font><br>');
parent.u1.document.write('<font color=#009933>【蓝色小屋】欢迎你!</font><font color=#FF0000> 室主:*伤感蓝调</font> <font color=#009933> 携全体管理欢迎社会各界朋友的到来! </font><br>');
}
...
function writecv_fnc(type)
{
	...
	if (type == 0)
		...
		HTMLstr += "</style><center><br><br><font face=楷体_GB2312><font size=2 color=yellow><center><u><b> 冀人老刀<br>友情技术支持<br>QQ：153251392</b></u></center></font></font><input type=button name=closev value=打开语音 onclick=\"{parent.writev_new();if(parent.InAdminMode==1){parent.EnableVoiceAdmin();}else{parent.DisableVoiceAdmin();}}\">";

	HTMLstr+="<script language='javascript'>window.onerror=new Function('return false');</script>";
	HTMLstr += "<br><a href=http://chat.yinsha.com/voice.htm target=_blank><span style=' font-size: 9pt; color:#0000FF; text-decoration: none'>说明&测试<br>真情041001版</span></a></body></html>";
	parent.voiceframe.rows="0,*";
	parent.v.document.open();
	parent.v.document.write(HTMLstr);
	parent.v.document.close();
