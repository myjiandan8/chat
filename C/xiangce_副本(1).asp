...
<div align="center">
			...
			<table border="0" width="384" id="table1">
				<tr>
					...
					分类: <a href="xiangce_副本(1).asp?zhiwu=室主">室主</a>
					<a href="xiangce_副本(1).asp?zhiwu=主持人">主持人</a>
					<a href="xiangce_副本(1).asp?zhiwu=歌手">歌手</a>
					<a href="xiangce_副本(1).asp?zhiwu=舞者">舞者</a>
					<a href="xiangce_副本(1).asp?zhiwu=嘉宾">嘉宾</a>
					<a href="xiangce_副本(1).asp?zhiwu=联友">聊友</a></td>
				</tr>
				...
				<tr>
					...
					<table border="0" width="96%" id="table2" height="116">
						<tr>
							...
							<img border="0" src="../image/<%=id%>/s<%=rs("picname")%>" width="138" height="120"></a></td>
							...
							<table border="0" width="215" id="table3" height="118" cellspacing="1">
								<tr>
									<td width="211" height="21">
								...
								<tr>
									<td width="211" height="72" valign="top">
									&nbsp;&nbsp;&nbsp;&nbsp; 
				...
				<tr>
					<td height="21">
					 <table cellspacing="5" cellpadding=0 width="385" border=0>
                        <tbody> 
                        <tr> 
                          <td width="375"> 共<%=total%>条&nbsp;&nbsp;共<%=rs.pagecount%>页 当前第<%=page%>页 分页： 
                            <%
if page>1 then%>
                            <a href="xiangce.asp?page=<%=page-1%>&zhiwu=<%=Request("zhiwu")%>">上一页</a> 
                            <%
end if
%>
                            <%
...
response.write "<a href='xiangce.asp?page="&j&"&zhiwu="&Request("zhiwu")&"'>["&j&"]</a>"
next
else
for j=1 to 8
response.write "[<a href='xiangce.asp?page="&j&"&zhiwu="& Request("zhiwu") &"'>"&j&"</a>]&nbsp;"
next
response.write  "[<a href='xiangce.asp?page="&rs.pagecount&"&zhiwu="& Request("zhiwu") &"' title='最后一页'>&gt;&gt;</a>]"
end if
%>
                            <%
if page<rs.pagecount   then%>
                            <a href="xiangce.asp?page=<%=page+1%>&zhiwu=<%=Request("zhiwu")%>">下一页</a> <font color="#336699"> 
                            <%
end if
%>
                            </font></td>
