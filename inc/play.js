...
function SetVolumeNum(gene)
{
   var mmsplayer=document.all("mmsplayer");	
	...
	if(vol>80)
       soundscr.background="images/player/player_v5.gif";
    if(vol>60 && vol<=80)
       soundscr.background="images/player/player_v4.gif";
    if(vol>40 && vol<=60)
       soundscr.background="images/player/player_v3.gif";
    if(vol>20 && vol<=40)
       soundscr.background="images/player/player_v2.gif";
    if(vol>0 && vol<=20)
       soundscr.background="images/player/player_v1.gif";
       
    if(vol<=0)
       soundscr.background="images/player/player_v0.gif";
