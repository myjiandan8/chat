...
rs.Open "select * from www_link",conn,1,3
rs.AddNew
...
case "edit" '信息修改
set rs=server.CreateObject("adodb.recordset")
rs.open "select * from www_link where linkid="&linkid,conn,1,3
...
case "del" '信息删除
conn.execute "delete from www_link where linkid="&linkid
response.Redirect "links.asp"
                    ...
                    <tr> 
                      <td> 
                        <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#006600">
                          <tr> 
                            <td bgcolor="#FFFFFF"> 
                              <div align="center"><font color="#000000">管理合作伙伴</font></div>
                            </td>
                          </tr>
                          <tr> 
                            <td height="99" valign="top" bgcolor="#E8F1FF"><br>
        <%set rs=server.CreateObject("adodb.recordset")
		rs.open "select * from www_link order by linkidorder",conn,1,1
		dim i
		i=rs.recordcount%>
		  ...
		  do while not rs.eof%>
                                <tr> 
                                  <form name="form1" method="post" action="links.asp?action=edit&id=<%=rs("linkid")%>">
                                    ...
                                    <td bgcolor="#E8F1FF"> 
                                      <div align="center"> 
                                        ...
                                        &nbsp;&nbsp;<a href=links.asp?action=del&id=<%=rs("linkid")%>><font color="#FF0000">删除</font></a> 
                                      </div>
                                    </td>
                                  </form>
                                </tr>
                    ...
                    <tr> 
                      <td> 
                        <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#006600">
                          <tr> 
                            <td bgcolor="#FFFFFF"> 
                              <div align="center"><font color="#000000">添加合作伙伴</font></div>
                            </td>
                          </tr>
                          <tr> 
