...
<HTML><HEAD><TITLE>聊湾视频门户总后台[VCU同盟]VCU.CN LIAOWAN.COM</TITLE><LINK href="img/lwoo.css" rel=stylesheet>
...
<BODY style="border:0px none; margin:0px; " scroll=no onMouseOver="window.status='聊湾视频门户总后台[VCU同盟]VCU.CN LIAOWAN.COM';return true">
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0>
  <TBODY>
  <TR>
    <TD id=frmTitle vAlign=center noWrap align=middle name="frmTitle">
    <IFRAME id=carnoc style="Z-INDEX: 2; VISIBILITY: inherit; WIDTH: 190; HEIGHT: 100%" name=carnoc src="index_left.asp" frameBorder=0 target="main">
    </IFRAME></TD>
