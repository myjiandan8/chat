  ...
  <tr> 
    <form method="post" action="memberList.asp" name="form1">
      <td colspan="4" bgcolor="#4296E7" height="28" width="737"> 
        <div align="center"><font color="#FFFFFF">服务器维护&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
          <b>&nbsp;<span lang="zh-cn"><a href="useradd.asp"><font color="#FFFFFF">添加新服务器</font></a></span></b></font></div>
      </td>
    </form>
  </tr>
  <tr bgcolor="#5EA5E6"> 
    <td width="100" nowrap> 
      <div align="center"><font color="#FFFFFF">服务器编号</font></div>
    </td>
    <td width="150" nowrap> 
      <div align="center"><font color="#FFFFFF">服务器域名</font></div>
    </td>
    <td width="249" nowrap align="center"> 
      <font color="#FFFFFF">接口地址</font></td>
    <td width="95" nowrap align="center"> 
      <font color="#FFFFFF">其他</font></td>
  </tr>
  <%
		dim rsID
		i=1
