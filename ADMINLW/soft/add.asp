...
<FORM method="POST" name="myform" action="addsave.asp" onsubmit='return check_input()' enctype=multipart/form-data>
  <TABLE width="692" border="0" align="center" cellspacing="1" height="670">
             <TBODY>
             <TR align="center">
             <TD colspan="4" height="22" bgcolor="#145f74" width="630"><B><FONT color="#FFFFFF">添 加 新 软 件</FONT></B></TD></TR><TR>
...
%></SELECT> </TD>
			<TD align="right" width="99" bgcolor="#A5D0DC" height="27"><B>选择分类：</B></TD>
             ...
             <OPTION selected value>==请选分类==</OPTION></SELECT> </TD></TR><TR>
             ...
             <INPUT type="text" name="softname" size="33" class="smallinput" maxlength="100"> 
             <INPUT onclick="javascript:Check()" type="button" value="检查是否有重复" name="cmdcancel1" class="buttonface"></TD></TR>
             <tr>
             ...
             <option selected value="0">普通软件</option>
             <option value="1">推荐软件</option>
             <option value="2">置顶推荐软件</option>
               </SELECT>&nbsp; </TD>
             </tr>
             <tr>
             ...
             千万不要处理错了<a target="_blank" href="add.asp">。</a></font></b></TD>
             </tr>
             <tr>
             ...
             的文件名</font>：</b></TD>
             <TD width="472" height="1" colspan="3" bgcolor="#cce6ed">
             <br>
             管理员必须提前将软件上传到服务器。小于1.5M的软件可以使用[<a href="UP.ASP?abc=1">网页上传软件</a>]。<br>
             大于1.5M文件使用FTP上传。大于50M由服务器上处理，联系超级管理员。<br>
             <INPUT type="text" name="filename" size="33" class="smallinput" maxlength="100"> 
             <INPUT onclick="javascript:Check1()" type="button" value="检查是否有重复" name="cmdcancel2" class="buttonface"><br>
             <b><font color="#008000">如 </font></b> <b>
             <font color="#008000">lftp.rar&nbsp;&nbsp; QQ2003m.ZIP</font></b><br>
...
　</b></font></TD>
             ...
             <br>
             连接点1：<INPUT type="text" name="lk1" size="33" class="smallinput" maxlength="100"> 
             可以只填一个连接点<br>
             连接点2：<INPUT type="text" name="lk2" size="33" class="smallinput" maxlength="100"><br>
             连接点3：<INPUT type="text" name="lk3" size="33" class="smallinput" maxlength="100"><br>
             连接点4：<INPUT type="text" name="lk4" size="33" class="smallinput" maxlength="100"></TD>
             </tr>
             <TR>
             ...
             <INPUT type="text" name="flash" size="26" class="smallinput" maxlength="100"></TD>
             </tr>
             <tr>
             ...
             <b>作者/厂家主页<font color="#FF0000">：</font></b></TD>
               ...
               <INPUT type="text" name="web" size="33" class="smallinput" maxlength="160" value="http://"> 
               [可选]</TD>
             </tr>
             <tr>
             ...
             <b>程序演示地址<font color="#FF0000">：</font></b></TD>
               <TD width="578" height="15" bgcolor="#cce6ed" colspan="3">
               <INPUT type="text" name="yanshi" size="33" class="smallinput" maxlength="160" value="http://"> 
               [可选]</TD>
             </tr>
             <tr>
             ...
             <font color="#008000">运行环境</font><font color="#FF0000">：</font></B></TD>
               <TD width="578" height="7" bgcolor="#cce6ed" colspan="3"><SELECT name="system" size="1">
             <OPTION value="Win9X, WinME, WinNT, Win2K, WinXP" name="system" selected>Win9X, WinME, WinNT, Win2K, WinXP</OPTION>
             <option value="WinNT, Win2K, WinXP">WinNT, Win2K, WinXP</option>
             ...
             <TD width="472" height="27" colspan="3" bgcolor="#cce6ed">1星.<INPUT type="radio" value="1" name="hot">&nbsp;&nbsp;&nbsp; 2星.<INPUT type="radio" value="2" name="hot">&nbsp;&nbsp;&nbsp; 3星.<INPUT type="radio" value="3" name="hot">&nbsp;&nbsp;&nbsp; 4星.<INPUT type="radio" value="4" name="hot">&nbsp;&nbsp;&nbsp; 5星.<INPUT type="radio" value="5" name="hot" checked>
             </TD>
             </tr>
             <tr>
             ...
             <b>软件关键字：</b></font></TD>
               ...
               <INPUT type="text" name="gj" size="54" class="smallinput" maxlength="160"> 
               关键字用 空格&quot; &quot; 隔开<br>
             ...
             <TEXTAREA rows="10" name="txt" cols="70" class="smallarea"></TEXTAREA> </FONT></TD></TR></TBODY></TABLE><DIV align="center">
             <CENTER>
