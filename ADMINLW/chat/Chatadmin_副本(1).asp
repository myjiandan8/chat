...
'处理BCHAT
sql="select admintor,port from [Room]"
set rsm=Bchatconn.execute (sql)
do while not (rsm.eof or err)

	admintors =badmin & rsm("admintor")
	letian=roomcfgdir & "\" & rsm("port") & "\adminpass_" & rsm("port") & ".txt"
                    ...
                    <tr> 
                      <td> 
                        <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#006600">
                          ...
                          <tr> 
                            <form name="form2" method="post" action="Chatadmin_副本(1).asp?action=add">
