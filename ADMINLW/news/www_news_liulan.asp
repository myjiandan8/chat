...
<div align="center">
  ...
  <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#C6C3FF" width="650" id="AutoNumber4" bgcolor="#F7F7FF" height="281">
    <tr>
      <td width="100%" background="../img/bg.gif" height="22">&nbsp;&nbsp;<img border="0" src="../img/jt.gif"><b><span lang="zh-cn"> 新闻浏览</span></b></td>
    </tr>
    <tr>
...
&nbsp;<img border="0" src="../img/pagelist.gif"> 新闻来自: <a href="<%=rsc("nccurl")%>"><%=rsc("ncc")%></a> 发布时间: <%=rsc("times")%>          新闻类型:
<%
...
<% if nz=1 or nz=2 then %>
 ...
 <img border="0" src="../img/msg_no_new_bar.gif"> <b><a href=www_news_liulan.asp?id=<%=ids%>><%=titles%></a></b>( 系列报道 )           
</td>
          </tr>
<%
...
do while not (rss.eof or err) %>
          <tr>
            ...
            <br>
&nbsp;&nbsp;<img border="0" src="../img/forum_online.gif"> <a href=www_news_liulan.asp?id=<%=rss("id")%>><%=rss("title")%></a> <%=rss("times")%> </td>
...
%>
          ...
          <tr>
            <td width="100%" height="18" bgcolor="#EEF2FF"> <img border="0" src="../img/mini_query.gif"> <a href="<%=rsc("nccurl")%>"><%=rsc("ncc")%></a> 
            ( 其他相关新闻和信息 )   </td>
          </tr>
          <tr>
