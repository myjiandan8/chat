...
.tabbg01 {	background-image: url('pic/gbz1.jpg');background-repeat: no-repeat;background-position: Right bottom}
.tabbg02 {	background-image: url('pic/toplogo.gif');background-repeat: no-repeat;background-position: left bottom}
-->
</style>
		...
		<tr>
			...
			<table border="0" width="100%" id="table332" cellspacing="0" cellpadding="0" height="63">
				<tr>
					...
					<img border="0" src="pic/ADC.gif" width="223" height="96"></td>
						</tr>
						<tr>
							<td height="24" align="center">
							<font color="#003366">
							<img border="0" src="img/announce.gif" width="18" height="18"><marquee scrolldelay="220" width="517">申请秀舞房间加QQ42839033 话题音乐房间QQ81196785&nbsp; 聊湾新概念聊天室系统开始销售,拥有属于自己视频聊天室,自己做室主,体味网络创业的乐趣从聊湾开始。联系QQ779810 小小 网站合作 QQ779811 乐天</marquee></font></td>
...
<%
opennews
sql="SELECT top 9 news_ahome, news_author, news_date, news_id, news_title FROM news ORDER BY news_date DESC"   
      ...
      <TABLE cellSpacing=0 cellPadding=0 width=288 align=center border=0 id="table329">
        ...
        <TR>
          <TD height=74 style="FILTER: dropshadow(color=#ffffff,offx=1,offy=1);color:#4b4b4b">
					<font color="#000000">&nbsp;&nbsp;&nbsp; 
					亲爱的聊湾忠实聊友们，聊湾新开通后，立志成为创立中国视频聊天第一门户，为聊友提供便捷和最完善视频聊天系统，为同盟网站提供展示本站风采的平台。聊湾以龙软强大的技术支持为基础，为同盟网站提供最专业的技术支持。<br>
&nbsp;&nbsp;&nbsp; 在此也特别感谢淡淡、老狼对本站的支持！！</font></TD></TR>
        <TR>
          <TD height=4>
...
<div align="center">
	<table border="0" width="778" id="table221" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" height="83">
		...
		<tr>
			...
			<table border="0" cellpadding="5" cellspacing="5" width="100%" id="table421">
				<tr>
					<td><font color="#FF0000"><b>通告</b></font><font color="#0E86BF">：请各位不能自动安装插件的聊友下载最新的聊天插件才能正常聊天：</font><b><a href="http://www.liaowan.com/Chatjs/LWSeTup.exe"><font color="#0E86BF">手动下载聊湾视频聊天插件V1.0</font></a></b><font color="#0E86BF">&nbsp;
					</font><b>
					<a target="_blank" href="http://www.bluesky.cn/download/bluesky.exe">
					<font color="#0E86BF">手动下载蓝天语音聊天插件</font></a></b></td>
				</tr>
				<tr>
					<td><b><font color="#FF0000">通知</font></b>：<font color="#800080">为加强管理，聊湾将暂时关闭所有房间的视频功能。以及其他网站聊天室的连接将在近期转入VCU。实现聊湾与VCU网站的独立运行。</font></td>
				</tr>
			</table>
			</td>
		</tr>
			...
			<div align="center">
				<table border="2" width="774" id="table225" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#C0C0C0" height="40">
					<tr>
						<td height="74">
						<div align="center">
		<table cellSpacing="0" cellPadding="0" width="766" border="0" id="table1">
			<form onsubmit="return smsdaychatcheckReg(this);" method="get" target="_blank" action="http://www.smsday.com/chat/reg.asp">
				<tr>
					<td width="530">
					<img height="70" src="http://www.smsday.com/ad/760_70_1.gif" width="530" border="0"></td>
					<td align="middle" width="238" bgColor="#000000" height="70">
					<img src="http://www.smsday.com/img/haotitle3.gif" align="absMiddle" border="0"><br>
					<input style="BORDER-RIGHT: 1px solid; BORDER-TOP: 1px solid; BORDER-LEFT: 1px solid; COLOR: #000000; BORDER-BOTTOM: 1px solid" maxLength="12" size="11" value="13" name="mobile_num">
					<input style="BORDER-RIGHT: #000000 0px solid; BORDER-TOP: #000000 0px solid; BORDER-LEFT: #000000 0px solid; COLOR: #ff0000; BORDER-BOTTOM: #000000 0px solid; BACKGROUND-COLOR: #ffffff" type="submit" value="马上享受" name="imageField4">
					<input id="unionid" type="hidden" name="unionid"><br>
					<font color="#FFFF00">郑重声明:本广告内容与聊湾无关</font></td>
				</tr>
			</form>
		</table>
						</div>
...
<table width="778" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" style="border-collapse: collapse" bordercolor="#111111" height="335">
  <tr> 
    <td valign="top" width="188" height="335" rowspan="3"> 
	  ...
	  <table border="0" width="100%" id="table14" height="394" cellspacing="1" cellpadding="2">
		<tr>
			<td height="5">
		...
		<tr>
			...
			<table border="1" width="100%" id="table223" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#0099FF" height="98" bgcolor="#D9F0FF">
				<tr>
					<td valign="top">
			<table border="0" width="100%" id="table224" cellspacing="0" cellpadding="0" height="101">
				<tr>
					<td bgcolor="#0099CC" height="5"></td>
				</tr>
				<tr>
					<td height="38" bgcolor="#FFFFFF">
					<img border="0" src="images/f-down.gif" width="172" height="29"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<table border="0" width="100%" id="table230" cellpadding="2" height="57">
						<tr>
							<td style="FILTER: dropshadow(color=#ffffff,offx=1,offy=1);color:#4b4b4b" height="53">
...
<form name="ss1" onsubmit="return false;" action="/ss.asp" method="post">
                              <tr>
							   ...
							   &nbsp;<img border="0" src="../images/icon_male.gif" width="13" height="13"><b><font color="#FF0000">
								<a target="_blank" href="http://www.liaowan.com/Chatjs/LWSeTup.exe">
								<font color="#FF0000">下载聊湾视频聊天插件</font></a></font></b></td>
                              </tr>
                              <tr>
                                <td width="100%" height="23">
                               &nbsp;<img border="0" src="../images/icon_female.gif" width="13" height="13"><b><font color="#003366">
								<a target="_blank" href="http://www.bluesky.cn/download/bluesky.exe">
								<font color="#003366">下载蓝天视频聊天插件</font></a></font></b></td>
                              </tr>
</form>
                              </table>
								</td>
		...
		<tr>
			<td align="center" valign="top" height="156">
					<table border="1" width="100%" id="table411" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#93DA14" height="152">
						<tr>
							<td bgcolor="#C1F167" height="22">
							<b><font color="#000000">&nbsp;<img border="0" src="img/ico.gif" width="9" height="15"> 功能导航</font><font color="#244A02">
							</font></b>
							</td>
						</tr>
						<tr>
							<td valign="top" class="tabbg01">
							<div align="center">
							<table border="0" width="95%" id="table412" height="127" cellpadding="2" cellspacing="1">
								<tr>
									<td height="21"><font color="#008000"><b>聊友工具箱</b></font></td>
								</tr>
								<tr>
									<td height="24">
									<img border="0" src="img/i5.gif" width="8" height="8"><a target="_blank" href="../vip/regadd.asp">用户注册</a>
									<img border="0" src="img/i5.gif" width="8" height="8"><a target="_blank" href="../vip/usermima.asp">密码找回</a> 
									<img border="0" src="img/i5.gif" width="8" height="8">帮助</td>
								</tr>
								<tr>
									<td height="16"><font color="#008000"><b>室主工具箱</b></font></td>
								</tr>
								<tr>
									<td height="24">
									<img border="0" src="img/i5.gif" width="8" height="8"><a target="_blank" href="/admin">室主管理</a>
									<img border="0" src="img/i5.gif" width="8" height="8">聊管设置  
									<img border="0" src="img/i5.gif" width="8" height="8">申请</td>
								</tr>
								<tr>
									<td height="16"><font color="#008000"><b>产品导航</b></font></td>
								</tr>
								<tr>
									<td>
									<img border="0" src="img/i5.gif" width="8" height="8">购买聊天室 
									<img border="0" src="img/i5.gif" width="8" height="8">彩马甲</td>
								</tr>
							</table>
							</div>
							</td>
		...
		<tr>
			<td align="center" valign="top" height="109">
					<table border="1" width="100%" id="table415" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#FFB84D" height="63">
						<tr>
							<td bgcolor="#FFCC66" height="22">
							<b><font color="#000000">&nbsp;<img border="0" src="img/ico.gif" width="9" height="15"> 
							客服向导</font><font color="#244A02">
							</font></b>
							</td>
						</tr>
						<tr>
							<td valign="top">
							<div align="center">
							<table border="0" width="177" id="table416" height="67" cellpadding="2" cellspacing="1">
								<tr>
									<td height="7" width="34"><b><font color="#FF0000">
									举报</font></b></td>
									<td height="7" width="132"><b><font color="#FF0000">
									QQ</font></b><b><font color="#000000"><a target="_blank" href="http://wpa.qq.com/msgrd?V=1&Uin=779811&Site=在线投诉&Menu=no"><font color="#FF0000">779811</font></a></font><font color="#FF0000"> </font><font color="#000000">
									<a target="_blank" href="http://wpa.qq.com/msgrd?V=1&Uin=419046025&Site=在线投诉&Menu=no">
									<font color="#FF0000">419046025</font></a></font></b></td>
								</tr>
								<tr>
									<td height="20" width="34"><b>&nbsp;&nbsp;&nbsp;
									</b></td>
									<td height="20" width="132"><b>
									<font color="#FF0000">QQ</font><font color="#000000"><a target="_blank" href="http://wpa.qq.com/msgrd?V=1&Uin=1117681&Site=在线投诉&Menu=no"><font color="#FF0000">1117681</font></a></font><font color="#FF0000">
									</font><font color="#000000">
									<a target="_blank" href="http://wpa.qq.com/msgrd?V=1&Uin=57423255&Site=在线投诉&Menu=no">
									<font color="#FF0000">57423255</font></a></font></b></td>
								</tr>
								<tr>
									<td height="23" width="34">
									<font color="#008000"><b>技术<br>
									</b>&nbsp;&nbsp;&nbsp;&nbsp; </font></td>
									<td height="23" width="132">
									<font color="#008000"><b>QQ<a target="_blank" href="http://wpa.qq.com/msgrd?V=1&Uin=153251392&Site=在线投诉&Menu=no"><font color="#008000">153251392</font></a>
									<a target="_blank" href="http://wpa.qq.com/msgrd?V=1&Uin=489244&Site=在线投诉&Menu=no">
									<font color="#008000">489244</font></a><br>
									QQ<a target="_blank" href="http://wpa.qq.com/msgrd?V=1&Uin=252244095&Site=在线投诉&Menu=no"><font color="#008000">252244095</font></a></b></font></td>
								</tr>
								<tr>
									<td height="20" width="34"><b><font color="#000080">
									业务</font></b></td>
									<td height="20" width="132"><b><font color="#000080">
									QQ<a target="_blank" href="http://wpa.qq.com/msgrd?V=1&Uin=81196785&Site=在线投诉&Menu=no"><font color="#000080">81196785</font></a>
									<a target="_blank" href="http://wpa.qq.com/msgrd?V=1&Uin=779810&Site=在线投诉&Menu=no">
									<font color="#000080">779810</font></a> </font></b></td>
								</tr>
								</table>
							</div>
							</td>
																...
																<tr>
																	...
																	<table cellSpacing="0" cellPadding="0" border="0" id="table364">
																		...
																		<tr>
																			...
																			<table height="300" cellSpacing="3" cellPadding="0" width="100%" border="0" id="table365">
																				<tr>
																					<td height="74">
...
Sub tuijian(fid)
				...
				sql="select top 18 * from [web] where ff=1 and  ufid="& fid &" ORDER BY ID ASC"
															...
															<table cellSpacing="1" cellPadding="0" bgColor="#b0b0ae" border="0" id="table374">
																<tr>
																	...
																	<table cellSpacing="0" cellPadding="0" border="0" id="table375">
																		...
																		<tr>
																			<td align="middle" height="200">
																			<table height="300" cellSpacing="3" cellPadding="0" width="100%" border="0" id="table376">
																				<tr>
																					<td height="74">
															...
															<table cellSpacing="1" cellPadding="0" bgColor="#b0b0ae" border="0" id="table385">
																<tr>
																	...
																	<table cellSpacing="0" cellPadding="0" border="0" id="table386">
																		...
																		<tr>
																			<td align="middle" height="200">
																			<table height="301" cellSpacing="3" cellPadding="0" width="100%" border="0" id="table387">
																				<tr>
																					<td height="74">
																					<table cellSpacing="0" cellPadding="4" width="100%" border="0" id="table388">
																						<tr>
																							...
																							<td><font color="#CC3300">购KTV包房<br>
																							与亲朋网络<br>
																							视频飑歌</font></td>
																						</tr>
																					</table>
  ...
  <tr> 
    <td align="center" valign="top" width="25%" height="78">
		<table border="0" width="778" id="table12" height="78" cellspacing="0" cellpadding="0">
			...
			<div align="center">
				<table border="2" width="774" id="table405" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#C0C0C0" height="40">
					<tr>
						<td height="60" valign="top">
						<table border="0" width="100%" id="table406" cellspacing="0" cellpadding="0" height="64">
							<tr>
								<td width="306" valign="top">
									<table height="60" cellSpacing="0" cellPadding="0" width="100%" border="0" id="table407">
										<tr>
											<td height="20">
											<table height="60" cellSpacing="0" cellPadding="0" width="100%" border="0" id="table408">
												<tr>
													<td width="50%" bgColor="#e8ebec">
													<table cellSpacing="2" cellPadding="0" width="100%" border="0" id="table409">
														<tr>
											...
											<div align="center">
											<table cellPadding="0" width="100%" border="0" id="table410" height="62">
												<tr>
													<td bgColor="#ffffff" height="18">
    ...
    <table border="0" cellpadding="2" cellspacing="1" width="100%" id="table347" height="409">
      ...
      <tr>
        ...
        <table border="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="table351" height="351">
                  ...
                  <tr>
                    <td width="97%" height="330" valign="top" style="border-left-style: solid; border-left-width: 1; border-right-style: solid; border-right-width: 1; border-bottom-style: solid; border-bottom-width: 1" bordercolor="#86D0FD" background="pic/bg23.gif">                    
<div align="center">
  <center>
...
<script>
	...
	<tr>
		<td width="100%"  colspan="2"><font color="#000080"><u>下载插件</u>: </font><img border="0" src="../PIC/imgico/vv0.gif" width="14" height="13"><a target="_blank" href="http://www.bluesky.cn/download/bluesky.exe"><font color="#0000FF">BChat</font></a><font color="#008000">
		</font>
		...
		<img border="0" src="../images/eye.gif" width="19" height="11"><font color="#FF3300">视
		频<img border="0" src="../PIC/IMG/A.gif">语音</font></td>
	</tr>
</table>
...
%>
		...
		<tr>
			...
			<div align="center">
				<table border="2" width="100%" id="table419" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#C0C0C0" height="40">
					<tr>
						<td height="74">
						<div align="center">
		<table cellSpacing="0" cellPadding="0" width="100%" border="0" id="table420">
			<form name="goto" onsubmit="return smsdaychatcheckReg(this);;" method="get" target="_blank" action="http://www.smsday.com/movie/reg.asp">
				<tr>
					<td width="385">
					<img height="70" src="http://www.smsday.com/ad/movie/760_70_1.gif" width="410" border="0"></td>
					<td align="middle" width="186" bgColor="#000000" height="70">
					<img src="http://www.smsday.com/img/haotitle3.gif" align="absMiddle" border="0"><br>
					<input style="BORDER-RIGHT: 1px solid; BORDER-TOP: 1px solid; BORDER-LEFT: 1px solid; COLOR: #000000; BORDER-BOTTOM: 1px solid" maxLength="12" size="9" value="13" name="mobile_num">
					<input style="BORDER-RIGHT: #000000 0px solid; BORDER-TOP: #000000 0px solid; BORDER-LEFT: #000000 0px solid; COLOR: #ff0000; BORDER-BOTTOM: #000000 0px solid; BACKGROUND-COLOR: #ffffff" type="submit" value="马上享受" name="imageField">
					<input id="unionid" type="hidden" name="unionid"><br>
					<font color="#FFFF00">声明:本广告内容与聊湾无关</font></td>
				</tr>
			</form>
		</table>
						</div>
