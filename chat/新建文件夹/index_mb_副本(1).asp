...
<font color="#FF0000">&nbsp; 聊湾升级服务器升级服务器硬件与网络环境，对大家造成的不便深表歉意。</font></td>
        </tr>
        <tr>
...
%><embed src="<%=wenjian%>" align="baseline" border="0" width="0" height="0"
        ...
        defaultframe="datawindow" hidden>
    </embed>
...
<SELECT style="border:1px solid #000000; WIDTH: 95; BACKGROUND-COLOR: #F7F7F7;" onchange=javascript:window.open(this.options[this.selectedIndex].value) size=2 name=wangy>  
