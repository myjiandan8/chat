...
sql="select top 32 Roomname,num,admin,host,id,RoomType,rtype,max,newtype,ff from [web] where [liebiao]=0 order by num desc"
set rs=Chatconn.execute (sql)
 i=0
 do while not (rs.eof or err or i=32)

	rooms = rooms & fenge & """" & rs("Roomname") & """" & "," & rs("num") & ",""" & rs("admin") & """," & rs("id") & "," & rs("RoomType") & ",""" & rs("rtype") & """," & rs("max") & "," & rs("newtype") & "," & rs("ff")
	fenge = ","
	i=i+1
  rs.moveNext
  loop
...
<table width="778" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" style="border-collapse: collapse" bordercolor="#111111" height="437">
  <tr> 
    <td valign="top" width="209" height="435"> 
	  ...
	  <table border="0" width="100%" id="table14" height="410">
		<tr>
			<td height="235" align="center" background="img/zi.gif" valign="top">
			<table border="0" width="94%" id="table16" height="220" cellspacing="1">
				<tr>
					<td height="57">　</td>
				</tr>
				<tr>
					<td height="124" valign="top"><font color="#00294F">&nbsp;&nbsp;&nbsp; 
					可视语音聊天，是一种最先进的聊天方式，您只有拥有一只麦克风和一个视频头就完全能够加入近来。在聊湾你可以与远方的亲人朋友面对面的语音交谈，也可以结交新的朋友，不用害羞无须拘束。聊湾语音聊天国际长途电话费，免了聊了半天还不知道对方性别的烦恼，免了文字的虚幻，给网络带来了我们期待的真实...</font></td>
				</tr>
				<tr>
					<td height="3"></td>
				</tr>
				<tr>
					<td><font color="#000000">运行房间:</font><font color="#FF0000"><b><%=maxroom%></b></font><font color="#000000">间 
		...
		<tr>
			<td align="center" valign="top">
			<a target="_blank" href="../info/shop.asp">
			<img border="0" src="../ad/PIC/1.gif" width="199" height="68"></a></td>
		</tr>
		<tr>
      ...
      <tr>
        ...
        <table border="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber20" height="351">
                  <tr>
                    ...
                    <font color="#025E95">&nbsp;<b>火爆房间排行</b> Top 32&nbsp; </font>
					<font color="#008000">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		 
		<img border="0" src="../PIC/IMG/m2.gif" width="15" height="13"></font><font color="#808080">聊天室请使用碧聊帐号</font></td>
...
<script>
	...
	{	
        ...
        document.write("<img border=0 src=../PIC/IMG/S" + Getff(i) + Getnewtype(i) + ".gif> ");
	...
	<tr>
		<td colspan="2"><font color="#000080">例:</font><img border="0" src="../PIC/IMG/m0.gif" width="15" height="13"><font color="#008000">蓝天
		 
		<img border="0" src="../PIC/IMG/m1.gif" width="15" height="13">和韵
		 
		<img border="0" src="../PIC/IMG/m2.gif" width="15" height="13">碧聊</font>&nbsp;
		<font color="#800080">
		<img border="0" src="../PIC/IMG/mm1.gif" width="15" height="13">舞<img border="0" src="../PIC/IMG/mm2.gif" width="15" height="13">歌<img border="0" src="../PIC/IMG/mm3.gif" width="15" height="13">情&nbsp;</font>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="90%" id="AutoNumber23">
		...
		<table border="0" width="98%" id="table1" cellspacing="0" cellpadding="0" height="221">
    		...
    		%>
					<tr>
						<td width="164" colspan="2" align="right" height="29">
