...
{document.addart.art_content.value=document.addart.art_content.value+str;}
var Quote = 0;
var Bold  = 0;
var Italic = 0;
var Underline = 0;
...
document.addart.art_content.value+=NewCode;
document.addart.art_content.focus();
return;
}
...
function AddText(text) {
	if (document.addart.art_content.createTextRange && document.addart.art_content.caretPos) {      
		var caretPos = document.addart.art_content.caretPos;      
		caretPos.text = caretPos.text.charAt(caretPos.text.length - 1) == ' ' ?
		text + ' ' : text;
	}
	else document.addart.art_content.value += text;
	document.addart.art_content.focus(caretPos);
}
function inputs(str)
{
AddText(str);
...
document.addart.art_content.value+=ToAdd;
document.addart.art_content.focus();
}
function Cimage() {
var FoundErrors = '';
...
function paste(text) {
	if (opener.document.addart.art_content.createTextRange && opener.document.addart.art_content.caretPos) {      
		var caretPos = opener.document.addart.art_content.caretPos;      
		caretPos.text = caretPos.text.charAt(caretPos.text.length - 1) == ' ' ?
		text + ' ' : text;
	}
	else opener.document.addart.art_content.value += text;
	opener.document.addart.art_content.focus(caretPos);
}
...
document.addart.art_content.value=fontbegin+document.addart.art_content.value+fontend;
document.addart.art_content.focus();
}
}
...
if (ie){
function ctlent(eventobject){if(event.ctrlKey && window.event.keyCode==13){this.document.addart.submit();}}
}
function DoTitle(addTitle) { 
var revisedTitle; 
var currentTitle = document.addart.subject.value; 
revisedTitle = currentTitle+addTitle; 
document.addart.subject.value=revisedTitle; 
document.addart.subject.focus(); 
return; }

function insertsmilie(smilieface){

	document.addart.art_content.value+=smilieface;
}
//-->
</script>