<%sub ubbshow()%>
<input onClick=Cbold() type="button" name="Bold" value="Bold" class="button"> <input onClick=Citalic() type="button" name="Italic" value="Italic" class="button"> 
<input onClick=Cunder() type="button" name="Underline" value="Underline" class="button"> 
<input onClick=Ccenter() type="button" name="Center" value="Center" class="button"> 
<input onClick=Curl() type="button" name="Link" value="Link" class="button"> <input onClick=Cimage() type="button" name="image" value="image" class="button"> 
<input onClick=Cfly() type="button" name="Fly" value="Fly" class="button"> 
<input type="button" name="iFrame" value="Frame" class="button" onClick=CiFrame()>
&nbsp;&nbsp;&nbsp;<br>
字体： 
