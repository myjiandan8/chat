...
<table width="271" border="0" cellspacing="0" cellpadding="0">
  <form name="form1" method="post" action="upfile1a.asp" enctype="multipart/form-data" >
    <tr align="center" valign="middle"> 
      <td width="271" height="54" align="center" id="upid"><input type="hidden" name="act" value="upload"> 
	  ...
	  window.upid.innerHTML=str+'<br>';
        ...
        <input type="hidden" name="filepath" class="tx" style="width:350" value="/upload">
        <br>
        图片: 
...
<%=request.cookies("0")%><br>
<%=request.cookies("1")%><br>
</body>
</html>
<script language="javascript">
