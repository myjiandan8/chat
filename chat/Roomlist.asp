...
<% call top %>
<SCRIPT language=Javascript src="/Room.asp?page=<%=page%>&maxPerPage=500" type=text/javascript></SCRIPT>
...
<div align="center">
  <center>
  <table border="0" cellpadding="2" width="604" id="table2" height="157">
    <form name="login" onsubmit="return false;" action="/" method="post">
    <tr>
      <td width="604" height="32" align="center" colspan="3">
...
<INPUT type="radio" name="SEX" value="1" checked></font>男 <font color="#336699"> <INPUT type="radio" name="SEX" value="2" ></font>女 &nbsp;验证码: <font color="#336699">
...
<input type="hidden" name="ROOMID">
    ...
    <tr>
      <td width="604" height="18" colspan="3">
      <p align="center"></td>
    </tr>
...
<script>
    ...
    <tr>
      ...
      <td width="206" height="23" valign="top">　</td>
    </tr>
