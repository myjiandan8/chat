...
<TITLE><%=chatfl(RoomType)%>--聊湾可视语音聊天网-BCHAT OR LWOO 龙软科技</TITLE>

<% call top %>
<SCRIPT language=Javascript src="/Room.asp?RoomType=<%=RoomType%>" type=text/javascript></SCRIPT>
...
<input type="hidden" name="ROOMID">
    ...
    <tr>
      ...
      <p align="center">&nbsp;<a href="Roomfl.asp?RoomType=1">情感</a>&nbsp;
 <a href="Roomfl.asp?RoomType=2">地域</a>&nbsp;
 <a href="Roomfl.asp?RoomType=3">文学</a>&nbsp;
 <a href="Roomfl.asp?RoomType=4">音乐</a>&nbsp;
 <a href="Roomfl.asp?RoomType=5">游戏</a>&nbsp; <a href="Roomfl.asp?RoomType=6">投资</a>&nbsp;
 <a href="Roomfl.asp?RoomType=7">戏剧</a>&nbsp;
 <a href="Roomfl.asp?RoomType=8">中年</a>&nbsp;
 <a href="Roomfl.asp?RoomType=9">老年</a>&nbsp;
 <a href="Roomfl.asp?RoomType=10">宗教</a>&nbsp;<br>
      <a href="Roomfl.asp?RoomType=11">教育</a>&nbsp;
 <a href="Roomfl.asp?RoomType=12">外语</a>&nbsp;
 <a href="Roomfl.asp?RoomType=13">爱好</a>&nbsp;
 <a href="Roomfl.asp?RoomType=14">校园</a>&nbsp;
 <a href="Roomfl.asp?RoomType=15">企业</a>&nbsp; <a href="Roomfl.asp?RoomType=16">会议</a>&nbsp;
 <a href="Roomfl.asp?RoomType=17">战友</a>&nbsp;
 <a href="Roomfl.asp?RoomType=18">交友</a>&nbsp;
 <a href="Roomfl.asp?RoomType=19">闲谈</a>&nbsp;
 <a href="Roomfl.asp?RoomType=20">其他</a></td>
    </tr>
               
    <tr>
      <td width="600" height="34" colspan="3">
      <p align="center">当前为：<b><font color="#800080"><%=chatfl(RoomType)%> </font></b>分类</td>
    </tr>
<script>
	for(var i=0; i<100; i++) 
	{	
