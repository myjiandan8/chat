<%sub ubbshow()%>
<input onClick=Cbold() type="button" name="Bold" value="B粗体" class="button"> 
<input onClick=Citalic() type="button" name="Italic" value="I斜体" class="button"> 
<input onClick=Cunder() type="button" name="Underline" value="U下划线" class="button"> 
<input onClick=Ccenter() type="button" name="Center" value="居中" class="button"> 
<input onClick=Curl() type="button" name="Link" value="超连接" class="button"> 
<input onClick=Cimage() type="button" name="image" value="图片" class="button"> 
<input onClick=Cfly() type="button" name="Fly" value="飘动" class="button"> 
<input type="button" name="iFrame" value="插入网页" class="button" onClick=CiFrame()>
&nbsp;&nbsp;&nbsp;<br>
字体： 
