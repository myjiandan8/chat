...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="650" id="AutoNumber6">
  <tr>
    <td width="100%">
    <br>
    <span lang="en-us">&nbsp;<img border="0" src="../../ADMINLW/img/closedfold.gif">
...
<div align="center">
  ...
  <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#C6C3FF" width="650" id="AutoNumber4" bgcolor="#F7F7FF" height="281">
    <tr>
      <td width="100%" background="../../ADMINLW/img/bg.gif" height="22">&nbsp;<img border="0" src="../../ADMINLW/img/jt.gif"><b>
<%
if id<>"" and xg<>"" then
                        ...
                        <TABLE cellSpacing=0 cellPadding=0 border=0>
                          ...
                          <TR>
                            <TD>
                              ...
                              <a target="_blank" href="../../ADMINLW/help/UBB.asp">内容支持插入ＵＢＢ标签，使用方法请参考帮助</a> 
                              <P><br>
                              <br>
                              <br>
...
&nbsp; 
                      ...
                      &nbsp;<a target="_blank" href="../../ADMINLW/help/color.asp">查看颜色表</a>&nbsp;&nbsp;
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="650" id="AutoNumber6">
  <tr>
    ...
    <br>
    <span lang="en-us">&nbsp;<img border="0" src="../../ADMINLW/img/closedfold.gif">
    您目前的位置>>><a href="../../ADMINLW/main.asp">首页</a>>>></span><a href="addnew.asp">添加新闻</a><span lang="en-us">>>>添加新闻</span>表单<span lang="en-us"> </td>
  </tr>
</table>
