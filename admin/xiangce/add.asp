...
<FORM method="POST" name="FrontPage_Form1" action="addsave.asp" onsubmit='return FrontPage_Form1_Validator(this)' enctype=multipart/form-data language="JavaScript">
