...
<div align="center">
        ...
        <div align="center">
          <center> 
        <table height=309 cellspacing=0 cellpadding=5 width=584 border=0 style="border-collapse: collapse" bordercolor="#111111">
          <tbody> 
          <tr> 
            <td height="344" width="574"> 
...
%>
                      ...
                      <table bordercolor=#cccccc cellspacing="3" cellpadding=3 width="553"  border="0" style="WORD-BREAK: break-all" align="center" >
                        <tr> 
                          <td valign=bottom bordercolor=#333333 height="2" width="541"> 
...
<font size="1" color="#C0C0C0">◇◇◇ ◇◇◇ ◇◇◇ ◇◇◇ ◇◇◇ ◇◇◇ ◇◇◇ ◇◇◇ </font></div>
                        ...
                        <tbody> 
                        <tr> 
                          <td valign=bottom bordercolor=#333333 width="541"> 
                            <table cellspacing=0 cellpadding=0 border=0 width="493" style="border-collapse: collapse" bordercolor="#111111">
                              <tbody> 
                              <tr> 
                                <td width=14><img 
                        src="IMAGES/top_l.gif"></td>
                                <td 
                      background="IMAGES/top_c.gif" width="463"></td>
                                <td width=16><img 
                      ...
                      background="IMAGES/center_l.gif">　</td>
                        ...
                        bgcolor=#fffff1 width="463">&nbsp;<img src=" <%=T_Emot%>" border="0"> 
<%=newsConvert(rs("content"))%>
                      ...
                      background="IMAGES/center_r.gif"><img 
                        ...
                        src="IMAGES/foot_l1.gif"></td>
                                <td 
                      background="IMAGES/foot_c.gif" width="463"><img 
                        ...
                        src="IMAGES/foot_r.gif"></td>
                            ...
                            <table cellspacing=0 cellpadding=0 width="412" border=0>
                              <tbody> 
                              <tr> 
                                <td valign=top width="112" height="18" rowspan="2"> 
                                ...
                                <td valign=bottom height="9" width="300"><a href="<%=homepage%>" target="_blank"><img src="IMAGES/home.gif" width="16" height="16" border="0">主页</a> 
                              ...
                              <tr> 
                                <td valign=bottom height="9" width="300"> 
...
%>
                                    <tbody> 
                                    <tr> 
                                      <td width=14 align="right"><img 
                        src="IMAGES/top_l.gif"></td>
                                      <td 
                      background="IMAGES/top_c.gif" width="236"></td>
                                      <td width=16><img 
                        src="IMAGES/top_r.gif"></td>
                                    </tr>
                                    <tr> 
                      ...
                      background="IMAGES/center_l.gif"></td>
                                      <td style="LINE-HEIGHT: 14pt" 
                        bgcolor=#fffff1 width="236">&nbsp;<font color=red>室主回复：</font><font color="#666633"> 
...
response.write reply%>
                      ...
                      background="IMAGES/center_r.gif"><img 
                        src="IMAGES/top_r2.gif"></td>
                                    ...
                                    <tr> 
                                      <td valign=top width=14 height="23" align="right"><img 
                        src="IMAGES/foot_l1.gif"></td>
                                      <td 
                      background="IMAGES/foot_c.gif" width="236">　</td>
                                      <td align=right width=16 height="23"><img 
                        src="IMAGES/foot_r.gif"></td>
                                    </tr>
                                    </tbody> 
                                    <%else%>
                              ...
                              <tr> 
                                <td valign=top colspan="2" width="412">&nbsp; </td>
                              </tr>
                                                            <tr> 
                                <td valign=top colspan="2" width="412"> <font color="#006699"> 

                                  </font> 
                                  <input type="button" name="注册" value="回复" onClick=javascript:window.open('reply.asp?id=<%=rs("id")%>','_self','') class="input1">
                                  <input type="button" name="注册2" value="删除" onClick=javascript:window.open('deltxt.asp?id=<%=rs("id")%>','_self','') class="input1">&nbsp;&nbsp;
                                </td>
                              </tr>
                              <tr> 
                                <td valign=top colspan="2" width="412"> 
                                </td>
                              </tr>
                              </tbody> 
                            </table>
