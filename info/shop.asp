...
<div align="center">
	<table border="0" width="582" id="table1" cellspacing="0" cellpadding="0" height="1167">
		<tr>
			<td height="29">
			<b>聊湾聊天室全自动购买系统</b></td>
		</tr>
  <tr> 
    <td height="1" background="../chat/images/dotlineh.gif"></td>
		...
		<tr>
			<td height="1111" align="center" valign="top">
...
<form name="login" id="login" onsubmit="return false;" action="/" method="post">
						<tr>
							<td width="64" height="26"><font color="#008000">
							价格计算：</font></td>
							<td height="26" width="315">
...
<%
 ...
 loop %>					
							...
							<td width="136" height="26">价格：<input style="color: #0000ff" type="text" name="m" size="8" value="180">元/年</td>
							<td width="58" height="26">
							<p align="left"><a href="#buzhou">购买步骤</a></td>
						</tr>
</form>
					</table>
						...
						<tr>
							...
							<table cellSpacing="4" cellPadding="0" width="98%" align="right" border="0" id="table5">
								<tr>
									...
									<img height="15" src="images/1.gif" width="13"></td>
									<td class="cn" width="96%"><strong>详细阅读</strong>《声明事项》，<strong>以及</strong>《
									聊湾聊天室服务条款》。</td>
								</tr>
								<tr>
									<td vAlign="top" width="4%">
									<img height="15" src="images/2.gif" width="13"></td>
									<td class="cn"><b>
									首先要在聊湾注册一个会员用户，然后记录自己的会员数字ID。</b></td>
								</tr>
								<tr>
									<td vAlign="top">
									<img height="15" src="images/3.gif" width="13"></td>
								...
								<tr>
									<td vAlign="top">
									<img height="15" src="images/4.gif" width="13"></td>
...
　<table class="dashtab" cellSpacing="0" cellPadding="6" width="100%" border="0" id="table6">
								...
								<tr>
									...
									<img height="15" src="images/5.gif" width="13"></td>
